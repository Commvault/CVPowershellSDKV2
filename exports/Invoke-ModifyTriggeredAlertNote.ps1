...
.Link
https://docs.microsoft.com/en-us/powershell/module/commvaultpowershell/invoke-modifytriggeredalertnote
#>
function Invoke-ModifyTriggeredAlertNote {
...
begin {
    try {
        ...
        $mapping = @{
            Modify = 'CommvaultPowerShell.private\Invoke-ModifyTriggeredAlertNote_Modify';
            ModifyExpanded = 'CommvaultPowerShell.private\Invoke-ModifyTriggeredAlertNote_ModifyExpanded';
            ModifyViaIdentity = 'CommvaultPowerShell.private\Invoke-ModifyTriggeredAlertNote_ModifyViaIdentity';
            ModifyViaIdentityExpanded = 'CommvaultPowerShell.private\Invoke-ModifyTriggeredAlertNote_ModifyViaIdentityExpanded';
        }
