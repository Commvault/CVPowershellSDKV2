...
.Link
https://docs.microsoft.com/en-us/powershell/module/commvaultpowershell/set-node
#>
function Set-Node {
...
begin {
    try {
        ...
        $mapping = @{
            Refresh = 'CommvaultPowerShell.private\Set-Node_Refresh';
            RefreshViaIdentity = 'CommvaultPowerShell.private\Set-Node_RefreshViaIdentity';
        }
