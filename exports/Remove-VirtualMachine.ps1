...
.Link
https://docs.microsoft.com/en-us/powershell/module/commvaultpowershell/remove-virtualmachine
#>
...
begin {
    try {
        ...
        $mapping = @{
            Delete = 'CommvaultPowerShell.private\Remove-VirtualMachine_Delete';
            DeleteViaIdentity = 'CommvaultPowerShell.private\Remove-VirtualMachine_DeleteViaIdentity';
        }
