...
.Link
https://docs.microsoft.com/en-us/powershell/module/commvaultpowershell/remove-usergroup
#>
...
begin {
    try {
        ...
        $mapping = @{
            Delete = 'CommvaultPowerShell.private\Remove-UserGroup_Delete';
            DeleteViaIdentity = 'CommvaultPowerShell.private\Remove-UserGroup_DeleteViaIdentity';
        }
