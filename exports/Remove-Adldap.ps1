...
.Link
https://docs.microsoft.com/en-us/powershell/module/commvaultpowershell/remove-adldap
#>
function Remove-Adldap {
...
begin {
    try {
        ...
        $mapping = @{
            Delete = 'CommvaultPowerShell.private\Remove-Adldap_Delete';
            DeleteViaIdentity = 'CommvaultPowerShell.private\Remove-Adldap_DeleteViaIdentity';
        }
