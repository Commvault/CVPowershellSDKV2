...
.Link
https://docs.microsoft.com/en-us/powershell/module/commvaultpowershell/remove-archivebackupdestination
#>
function Remove-ArchiveBackupDestination {
...
begin {
    try {
        ...
        $mapping = @{
            Delete = 'CommvaultPowerShell.private\Remove-ArchiveBackupDestination_Delete';
            DeleteViaIdentity = 'CommvaultPowerShell.private\Remove-ArchiveBackupDestination_DeleteViaIdentity';
        }
