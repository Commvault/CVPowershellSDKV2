...
.Link
https://docs.microsoft.com/en-us/powershell/module/commvaultpowershell/get-companydetail
#>
function Get-CompanyDetail {
...
begin {
    try {
        ...
        $mapping = @{
            Get = 'CommvaultPowerShell.private\Get-CompanyDetail_Get';
            GetViaIdentity = 'CommvaultPowerShell.private\Get-CompanyDetail_GetViaIdentity';
        }
