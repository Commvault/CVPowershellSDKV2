...
.Link
https://docs.microsoft.com/en-us/powershell/module/commvaultpowershell/disable-ddbcommcell
#>
function Disable-DdbCommcell {
...
begin {
    try {
        ...
        $mapping = @{
            Disable = 'CommvaultPowerShell.private\Disable-DdbCommcell_Disable';
        }
