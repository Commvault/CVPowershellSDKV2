...
.Link
https://docs.microsoft.com/en-us/powershell/module/commvaultpowershell/disable-contentindexingcommcell
#>
function Disable-ContentIndexingCommcell {
...
begin {
    try {
        ...
        $mapping = @{
            Disable = 'CommvaultPowerShell.private\Disable-ContentIndexingCommcell_Disable';
        }
