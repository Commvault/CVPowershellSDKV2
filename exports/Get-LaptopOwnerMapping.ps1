...
.Link
https://docs.microsoft.com/en-us/powershell/module/commvaultpowershell/get-laptopownermapping
#>
function Get-LaptopOwnerMapping {
...
begin {
    try {
        ...
        $mapping = @{
            Get = 'CommvaultPowerShell.private\Get-LaptopOwnerMapping_Get';
        }
