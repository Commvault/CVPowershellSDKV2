...
.Link
https://docs.microsoft.com/en-us/powershell/module/commvaultpowershell/get-usergroupdetail
#>
function Get-UserGroupDetail {
...
begin {
    try {
        ...
        $mapping = @{
            Get = 'CommvaultPowerShell.private\Get-UserGroupDetail_Get';
            GetViaIdentity = 'CommvaultPowerShell.private\Get-UserGroupDetail_GetViaIdentity';
        }
