...
.Link
https://docs.microsoft.com/en-us/powershell/module/commvaultpowershell/get-laptopplan
#>
function Get-LaptopPlan {
...
begin {
    try {
        ...
        $mapping = @{
            Get = 'CommvaultPowerShell.private\Get-LaptopPlan_Get';
            GetViaIdentity = 'CommvaultPowerShell.private\Get-LaptopPlan_GetViaIdentity';
        }
