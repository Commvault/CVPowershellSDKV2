...
.Link
https://docs.microsoft.com/en-us/powershell/module/commvaultpowershell/enable-restoreinstance
#>
function Enable-RestoreInstance {
...
begin {
    try {
        ...
        $mapping = @{
            Enable = 'CommvaultPowerShell.private\Enable-RestoreInstance_Enable';
            EnableViaIdentity = 'CommvaultPowerShell.private\Enable-RestoreInstance_EnableViaIdentity';
        }
