...
.Link
https://docs.microsoft.com/en-us/powershell/module/commvaultpowershell/disable-schedulercommcell
#>
function Disable-SchedulerCommcell {
...
begin {
    try {
        ...
        $mapping = @{
            Disable = 'CommvaultPowerShell.private\Disable-SchedulerCommcell_Disable';
        }
