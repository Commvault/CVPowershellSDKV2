...
.Link
https://docs.microsoft.com/en-us/powershell/module/commvaultpowershell/remove-backupdestination
#>
...
begin {
    try {
        ...
        $mapping = @{
            Delete = 'CommvaultPowerShell.private\Remove-BackupDestination_Delete';
            DeleteViaIdentity = 'CommvaultPowerShell.private\Remove-BackupDestination_DeleteViaIdentity';
        }
