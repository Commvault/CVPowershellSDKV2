...
.Link
https://docs.microsoft.com/en-us/powershell/module/commvaultpowershell/invoke-laptop
#>
function Invoke-Laptop {
...
begin {
    try {
        ...
        $mapping = @{
            Post = 'CommvaultPowerShell.private\Invoke-Laptop_Post';
            PostExpanded = 'CommvaultPowerShell.private\Invoke-Laptop_PostExpanded';
        }
