...
.Link
https://docs.microsoft.com/en-us/powershell/module/commvaultpowershell/get-roledetail
#>
...
begin {
    try {
        ...
        $mapping = @{
            Get = 'CommvaultPowerShell.private\Get-RoleDetail_Get';
            GetViaIdentity = 'CommvaultPowerShell.private\Get-RoleDetail_GetViaIdentity';
        }
