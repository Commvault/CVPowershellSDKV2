...
.Link
https://docs.microsoft.com/en-us/powershell/module/commvaultpowershell/get-backupdestination
#>
...
begin {
    try {
        ...
        $mapping = @{
            Get = 'CommvaultPowerShell.private\Get-BackupDestination_Get';
            GetViaIdentity = 'CommvaultPowerShell.private\Get-BackupDestination_GetViaIdentity';
        }
