...
.Link
https://docs.microsoft.com/en-us/powershell/module/commvaultpowershell/get-requestdetail
#>
...
begin {
    try {
        ...
        $mapping = @{
            Get = 'CommvaultPowerShell.private\Get-RequestDetail_Get';
            GetViaIdentity = 'CommvaultPowerShell.private\Get-RequestDetail_GetViaIdentity';
        }
