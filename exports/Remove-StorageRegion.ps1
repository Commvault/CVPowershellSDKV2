...
.Link
https://docs.microsoft.com/en-us/powershell/module/commvaultpowershell/remove-storageregion
#>
function Remove-StorageRegion {
...
begin {
    try {
        ...
        $mapping = @{
            Delete = 'CommvaultPowerShell.private\Remove-StorageRegion_Delete';
            Delete1 = 'CommvaultPowerShell.private\Remove-StorageRegion_Delete1';
            Delete2 = 'CommvaultPowerShell.private\Remove-StorageRegion_Delete2';
            DeleteViaIdentity = 'CommvaultPowerShell.private\Remove-StorageRegion_DeleteViaIdentity';
            DeleteViaIdentity1 = 'CommvaultPowerShell.private\Remove-StorageRegion_DeleteViaIdentity1';
            DeleteViaIdentity2 = 'CommvaultPowerShell.private\Remove-StorageRegion_DeleteViaIdentity2';
        }
