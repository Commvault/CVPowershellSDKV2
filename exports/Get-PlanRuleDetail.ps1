...
.Link
https://docs.microsoft.com/en-us/powershell/module/commvaultpowershell/get-planruledetail
#>
function Get-PlanRuleDetail {
...
begin {
    try {
        ...
        $mapping = @{
            Get = 'CommvaultPowerShell.private\Get-PlanRuleDetail_Get';
            GetViaIdentity = 'CommvaultPowerShell.private\Get-PlanRuleDetail_GetViaIdentity';
        }
