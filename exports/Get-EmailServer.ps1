...
.Link
https://docs.microsoft.com/en-us/powershell/module/commvaultpowershell/get-emailserver
#>
function Get-EmailServer {
...
begin {
    try {
        ...
        $mapping = @{
            Get = 'CommvaultPowerShell.private\Get-EmailServer_Get';
        }
