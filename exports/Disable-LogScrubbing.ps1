...
.Link
https://docs.microsoft.com/en-us/powershell/module/commvaultpowershell/disable-logscrubbing
#>
function Disable-LogScrubbing {
...
begin {
    try {
        ...
        $mapping = @{
            Disable = 'CommvaultPowerShell.private\Disable-LogScrubbing_Disable';
        }
