...
.Link
https://docs.microsoft.com/en-us/powershell/module/commvaultpowershell/get-activateentityauditlist
#>
function Get-ActivateEntityAuditList {
...
begin {
    try {
        ...
        $mapping = @{
            Get = 'CommvaultPowerShell.private\Get-ActivateEntityAuditList_Get';
            GetViaIdentity = 'CommvaultPowerShell.private\Get-ActivateEntityAuditList_GetViaIdentity';
        }
