...
.Link
https://docs.microsoft.com/en-us/powershell/module/commvaultpowershell/disable-restorecommcell
#>
function Disable-RestoreCommcell {
...
begin {
    try {
        ...
        $mapping = @{
            Disable = 'CommvaultPowerShell.private\Disable-RestoreCommcell_Disable';
        }
