...
.Link
https://docs.microsoft.com/en-us/powershell/module/commvaultpowershell/get-vmdetail
#>
...
begin {
    try {
        ...
        $mapping = @{
            Get = 'CommvaultPowerShell.private\Get-VMDetail_Get';
            GetViaIdentity = 'CommvaultPowerShell.private\Get-VMDetail_GetViaIdentity';
        }
