...
MAPPINGS <ISnapshotCopyMapping[]>: .
  ...
  [Vendor <String>]: Snapshot vendors available for Snap Copy mappings
.Link
https://docs.microsoft.com/en-us/powershell/module/commvaultpowershell/invoke-modifybackupdestination
#>
function Invoke-ModifyBackupDestination {
...
begin {
    try {
        ...
        $mapping = @{
            Modify = 'CommvaultPowerShell.private\Invoke-ModifyBackupDestination_Modify';
            ModifyExpanded = 'CommvaultPowerShell.private\Invoke-ModifyBackupDestination_ModifyExpanded';
            ModifyViaIdentity = 'CommvaultPowerShell.private\Invoke-ModifyBackupDestination_ModifyViaIdentity';
            ModifyViaIdentityExpanded = 'CommvaultPowerShell.private\Invoke-ModifyBackupDestination_ModifyViaIdentityExpanded';
        }
