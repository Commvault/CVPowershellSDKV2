...
.Link
https://docs.microsoft.com/en-us/powershell/module/commvaultpowershell/invoke-modifymediaagent
#>
function Invoke-ModifyMediaAgent {
...
begin {
    try {
        ...
        $mapping = @{
            Modify = 'CommvaultPowerShell.private\Invoke-ModifyMediaAgent_Modify';
            ModifyExpanded = 'CommvaultPowerShell.private\Invoke-ModifyMediaAgent_ModifyExpanded';
            ModifyViaIdentity = 'CommvaultPowerShell.private\Invoke-ModifyMediaAgent_ModifyViaIdentity';
            ModifyViaIdentityExpanded = 'CommvaultPowerShell.private\Invoke-ModifyMediaAgent_ModifyViaIdentityExpanded';
        }
