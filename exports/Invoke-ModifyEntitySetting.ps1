...
ENTITYSETTINGS <IModifyEntitySettingsItem[]>: .
  ...
  [EntityType <String>]: 
.Link
https://docs.microsoft.com/en-us/powershell/module/commvaultpowershell/invoke-modifyentitysetting
#>
function Invoke-ModifyEntitySetting {
...
begin {
    try {
        ...
        $mapping = @{
            Modify = 'CommvaultPowerShell.private\Invoke-ModifyEntitySetting_Modify';
            ModifyExpanded = 'CommvaultPowerShell.private\Invoke-ModifyEntitySetting_ModifyExpanded';
        }
