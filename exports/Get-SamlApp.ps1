...
.Link
https://docs.microsoft.com/en-us/powershell/module/commvaultpowershell/get-samlapp
#>
function Get-SamlApp {
...
begin {
    try {
        ...
        $mapping = @{
            Get = 'CommvaultPowerShell.private\Get-SamlApp_Get';
            GetViaIdentity = 'CommvaultPowerShell.private\Get-SamlApp_GetViaIdentity';
        }
