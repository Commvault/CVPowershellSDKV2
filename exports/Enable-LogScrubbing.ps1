...
.Link
https://docs.microsoft.com/en-us/powershell/module/commvaultpowershell/enable-logscrubbing
#>
function Enable-LogScrubbing {
...
begin {
    try {
        ...
        $mapping = @{
            Enable = 'CommvaultPowerShell.private\Enable-LogScrubbing_Enable';
        }
