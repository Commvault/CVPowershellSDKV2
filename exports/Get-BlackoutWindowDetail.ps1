...
.Link
https://docs.microsoft.com/en-us/powershell/module/commvaultpowershell/get-blackoutwindowdetail
#>
function Get-BlackoutWindowDetail {
...
begin {
    try {
        ...
        $mapping = @{
            Get = 'CommvaultPowerShell.private\Get-BlackoutWindowDetail_Get';
            GetViaIdentity = 'CommvaultPowerShell.private\Get-BlackoutWindowDetail_GetViaIdentity';
        }
