...
.Link
https://docs.microsoft.com/en-us/powershell/module/commvaultpowershell/get-recoverypointstore
#>
function Get-RecoveryPointStore {
...
begin {
    try {
        ...
        $mapping = @{
            Get = 'CommvaultPowerShell.private\Get-RecoveryPointStore_Get';
            GetViaIdentity = 'CommvaultPowerShell.private\Get-RecoveryPointStore_GetViaIdentity';
        }
