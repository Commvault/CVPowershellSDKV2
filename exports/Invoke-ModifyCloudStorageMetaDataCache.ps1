...
.Link
https://docs.microsoft.com/en-us/powershell/module/commvaultpowershell/invoke-modifycloudstoragemetadatacache
#>
function Invoke-ModifyCloudStorageMetaDataCache {
...
begin {
    try {
        ...
        $mapping = @{
            Modify = 'CommvaultPowerShell.private\Invoke-ModifyCloudStorageMetaDataCache_Modify';
            ModifyExpanded = 'CommvaultPowerShell.private\Invoke-ModifyCloudStorageMetaDataCache_ModifyExpanded';
            ModifyViaIdentity = 'CommvaultPowerShell.private\Invoke-ModifyCloudStorageMetaDataCache_ModifyViaIdentity';
            ModifyViaIdentityExpanded = 'CommvaultPowerShell.private\Invoke-ModifyCloudStorageMetaDataCache_ModifyViaIdentityExpanded';
        }
