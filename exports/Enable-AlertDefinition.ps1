...
.Link
https://docs.microsoft.com/en-us/powershell/module/commvaultpowershell/enable-alertdefinition
#>
...
begin {
    try {
        ...
        $mapping = @{
            Enable = 'CommvaultPowerShell.private\Enable-AlertDefinition_Enable';
            EnableViaIdentity = 'CommvaultPowerShell.private\Enable-AlertDefinition_EnableViaIdentity';
        }
