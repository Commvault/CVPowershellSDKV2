...
.Link
https://docs.microsoft.com/en-us/powershell/module/commvaultpowershell/send-testmailreq
#>
function Send-TestMailReq {
...
begin {
    try {
        ...
        $mapping = @{
            Send = 'CommvaultPowerShell.private\Send-TestMailReq_Send';
            SendExpanded = 'CommvaultPowerShell.private\Send-TestMailReq_SendExpanded';
        }
