...
.Link
https://docs.microsoft.com/en-us/powershell/module/commvaultpowershell/remove-laptopplan
#>
function Remove-LaptopPlan {
...
begin {
    try {
        ...
        $mapping = @{
            Delete = 'CommvaultPowerShell.private\Remove-LaptopPlan_Delete';
            DeleteViaIdentity = 'CommvaultPowerShell.private\Remove-LaptopPlan_DeleteViaIdentity';
        }
