...
.Link
https://docs.microsoft.com/en-us/powershell/module/commvaultpowershell/disable-backupservergroup
#>
function Disable-BackupServerGroup {
...
begin {
    try {
        ...
        $mapping = @{
            Disable = 'CommvaultPowerShell.private\Disable-BackupServerGroup_Disable';
            DisableViaIdentity = 'CommvaultPowerShell.private\Disable-BackupServerGroup_DisableViaIdentity';
        }
