...
.Link
https://docs.microsoft.com/en-us/powershell/module/commvaultpowershell/get-hypervisor
#>
...
begin {
    try {
        ...
        $mapping = @{
            Get = 'CommvaultPowerShell.private\Get-Hypervisor_Get';
            GetViaIdentity = 'CommvaultPowerShell.private\Get-Hypervisor_GetViaIdentity';
            List = 'CommvaultPowerShell.private\Get-Hypervisor_List';
        }
