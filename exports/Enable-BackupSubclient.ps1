...
.Link
https://docs.microsoft.com/en-us/powershell/module/commvaultpowershell/enable-backupsubclient
#>
function Enable-BackupSubclient {
...
begin {
    try {
        ...
        $mapping = @{
            Enable = 'CommvaultPowerShell.private\Enable-BackupSubclient_Enable';
            EnableViaIdentity = 'CommvaultPowerShell.private\Enable-BackupSubclient_EnableViaIdentity';
        }
