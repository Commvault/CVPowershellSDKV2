...
.Link
https://docs.microsoft.com/en-us/powershell/module/commvaultpowershell/enable-backupservergroup
#>
function Enable-BackupServerGroup {
...
begin {
    try {
        ...
        $mapping = @{
            Enable = 'CommvaultPowerShell.private\Enable-BackupServerGroup_Enable';
            EnableViaIdentity = 'CommvaultPowerShell.private\Enable-BackupServerGroup_EnableViaIdentity';
        }
