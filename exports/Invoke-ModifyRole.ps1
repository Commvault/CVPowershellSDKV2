...
SECURITY <IUpdateSecurityAssoc[]>: Used to update the security association for the role
  ...
  [UserName <String>]: 
.Link
https://docs.microsoft.com/en-us/powershell/module/commvaultpowershell/invoke-modifyrole
#>
function Invoke-ModifyRole {
...
begin {
    try {
        ...
        $mapping = @{
            Modify = 'CommvaultPowerShell.private\Invoke-ModifyRole_Modify';
            ModifyExpanded = 'CommvaultPowerShell.private\Invoke-ModifyRole_ModifyExpanded';
            ModifyViaIdentity = 'CommvaultPowerShell.private\Invoke-ModifyRole_ModifyViaIdentity';
            ModifyViaIdentityExpanded = 'CommvaultPowerShell.private\Invoke-ModifyRole_ModifyViaIdentityExpanded';
        }
