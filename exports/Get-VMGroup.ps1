...
.Link
https://docs.microsoft.com/en-us/powershell/module/commvaultpowershell/get-vmgroup
#>
...
begin {
    try {
        ...
        $mapping = @{
            Get = 'CommvaultPowerShell.private\Get-VMGroup_Get';
            Get1 = 'CommvaultPowerShell.private\Get-VMGroup_Get1';
            GetViaIdentity = 'CommvaultPowerShell.private\Get-VMGroup_GetViaIdentity';
        }
