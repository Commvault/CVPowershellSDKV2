...
.Link
https://docs.microsoft.com/en-us/powershell/module/commvaultpowershell/get-bucketdetail
#>
function Get-BucketDetail {
...
begin {
    try {
        ...
        $mapping = @{
            Get = 'CommvaultPowerShell.private\Get-BucketDetail_Get';
            GetViaIdentity = 'CommvaultPowerShell.private\Get-BucketDetail_GetViaIdentity';
        }
