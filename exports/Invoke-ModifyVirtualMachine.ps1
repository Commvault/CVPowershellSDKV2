...
SECURITYPERMISSIONS <IPermissionResp[]>: .
  ...
  [Type <String>]: Returns the type of association.
.Link
https://docs.microsoft.com/en-us/powershell/module/commvaultpowershell/invoke-modifyvirtualmachine
#>
function Invoke-ModifyVirtualMachine {
...
begin {
    try {
        ...
        $mapping = @{
            Modify = 'CommvaultPowerShell.private\Invoke-ModifyVirtualMachine_Modify';
            ModifyExpanded = 'CommvaultPowerShell.private\Invoke-ModifyVirtualMachine_ModifyExpanded';
            ModifyViaIdentity = 'CommvaultPowerShell.private\Invoke-ModifyVirtualMachine_ModifyViaIdentity';
            ModifyViaIdentityExpanded = 'CommvaultPowerShell.private\Invoke-ModifyVirtualMachine_ModifyViaIdentityExpanded';
        }
