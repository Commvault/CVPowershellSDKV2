...
begin {
    try {
        ...
        $mapping = @{
            Put = 'CommvaultPowerShell.private\Set-PlanRuleSetting_Put';
            PutExpanded = 'CommvaultPowerShell.private\Set-PlanRuleSetting_PutExpanded';
        }
