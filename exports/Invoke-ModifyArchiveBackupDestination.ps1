...
.Link
https://docs.microsoft.com/en-us/powershell/module/commvaultpowershell/invoke-modifyarchivebackupdestination
#>
function Invoke-ModifyArchiveBackupDestination {
...
begin {
    try {
        ...
        $mapping = @{
            Modify = 'CommvaultPowerShell.private\Invoke-ModifyArchiveBackupDestination_Modify';
            ModifyExpanded = 'CommvaultPowerShell.private\Invoke-ModifyArchiveBackupDestination_ModifyExpanded';
            ModifyViaIdentity = 'CommvaultPowerShell.private\Invoke-ModifyArchiveBackupDestination_ModifyViaIdentity';
            ModifyViaIdentityExpanded = 'CommvaultPowerShell.private\Invoke-ModifyArchiveBackupDestination_ModifyViaIdentityExpanded';
        }
