...
.Link
https://docs.microsoft.com/en-us/powershell/module/commvaultpowershell/get-apllicationgroup
#>
function Get-APllicationGroup {
...
begin {
    try {
        ...
        $mapping = @{
            Get = 'CommvaultPowerShell.private\Get-APllicationGroup_Get';
        }
