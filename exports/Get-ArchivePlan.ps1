...
.Link
https://docs.microsoft.com/en-us/powershell/module/commvaultpowershell/get-archiveplan
#>
...
begin {
    try {
        ...
        $mapping = @{
            Get = 'CommvaultPowerShell.private\Get-ArchivePlan_Get';
            GetViaIdentity = 'CommvaultPowerShell.private\Get-ArchivePlan_GetViaIdentity';
        }
