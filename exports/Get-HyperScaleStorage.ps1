...
.Link
https://docs.microsoft.com/en-us/powershell/module/commvaultpowershell/get-hyperscalestorage
#>
function Get-HyperScaleStorage {
...
begin {
    try {
        ...
        $mapping = @{
            Get = 'CommvaultPowerShell.private\Get-HyperScaleStorage_Get';
            GetViaIdentity = 'CommvaultPowerShell.private\Get-HyperScaleStorage_GetViaIdentity';
        }
