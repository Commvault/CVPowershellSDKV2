...
.Link
https://docs.microsoft.com/en-us/powershell/module/commvaultpowershell/enable-dataagingservergroup
#>
function Enable-DataAgingServerGroup {
...
begin {
    try {
        ...
        $mapping = @{
            Enable = 'CommvaultPowerShell.private\Enable-DataAgingServerGroup_Enable';
            EnableViaIdentity = 'CommvaultPowerShell.private\Enable-DataAgingServerGroup_EnableViaIdentity';
        }
