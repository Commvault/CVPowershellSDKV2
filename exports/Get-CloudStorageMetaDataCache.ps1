...
.Link
https://docs.microsoft.com/en-us/powershell/module/commvaultpowershell/get-cloudstoragemetadatacache
#>
function Get-CloudStorageMetaDataCache {
...
begin {
    try {
        ...
        $mapping = @{
            Get = 'CommvaultPowerShell.private\Get-CloudStorageMetaDataCache_Get';
            GetViaIdentity = 'CommvaultPowerShell.private\Get-CloudStorageMetaDataCache_GetViaIdentity';
        }
