...
REVIEWERS <IIdNameDisplayName[]>: List of reviewers for the request
  ...
  [Name <String>]: 
.Link
https://docs.microsoft.com/en-us/powershell/module/commvaultpowershell/set-
#>
function Set- {
...
begin {
    try {
        ...
        $mapping = @{
            Configure = 'CommvaultPowerShell.private\Set-_Configure';
            ConfigureExpanded = 'CommvaultPowerShell.private\Set-_ConfigureExpanded';
            ConfigureViaIdentity = 'CommvaultPowerShell.private\Set-_ConfigureViaIdentity';
            ConfigureViaIdentityExpanded = 'CommvaultPowerShell.private\Set-_ConfigureViaIdentityExpanded';
        }
