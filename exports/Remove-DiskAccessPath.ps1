...
.Link
https://docs.microsoft.com/en-us/powershell/module/commvaultpowershell/remove-diskaccesspath
#>
function Remove-DiskAccessPath {
...
begin {
    try {
        ...
        $mapping = @{
            Delete = 'CommvaultPowerShell.private\Remove-DiskAccessPath_Delete';
            DeleteViaIdentity = 'CommvaultPowerShell.private\Remove-DiskAccessPath_DeleteViaIdentity';
        }
