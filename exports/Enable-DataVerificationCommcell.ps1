...
.Link
https://docs.microsoft.com/en-us/powershell/module/commvaultpowershell/enable-dataverificationcommcell
#>
function Enable-DataVerificationCommcell {
...
begin {
    try {
        ...
        $mapping = @{
            Enable = 'CommvaultPowerShell.private\Enable-DataVerificationCommcell_Enable';
        }
