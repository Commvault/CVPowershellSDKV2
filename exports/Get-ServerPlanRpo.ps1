...
.Link
https://docs.microsoft.com/en-us/powershell/module/commvaultpowershell/get-serverplanrpo
#>
function Get-ServerPlanRpo {
...
begin {
    try {
        ...
        $mapping = @{
            Get = 'CommvaultPowerShell.private\Get-ServerPlanRpo_Get';
            GetViaIdentity = 'CommvaultPowerShell.private\Get-ServerPlanRpo_GetViaIdentity';
        }
