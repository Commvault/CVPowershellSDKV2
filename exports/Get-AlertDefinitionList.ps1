...
.Link
https://docs.microsoft.com/en-us/powershell/module/commvaultpowershell/get-alertdefinitionlist
#>
function Get-AlertDefinitionList {
...
begin {
    try {
        ...
        $mapping = @{
            Get = 'CommvaultPowerShell.private\Get-AlertDefinitionList_Get';
        }
