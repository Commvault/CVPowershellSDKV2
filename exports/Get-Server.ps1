...
.Link
https://docs.microsoft.com/en-us/powershell/module/commvaultpowershell/get-server
#>
function Get-Server {
...
begin {
    try {
        ...
        $mapping = @{
            Get = 'CommvaultPowerShell.private\Get-Server_Get';
            Get1 = 'CommvaultPowerShell.private\Get-Server_Get1';
            GetViaIdentity = 'CommvaultPowerShell.private\Get-Server_GetViaIdentity';
        }
