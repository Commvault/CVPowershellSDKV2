...
.Link
https://docs.microsoft.com/en-us/powershell/module/commvaultpowershell/invoke-modifyschedulepattern
#>
function Invoke-ModifySchedulePattern {
...
begin {
    try {
        ...
        $mapping = @{
            Modify = 'CommvaultPowerShell.private\Invoke-ModifySchedulePattern_Modify';
            ModifyExpanded = 'CommvaultPowerShell.private\Invoke-ModifySchedulePattern_ModifyExpanded';
            ModifyViaIdentity = 'CommvaultPowerShell.private\Invoke-ModifySchedulePattern_ModifyViaIdentity';
            ModifyViaIdentityExpanded = 'CommvaultPowerShell.private\Invoke-ModifySchedulePattern_ModifyViaIdentityExpanded';
        }
