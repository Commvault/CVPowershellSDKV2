...
.Link
https://docs.microsoft.com/en-us/powershell/module/commvaultpowershell/enable-restoreservergroup
#>
function Enable-RestoreServerGroup {
...
begin {
    try {
        ...
        $mapping = @{
            Enable = 'CommvaultPowerShell.private\Enable-RestoreServerGroup_Enable';
            EnableViaIdentity = 'CommvaultPowerShell.private\Enable-RestoreServerGroup_EnableViaIdentity';
        }
