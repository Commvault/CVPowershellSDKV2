...
.Link
https://docs.microsoft.com/en-us/powershell/module/commvaultpowershell/get-userdetail
#>
...
begin {
    try {
        ...
        $mapping = @{
            Get = 'CommvaultPowerShell.private\Get-UserDetail_Get';
            GetViaIdentity = 'CommvaultPowerShell.private\Get-UserDetail_GetViaIdentity';
        }
