...
.Link
https://docs.microsoft.com/en-us/powershell/module/commvaultpowershell/group-
#>
function Group- {
[OutputType([Commvault.Powershell.Models.ICreateTaskRespforBackup], [Commvault.Powershell.Models.IGenericResp], [Commvault.Powershell.Models.IVMGroupPreviewResp])]
...
param(
    ...
    [Parameter(ParameterSetName='GroupViaIdentity')]
    ...
    [Parameter(ParameterSetName='Group1', Mandatory, ValueFromPipeline)]
...
begin {
    try {
        ...
        $mapping = @{
            Group = 'CommvaultPowerShell.private\Group-_Group';
            Group1 = 'CommvaultPowerShell.private\Group-_Group1';
            GroupExpanded = 'CommvaultPowerShell.private\Group-_GroupExpanded';
            GroupViaIdentity = 'CommvaultPowerShell.private\Group-_GroupViaIdentity';
        }
