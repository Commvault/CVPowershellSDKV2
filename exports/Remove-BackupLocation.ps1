...
.Link
https://docs.microsoft.com/en-us/powershell/module/commvaultpowershell/remove-backuplocation
#>
function Remove-BackupLocation {
...
begin {
    try {
        ...
        $mapping = @{
            Delete = 'CommvaultPowerShell.private\Remove-BackupLocation_Delete';
            DeleteViaIdentity = 'CommvaultPowerShell.private\Remove-BackupLocation_DeleteViaIdentity';
        }
