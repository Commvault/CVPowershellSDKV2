...
.Link
https://docs.microsoft.com/en-us/powershell/module/commvaultpowershell/disable-backupsubclient
#>
function Disable-BackupSubclient {
...
begin {
    try {
        ...
        $mapping = @{
            Disable = 'CommvaultPowerShell.private\Disable-BackupSubclient_Disable';
            DisableViaIdentity = 'CommvaultPowerShell.private\Disable-BackupSubclient_DisableViaIdentity';
        }
