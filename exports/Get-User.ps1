...
.Link
https://docs.microsoft.com/en-us/powershell/module/commvaultpowershell/get-user
#>
function Get-User {
[OutputType([Commvault.Powershell.Models.IUserListResp])]
...
begin {
    try {
        ...
        $mapping = @{
            Get = 'CommvaultPowerShell.private\Get-User_Get';
        }
