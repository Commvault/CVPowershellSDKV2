...
.Link
https://docs.microsoft.com/en-us/powershell/module/commvaultpowershell/get-gcpspannerinstancelist
#>
function Get-GcpSpannerInstanceList {
...
begin {
    try {
        ...
        $mapping = @{
            Get = 'CommvaultPowerShell.private\Get-GcpSpannerInstanceList_Get';
        }
