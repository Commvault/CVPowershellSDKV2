...
.Link
https://docs.microsoft.com/en-us/powershell/module/commvaultpowershell/enable-backupinstance
#>
function Enable-BackupInstance {
...
begin {
    try {
        ...
        $mapping = @{
            Enable = 'CommvaultPowerShell.private\Enable-BackupInstance_Enable';
            EnableViaIdentity = 'CommvaultPowerShell.private\Enable-BackupInstance_EnableViaIdentity';
        }
