...
.Link
https://docs.microsoft.com/en-us/powershell/module/commvaultpowershell/get-plan
#>
function Get-Plan {
...
begin {
    try {
        ...
        $mapping = @{
            Get = 'CommvaultPowerShell.private\Get-Plan_Get';
            GetViaIdentity = 'CommvaultPowerShell.private\Get-Plan_GetViaIdentity';
        }
