...
.Link
https://docs.microsoft.com/en-us/powershell/module/commvaultpowershell/disable-dataagingservergroup
#>
function Disable-DataAgingServerGroup {
...
begin {
    try {
        ...
        $mapping = @{
            Disable = 'CommvaultPowerShell.private\Disable-DataAgingServerGroup_Disable';
            DisableViaIdentity = 'CommvaultPowerShell.private\Disable-DataAgingServerGroup_DisableViaIdentity';
        }
