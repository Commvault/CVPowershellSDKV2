...
.Link
https://docs.microsoft.com/en-us/powershell/module/commvaultpowershell/remove-recoverytarget
#>
function Remove-RecoveryTarget {
...
begin {
    try {
        ...
        $mapping = @{
            Delete = 'CommvaultPowerShell.private\Remove-RecoveryTarget_Delete';
            DeleteViaIdentity = 'CommvaultPowerShell.private\Remove-RecoveryTarget_DeleteViaIdentity';
        }
