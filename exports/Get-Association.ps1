...
.Link
https://docs.microsoft.com/en-us/powershell/module/commvaultpowershell/get-association
#>
...
begin {
    try {
        ...
        $mapping = @{
            Get = 'CommvaultPowerShell.private\Get-Association_Get';
            GetViaIdentity = 'CommvaultPowerShell.private\Get-Association_GetViaIdentity';
        }
