...
.Link
https://docs.microsoft.com/en-us/powershell/module/commvaultpowershell/disable-backupagent
#>
function Disable-BackupAgent {
...
begin {
    try {
        ...
        $mapping = @{
            Disable = 'CommvaultPowerShell.private\Disable-BackupAgent_Disable';
            DisableViaIdentity = 'CommvaultPowerShell.private\Disable-BackupAgent_DisableViaIdentity';
        }
