...
#>
function Remove-BulkLaptopOwnerMappingActionDelete {
...
begin {
    try {
        ...
        $mapping = @{
            Delete = 'CommvaultPowerShell.private\Remove-BulkLaptopOwnerMappingActionDelete_Delete';
            DeleteExpanded = 'CommvaultPowerShell.private\Remove-BulkLaptopOwnerMappingActionDelete_DeleteExpanded';
        }
