...
.Link
https://docs.microsoft.com/en-us/powershell/module/commvaultpowershell/remove-user
#>
...
begin {
    try {
        ...
        $mapping = @{
            Delete = 'CommvaultPowerShell.private\Remove-User_Delete';
            DeleteViaIdentity = 'CommvaultPowerShell.private\Remove-User_DeleteViaIdentity';
        }
