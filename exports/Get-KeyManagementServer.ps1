...
.Link
https://docs.microsoft.com/en-us/powershell/module/commvaultpowershell/get-keymanagementserver
#>
function Get-KeyManagementServer {
...
begin {
    try {
        ...
        $mapping = @{
            Get = 'CommvaultPowerShell.private\Get-KeyManagementServer_Get';
        }
