...
.Link
https://docs.microsoft.com/en-us/powershell/module/commvaultpowershell/disable-auxillarycopycommcell
#>
function Disable-AuxillaryCopyCommcell {
...
begin {
    try {
        ...
        $mapping = @{
            Disable = 'CommvaultPowerShell.private\Disable-AuxillaryCopyCommcell_Disable';
        }
