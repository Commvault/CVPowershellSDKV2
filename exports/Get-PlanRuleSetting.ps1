...
.Link
https://docs.microsoft.com/en-us/powershell/module/commvaultpowershell/get-planrulesetting
#>
function Get-PlanRuleSetting {
...
begin {
    try {
        ...
        $mapping = @{
            Get = 'CommvaultPowerShell.private\Get-PlanRuleSetting_Get';
        }
