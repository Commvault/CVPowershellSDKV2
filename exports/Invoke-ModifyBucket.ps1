...
.Link
https://docs.microsoft.com/en-us/powershell/module/commvaultpowershell/invoke-modifybucket
#>
function Invoke-ModifyBucket {
...
begin {
    try {
        ...
        $mapping = @{
            Modify = 'CommvaultPowerShell.private\Invoke-ModifyBucket_Modify';
            ModifyExpanded = 'CommvaultPowerShell.private\Invoke-ModifyBucket_ModifyExpanded';
            ModifyViaIdentity = 'CommvaultPowerShell.private\Invoke-ModifyBucket_ModifyViaIdentity';
            ModifyViaIdentityExpanded = 'CommvaultPowerShell.private\Invoke-ModifyBucket_ModifyViaIdentityExpanded';
        }
