...
#>
function Set-PlanRuleEntityInclude {
...
begin {
    try {
        ...
        $mapping = @{
            Put = 'CommvaultPowerShell.private\Set-PlanRuleEntityInclude_Put';
            PutExpanded = 'CommvaultPowerShell.private\Set-PlanRuleEntityInclude_PutExpanded';
        }
