...
.Link
https://docs.microsoft.com/en-us/powershell/module/commvaultpowershell/disable-restoreagent
#>
function Disable-RestoreAgent {
...
begin {
    try {
        ...
        $mapping = @{
            Disable = 'CommvaultPowerShell.private\Disable-RestoreAgent_Disable';
            DisableViaIdentity = 'CommvaultPowerShell.private\Disable-RestoreAgent_DisableViaIdentity';
        }
