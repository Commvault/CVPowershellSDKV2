...
.Link
https://docs.microsoft.com/en-us/powershell/module/commvaultpowershell/remove-plan
#>
...
begin {
    try {
        ...
        $mapping = @{
            Delete = 'CommvaultPowerShell.private\Remove-Plan_Delete';
            DeleteViaIdentity = 'CommvaultPowerShell.private\Remove-Plan_DeleteViaIdentity';
        }
