...
.Link
https://docs.microsoft.com/en-us/powershell/module/commvaultpowershell/disable-jobactivitycommcell
#>
function Disable-JobActivityCommcell {
...
begin {
    try {
        ...
        $mapping = @{
            Disable = 'CommvaultPowerShell.private\Disable-JobActivityCommcell_Disable';
        }
