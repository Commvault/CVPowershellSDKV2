...
.Link
https://docs.microsoft.com/en-us/powershell/module/commvaultpowershell/remove-vmgroup
#>
...
begin {
    try {
        ...
        $mapping = @{
            Delete = 'CommvaultPowerShell.private\Remove-VMGroup_Delete';
            DeleteViaIdentity = 'CommvaultPowerShell.private\Remove-VMGroup_DeleteViaIdentity';
        }
