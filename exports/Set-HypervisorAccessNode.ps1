...
.Link
https://docs.microsoft.com/en-us/powershell/module/commvaultpowershell/set-hypervisoraccessnode
#>
function Set-HypervisorAccessNode {
...
begin {
    try {
        ...
        $mapping = @{
            Set = 'CommvaultPowerShell.private\Set-HypervisorAccessNode_Set';
            SetExpanded = 'CommvaultPowerShell.private\Set-HypervisorAccessNode_SetExpanded';
            SetViaIdentity = 'CommvaultPowerShell.private\Set-HypervisorAccessNode_SetViaIdentity';
            SetViaIdentityExpanded = 'CommvaultPowerShell.private\Set-HypervisorAccessNode_SetViaIdentityExpanded';
        }
