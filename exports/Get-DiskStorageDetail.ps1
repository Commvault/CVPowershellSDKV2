...
.Link
https://docs.microsoft.com/en-us/powershell/module/commvaultpowershell/get-diskstoragedetail
#>
function Get-DiskStorageDetail {
...
begin {
    try {
        ...
        $mapping = @{
            Get = 'CommvaultPowerShell.private\Get-DiskStorageDetail_Get';
            GetViaIdentity = 'CommvaultPowerShell.private\Get-DiskStorageDetail_GetViaIdentity';
        }
