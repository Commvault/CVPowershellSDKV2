...
.Link
https://docs.microsoft.com/en-us/powershell/module/commvaultpowershell/disable-backupinstance
#>
function Disable-BackupInstance {
...
begin {
    try {
        ...
        $mapping = @{
            Disable = 'CommvaultPowerShell.private\Disable-BackupInstance_Disable';
            DisableViaIdentity = 'CommvaultPowerShell.private\Disable-BackupInstance_DisableViaIdentity';
        }
