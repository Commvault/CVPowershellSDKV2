...
.Link
https://docs.microsoft.com/en-us/powershell/module/commvaultpowershell/remove-accesspath
#>
function Remove-AccessPath {
...
begin {
    try {
        ...
        $mapping = @{
            Delete = 'CommvaultPowerShell.private\Remove-AccessPath_Delete';
            DeleteViaIdentity = 'CommvaultPowerShell.private\Remove-AccessPath_DeleteViaIdentity';
        }
