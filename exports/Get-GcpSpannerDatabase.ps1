...
.Link
https://docs.microsoft.com/en-us/powershell/module/commvaultpowershell/get-gcpspannerdatabase
#>
function Get-GcpSpannerDatabase {
...
begin {
    try {
        ...
        $mapping = @{
            Get = 'CommvaultPowerShell.private\Get-GcpSpannerDatabase_Get';
        }
