...
.Link
https://docs.microsoft.com/en-us/powershell/module/commvaultpowershell/enable-ddbcommcell
#>
function Enable-DdbCommcell {
...
begin {
    try {
        ...
        $mapping = @{
            Enable = 'CommvaultPowerShell.private\Enable-DdbCommcell_Enable';
        }
