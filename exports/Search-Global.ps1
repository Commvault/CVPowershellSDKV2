...
.Link
https://docs.microsoft.com/en-us/powershell/module/commvaultpowershell/search-global
#>
...
begin {
    try {
        ...
        $mapping = @{
            Search = 'CommvaultPowerShell.private\Search-Global_Search';
            SearchViaIdentity = 'CommvaultPowerShell.private\Search-Global_SearchViaIdentity';
        }
