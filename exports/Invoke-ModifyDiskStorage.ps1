...
SECURITY <IUpdateSecurityAssoc[]>: .
  ...
  [UserName <String>]: 
.Link
https://docs.microsoft.com/en-us/powershell/module/commvaultpowershell/invoke-modifydiskstorage
#>
function Invoke-ModifyDiskStorage {
...
begin {
    try {
        ...
        $mapping = @{
            Modify = 'CommvaultPowerShell.private\Invoke-ModifyDiskStorage_Modify';
            ModifyExpanded = 'CommvaultPowerShell.private\Invoke-ModifyDiskStorage_ModifyExpanded';
            ModifyViaIdentity = 'CommvaultPowerShell.private\Invoke-ModifyDiskStorage_ModifyViaIdentity';
            ModifyViaIdentityExpanded = 'CommvaultPowerShell.private\Invoke-ModifyDiskStorage_ModifyViaIdentityExpanded';
        }
