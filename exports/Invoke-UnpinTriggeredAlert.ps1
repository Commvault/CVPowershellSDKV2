...
.Link
https://docs.microsoft.com/en-us/powershell/module/commvaultpowershell/invoke-unpintriggeredalert
#>
function Invoke-UnpinTriggeredAlert {
...
begin {
    try {
        ...
        $mapping = @{
            Unpin = 'CommvaultPowerShell.private\Invoke-UnpinTriggeredAlert_Unpin';
            UnpinViaIdentity = 'CommvaultPowerShell.private\Invoke-UnpinTriggeredAlert_UnpinViaIdentity';
        }
