...
.Link
https://docs.microsoft.com/en-us/powershell/module/commvaultpowershell/get-globalexception
#>
function Get-GlobalException {
...
begin {
    try {
        ...
        $mapping = @{
            Get = 'CommvaultPowerShell.private\Get-GlobalException_Get';
        }
