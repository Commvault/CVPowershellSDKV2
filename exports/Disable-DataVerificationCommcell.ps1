...
.Link
https://docs.microsoft.com/en-us/powershell/module/commvaultpowershell/disable-dataverificationcommcell
#>
function Disable-DataVerificationCommcell {
...
begin {
    try {
        ...
        $mapping = @{
            Disable = 'CommvaultPowerShell.private\Disable-DataVerificationCommcell_Disable';
        }
