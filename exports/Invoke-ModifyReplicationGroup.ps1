...
.Link
https://docs.microsoft.com/en-us/powershell/module/commvaultpowershell/invoke-modifyreplicationgroup
#>
function Invoke-ModifyReplicationGroup {
...
begin {
    try {
        ...
        $mapping = @{
            Modify = 'CommvaultPowerShell.private\Invoke-ModifyReplicationGroup_Modify';
            ModifyExpanded = 'CommvaultPowerShell.private\Invoke-ModifyReplicationGroup_ModifyExpanded';
            ModifyViaIdentity = 'CommvaultPowerShell.private\Invoke-ModifyReplicationGroup_ModifyViaIdentity';
            ModifyViaIdentityExpanded = 'CommvaultPowerShell.private\Invoke-ModifyReplicationGroup_ModifyViaIdentityExpanded';
        }
