...
.Link
https://docs.microsoft.com/en-us/powershell/module/commvaultpowershell/disable-restoreservergroup
#>
function Disable-RestoreServerGroup {
...
begin {
    try {
        ...
        $mapping = @{
            Disable = 'CommvaultPowerShell.private\Disable-RestoreServerGroup_Disable';
            DisableViaIdentity = 'CommvaultPowerShell.private\Disable-RestoreServerGroup_DisableViaIdentity';
        }
