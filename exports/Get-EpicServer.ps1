...
.Link
https://docs.microsoft.com/en-us/powershell/module/commvaultpowershell/get-epicserver
#>
function Get-EpicServer {
...
begin {
    try {
        ...
        $mapping = @{
            Get = 'CommvaultPowerShell.private\Get-EpicServer_Get';
        }
