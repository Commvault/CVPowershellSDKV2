...
SECURITY <IUpdateSecurityAssoc[]>: .
  ...
  [UserName <String>]: 
.Link
https://docs.microsoft.com/en-us/powershell/module/commvaultpowershell/invoke-modifyhyperscalestorage
#>
function Invoke-ModifyHyperScaleStorage {
...
begin {
    try {
        ...
        $mapping = @{
            Modify = 'CommvaultPowerShell.private\Invoke-ModifyHyperScaleStorage_Modify';
            ModifyExpanded = 'CommvaultPowerShell.private\Invoke-ModifyHyperScaleStorage_ModifyExpanded';
            ModifyViaIdentity = 'CommvaultPowerShell.private\Invoke-ModifyHyperScaleStorage_ModifyViaIdentity';
            ModifyViaIdentityExpanded = 'CommvaultPowerShell.private\Invoke-ModifyHyperScaleStorage_ModifyViaIdentityExpanded';
        }
