...
.Link
https://docs.microsoft.com/en-us/powershell/module/commvaultpowershell/disable-alertdefinition
#>
function Disable-AlertDefinition {
...
begin {
    try {
        ...
        $mapping = @{
            Disable = 'CommvaultPowerShell.private\Disable-AlertDefinition_Disable';
            DisableViaIdentity = 'CommvaultPowerShell.private\Disable-AlertDefinition_DisableViaIdentity';
        }
