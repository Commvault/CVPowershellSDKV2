...
.Link
https://docs.microsoft.com/en-us/powershell/module/commvaultpowershell/get-project
#>
...
begin {
    try {
        ...
        $mapping = @{
            Get = 'CommvaultPowerShell.private\Get-Project_Get';
            GetViaIdentity = 'CommvaultPowerShell.private\Get-Project_GetViaIdentity';
        }
