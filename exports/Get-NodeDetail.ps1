...
.Link
https://docs.microsoft.com/en-us/powershell/module/commvaultpowershell/get-nodedetail
#>
function Get-NodeDetail {
...
begin {
    try {
        ...
        $mapping = @{
            Get = 'CommvaultPowerShell.private\Get-NodeDetail_Get';
            GetViaIdentity = 'CommvaultPowerShell.private\Get-NodeDetail_GetViaIdentity';
        }
