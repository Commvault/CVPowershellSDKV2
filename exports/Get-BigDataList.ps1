...
.Link
https://docs.microsoft.com/en-us/powershell/module/commvaultpowershell/get-bigdatalist
#>
function Get-BigDataList {
...
begin {
    try {
        ...
        $mapping = @{
            Get = 'CommvaultPowerShell.private\Get-BigDataList_Get';
        }
