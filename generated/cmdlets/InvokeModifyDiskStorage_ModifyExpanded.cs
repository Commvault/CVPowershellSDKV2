...
namespace Commvault.Powershell.Cmdlets
{
    ...
    /// <remarks>
    /// [OpenAPI] ModifyDiskStorage=>PUT:"/V4/Storage/Disk/{storagePoolId}"
    /// </remarks>
    [global::System.Management.Automation.Cmdlet(global::System.Management.Automation.VerbsLifecycle.Invoke, @"ModifyDiskStorage_ModifyExpanded", SupportsShouldProcess = true)]
    [global::System.Management.Automation.OutputType(typeof(Commvault.Powershell.Models.IGenericResp))]
    [global::Commvault.Powershell.Description(@"Modify the properties of an existing disk storage pool")]
    [global::Commvault.Powershell.Generated]
    public partial class InvokeModifyDiskStorage_ModifyExpanded : global::System.Management.Automation.PSCmdlet,
        Commvault.Powershell.Runtime.IEventListener
    {
        ...
        private Commvault.Powershell.Models.IUpdateDiskStorage _body= new Commvault.Powershell.Models.UpdateDiskStorage();

        private Commvault.Powershell.Models.IUpdateDiskStorage Body { get => this._body; set => this._body = value; }
        ...
        public string DataEncryptionCipher { get => Body.DataEncryptionCipher ?? null; set => Body.DataEncryptionCipher = value; }
        ...
        public global::System.Management.Automation.SwitchParameter DataEncryptionEncrypt { get => Body.DataEncryptionEncrypt ?? default(global::System.Management.Automation.SwitchParameter); set => Body.DataEncryptionEncrypt = value; }
        ...
        public int DataEncryptionKeyLength { get => Body.DataEncryptionKeyLength ?? default(int); set => Body.DataEncryptionKeyLength = value; }
        ...
        [global::System.Management.Automation.Parameter(Mandatory = false, HelpMessage = "change the name of the storage pool")]
        [global::Commvault.Powershell.Category(global::Commvault.Powershell.ParameterCategory.Body)]
        [Commvault.Powershell.Runtime.Info(
        Required = false,
        ReadOnly = false,
        ...
        /// <summary>
        /// Intializes a new instance of the <see cref="InvokeModifyDiskStorage_ModifyExpanded" /> cmdlet class.
        /// </summary>
        public InvokeModifyDiskStorage_ModifyExpanded()
        {
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                // work
                if (ShouldProcess($"Call remote 'ModifyDiskStorage' operation"))
                {
        ...
        protected async global::System.Threading.Tasks.Task ProcessRecordAsync()
        {
            using( NoSynchronizationContext )
            {
                ...
                try
                {
                    ...
                    await this.Client.ModifyDiskStorage(StoragePoolId, Body, onOk, onBadRequest, onNotFound, this, Pipeline);
