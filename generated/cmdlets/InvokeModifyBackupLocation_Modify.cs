...
namespace Commvault.Powershell.Cmdlets
{
    ...
    /// </remarks>
    [global::System.Management.Automation.Cmdlet(global::System.Management.Automation.VerbsLifecycle.Invoke, @"ModifyBackupLocation_Modify", SupportsShouldProcess = true)]
    ...
    public partial class InvokeModifyBackupLocation_Modify : global::System.Management.Automation.PSCmdlet,
        Commvault.Powershell.Runtime.IEventListener
    {
        ...
        private Commvault.Powershell.Models.IUpdateBackupLocation _body;

        /// <summary>
        /// While adding network access path, please add credentials or saved credentials. If both are provided, credentials will
        /// be selected.
        /// </summary>
        [global::System.Management.Automation.Parameter(Mandatory = true, HelpMessage = "While adding network access path, please add credentials or saved credentials. If both are provided, credentials will be selected.", ValueFromPipeline = true)]
        [Commvault.Powershell.Runtime.Info(
        Required = true,
        ReadOnly = false,
        ...
        SerializedName = @"body",
        PossibleTypes = new [] { typeof(Commvault.Powershell.Models.IUpdateBackupLocation) })]
        public Commvault.Powershell.Models.IUpdateBackupLocation Body { get => this._body; set => this._body = value; }
        ...
        /// <summary>
        /// Intializes a new instance of the <see cref="InvokeModifyBackupLocation_Modify" /> cmdlet class.
        /// </summary>
        public InvokeModifyBackupLocation_Modify()
        {
