...
namespace Commvault.Powershell.Cmdlets
{
    ...
    /// <remarks>
    /// [OpenAPI] ModifyBucketOfCloudStorage=>PUT:"/V4/Storage/Cloud/{cloudStorageId}/Bucket/{bucketId}"
    /// </remarks>
    [global::System.Management.Automation.Cmdlet(global::System.Management.Automation.VerbsLifecycle.Invoke, @"ModifyBucket_ModifyExpanded", SupportsShouldProcess = true)]
    [global::System.Management.Automation.OutputType(typeof(Commvault.Powershell.Models.IGenericResp))]
    [global::Commvault.Powershell.Description(@"Modify configuration of a specific bucket of a specific cloud storage")]
    [global::Commvault.Powershell.Generated]
    public partial class InvokeModifyBucket_ModifyExpanded : global::System.Management.Automation.PSCmdlet,
        Commvault.Powershell.Runtime.IEventListener
    {
        ...
        private Commvault.Powershell.Models.ICloudBucketConfiguration _body= new Commvault.Powershell.Models.CloudBucketConfiguration();

        /// <summary>CloudBucketConfiguration</summary>
        private Commvault.Powershell.Models.ICloudBucketConfiguration Body { get => this._body; set => this._body = value; }
        ...
        [global::System.Management.Automation.Parameter(Mandatory = false, HelpMessage = "When true, means mount path is enabled")]
        ...
        public global::System.Management.Automation.SwitchParameter Enable { get => Body.Enable ?? default(global::System.Management.Automation.SwitchParameter); set => Body.Enable = value; }
        ...
        /// library.
        /// </summary>
        [global::System.Management.Automation.Parameter(Mandatory = false, HelpMessage = "When true, the deduplicated blocks in the mount path will not be referenced when there are multiple mount paths in the library.")]
        [global::Commvault.Powershell.Category(global::Commvault.Powershell.ParameterCategory.Body)]
        [Commvault.Powershell.Runtime.Info(
        Required = false,
        ReadOnly = false,
        ...
        PossibleTypes = new [] { typeof(global::System.Management.Automation.SwitchParameter) })]
        public global::System.Management.Automation.SwitchParameter PrepareForRetirement { get => Body.PrepareForRetirement ?? default(global::System.Management.Automation.SwitchParameter); set => Body.PrepareForRetirement = value; }

        /// <summary>
        /// When true, prevents new data writes to backup location by changing number of writers to zero
        /// </summary>
        [global::System.Management.Automation.Parameter(Mandatory = false, HelpMessage = "When true, prevents new data writes to backup location by changing number of writers to zero")]
        [global::Commvault.Powershell.Category(global::Commvault.Powershell.ParameterCategory.Body)]
        [Commvault.Powershell.Runtime.Info(
        Required = false,
        ReadOnly = false,
        ...
        PossibleTypes = new [] { typeof(global::System.Management.Automation.SwitchParameter) })]
        public global::System.Management.Automation.SwitchParameter PreventNewDataWritesToBackupLocation { get => Body.PreventNewDataWritesToBackupLocation ?? default(global::System.Management.Automation.SwitchParameter); set => Body.PreventNewDataWritesToBackupLocation = value; }
        ...
        SerializedName = @"id",
        PossibleTypes = new [] { typeof(int) })]
        public int StorageAcceleratorCredentialsId { get => Body.StorageAcceleratorCredentialsId ?? default(int); set => Body.StorageAcceleratorCredentialsId = value; }
        ...
        public string StorageAcceleratorCredentialsName { get => Body.StorageAcceleratorCredentialsName ?? null; set => Body.StorageAcceleratorCredentialsName = value; }
        ...
        /// <summary>
        /// Intializes a new instance of the <see cref="InvokeModifyBucket_ModifyExpanded" /> cmdlet class.
        /// </summary>
        public InvokeModifyBucket_ModifyExpanded()
        {
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                // work
                if (ShouldProcess($"Call remote 'ModifyBucketOfCloudStorage' operation"))
                {
        ...
        protected async global::System.Threading.Tasks.Task ProcessRecordAsync()
        {
            using( NoSynchronizationContext )
            {
                ...
                try
                {
                    ...
                    await this.Client.ModifyBucketOfCloudStorage(CloudStorageId, BucketId, Body, onOk, onNotFound, onInternalServerError, this, Pipeline);
                ...
                {
                    WriteError(new global::System.Management.Automation.ErrorRecord(urexception, urexception.StatusCode.ToString(), global::System.Management.Automation.ErrorCategory.InvalidOperation, new {  CloudStorageId=CloudStorageId,BucketId=BucketId,body=Body})
                    {
