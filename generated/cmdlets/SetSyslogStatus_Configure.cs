...
namespace Commvault.Powershell.Cmdlets
{
    ...
    /// </remarks>
    [global::System.Management.Automation.Cmdlet(global::System.Management.Automation.VerbsCommon.Set, @"SyslogStatus_Configure", SupportsShouldProcess = true)]
    ...
    public partial class SetSyslogStatus_Configure : global::System.Management.Automation.PSCmdlet,
        Commvault.Powershell.Runtime.IEventListener
    {
        ...
        private Commvault.Powershell.Models.ISyslogConfigure _body;

        /// <summary>This operation configures a syslog server.</summary>
        [global::System.Management.Automation.Parameter(Mandatory = true, HelpMessage = "This operation configures a syslog server.", ValueFromPipeline = true)]
        [Commvault.Powershell.Runtime.Info(
        Required = true,
        ReadOnly = false,
        Description = @"This operation configures a syslog server.",
        SerializedName = @"body",
        PossibleTypes = new [] { typeof(Commvault.Powershell.Models.ISyslogConfigure) })]
        public Commvault.Powershell.Models.ISyslogConfigure Body { get => this._body; set => this._body = value; }
        ...
        /// <summary>
        /// Intializes a new instance of the <see cref="SetSyslogStatus_Configure" /> cmdlet class.
        /// </summary>
        public SetSyslogStatus_Configure()
        {
