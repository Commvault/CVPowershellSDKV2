...
namespace Commvault.Powershell.Cmdlets
{
    ...
    /// <remarks>
    /// [OpenAPI] DeleteRecoveryTarget=>DELETE:"/V4/RecoveryTarget/{recoveryTargetId}"
    /// </remarks>
    [global::System.Management.Automation.Cmdlet(global::System.Management.Automation.VerbsCommon.Remove, @"RecoveryTarget_Delete", SupportsShouldProcess = true)]
    [global::System.Management.Automation.OutputType(typeof(Commvault.Powershell.Models.IGenericResp))]
    [global::Commvault.Powershell.Description(@"To delete an exisitng recovery target")]
    [global::Commvault.Powershell.Generated]
    public partial class RemoveRecoveryTarget_Delete : global::System.Management.Automation.PSCmdlet,
        Commvault.Powershell.Runtime.IEventListener
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                // work
                if (ShouldProcess($"Call remote 'DeleteRecoveryTarget' operation"))
                {
        ...
        protected async global::System.Threading.Tasks.Task ProcessRecordAsync()
        {
            using( NoSynchronizationContext )
            {
                ...
                try
                {
                    ...
                    await this.Client.DeleteRecoveryTarget(RecoveryTargetId, onOk, onNotFound, onServiceUnavailable, this, Pipeline);
        ...
        /// <summary>
        /// Intializes a new instance of the <see cref="RemoveRecoveryTarget_Delete" /> cmdlet class.
        /// </summary>
        public RemoveRecoveryTarget_Delete()
        {
