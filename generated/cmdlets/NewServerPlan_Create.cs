...
namespace Commvault.Powershell.Cmdlets
{
    ...
    /// </remarks>
    [global::System.Management.Automation.Cmdlet(global::System.Management.Automation.VerbsCommon.New, @"ServerPlan_Create", SupportsShouldProcess = true)]
    ...
    public partial class NewServerPlan_Create : global::System.Management.Automation.PSCmdlet,
        Commvault.Powershell.Runtime.IEventListener
    {
        ...
        private Commvault.Powershell.Models.ICreateServerPlan _body;
        ...
        Description = @"",
        SerializedName = @"body",
        PossibleTypes = new [] { typeof(Commvault.Powershell.Models.ICreateServerPlan) })]
        public Commvault.Powershell.Models.ICreateServerPlan Body { get => this._body; set => this._body = value; }
        ...
        /// <summary>
        /// Intializes a new instance of the <see cref="NewServerPlan_Create" /> cmdlet class.
        /// </summary>
        public NewServerPlan_Create()
        {
