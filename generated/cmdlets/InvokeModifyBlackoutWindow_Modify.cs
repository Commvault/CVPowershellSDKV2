...
namespace Commvault.Powershell.Cmdlets
{
    ...
    /// </remarks>
    [global::System.Management.Automation.Cmdlet(global::System.Management.Automation.VerbsLifecycle.Invoke, @"ModifyBlackoutWindow_Modify", SupportsShouldProcess = true)]
    ...
    public partial class InvokeModifyBlackoutWindow_Modify : global::System.Management.Automation.PSCmdlet,
        Commvault.Powershell.Runtime.IEventListener
    {
        ...
        private Commvault.Powershell.Models.IUpdateBlackoutWindow _body;

        /// <summary>
        /// company-refers to company to which the blackout window is associated.Dates have to be provided in unix time format.
        /// </summary>
        [global::System.Management.Automation.Parameter(Mandatory = true, HelpMessage = "company-refers to company to which the blackout window is associated.Dates have to be provided in unix time format.", ValueFromPipeline = true)]
        [Commvault.Powershell.Runtime.Info(
        Required = true,
        ReadOnly = false,
        ...
        SerializedName = @"body",
        PossibleTypes = new [] { typeof(Commvault.Powershell.Models.IUpdateBlackoutWindow) })]
        public Commvault.Powershell.Models.IUpdateBlackoutWindow Body { get => this._body; set => this._body = value; }
        ...
        /// <summary>
        /// Intializes a new instance of the <see cref="InvokeModifyBlackoutWindow_Modify" /> cmdlet class.
        /// </summary>
        public InvokeModifyBlackoutWindow_Modify()
        {
