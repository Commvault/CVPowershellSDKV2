...
namespace Commvault.Powershell.Cmdlets
{
    ...
    /// <remarks>
    /// [OpenAPI] DeleteBackupLocation=>DELETE:"/V4/Storage/Disk/{storagePoolId}/BackupLocation/{backupLocationId}"
    /// </remarks>
    [global::System.Management.Automation.Cmdlet(global::System.Management.Automation.VerbsCommon.Remove, @"BackupLocation_Delete", SupportsShouldProcess = true)]
    ...
    public partial class RemoveBackupLocation_Delete : global::System.Management.Automation.PSCmdlet,
        Commvault.Powershell.Runtime.IEventListener
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                // work
                if (ShouldProcess($"Call remote 'DeleteBackupLocation' operation"))
                {
        ...
        protected async global::System.Threading.Tasks.Task ProcessRecordAsync()
        {
            using( NoSynchronizationContext )
            {
                ...
                try
                {
                    ...
                    await this.Client.DeleteBackupLocation(StoragePoolId, BackupLocationId, onOk, onBadRequest, onNotFound, this, Pipeline);
        ...
        /// <summary>
        /// Intializes a new instance of the <see cref="RemoveBackupLocation_Delete" /> cmdlet class.
        /// </summary>
        public RemoveBackupLocation_Delete()
        {
