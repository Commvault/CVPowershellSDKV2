...
namespace Commvault.Powershell.Cmdlets
{
    ...
    /// <remarks>
    /// [OpenAPI] DeleteVirtualMachine=>DELETE:"/V4/VirtualMachines/{vmUUID}"
    /// </remarks>
    [global::System.Management.Automation.Cmdlet(global::System.Management.Automation.VerbsCommon.Remove, @"VirtualMachine_Delete", SupportsShouldProcess = true)]
    [global::System.Management.Automation.OutputType(typeof(Commvault.Powershell.Models.IGenericResp))]
    [global::Commvault.Powershell.Description(@"Used to delete a virtual machine")]
    [global::Commvault.Powershell.Generated]
    public partial class RemoveVirtualMachine_Delete : global::System.Management.Automation.PSCmdlet,
        Commvault.Powershell.Runtime.IEventListener
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                // work
                if (ShouldProcess($"Call remote 'DeleteVirtualMachine' operation"))
                {
        ...
        protected async global::System.Threading.Tasks.Task ProcessRecordAsync()
        {
            using( NoSynchronizationContext )
            {
                ...
                try
                {
                    ...
                    await this.Client.DeleteVirtualMachine(VMUuid, onOk, onBadRequest, onInternalServerError, this, Pipeline);
                ...
                {
                    WriteError(new global::System.Management.Automation.ErrorRecord(urexception, urexception.StatusCode.ToString(), global::System.Management.Automation.ErrorCategory.InvalidOperation, new {  VMUuid=VMUuid})
                    {
        ...
        /// <summary>
        /// Intializes a new instance of the <see cref="RemoveVirtualMachine_Delete" /> cmdlet class.
        /// </summary>
        public RemoveVirtualMachine_Delete()
        {
