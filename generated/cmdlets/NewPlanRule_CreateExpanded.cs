...
namespace Commvault.Powershell.Cmdlets
{
    ...
    /// </summary>
    /// <remarks>
    /// [OpenAPI] CreatePlanRule=>POST:"/V4/Plan/Rule"
    /// </remarks>
    [global::System.Management.Automation.Cmdlet(global::System.Management.Automation.VerbsCommon.New, @"PlanRule_CreateExpanded", SupportsShouldProcess = true)]
    ...
    [global::Commvault.Powershell.Description(@"Api to create plan rules. Request body will suggest plan against which rule need to be created and type of entities(workloads type, server groups, regions and all) that need to be referenced for applying that rule against a workload.")]
    [global::Commvault.Powershell.Generated]
    public partial class NewPlanRule_CreateExpanded : global::System.Management.Automation.PSCmdlet,
        Commvault.Powershell.Runtime.IEventListener
    {
        ...
        private Commvault.Powershell.Models.ICreatePlanEntityRule _body= new Commvault.Powershell.Models.CreatePlanEntityRule();
        ...
        /// matched.
        /// </summary>
        private Commvault.Powershell.Models.ICreatePlanEntityRule Body { get => this._body; set => this._body = value; }
        ...
        /// </summary>
        [global::System.Management.Automation.Parameter(Mandatory = false, HelpMessage = "Optional field to suggest priority/rank of the rule. If not present, we will process rule in the same order they are created.")]
        [global::Commvault.Powershell.Category(global::Commvault.Powershell.ParameterCategory.Body)]
        [Commvault.Powershell.Runtime.Info(
        Required = false,
        ReadOnly = false,
        ...
        /// <summary>
        /// Intializes a new instance of the <see cref="NewPlanRule_CreateExpanded" /> cmdlet class.
        /// </summary>
        public NewPlanRule_CreateExpanded()
        {
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                // work
                if (ShouldProcess($"Call remote 'CreatePlanRule' operation"))
                {
        ...
        protected async global::System.Threading.Tasks.Task ProcessRecordAsync()
        {
            using( NoSynchronizationContext )
            {
                ...
                try
                {
                    ...
                    await this.Client.CreatePlanRule(Body, onOk, onForbidden, onInternalServerError, this, Pipeline);
