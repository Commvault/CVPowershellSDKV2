...
namespace Commvault.Powershell.Cmdlets
{
    ...
    /// <remarks>
    /// [OpenAPI] UpdatePlanRuleRank=>PUT:"/V4/Plan/Rule/Rank"
    /// </remarks>
    [global::System.Management.Automation.Cmdlet(global::System.Management.Automation.VerbsCommon.Set, @"PlanRuleRank_UpdateExpanded", SupportsShouldProcess = true)]
    [global::System.Management.Automation.OutputType(typeof(Commvault.Powershell.Models.IGenericResp))]
    [global::Commvault.Powershell.Description(@"API to update rank for multiple rules at a time.")]
    [global::Commvault.Powershell.Generated]
    public partial class SetPlanRuleRank_UpdateExpanded : global::System.Management.Automation.PSCmdlet,
        Commvault.Powershell.Runtime.IEventListener
    {
        ...
        private Commvault.Powershell.Models.IUpdatePlanEntityRuleRanks _body= new Commvault.Powershell.Models.UpdatePlanEntityRuleRanks();

        /// <summary>
        /// Plan entity rule update rank object. Fields in this object need to be populated to suggest what rank need to be set for
        /// the said rule.
        /// </summary>
        private Commvault.Powershell.Models.IUpdatePlanEntityRuleRanks Body { get => this._body; set => this._body = value; }
        ...
        [global::System.Management.Automation.Parameter(Mandatory = false, HelpMessage = "Lits of plan entity rule object suggesting their ranks.")]
        ...
        public Commvault.Powershell.Models.IPlanEntityRuleRank[] Rules { get => Body.Rules ?? null /* arrayOf */; set => Body.Rules = value; }
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                // work
                if (ShouldProcess($"Call remote 'UpdatePlanRuleRank' operation"))
                {
        ...
        protected async global::System.Threading.Tasks.Task ProcessRecordAsync()
        {
            using( NoSynchronizationContext )
            {
                ...
                try
                {
                    ...
                    await this.Client.UpdatePlanRuleRank(Body, onOk, onBadRequest, onForbidden, onInternalServerError, this, Pipeline);
        ...
        /// <summary>
        /// Intializes a new instance of the <see cref="SetPlanRuleRank_UpdateExpanded" /> cmdlet class.
        /// </summary>
        public SetPlanRuleRank_UpdateExpanded()
        {
