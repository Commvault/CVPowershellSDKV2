...
namespace Commvault.Powershell.Cmdlets
{
    ...
    /// </remarks>
    [global::System.Management.Automation.Cmdlet(global::System.Management.Automation.VerbsCommon.Set, @"ServerPlanRpo_Update", SupportsShouldProcess = true)]
    ...
    public partial class SetServerPlanRpo_Update : global::System.Management.Automation.PSCmdlet,
        Commvault.Powershell.Runtime.IEventListener
    {
        ...
        private Commvault.Powershell.Models.IServerPlanUpdateRpo _body;
        ...
        /// </summary>
        [global::System.Management.Automation.Parameter(Mandatory = true, HelpMessage = "Recovery Point Objective (RPO) is the maximum amount of time that data can be lost during a service disruption. Your RPO determines the frequency of your backup jobs.", ValueFromPipeline = true)]
        ...
        SerializedName = @"body",
        PossibleTypes = new [] { typeof(Commvault.Powershell.Models.IServerPlanUpdateRpo) })]
        public Commvault.Powershell.Models.IServerPlanUpdateRpo Body { get => this._body; set => this._body = value; }
        ...
        /// <summary>
        /// Intializes a new instance of the <see cref="SetServerPlanRpo_Update" /> cmdlet class.
        /// </summary>
        public SetServerPlanRpo_Update()
        {
