...
namespace Commvault.Powershell.Cmdlets
{
    ...
    /// </remarks>
    [global::System.Management.Automation.Cmdlet(global::System.Management.Automation.VerbsCommon.New, @"CdmPlan_Create", SupportsShouldProcess = true)]
    ...
    public partial class NewCdmPlan_Create : global::System.Management.Automation.PSCmdlet,
        Commvault.Powershell.Runtime.IEventListener
    {
        ...
        private Commvault.Powershell.Models.ICreateCdmPlan _body;
        ...
        Description = @"",
        SerializedName = @"body",
        PossibleTypes = new [] { typeof(Commvault.Powershell.Models.ICreateCdmPlan) })]
        public Commvault.Powershell.Models.ICreateCdmPlan Body { get => this._body; set => this._body = value; }
        ...
        /// <summary>Intializes a new instance of the <see cref="NewCdmPlan_Create" /> cmdlet class.</summary>
        public NewCdmPlan_Create()
        {
