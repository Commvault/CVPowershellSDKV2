...
namespace Commvault.Powershell.Cmdlets
{
    ...
    /// <remarks>
    /// [OpenAPI] ModifyLaptopBackupDestination=>PUT:"/V4/LaptopPlan/{planId}/BackupDestination/{BackupDestinationId}"
    /// </remarks>
    [global::System.Management.Automation.Cmdlet(global::System.Management.Automation.VerbsLifecycle.Invoke, @"ModifyLaptopBackupDestination_ModifyExpanded", SupportsShouldProcess = true)]
    [global::System.Management.Automation.OutputType(typeof(Commvault.Powershell.Models.IPlanBackupDestinationResp))]
    [global::Commvault.Powershell.Description(@"Modify Backup Destination for a Plan")]
    [global::Commvault.Powershell.Generated]
    public partial class InvokeModifyLaptopBackupDestination_ModifyExpanded : global::System.Management.Automation.PSCmdlet,
        Commvault.Powershell.Runtime.IEventListener
    {
        ...
        [global::System.Management.Automation.Parameter(Mandatory = true, HelpMessage = "Id of the backupDestination to be modified")]
        ...
        /// </summary>
        [global::System.Management.Automation.Parameter(Mandatory = false, HelpMessage = "Specify the Backup start time in seconds. The time is provided in unix time format.")]
        ...
        PossibleTypes = new [] { typeof(int) })]
        public int BackupStartTime { get => Body.BackupStartTime ?? default(int); set => Body.BackupStartTime = value; }
        ...
        public string BackupsToCopy { get => Body.BackupsToCopy ?? null; set => Body.BackupsToCopy = value; }

        /// <summary>Backing field for <see cref="Body" /> property.</summary>
        private Commvault.Powershell.Models.IUpdatePlanBackupDestination _body= new Commvault.Powershell.Models.UpdatePlanBackupDestination();

        private Commvault.Powershell.Models.IUpdatePlanBackupDestination Body { get => this._body; set => this._body = value; }
        ...
        public global::System.Management.Automation.SwitchParameter FirstExtendedRetentionRuleIsInfiniteRetention { get => Body.FirstExtendedRetentionRuleIsInfiniteRetention ?? default(global::System.Management.Automation.SwitchParameter); set => Body.FirstExtendedRetentionRuleIsInfiniteRetention = value; }

        /// <summary>
        /// Default value is 30 days. Infinite retention takes precedence over retentionPeriodDays.
        /// </summary>
        [global::System.Management.Automation.Parameter(Mandatory = false, HelpMessage = "Default value is 30 days. Infinite retention takes precedence over retentionPeriodDays.")]
        [global::Commvault.Powershell.Category(global::Commvault.Powershell.ParameterCategory.Body)]
        [Commvault.Powershell.Runtime.Info(
        Required = false,
        ReadOnly = false,
        ...
        PossibleTypes = new [] { typeof(int) })]
        public int FirstExtendedRetentionRuleRetentionPeriodDays { get => Body.FirstExtendedRetentionRuleRetentionPeriodDays ?? default(int); set => Body.FirstExtendedRetentionRuleRetentionPeriodDays = value; }
        ...
        SerializedName = @"type",
        PossibleTypes = new [] { typeof(string) })]
        public string FirstExtendedRetentionRuleType { get => Body.FirstExtendedRetentionRuleType ?? null; set => Body.FirstExtendedRetentionRuleType = value; }
        ...
        public Commvault.Powershell.Models.ISnapshotCopyMapping[] Mappings { get => Body.Mappings ?? null /* arrayOf */; set => Body.Mappings = value; }
        ...
        [global::System.Management.Automation.Parameter(Mandatory = false, HelpMessage = "Retention period in days. -1 can be specified for infinite retention.")]
        [global::Commvault.Powershell.Category(global::Commvault.Powershell.ParameterCategory.Body)]
        [Commvault.Powershell.Runtime.Info(
        Required = false,
        ReadOnly = false,
        ...
        SerializedName = @"retentionPeriodDays",
        PossibleTypes = new [] { typeof(int) })]
        public int RetentionPeriodDays { get => Body.RetentionPeriodDays ?? default(int); set => Body.RetentionPeriodDays = value; }
        ...
        PossibleTypes = new [] { typeof(string) })]
        public string RetentionRuleType { get => Body.RetentionRuleType ?? null; set => Body.RetentionRuleType = value; }
        ...
        SerializedName = @"isInfiniteRetention",
        PossibleTypes = new [] { typeof(global::System.Management.Automation.SwitchParameter) })]
        public global::System.Management.Automation.SwitchParameter SecondExtendedRetentionRuleIsInfiniteRetention { get => Body.SecondExtendedRetentionRuleIsInfiniteRetention ?? default(global::System.Management.Automation.SwitchParameter); set => Body.SecondExtendedRetentionRuleIsInfiniteRetention = value; }
        ...
        SerializedName = @"retentionPeriodDays",
        PossibleTypes = new [] { typeof(int) })]
        public int SecondExtendedRetentionRuleRetentionPeriodDays { get => Body.SecondExtendedRetentionRuleRetentionPeriodDays ?? default(int); set => Body.SecondExtendedRetentionRuleRetentionPeriodDays = value; }
        ...
        SerializedName = @"type",
        PossibleTypes = new [] { typeof(string) })]
        public string SecondExtendedRetentionRuleType { get => Body.SecondExtendedRetentionRuleType ?? null; set => Body.SecondExtendedRetentionRuleType = value; }

        /// <summary>
        /// Number of snap recovery points for snap copy for retention. Can be specified instead of retention period in Days for snap
        /// copy.
        /// </summary>
        [global::System.Management.Automation.Parameter(Mandatory = false, HelpMessage = "Number of snap recovery points for snap copy for retention. Can be specified instead of retention period in Days for snap copy.")]
        [global::Commvault.Powershell.Category(global::Commvault.Powershell.ParameterCategory.Body)]
        [Commvault.Powershell.Runtime.Info(
        Required = false,
        ReadOnly = false,
        ...
        PossibleTypes = new [] { typeof(int) })]
        public int SnapRecoveryPoints { get => Body.SnapRecoveryPoints ?? default(int); set => Body.SnapRecoveryPoints = value; }
        ...
        SerializedName = @"id",
        PossibleTypes = new [] { typeof(int) })]
        public int SourceCopyId { get => Body.SourceCopyId ?? default(int); set => Body.SourceCopyId = value; }
        ...
        SerializedName = @"name",
        PossibleTypes = new [] { typeof(string) })]
        public string SourceCopyName { get => Body.SourceCopyName ?? null; set => Body.SourceCopyName = value; }
        ...
        SerializedName = @"isInfiniteRetention",
        PossibleTypes = new [] { typeof(global::System.Management.Automation.SwitchParameter) })]
        public global::System.Management.Automation.SwitchParameter ThirdExtendedRetentionRuleIsInfiniteRetention { get => Body.ThirdExtendedRetentionRuleIsInfiniteRetention ?? default(global::System.Management.Automation.SwitchParameter); set => Body.ThirdExtendedRetentionRuleIsInfiniteRetention = value; }
        ...
        SerializedName = @"retentionPeriodDays",
        PossibleTypes = new [] { typeof(int) })]
        public int ThirdExtendedRetentionRuleRetentionPeriodDays { get => Body.ThirdExtendedRetentionRuleRetentionPeriodDays ?? default(int); set => Body.ThirdExtendedRetentionRuleRetentionPeriodDays = value; }
        ...
        SerializedName = @"type",
        PossibleTypes = new [] { typeof(string) })]
        public string ThirdExtendedRetentionRuleType { get => Body.ThirdExtendedRetentionRuleType ?? null; set => Body.ThirdExtendedRetentionRuleType = value; }

        /// <summary>
        /// Use extended retention rules. Must specify if updating extended retention rules.
        /// </summary>
        [global::System.Management.Automation.Parameter(Mandatory = false, HelpMessage = "Use extended retention rules. Must specify if updating extended retention rules.")]
        [global::Commvault.Powershell.Category(global::Commvault.Powershell.ParameterCategory.Body)]
        [Commvault.Powershell.Runtime.Info(
        Required = false,
        ReadOnly = false,
        ...
        PossibleTypes = new [] { typeof(global::System.Management.Automation.SwitchParameter) })]
        public global::System.Management.Automation.SwitchParameter UseExtendedRetentionRules { get => Body.UseExtendedRetentionRules ?? default(global::System.Management.Automation.SwitchParameter); set => Body.UseExtendedRetentionRules = value; }
        ...
        /// </summary>
        /// <param name="responseMessage">the raw response message as an global::System.Net.Http.HttpResponseMessage.</param>
        /// <param name="response">the body result as a <see cref="Commvault.Powershell.Models.IPlanBackupDestinationResp" /> from
        ...
        /// <summary>
        /// Intializes a new instance of the <see cref="InvokeModifyLaptopBackupDestination_ModifyExpanded" /> cmdlet class.
        /// </summary>
        public InvokeModifyLaptopBackupDestination_ModifyExpanded()
        {
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                // work
                if (ShouldProcess($"Call remote 'ModifyLaptopBackupDestination' operation"))
                {
        ...
        protected async global::System.Threading.Tasks.Task ProcessRecordAsync()
        {
            using( NoSynchronizationContext )
            {
                ...
                try
                {
                    ...
                    await this.Client.ModifyLaptopBackupDestination(PlanId, BackupDestinationId, Body, onOk, onNotFound, this, Pipeline);
                ...
                {
                    WriteError(new global::System.Management.Automation.ErrorRecord(urexception, urexception.StatusCode.ToString(), global::System.Management.Automation.ErrorCategory.InvalidOperation, new {  PlanId=PlanId,BackupDestinationId=BackupDestinationId,body=Body})
                    {
