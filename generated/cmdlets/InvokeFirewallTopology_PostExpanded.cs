...
namespace Commvault.Powershell.Cmdlets
{
    ...
    /// <remarks>
    /// [OpenAPI] PostFirewallTopology=>POST:"/V4/NetworkTopology"
    /// </remarks>
    [global::System.Management.Automation.Cmdlet(global::System.Management.Automation.VerbsLifecycle.Invoke, @"FirewallTopology_PostExpanded", SupportsShouldProcess = true)]
    [global::System.Management.Automation.OutputType(typeof(Commvault.Powershell.Models.IFirewallTopologyCreateResp))]
    [global::Commvault.Powershell.Description(@"This endpoint is used to create network topology.")]
    [global::Commvault.Powershell.Generated]
    public partial class InvokeFirewallTopology_PostExpanded : global::System.Management.Automation.PSCmdlet,
        Commvault.Powershell.Runtime.IEventListener
    {
        ...
        private Commvault.Powershell.Models.IFirewallTopologyCreateReq _body= new Commvault.Powershell.Models.FirewallTopologyCreateReq();

        /// <summary>FirewallTopologyReq</summary>
        private Commvault.Powershell.Models.IFirewallTopologyCreateReq Body { get => this._body; set => this._body = value; }
        ...
        [global::System.Management.Automation.Parameter(Mandatory = false, HelpMessage = "The type of clients associated with the topology.")]
        ...
        public string ClientType { get => Body.ClientType ?? null; set => Body.ClientType = value; }

        /// <summary>Flag determining if we want the data from tunnel to use HTTPS protocol</summary>
        [global::System.Management.Automation.Parameter(Mandatory = false, HelpMessage = "Flag determining if we want the data from tunnel to use HTTPS protocol")]
        [global::Commvault.Powershell.Category(global::Commvault.Powershell.ParameterCategory.Body)]
        [Commvault.Powershell.Runtime.Info(
        Required = false,
        ReadOnly = false,
        ...
        public global::System.Management.Automation.SwitchParameter EncryptTraffic { get => Body.EncryptTraffic ?? default(global::System.Management.Automation.SwitchParameter); set => Body.EncryptTraffic = value; }
        ...
        public Commvault.Powershell.Models.IFirewallTopologyGroups[] FirewallGroups { get => Body.FirewallGroups ?? null /* arrayOf */; set => Body.FirewallGroups = value; }
        ...
        PossibleTypes = new [] { typeof(string) })]
        public string TopologyName { get => Body.TopologyName ?? null; set => Body.TopologyName = value; }

        /// <summary>
        /// The type of topology of client groups (and sometimes network gateway) for this instance.
        /// </summary>
        [global::System.Management.Automation.Parameter(Mandatory = false, HelpMessage = "The type of topology of client groups (and sometimes network gateway) for this instance.")]
        [global::Commvault.Powershell.Category(global::Commvault.Powershell.ParameterCategory.Body)]
        [Commvault.Powershell.Runtime.Info(
        Required = false,
        ReadOnly = false,
        ...
        PossibleTypes = new [] { typeof(string) })]
        public string TopologyType { get => Body.TopologyType ?? null; set => Body.TopologyType = value; }

        /// <summary>The protocol for outgoing communication</summary>
        [global::System.Management.Automation.Parameter(Mandatory = false, HelpMessage = "The protocol for outgoing communication")]
        [global::Commvault.Powershell.Category(global::Commvault.Powershell.ParameterCategory.Body)]
        [Commvault.Powershell.Runtime.Info(
        Required = false,
        ReadOnly = false,
        ...
        PossibleTypes = new [] { typeof(string) })]
        public string TunnelProtocol { get => Body.TunnelProtocol ?? null; set => Body.TunnelProtocol = value; }

        /// <summary>The number of tunnel connections per route</summary>
        [global::System.Management.Automation.Parameter(Mandatory = false, HelpMessage = "The number of tunnel connections per route")]
        [global::Commvault.Powershell.Category(global::Commvault.Powershell.ParameterCategory.Body)]
        [Commvault.Powershell.Runtime.Info(
        Required = false,
        ReadOnly = false,
        ...
        /// </summary>
        [global::System.Management.Automation.Parameter(Mandatory = false, HelpMessage = "Flag determining wether network gateways are used to connect all infrastructure machines")]
        [global::Commvault.Powershell.Category(global::Commvault.Powershell.ParameterCategory.Body)]
        [Commvault.Powershell.Runtime.Info(
        Required = false,
        ReadOnly = false,
        ...
        PossibleTypes = new [] { typeof(global::System.Management.Automation.SwitchParameter) })]
        public global::System.Management.Automation.SwitchParameter UseWildCardProxy { get => Body.UseWildCardProxy ?? default(global::System.Management.Automation.SwitchParameter); set => Body.UseWildCardProxy = value; }
        ...
        /// </summary>
        /// <param name="responseMessage">the raw response message as an global::System.Net.Http.HttpResponseMessage.</param>
        /// <param name="response">the body result as a <see cref="Commvault.Powershell.Models.IFirewallTopologyCreateResp" /> from
        /// the remote call</param>
        /// <param name="returnNow">/// Determines if the rest of the onOk method should be processed, or if the method should return
        /// immediately (set to true to skip further processing )</param>

        partial void overrideOnOk(global::System.Net.Http.HttpResponseMessage responseMessage, global::System.Threading.Tasks.Task<Commvault.Powershell.Models.IFirewallTopologyCreateResp> response, ref global::System.Threading.Tasks.Task<bool> returnNow);
        ...
        /// <summary>
        /// Intializes a new instance of the <see cref="InvokeFirewallTopology_PostExpanded" /> cmdlet class.
        /// </summary>
        public InvokeFirewallTopology_PostExpanded()
        {
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                // work
                if (ShouldProcess($"Call remote 'PostFirewallTopology' operation"))
                {
        ...
        protected async global::System.Threading.Tasks.Task ProcessRecordAsync()
        {
            using( NoSynchronizationContext )
            {
                ...
                try
                {
                    ...
                    await this.Client.PostFirewallTopology(Body, onOk, onBadRequest, onInternalServerError, this, Pipeline);
        ...
        /// A <see cref="global::System.Threading.Tasks.Task" /> that will be complete when handling of the method is completed.
        /// </returns>
        private async global::System.Threading.Tasks.Task onOk(global::System.Net.Http.HttpResponseMessage responseMessage, global::System.Threading.Tasks.Task<Commvault.Powershell.Models.IFirewallTopologyCreateResp> response)
        {
            using( NoSynchronizationContext )
            {
                var _returnNow = global::System.Threading.Tasks.Task<bool>.FromResult(false);
                ...
                // (await response) // should be Commvault.Powershell.Models.IFirewallTopologyCreateResp
