...
namespace Commvault.Powershell.Cmdlets
{
    ...
    /// <remarks>
    /// [OpenAPI] UpdateGlobalExceptions=>POST:"/V4/GlobalExceptions"
    /// </remarks>
    [global::System.Management.Automation.Cmdlet(global::System.Management.Automation.VerbsData.Update, @"GlobalException_UpdateExpanded", SupportsShouldProcess = true)]
    [global::System.Management.Automation.OutputType(typeof(Commvault.Powershell.Models.IGenericResp))]
    [global::Commvault.Powershell.Description(@"Add/Edit/Delete global execptions")]
    [global::Commvault.Powershell.Generated]
    public partial class UpdateGlobalException_UpdateExpanded : global::System.Management.Automation.PSCmdlet,
        Commvault.Powershell.Runtime.IEventListener
    {
        ...
        private Commvault.Powershell.Models.ISetGlobalExceptions _body= new Commvault.Powershell.Models.SetGlobalExceptions();

        /// <summary>Used to set global exceptions</summary>
        private Commvault.Powershell.Models.ISetGlobalExceptions Body { get => this._body; set => this._body = value; }
        ...
        [global::System.Management.Automation.Parameter(Mandatory = false, HelpMessage = "Array of exceptions which will be operated upon based on the operation type")]
        ...
        public string[] UnixGlobalExceptionExceptions { get => Body.UnixGlobalExceptionExceptions ?? null /* arrayOf */; set => Body.UnixGlobalExceptionExceptions = value; }

        /// <summary>
        /// The operations on global exceptions provided would be executed based on the operation type provided
        /// </summary>
        [global::System.Management.Automation.Parameter(Mandatory = false, HelpMessage = "The operations on global exceptions provided would be executed based on the operation type provided")]
        [global::Commvault.Powershell.Category(global::Commvault.Powershell.ParameterCategory.Body)]
        [Commvault.Powershell.Runtime.Info(
        Required = false,
        ReadOnly = false,
        ...
        PossibleTypes = new [] { typeof(string) })]
        public string UnixGlobalExceptionOperationType { get => Body.UnixGlobalExceptionOperationType ?? null; set => Body.UnixGlobalExceptionOperationType = value; }

        /// <summary>Boolean value which updates the property useGlobalExceptionsOnAllSubclients</summary>
        [global::System.Management.Automation.Parameter(Mandatory = false, HelpMessage = "Boolean value which updates the property useGlobalExceptionsOnAllSubclients")]
        [global::Commvault.Powershell.Category(global::Commvault.Powershell.ParameterCategory.Body)]
        [Commvault.Powershell.Runtime.Info(
        Required = false,
        ReadOnly = false,
        ...
        public global::System.Management.Automation.SwitchParameter UseGlobalExceptionsOnAllSubclients { get => Body.UseGlobalExceptionsOnAllSubclients ?? default(global::System.Management.Automation.SwitchParameter); set => Body.UseGlobalExceptionsOnAllSubclients = value; }
        ...
        SerializedName = @"exceptions",
        PossibleTypes = new [] { typeof(string) })]
        public string[] WindowGlobalExceptionExceptions { get => Body.WindowGlobalExceptionExceptions ?? null /* arrayOf */; set => Body.WindowGlobalExceptionExceptions = value; }
        ...
        SerializedName = @"operationType",
        PossibleTypes = new [] { typeof(string) })]
        public string WindowGlobalExceptionOperationType { get => Body.WindowGlobalExceptionOperationType ?? null; set => Body.WindowGlobalExceptionOperationType = value; }
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                // work
                if (ShouldProcess($"Call remote 'UpdateGlobalExceptions' operation"))
                {
        ...
        protected async global::System.Threading.Tasks.Task ProcessRecordAsync()
        {
            using( NoSynchronizationContext )
            {
                ...
                try
                {
                    ...
                    await this.Client.UpdateGlobalExceptions(Body, onOk, onBadRequest, onInternalServerError, this, Pipeline);
        ...
        /// <summary>
        /// Intializes a new instance of the <see cref="UpdateGlobalException_UpdateExpanded" /> cmdlet class.
        /// </summary>
        public UpdateGlobalException_UpdateExpanded()
        {
