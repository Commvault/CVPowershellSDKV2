...
namespace Commvault.Powershell.Cmdlets
{
    ...
    /// <remarks>
    /// [OpenAPI] DeleteDiskAccessPath=>DELETE:"/V4/Storage/Disk/{storagePoolId}/BackupLocation/{backupLocationId}/AccessPath/{accessPathId}"
    /// </remarks>
    [global::System.Management.Automation.Cmdlet(global::System.Management.Automation.VerbsCommon.Remove, @"DiskAccessPath_Delete", SupportsShouldProcess = true)]
    [global::System.Management.Automation.OutputType(typeof(Commvault.Powershell.Models.IGenericResp))]
    [global::Commvault.Powershell.Description(@"Used to delete a media agent to a disk access path")]
    [global::Commvault.Powershell.Generated]
    public partial class RemoveDiskAccessPath_Delete : global::System.Management.Automation.PSCmdlet,
        Commvault.Powershell.Runtime.IEventListener
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                // work
                if (ShouldProcess($"Call remote 'DeleteDiskAccessPath' operation"))
                {
        ...
        protected async global::System.Threading.Tasks.Task ProcessRecordAsync()
        {
            using( NoSynchronizationContext )
            {
                ...
                try
                {
                    ...
                    await this.Client.DeleteDiskAccessPath(StoragePoolId, BackupLocationId, AccessPathId, onOk, onNotFound, this, Pipeline);
                ...
                {
                    WriteError(new global::System.Management.Automation.ErrorRecord(urexception, urexception.StatusCode.ToString(), global::System.Management.Automation.ErrorCategory.InvalidOperation, new {  StoragePoolId=StoragePoolId,BackupLocationId=BackupLocationId,AccessPathId=AccessPathId})
                    {
        ...
        /// <summary>
        /// Intializes a new instance of the <see cref="RemoveDiskAccessPath_Delete" /> cmdlet class.
        /// </summary>
        public RemoveDiskAccessPath_Delete()
        {
