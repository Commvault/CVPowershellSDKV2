...
namespace Commvault.Powershell.Cmdlets
{
    ...
    /// <remarks>
    /// [OpenAPI] ConfigureSyslogStatus=>POST:"/V4/SyslogServer"
    /// </remarks>
    [global::System.Management.Automation.Cmdlet(global::System.Management.Automation.VerbsCommon.Set, @"SyslogStatus_ConfigureExpanded", SupportsShouldProcess = true)]
    [global::System.Management.Automation.OutputType(typeof(Commvault.Powershell.Models.IGenericResp))]
    [global::Commvault.Powershell.Description(@"This endpoint configures a syslog server.")]
    [global::Commvault.Powershell.Generated]
    public partial class SetSyslogStatus_ConfigureExpanded : global::System.Management.Automation.PSCmdlet,
        Commvault.Powershell.Runtime.IEventListener
    {
        ...
        private Commvault.Powershell.Models.ISyslogConfigure _body= new Commvault.Powershell.Models.SyslogConfigure();

        /// <summary>This operation configures a syslog server.</summary>
        private Commvault.Powershell.Models.ISyslogConfigure Body { get => this._body; set => this._body = value; }
        ...
        /// </summary>
        [global::System.Management.Automation.Parameter(Mandatory = false, HelpMessage = "Content of the uploaded certificate authority file. It should be base64 encoded. Accepted fileTypes are key,crt,pem.")]
        ...
        public string CertificateAuthorityContent { get => Body.CertificateAuthorityContent ?? null; set => Body.CertificateAuthorityContent = value; }

        /// <summary>File name of the uploaded certificate authority file</summary>
        [global::System.Management.Automation.Parameter(Mandatory = false, HelpMessage = "File name of the uploaded certificate authority file")]
        [global::Commvault.Powershell.Category(global::Commvault.Powershell.ParameterCategory.Body)]
        [Commvault.Powershell.Runtime.Info(
        Required = false,
        ReadOnly = false,
        ...
        PossibleTypes = new [] { typeof(string) })]
        public string CertificateAuthorityName { get => Body.CertificateAuthorityName ?? null; set => Body.CertificateAuthorityName = value; }
        ...
        [global::System.Management.Automation.Parameter(Mandatory = false, HelpMessage = "Forward the system log for alerts to the server.")]
        [global::Commvault.Powershell.Category(global::Commvault.Powershell.ParameterCategory.Body)]
        [Commvault.Powershell.Runtime.Info(
        Required = false,
        ReadOnly = false,
        ...
        public global::System.Management.Automation.SwitchParameter ForwardToSyslogAlerts { get => Body.ForwardToSyslogAlerts ?? default(global::System.Management.Automation.SwitchParameter); set => Body.ForwardToSyslogAlerts = value; }

        /// <summary>Forward the system log for audit trails to the server.</summary>
        [global::System.Management.Automation.Parameter(Mandatory = false, HelpMessage = "Forward the system log for audit trails to the server.")]
        [global::Commvault.Powershell.Category(global::Commvault.Powershell.ParameterCategory.Body)]
        [Commvault.Powershell.Runtime.Info(
        Required = false,
        ReadOnly = false,
        ...
        PossibleTypes = new [] { typeof(global::System.Management.Automation.SwitchParameter) })]
        public global::System.Management.Automation.SwitchParameter ForwardToSyslogAudit { get => Body.ForwardToSyslogAudit ?? default(global::System.Management.Automation.SwitchParameter); set => Body.ForwardToSyslogAudit = value; }

        /// <summary>Forward the system log for events to the server.</summary>
        [global::System.Management.Automation.Parameter(Mandatory = false, HelpMessage = "Forward the system log for events to the server.")]
        [global::Commvault.Powershell.Category(global::Commvault.Powershell.ParameterCategory.Body)]
        [Commvault.Powershell.Runtime.Info(
        Required = false,
        ReadOnly = false,
        ...
        PossibleTypes = new [] { typeof(global::System.Management.Automation.SwitchParameter) })]
        public global::System.Management.Automation.SwitchParameter ForwardToSyslogEvents { get => Body.ForwardToSyslogEvents ?? default(global::System.Management.Automation.SwitchParameter); set => Body.ForwardToSyslogEvents = value; }

        /// <summary>The hostname or the IP address of the syslog server.</summary>
        [global::System.Management.Automation.Parameter(Mandatory = true, HelpMessage = "The hostname or the IP address of the syslog server.")]
        [global::Commvault.Powershell.Category(global::Commvault.Powershell.ParameterCategory.Body)]
        [Commvault.Powershell.Runtime.Info(
        Required = true,
        ReadOnly = false,
        ...
        PossibleTypes = new [] { typeof(string) })]
        public string Hostname { get => Body.Hostname ?? null; set => Body.Hostname = value; }
        ...
        [global::System.Management.Automation.Parameter(Mandatory = false, HelpMessage = "The port on which the syslog server accepts the logs.")]
        [global::Commvault.Powershell.Category(global::Commvault.Powershell.ParameterCategory.Body)]
        [Commvault.Powershell.Runtime.Info(
        Required = false,
        ReadOnly = false,
        ...
        /// </summary>
        [global::System.Management.Automation.Parameter(Mandatory = false, HelpMessage = "When false UDP port will be used, when true TLS encryption will be used to connect to Syslog Server. To upload Certificate Authority file it should be enabled.")]
        [global::Commvault.Powershell.Category(global::Commvault.Powershell.ParameterCategory.Body)]
        [Commvault.Powershell.Runtime.Info(
        Required = false,
        ReadOnly = false,
        ...
        PossibleTypes = new [] { typeof(global::System.Management.Automation.SwitchParameter) })]
        public global::System.Management.Automation.SwitchParameter SecureMessaging { get => Body.SecureMessaging ?? default(global::System.Management.Automation.SwitchParameter); set => Body.SecureMessaging = value; }
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                // work
                if (ShouldProcess($"Call remote 'ConfigureSyslogStatus' operation"))
                {
        ...
        protected async global::System.Threading.Tasks.Task ProcessRecordAsync()
        {
            using( NoSynchronizationContext )
            {
                ...
                try
                {
                    ...
                    await this.Client.ConfigureSyslogStatus(Body, onOk, onBadRequest, onInternalServerError, this, Pipeline);
        ...
        /// <summary>
        /// Intializes a new instance of the <see cref="SetSyslogStatus_ConfigureExpanded" /> cmdlet class.
        /// </summary>
        public SetSyslogStatus_ConfigureExpanded()
        {
