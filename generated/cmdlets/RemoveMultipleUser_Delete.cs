...
namespace Commvault.Powershell.Cmdlets
{
    ...
    /// </remarks>
    [global::System.Management.Automation.Cmdlet(global::System.Management.Automation.VerbsCommon.Remove, @"MultipleUser_Delete", SupportsShouldProcess = true)]
    ...
    public partial class RemoveMultipleUser_Delete : global::System.Management.Automation.PSCmdlet,
        Commvault.Powershell.Runtime.IEventListener
    {
        ...
        private Commvault.Powershell.Models.IDeleteMultipleUsers _body;

        /// <summary>
        /// Used to delete multiple users and carry out property transfership of deleted users
        /// </summary>
        [global::System.Management.Automation.Parameter(Mandatory = true, HelpMessage = "Used to delete multiple users and carry out property transfership of deleted users", ValueFromPipeline = true)]
        [Commvault.Powershell.Runtime.Info(
        Required = true,
        ReadOnly = false,
        Description = @"Used to delete multiple users and carry out property transfership of deleted users",
        SerializedName = @"body",
        PossibleTypes = new [] { typeof(Commvault.Powershell.Models.IDeleteMultipleUsers) })]
        public Commvault.Powershell.Models.IDeleteMultipleUsers Body { get => this._body; set => this._body = value; }
        ...
        /// <summary>
        /// Intializes a new instance of the <see cref="RemoveMultipleUser_Delete" /> cmdlet class.
        /// </summary>
        public RemoveMultipleUser_Delete()
        {
