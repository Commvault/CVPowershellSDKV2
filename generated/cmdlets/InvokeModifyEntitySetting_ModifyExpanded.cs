...
namespace Commvault.Powershell.Cmdlets
{
    ...
    /// </summary>
    /// <remarks>
    /// [OpenAPI] ModifyEntitySettings=>PUT:"/V4/EntitySettings"
    /// </remarks>
    [global::System.Management.Automation.Cmdlet(global::System.Management.Automation.VerbsLifecycle.Invoke, @"ModifyEntitySetting_ModifyExpanded", SupportsShouldProcess = true)]
    [global::System.Management.Automation.OutputType(typeof(Commvault.Powershell.Models.IGenericResp))]
    [global::Commvault.Powershell.Description(@"Modify entity settings used to change default behaviour for linked entity like servers or server groups")]
    [global::Commvault.Powershell.Generated]
    public partial class InvokeModifyEntitySetting_ModifyExpanded : global::System.Management.Automation.PSCmdlet,
        Commvault.Powershell.Runtime.IEventListener
    {
        ...
        private Commvault.Powershell.Models.IModifyEntitySettings _body= new Commvault.Powershell.Models.ModifyEntitySettings();

        /// <summary>ModifyEntitySettings</summary>
        private Commvault.Powershell.Models.IModifyEntitySettings Body { get => this._body; set => this._body = value; }
        ...
        public Commvault.Powershell.Models.IModifyEntitySettingsItem[] EntitySettings { get => Body.EntitySettings ?? null /* arrayOf */; set => Body.EntitySettings = value; }
        ...
        /// <summary>
        /// Intializes a new instance of the <see cref="InvokeModifyEntitySetting_ModifyExpanded" /> cmdlet class.
        /// </summary>
        public InvokeModifyEntitySetting_ModifyExpanded()
        {
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                // work
                if (ShouldProcess($"Call remote 'ModifyEntitySettings' operation"))
                {
        ...
        protected async global::System.Threading.Tasks.Task ProcessRecordAsync()
        {
            using( NoSynchronizationContext )
            {
                ...
                try
                {
                    ...
                    await this.Client.ModifyEntitySettings(Body, onOk, this, Pipeline);
