...
namespace Commvault.Powershell.Cmdlets
{
    ...
    /// </remarks>
    [global::System.Management.Automation.Cmdlet(global::System.Management.Automation.VerbsCommon.New, @"SamlApp_Create", SupportsShouldProcess = true)]
    ...
    public partial class NewSamlApp_Create : global::System.Management.Automation.PSCmdlet,
        Commvault.Powershell.Runtime.IEventListener
    {
        ...
        private Commvault.Powershell.Models.ISamlReq _body;

        /// <summary>Create SAML request</summary>
        [global::System.Management.Automation.Parameter(Mandatory = true, HelpMessage = "Create SAML request", ValueFromPipeline = true)]
        [Commvault.Powershell.Runtime.Info(
        Required = true,
        ReadOnly = false,
        Description = @"Create SAML request",
        SerializedName = @"body",
        PossibleTypes = new [] { typeof(Commvault.Powershell.Models.ISamlReq) })]
        public Commvault.Powershell.Models.ISamlReq Body { get => this._body; set => this._body = value; }
        ...
        /// <summary>Intializes a new instance of the <see cref="NewSamlApp_Create" /> cmdlet class.</summary>
        public NewSamlApp_Create()
        {
