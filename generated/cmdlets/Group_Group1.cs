...
namespace Commvault.Powershell.Cmdlets
{
    ...
    /// <remarks>
    /// [OpenAPI] VmGroupPreview=>POST:"/V4/VmGroup/Preview"
    /// </remarks>
    [global::System.Management.Automation.Cmdlet(global::System.Management.Automation.VerbsData.Group, @"_Group1", SupportsShouldProcess = true)]
    ...
    public partial class Group_Group1 : global::System.Management.Automation.PSCmdlet,
        Commvault.Powershell.Runtime.IEventListener
    {
        ...
        /// <summary>Intializes a new instance of the <see cref="Group_Group1" /> cmdlet class.</summary>
        public Group_Group1()
        {
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                // work
                if (ShouldProcess($"Call remote 'VMGroupPreview' operation"))
                {
        ...
        protected async global::System.Threading.Tasks.Task ProcessRecordAsync()
        {
            using( NoSynchronizationContext )
            {
                ...
                try
                {
                    ...
                    await this.Client.VMGroupPreview(this.InvocationInformation.BoundParameters.ContainsKey("HypervisorId") ? HypervisorId : default(int?), Body, onOk, onInternalServerError, this, Pipeline);
                ...
                {
                    WriteError(new global::System.Management.Automation.ErrorRecord(urexception, urexception.StatusCode.ToString(), global::System.Management.Automation.ErrorCategory.InvalidOperation, new {  HypervisorId=this.InvocationInformation.BoundParameters.ContainsKey("HypervisorId") ? HypervisorId : default(int?),body=Body})
                    {
