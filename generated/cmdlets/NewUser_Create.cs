...
namespace Commvault.Powershell.Cmdlets
{
    ...
    /// </remarks>
    [global::System.Management.Automation.Cmdlet(global::System.Management.Automation.VerbsCommon.New, @"User_Create", SupportsShouldProcess = true)]
    ...
    public partial class NewUser_Create : global::System.Management.Automation.PSCmdlet,
        Commvault.Powershell.Runtime.IEventListener
    {
        ...
        private Commvault.Powershell.Models.ICreateUsers _body;

        /// <summary>Used to create single or multiple users.</summary>
        [global::System.Management.Automation.Parameter(Mandatory = true, HelpMessage = "Used to create single or multiple users.", ValueFromPipeline = true)]
        [Commvault.Powershell.Runtime.Info(
        Required = true,
        ReadOnly = false,
        Description = @"Used to create single or multiple users.",
        SerializedName = @"body",
        PossibleTypes = new [] { typeof(Commvault.Powershell.Models.ICreateUsers) })]
        public Commvault.Powershell.Models.ICreateUsers Body { get => this._body; set => this._body = value; }
        ...
        /// <summary>Intializes a new instance of the <see cref="NewUser_Create" /> cmdlet class.</summary>
        public NewUser_Create()
        {
