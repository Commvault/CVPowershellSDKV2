...
namespace Commvault.Powershell.Cmdlets
{
    ...
    /// <remarks>
    /// [OpenAPI] VMGroupBackup=>POST:"/V4/VmGroup/{VmGroupId}/backup"
    /// </remarks>
    [global::System.Management.Automation.Cmdlet(global::System.Management.Automation.VerbsData.Group, @"_Group", SupportsShouldProcess = true)]
    ...
    public partial class Group_Group : global::System.Management.Automation.PSCmdlet,
        Commvault.Powershell.Runtime.IEventListener
    {
        ...
        /// <summary>Intializes a new instance of the <see cref="Group_Group" /> cmdlet class.</summary>
        public Group_Group()
        {
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                // work
                if (ShouldProcess($"Call remote 'VmgroupBackup' operation"))
                {
        ...
        protected async global::System.Threading.Tasks.Task ProcessRecordAsync()
        {
            using( NoSynchronizationContext )
            {
                ...
                try
                {
                    ...
                    await this.Client.VmgroupBackup(VMGroupId, this.InvocationInformation.BoundParameters.ContainsKey("BackupLevel") ? BackupLevel : null, onOk, onNotFound, onInternalServerError, this, Pipeline);
