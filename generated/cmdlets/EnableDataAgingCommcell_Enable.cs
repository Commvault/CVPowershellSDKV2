...
namespace Commvault.Powershell.Cmdlets
{
    ...
    /// <remarks>
    /// [OpenAPI] EnableDataAgingCommcell=>PUT:"/V4/Commcell/DataAging/Action/Enable"
    /// </remarks>
    [global::System.Management.Automation.Cmdlet(global::System.Management.Automation.VerbsLifecycle.Enable, @"DataAgingCommcell_Enable", SupportsShouldProcess = true)]
    [global::System.Management.Automation.OutputType(typeof(Commvault.Powershell.Models.IGenericResp))]
    [global::Commvault.Powershell.Description(@"Used to enable data aging property for commcell")]
    [global::Commvault.Powershell.Generated]
    public partial class EnableDataAgingCommcell_Enable : global::System.Management.Automation.PSCmdlet,
        Commvault.Powershell.Runtime.IEventListener
    {
        ...
        /// <summary>
        /// Intializes a new instance of the <see cref="EnableDataAgingCommcell_Enable" /> cmdlet class.
        /// </summary>
        public EnableDataAgingCommcell_Enable()
        {
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                // work
                if (ShouldProcess($"Call remote 'EnableDataAgingCommcell' operation"))
                {
        ...
        protected async global::System.Threading.Tasks.Task ProcessRecordAsync()
        {
            using( NoSynchronizationContext )
            {
                ...
                try
                {
                    ...
                    await this.Client.EnableDataAgingCommcell(onOk, this, Pipeline);
