...
namespace Commvault.Powershell.Cmdlets
{
    ...
    /// <remarks>
    /// [OpenAPI] DeleteHypervisor=>DELETE:"/V4/Hypervisor/{hypervisorId}"
    /// </remarks>
    [global::System.Management.Automation.Cmdlet(global::System.Management.Automation.VerbsCommon.Remove, @"Hypervisor_Delete", SupportsShouldProcess = true)]
    [global::System.Management.Automation.OutputType(typeof(Commvault.Powershell.Models.IGenericResp))]
    [global::Commvault.Powershell.Description(@"delete an existing vm group")]
    [global::Commvault.Powershell.Generated]
    public partial class RemoveHypervisor_Delete : global::System.Management.Automation.PSCmdlet,
        Commvault.Powershell.Runtime.IEventListener
    {
        ...
        /// <summary>Id of the Hypervisor to delete</summary>
        [global::System.Management.Automation.Parameter(Mandatory = true, HelpMessage = "Id of the Hypervisor to delete")]
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                // work
                if (ShouldProcess($"Call remote 'DeleteHypervisor' operation"))
                {
        ...
        protected async global::System.Threading.Tasks.Task ProcessRecordAsync()
        {
            using( NoSynchronizationContext )
            {
                ...
                try
                {
                    ...
                    await this.Client.DeleteHypervisor(HypervisorId, onOk, onNotFound, onInternalServerError, this, Pipeline);
        ...
        /// <summary>
        /// Intializes a new instance of the <see cref="RemoveHypervisor_Delete" /> cmdlet class.
        /// </summary>
        public RemoveHypervisor_Delete()
        {
