...
namespace Commvault.Powershell.Cmdlets
{
    ...
    /// <remarks>
    /// [OpenAPI] PostLaptopOwnerMapping=>POST:"/V4/LaptopOwnerMapping"
    /// </remarks>
    [global::System.Management.Automation.Cmdlet(global::System.Management.Automation.VerbsLifecycle.Invoke, @"LaptopOwnerMapping_Post", SupportsShouldProcess = true)]
    [global::System.Management.Automation.OutputType(typeof(Commvault.Powershell.Models.IGenericResp))]
    [global::Commvault.Powershell.Description(@"API to create laptop owner mappings")]
    [global::Commvault.Powershell.Generated]
    public partial class InvokeLaptopOwnerMapping_Post : global::System.Management.Automation.PSCmdlet,
        Commvault.Powershell.Runtime.IEventListener
    {
        ...
        private Commvault.Powershell.Models.ICreateLaptopOwnerMapping _body;
        ...
        /// </summary>
        [global::System.Management.Automation.Parameter(Mandatory = true, HelpMessage = "POST request for adding new laptop owner mapping, The mandotary fields are combination of multiple properties SerialNumber AND (host OR laptopName) AND (ownerEmail OR ownerUPN)", ValueFromPipeline = true)]
        ...
        SerializedName = @"body",
        PossibleTypes = new [] { typeof(Commvault.Powershell.Models.ICreateLaptopOwnerMapping) })]
        public Commvault.Powershell.Models.ICreateLaptopOwnerMapping Body { get => this._body; set => this._body = value; }
        ...
        /// <summary>
        /// Intializes a new instance of the <see cref="InvokeLaptopOwnerMapping_Post" /> cmdlet class.
        /// </summary>
        public InvokeLaptopOwnerMapping_Post()
        {
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                // work
                if (ShouldProcess($"Call remote 'PostLaptopOwnerMapping' operation"))
                {
        ...
        protected async global::System.Threading.Tasks.Task ProcessRecordAsync()
        {
            using( NoSynchronizationContext )
            {
                ...
                try
                {
                    ...
                    await this.Client.PostLaptopOwnerMapping(Body, onOk, onNotFound, onServiceUnavailable, this, Pipeline);
