...
namespace Commvault.Powershell.Cmdlets
{
    ...
    /// <remarks>
    /// [OpenAPI] CreateNewRole=>POST:"/V4/Role"
    /// </remarks>
    [global::System.Management.Automation.Cmdlet(global::System.Management.Automation.VerbsCommon.New, @"NewRole_CreateExpanded", SupportsShouldProcess = true)]
    [global::System.Management.Automation.OutputType(typeof(Commvault.Powershell.Models.IIdName))]
    [global::Commvault.Powershell.Description(@"Create a new role")]
    [global::Commvault.Powershell.Generated]
    public partial class NewNewRole_CreateExpanded : global::System.Management.Automation.PSCmdlet,
        Commvault.Powershell.Runtime.IEventListener
    {
        ...
        private Commvault.Powershell.Models.ICreateRole _body= new Commvault.Powershell.Models.CreateRole();

        /// <summary>Create a new role.</summary>
        private Commvault.Powershell.Models.ICreateRole Body { get => this._body; set => this._body = value; }
        ...
        /// </summary>
        [global::System.Management.Automation.Parameter(Mandatory = false, HelpMessage = "Used to determine if the role is enabled or disabled. If not provided, role will be enabled by default.")]
        ...
        [global::System.Management.Automation.Parameter(Mandatory = true, HelpMessage = "Name of the new role")]
        [global::Commvault.Powershell.Category(global::Commvault.Powershell.ParameterCategory.Body)]
        [Commvault.Powershell.Runtime.Info(
        Required = true,
        ReadOnly = false,
        ...
        [global::System.Management.Automation.Parameter(Mandatory = true, HelpMessage = "Used to provide the list of permissions associated with the role.")]
        [global::Commvault.Powershell.Category(global::Commvault.Powershell.ParameterCategory.Body)]
        [Commvault.Powershell.Runtime.Info(
        Required = true,
        ReadOnly = false,
        ...
        /// </summary>
        [global::System.Management.Automation.Parameter(Mandatory = false, HelpMessage = "Determines if the role is visible to everyone. if not provided, it will be set to false by default.")]
        [global::Commvault.Powershell.Category(global::Commvault.Powershell.ParameterCategory.Body)]
        [Commvault.Powershell.Runtime.Info(
        Required = false,
        ReadOnly = false,
        ...
        /// <summary>
        /// Intializes a new instance of the <see cref="NewNewRole_CreateExpanded" /> cmdlet class.
        /// </summary>
        public NewNewRole_CreateExpanded()
        {
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                // work
                if (ShouldProcess($"Call remote 'CreateNewRole' operation"))
                {
        ...
        protected async global::System.Threading.Tasks.Task ProcessRecordAsync()
        {
            using( NoSynchronizationContext )
            {
                ...
                try
                {
                    ...
                    await this.Client.CreateNewRole(Body, onOk, onBadRequest, onInternalServerError, this, Pipeline);
