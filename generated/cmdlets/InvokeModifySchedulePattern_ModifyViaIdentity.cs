...
namespace Commvault.Powershell.Cmdlets
{
    ...
    /// </remarks>
    [global::System.Management.Automation.Cmdlet(global::System.Management.Automation.VerbsLifecycle.Invoke, @"ModifySchedulePattern_ModifyViaIdentity", SupportsShouldProcess = true)]
    ...
    public partial class InvokeModifySchedulePattern_ModifyViaIdentity : global::System.Management.Automation.PSCmdlet,
        Commvault.Powershell.Runtime.IEventListener
    {
        ...
        private Commvault.Powershell.Models.IPlanPattern _body;

        /// <summary>
        /// If updating pattern, the value which needs to be retained also needs to be provided along with the updated value
        /// </summary>
        [global::System.Management.Automation.Parameter(Mandatory = true, HelpMessage = "If updating pattern, the value which needs to be retained also needs to be provided along with the updated value", ValueFromPipeline = true)]
        ...
        SerializedName = @"body",
        PossibleTypes = new [] { typeof(Commvault.Powershell.Models.IPlanPattern) })]
        public Commvault.Powershell.Models.IPlanPattern Body { get => this._body; set => this._body = value; }
        ...
        /// <summary>
        /// Intializes a new instance of the <see cref="InvokeModifySchedulePattern_ModifyViaIdentity" /> cmdlet class.
        /// </summary>
        public InvokeModifySchedulePattern_ModifyViaIdentity()
        {
