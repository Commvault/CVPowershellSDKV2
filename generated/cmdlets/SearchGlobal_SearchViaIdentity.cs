...
namespace Commvault.Powershell.Cmdlets
{
    ...
    /// <remarks>
    /// [OpenAPI] GlobalSearch=>GET:"/{globalSearchEntity}/aggregate"
    /// </remarks>
    [global::System.Management.Automation.Cmdlet(global::System.Management.Automation.VerbsCommon.Search, @"Global_SearchViaIdentity")]
    [global::System.Management.Automation.OutputType(typeof(Commvault.Powershell.Models.IGroupByAggregationValue))]
    [global::Commvault.Powershell.Description(@"")]
    [global::Commvault.Powershell.Generated]
    public partial class SearchGlobal_SearchViaIdentity : global::System.Management.Automation.PSCmdlet,
        Commvault.Powershell.Runtime.IEventListener
    {
        ...
        /// <summary>Backing field for <see cref="AggregateOn" /> property.</summary>
        private string _aggregateOn;

        /// <summary>attribute on which aggregation function would be applied.</summary>
        [global::System.Management.Automation.Parameter(Mandatory = false, HelpMessage = "attribute on which aggregation function would be applied.")]
        [Commvault.Powershell.Runtime.Info(
        Required = false,
        ReadOnly = false,
        Description = @"attribute on which aggregation function would be applied.",
        SerializedName = @"aggregateOn",
        PossibleTypes = new [] { typeof(string) })]
        [global::Commvault.Powershell.Category(global::Commvault.Powershell.ParameterCategory.Query)]
        public string AggregateOn { get => this._aggregateOn; set => this._aggregateOn = value; }
        ...
        /// <summary>Backing field for <see cref="Fq" /> property.</summary>
        private string _fq;

        /// <summary>Filter criteria to filter out global search entities</summary>
        [global::System.Management.Automation.Parameter(Mandatory = false, HelpMessage = "Filter criteria to filter out global search entities")]
        [Commvault.Powershell.Runtime.Info(
        Required = false,
        ReadOnly = false,
        ...
        PossibleTypes = new [] { typeof(string) })]
        [global::Commvault.Powershell.Category(global::Commvault.Powershell.ParameterCategory.Query)]
        public string Fq { get => this._fq; set => this._fq = value; }

        /// <summary>Backing field for <see cref="Func" /> property.</summary>
        private string _func;

        /// <summary>aggregation function to be applied.</summary>
        [global::System.Management.Automation.Parameter(Mandatory = true, HelpMessage = "aggregation function to be applied.")]
        [Commvault.Powershell.Runtime.Info(
        Required = true,
        ReadOnly = false,
        ...
        PossibleTypes = new [] { typeof(string) })]
        [global::Commvault.Powershell.Category(global::Commvault.Powershell.ParameterCategory.Query)]
        public string Func { get => this._func; set => this._func = value; }
        ...
        /// </summary>
        [global::System.Management.Automation.Parameter(Mandatory = false, HelpMessage = "comma-seperated list of attributes based on which aggregate results would be grouped")]
        [Commvault.Powershell.Runtime.Info(
        Required = false,
        ReadOnly = false,
        Description = @"comma-seperated list of attributes based on which aggregate results would be grouped",
        ...
        /// </summary>
        /// <param name="responseMessage">the raw response message as an global::System.Net.Http.HttpResponseMessage.</param>
        /// <param name="response">the body result as a <see cref="Commvault.Powershell.Models.IGlobalEntityAggregationValueResp"
        /// /> from the remote call</param>
        /// <param name="returnNow">/// Determines if the rest of the onOk method should be processed, or if the method should return
        /// immediately (set to true to skip further processing )</param>

        partial void overrideOnOk(global::System.Net.Http.HttpResponseMessage responseMessage, global::System.Threading.Tasks.Task<Commvault.Powershell.Models.IGlobalEntityAggregationValueResp> response, ref global::System.Threading.Tasks.Task<bool> returnNow);
        ...
        protected async global::System.Threading.Tasks.Task ProcessRecordAsync()
        {
            using( NoSynchronizationContext )
            {
                ...
                try
                {
                    ...
                    if (null == InputObject.GlobalSearchEntity)
                    {
                        ThrowTerminatingError( new global::System.Management.Automation.ErrorRecord(new global::System.Exception("InputObject has null value for InputObject.GlobalSearchEntity"),string.Empty, global::System.Management.Automation.ErrorCategory.InvalidArgument, InputObject) );
                    }
                    await this.Client.GlobalSearch(InputObject.GlobalSearchEntity ?? null, this.InvocationInformation.BoundParameters.ContainsKey("Fq") ? Fq : null, this.InvocationInformation.BoundParameters.ContainsKey("GroupBy") ? GroupBy : null, Func, this.InvocationInformation.BoundParameters.ContainsKey("AggregateOn") ? AggregateOn : null, onOk, onNotFound, this, Pipeline);
                ...
                {
                    WriteError(new global::System.Management.Automation.ErrorRecord(urexception, urexception.StatusCode.ToString(), global::System.Management.Automation.ErrorCategory.InvalidOperation, new {  Fq=this.InvocationInformation.BoundParameters.ContainsKey("Fq") ? Fq : null,GroupBy=this.InvocationInformation.BoundParameters.ContainsKey("GroupBy") ? GroupBy : null,Func=Func,AggregateOn=this.InvocationInformation.BoundParameters.ContainsKey("AggregateOn") ? AggregateOn : null})
                    {
        ...
        /// <summary>
        /// Intializes a new instance of the <see cref="SearchGlobal_SearchViaIdentity" /> cmdlet class.
        /// </summary>
        public SearchGlobal_SearchViaIdentity()
        {
        ...
        /// A <see cref="global::System.Threading.Tasks.Task" /> that will be complete when handling of the method is completed.
        /// </returns>
        private async global::System.Threading.Tasks.Task onOk(global::System.Net.Http.HttpResponseMessage responseMessage, global::System.Threading.Tasks.Task<Commvault.Powershell.Models.IGlobalEntityAggregationValueResp> response)
        {
            using( NoSynchronizationContext )
            {
                var _returnNow = global::System.Threading.Tasks.Task<bool>.FromResult(false);
                ...
                // nested-array / aggregation / <none>
                WriteObject((await response).Aggregation, true);
            }
        }
    }
}