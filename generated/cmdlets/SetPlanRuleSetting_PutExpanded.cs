...
namespace Commvault.Powershell.Cmdlets
{
    ...
    /// <remarks>
    /// [OpenAPI] PutPlanRuleSettings=>PUT:"/V4/Plan/Rule/Settings"
    /// </remarks>
    [global::System.Management.Automation.Cmdlet(global::System.Management.Automation.VerbsCommon.Set, @"PlanRuleSetting_PutExpanded", SupportsShouldProcess = true)]
    [global::System.Management.Automation.OutputType(typeof(Commvault.Powershell.Models.IGenericResp))]
    [global::Commvault.Powershell.Description(@"API to set plan rule execution settings")]
    [global::Commvault.Powershell.Generated]
    public partial class SetPlanRuleSetting_PutExpanded : global::System.Management.Automation.PSCmdlet,
        Commvault.Powershell.Runtime.IEventListener
    {
        ...
        private Commvault.Powershell.Models.IPlanRuleExecutionSettings _body= new Commvault.Powershell.Models.PlanRuleExecutionSettings();

        /// <summary>Message object to hold settings for plan rule execution.</summary>
        private Commvault.Powershell.Models.IPlanRuleExecutionSettings Body { get => this._body; set => this._body = value; }
        ...
        /// </summary>
        [global::System.Management.Automation.Parameter(Mandatory = false, HelpMessage = "Setting to suggest evaluation frequency in case of evaluation mode being Automatic.")]
        ...
        public string ExecutionMode { get => Body.ExecutionMode ?? null; set => Body.ExecutionMode = value; }
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                // work
                if (ShouldProcess($"Call remote 'PutPlanRuleSettings' operation"))
                {
        ...
        protected async global::System.Threading.Tasks.Task ProcessRecordAsync()
        {
            using( NoSynchronizationContext )
            {
                ...
                try
                {
                    ...
                    await this.Client.PutPlanRuleSettings(Body, onOk, onUnauthorized, onInternalServerError, this, Pipeline);
        ...
        /// <summary>
        /// Intializes a new instance of the <see cref="SetPlanRuleSetting_PutExpanded" /> cmdlet class.
        /// </summary>
        public SetPlanRuleSetting_PutExpanded()
        {
