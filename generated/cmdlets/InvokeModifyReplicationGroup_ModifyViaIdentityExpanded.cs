...
namespace Commvault.Powershell.Cmdlets
{
    ...
    /// <remarks>
    /// [OpenAPI] ModifyReplicationGroup=>PUT:"/V4/ReplicationGroup/{replicationGroupId}"
    /// </remarks>
    [global::System.Management.Automation.Cmdlet(global::System.Management.Automation.VerbsLifecycle.Invoke, @"ModifyReplicationGroup_ModifyViaIdentityExpanded", SupportsShouldProcess = true)]
    [global::System.Management.Automation.OutputType(typeof(Commvault.Powershell.Models.IGenericResp))]
    [global::Commvault.Powershell.Description(@"Modify the properties of an existing replication group")]
    [global::Commvault.Powershell.Generated]
    public partial class InvokeModifyReplicationGroup_ModifyViaIdentityExpanded : global::System.Management.Automation.PSCmdlet,
        Commvault.Powershell.Runtime.IEventListener
    {
        ...
        private Commvault.Powershell.Models.IUpdateReplicationGroup _body= new Commvault.Powershell.Models.UpdateReplicationGroup();

        /// <summary>UpdateReplicationGroupReq</summary>
        private Commvault.Powershell.Models.IUpdateReplicationGroup Body { get => this._body; set => this._body = value; }
        ...
        [global::System.Management.Automation.Parameter(Mandatory = false, HelpMessage = "Used to enable or disable a replication group")]
        ...
        [global::System.Management.Automation.Parameter(Mandatory = false, HelpMessage = "Used to change the name of a replication group")]
        [global::Commvault.Powershell.Category(global::Commvault.Powershell.ParameterCategory.Body)]
        [Commvault.Powershell.Runtime.Info(
        Required = false,
        ReadOnly = false,
        ...
        /// <summary>
        /// Intializes a new instance of the <see cref="InvokeModifyReplicationGroup_ModifyViaIdentityExpanded" /> cmdlet class.
        /// </summary>
        public InvokeModifyReplicationGroup_ModifyViaIdentityExpanded()
        {
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                // work
                if (ShouldProcess($"Call remote 'ModifyReplicationGroup' operation"))
                {
        ...
        protected async global::System.Threading.Tasks.Task ProcessRecordAsync()
        {
            using( NoSynchronizationContext )
            {
                ...
                try
                {
                    ...
                    await this.Client.ModifyReplicationGroup(InputObject.ReplicationGroupId ?? null, Body, onOk, onBadRequest, onNotFound, onInternalServerError, this, Pipeline);
