...
namespace Commvault.Powershell.Cmdlets
{
    ...
    /// <remarks>
    /// [OpenAPI] DeleteAccessPathForBucketOfCloudStorage=>DELETE:"/V4/Storage/Cloud/{cloudStorageId}/Bucket/{bucketId}/AccessPath/{accessPathId}"
    /// </remarks>
    [global::System.Management.Automation.Cmdlet(global::System.Management.Automation.VerbsCommon.Remove, @"AccessPath_Delete", SupportsShouldProcess = true)]
    [global::System.Management.Automation.OutputType(typeof(Commvault.Powershell.Models.IGenericResp))]
    [global::Commvault.Powershell.Description(@"Disassociate a MediaAgent (cloud Access Path) from a bucket of a cloud storage")]
    [global::Commvault.Powershell.Generated]
    public partial class RemoveAccessPath_Delete : global::System.Management.Automation.PSCmdlet,
        Commvault.Powershell.Runtime.IEventListener
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                // work
                if (ShouldProcess($"Call remote 'DeleteAccessPathForBucketOfCloudStorage' operation"))
                {
        ...
        protected async global::System.Threading.Tasks.Task ProcessRecordAsync()
        {
            using( NoSynchronizationContext )
            {
                ...
                try
                {
                    ...
                    await this.Client.DeleteAccessPathForBucketOfCloudStorage(CloudStorageId, BucketId, AccessPathId, onOk, onNotFound, onInternalServerError, this, Pipeline);
                ...
                {
                    WriteError(new global::System.Management.Automation.ErrorRecord(urexception, urexception.StatusCode.ToString(), global::System.Management.Automation.ErrorCategory.InvalidOperation, new {  CloudStorageId=CloudStorageId,BucketId=BucketId,AccessPathId=AccessPathId})
                    {
        ...
        /// <summary>
        /// Intializes a new instance of the <see cref="RemoveAccessPath_Delete" /> cmdlet class.
        /// </summary>
        public RemoveAccessPath_Delete()
        {
