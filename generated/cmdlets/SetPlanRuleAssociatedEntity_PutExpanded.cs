...
namespace Commvault.Powershell.Cmdlets
{
    ...
    /// <remarks>
    /// [OpenAPI] PutPlanRuleAssociatedEntities=>PUT:"/V4/Plan/Rule/Entities"
    /// </remarks>
    [global::System.Management.Automation.Cmdlet(global::System.Management.Automation.VerbsCommon.Set, @"PlanRuleAssociatedEntity_PutExpanded", SupportsShouldProcess = true)]
    [global::System.Management.Automation.OutputType(typeof(Commvault.Powershell.Models.IGenericResp))]
    [global::Commvault.Powershell.Description(@"API to send request to process plan rules against specific set of entities.")]
    [global::Commvault.Powershell.Generated]
    public partial class SetPlanRuleAssociatedEntity_PutExpanded : global::System.Management.Automation.PSCmdlet,
        Commvault.Powershell.Runtime.IEventListener
    {
        ...
        [global::System.Management.Automation.Parameter(Mandatory = false, HelpMessage = "List of backupsets against which plan rules need to be executed and evaluated.")]
        ...
        public Commvault.Powershell.Models.IIdName[] Backupsets { get => Body.Backupsets ?? null /* arrayOf */; set => Body.Backupsets = value; }

        /// <summary>Backing field for <see cref="Body" /> property.</summary>
        private Commvault.Powershell.Models.IExecutePlanRules _body= new Commvault.Powershell.Models.ExecutePlanRules();

        /// <summary>
        /// Message object to hold information of entities against which plan rule need to be analyzed
        /// </summary>
        private Commvault.Powershell.Models.IExecutePlanRules Body { get => this._body; set => this._body = value; }
        ...
        [global::System.Management.Automation.AllowEmptyCollection]
        [global::System.Management.Automation.Parameter(Mandatory = false, HelpMessage = "List of clients against which plan rules need to be executed and evaluated.")]
        [global::Commvault.Powershell.Category(global::Commvault.Powershell.ParameterCategory.Body)]
        [Commvault.Powershell.Runtime.Info(
        Required = false,
        ReadOnly = false,
        ...
        PossibleTypes = new [] { typeof(Commvault.Powershell.Models.IIdName) })]
        public Commvault.Powershell.Models.IIdName[] Clients { get => Body.Clients ?? null /* arrayOf */; set => Body.Clients = value; }
        ...
        /// </summary>
        [global::System.Management.Automation.Parameter(Mandatory = false, HelpMessage = "Boolean to indicate if we want to evaluate rule for entities associated to plan. Default is false. Only entities with no plan associated will be evaluated.")]
        [global::Commvault.Powershell.Category(global::Commvault.Powershell.ParameterCategory.Body)]
        [Commvault.Powershell.Runtime.Info(
        Required = false,
        ReadOnly = false,
        ...
        public global::System.Management.Automation.SwitchParameter IgnorePreviousPlanAssociation { get => Body.IgnorePreviousPlanAssociation ?? default(global::System.Management.Automation.SwitchParameter); set => Body.IgnorePreviousPlanAssociation = value; }

        /// <summary>List of instances against which plan rules need to be executed and evaluated.</summary>
        [global::System.Management.Automation.AllowEmptyCollection]
        [global::System.Management.Automation.Parameter(Mandatory = false, HelpMessage = "List of instances against which plan rules need to be executed and evaluated.")]
        [global::Commvault.Powershell.Category(global::Commvault.Powershell.ParameterCategory.Body)]
        [Commvault.Powershell.Runtime.Info(
        Required = false,
        ReadOnly = false,
        ...
        PossibleTypes = new [] { typeof(Commvault.Powershell.Models.IIdName) })]
        public Commvault.Powershell.Models.IIdName[] Instances { get => Body.Instances ?? null /* arrayOf */; set => Body.Instances = value; }
        ...
        /// </summary>
        [global::System.Management.Automation.Parameter(Mandatory = false, HelpMessage = "Boolean to indicate if request is to preview list of subclients that will be associated via plan rules")]
        [global::Commvault.Powershell.Category(global::Commvault.Powershell.ParameterCategory.Body)]
        [Commvault.Powershell.Runtime.Info(
        Required = false,
        ReadOnly = false,
        ...
        PossibleTypes = new [] { typeof(global::System.Management.Automation.SwitchParameter) })]
        public global::System.Management.Automation.SwitchParameter IsPreviewOnly { get => Body.IsPreviewOnly ?? default(global::System.Management.Automation.SwitchParameter); set => Body.IsPreviewOnly = value; }
        ...
        [global::System.Management.Automation.AllowEmptyCollection]
        [global::System.Management.Automation.Parameter(Mandatory = false, HelpMessage = "List of subclients against which plan rules need to be executed and evaluated.")]
        [global::Commvault.Powershell.Category(global::Commvault.Powershell.ParameterCategory.Body)]
        [Commvault.Powershell.Runtime.Info(
        Required = false,
        ReadOnly = false,
        ...
        PossibleTypes = new [] { typeof(Commvault.Powershell.Models.IIdName) })]
        public Commvault.Powershell.Models.IIdName[] Subclients { get => Body.Subclients ?? null /* arrayOf */; set => Body.Subclients = value; }
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                // work
                if (ShouldProcess($"Call remote 'PutPlanRuleAssociatedEntities' operation"))
                {
        ...
        protected async global::System.Threading.Tasks.Task ProcessRecordAsync()
        {
            using( NoSynchronizationContext )
            {
                ...
                try
                {
                    ...
                    await this.Client.PutPlanRuleAssociatedEntities(Body, onOk, onInternalServerError, this, Pipeline);
        ...
        /// <summary>
        /// Intializes a new instance of the <see cref="SetPlanRuleAssociatedEntity_PutExpanded" /> cmdlet class.
        /// </summary>
        public SetPlanRuleAssociatedEntity_PutExpanded()
        {
