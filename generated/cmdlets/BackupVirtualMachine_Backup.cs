...
namespace Commvault.Powershell.Cmdlets
{
    ...
    /// <remarks>
    /// [OpenAPI] BackupVirtualMachine=>POST:"/V4/VirtualMachines/{vmUUID}/backup"
    /// </remarks>
    [global::System.Management.Automation.Cmdlet(global::System.Management.Automation.VerbsData.Backup, @"VirtualMachine_Backup", SupportsShouldProcess = true)]
    [global::System.Management.Automation.OutputType(typeof(Commvault.Powershell.Models.ICreateTaskRespforBackup), typeof(Commvault.Powershell.Models.IGenericResp))]
    [global::Commvault.Powershell.Description(@"To Backup the virtual machines in vmgroup")]
    [global::Commvault.Powershell.Generated]
    public partial class BackupVirtualMachine_Backup : global::System.Management.Automation.PSCmdlet,
        Commvault.Powershell.Runtime.IEventListener
    {
        ...
        private string _backupLevel;

        /// <summary>Backup level , Default :Incremental</summary>
        [global::System.Management.Automation.Parameter(Mandatory = false, HelpMessage = "Backup level , Default :Incremental")]
        ...
        public string BackupLevel { get => this._backupLevel; set => this._backupLevel = value; }
        ...
        /// <summary>Id of the Virtual Machine to backup</summary>
        [global::System.Management.Automation.Parameter(Mandatory = true, HelpMessage = "Id of the Virtual Machine to backup")]
        [Commvault.Powershell.Runtime.Info(
        Required = true,
        ReadOnly = false,
        ...
        /// </summary>
        /// <param name="responseMessage">the raw response message as an global::System.Net.Http.HttpResponseMessage.</param>
        /// <param name="response">the body result as a <see cref="Commvault.Powershell.Models.ICreateTaskRespforBackup" /> from the
        /// remote call</param>
        /// <param name="returnNow">/// Determines if the rest of the onOk method should be processed, or if the method should return
        /// immediately (set to true to skip further processing )</param>

        partial void overrideOnOk(global::System.Net.Http.HttpResponseMessage responseMessage, global::System.Threading.Tasks.Task<Commvault.Powershell.Models.ICreateTaskRespforBackup> response, ref global::System.Threading.Tasks.Task<bool> returnNow);

        /// <summary>
        /// Intializes a new instance of the <see cref="BackupVirtualMachine_Backup" /> cmdlet class.
        /// </summary>
        public BackupVirtualMachine_Backup()
        {
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                // work
                if (ShouldProcess($"Call remote 'BackupVirtualMachine' operation"))
                {
        ...
        protected async global::System.Threading.Tasks.Task ProcessRecordAsync()
        {
            using( NoSynchronizationContext )
            {
                ...
                try
                {
                    ...
                    await this.Client.BackupVirtualMachine(VMUuid, this.InvocationInformation.BoundParameters.ContainsKey("BackupLevel") ? BackupLevel : null, onOk, onNotFound, onInternalServerError, this, Pipeline);
                ...
                {
                    WriteError(new global::System.Management.Automation.ErrorRecord(urexception, urexception.StatusCode.ToString(), global::System.Management.Automation.ErrorCategory.InvalidOperation, new {  VMUuid=VMUuid,BackupLevel=this.InvocationInformation.BoundParameters.ContainsKey("BackupLevel") ? BackupLevel : null})
                    {
        ...
        /// A <see cref="global::System.Threading.Tasks.Task" /> that will be complete when handling of the method is completed.
        /// </returns>
        private async global::System.Threading.Tasks.Task onOk(global::System.Net.Http.HttpResponseMessage responseMessage, global::System.Threading.Tasks.Task<Commvault.Powershell.Models.ICreateTaskRespforBackup> response)
        {
            using( NoSynchronizationContext )
            {
                var _returnNow = global::System.Threading.Tasks.Task<bool>.FromResult(false);
                ...
                // (await response) // should be Commvault.Powershell.Models.ICreateTaskRespforBackup
                WriteObject((await response));
            }
        }
    }
