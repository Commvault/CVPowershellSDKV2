...
namespace Commvault.Powershell.Cmdlets
{
    ...
    /// </remarks>
    [global::System.Management.Automation.Cmdlet(global::System.Management.Automation.VerbsLifecycle.Invoke, @"ModifyBackupLocation_ModifyExpanded", SupportsShouldProcess = true)]
    ...
    public partial class InvokeModifyBackupLocation_ModifyExpanded : global::System.Management.Automation.PSCmdlet,
        Commvault.Powershell.Runtime.IEventListener
    {
        ...
        /// <summary>Id of the backup location to update</summary>
        [global::System.Management.Automation.Parameter(Mandatory = true, HelpMessage = "Id of the backup location to update")]
        [Commvault.Powershell.Runtime.Info(
        Required = true,
        ReadOnly = false,
        ...
        /// <summary>
        /// Intializes a new instance of the <see cref="InvokeModifyBackupLocation_ModifyExpanded" /> cmdlet class.
        /// </summary>
        public InvokeModifyBackupLocation_ModifyExpanded()
        {
        ...
        protected async global::System.Threading.Tasks.Task ProcessRecordAsync()
        {
            using( NoSynchronizationContext )
            {
                ...
                try
                {
                    ...
                    await this.Client.ModifyBackupLocation(StoragePoolId, BackupLocationId, Body, onOk, onBadRequest, onNotFound, this, Pipeline);
                ...
                {
                    WriteError(new global::System.Management.Automation.ErrorRecord(urexception, urexception.StatusCode.ToString(), global::System.Management.Automation.ErrorCategory.InvalidOperation, new {  StoragePoolId=StoragePoolId,BackupLocationId=BackupLocationId,body=Body})
                    {
