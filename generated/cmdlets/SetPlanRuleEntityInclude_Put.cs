...
namespace Commvault.Powershell.Cmdlets
{
    ...
    /// <remarks>
    /// [OpenAPI] PutPlanRuleEntitiesInclude=>PUT:"/V4/Plan/Rule/Entities/Include"
    /// </remarks>
    [global::System.Management.Automation.Cmdlet(global::System.Management.Automation.VerbsCommon.Set, @"PlanRuleEntityInclude_Put", SupportsShouldProcess = true)]
    [global::System.Management.Automation.OutputType(typeof(Commvault.Powershell.Models.IGenericResp))]
    [global::Commvault.Powershell.Description(@"API to include workloads to be applicable for plan rule evaluation.")]
    [global::Commvault.Powershell.Generated]
    public partial class SetPlanRuleEntityInclude_Put : global::System.Management.Automation.PSCmdlet,
        Commvault.Powershell.Runtime.IEventListener
    {
        ...
        private Commvault.Powershell.Models.IIncludeEntitiesForPlanRuleEvaluation _body;

        /// <summary>Entities that need to be included for plan rule evaluation</summary>
        [global::System.Management.Automation.Parameter(Mandatory = true, HelpMessage = "Entities that need to be included for plan rule evaluation", ValueFromPipeline = true)]
        [Commvault.Powershell.Runtime.Info(
        Required = true,
        ReadOnly = false,
        Description = @"Entities that need to be included for plan rule evaluation",
        SerializedName = @"body",
        PossibleTypes = new [] { typeof(Commvault.Powershell.Models.IIncludeEntitiesForPlanRuleEvaluation) })]
        public Commvault.Powershell.Models.IIncludeEntitiesForPlanRuleEvaluation Body { get => this._body; set => this._body = value; }
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                // work
                if (ShouldProcess($"Call remote 'PutPlanRuleEntitiesInclude' operation"))
                {
        ...
        protected async global::System.Threading.Tasks.Task ProcessRecordAsync()
        {
            using( NoSynchronizationContext )
            {
                ...
                try
                {
                    ...
                    await this.Client.PutPlanRuleEntitiesInclude(Body, onOk, onForbidden, onInternalServerError, this, Pipeline);
        ...
        /// <summary>
        /// Intializes a new instance of the <see cref="SetPlanRuleEntityInclude_Put" /> cmdlet class.
        /// </summary>
        public SetPlanRuleEntityInclude_Put()
        {
