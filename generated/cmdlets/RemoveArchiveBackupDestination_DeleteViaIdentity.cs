        ...
        protected async global::System.Threading.Tasks.Task ProcessRecordAsync()
        {
            using( NoSynchronizationContext )
            {
                ...
                try
                {
                    ...
                    await this.Client.DeleteArchiveBackupDestination(InputObject.PlanId ?? default(int), InputObject.BackupDestinationId ?? default(int), onOk, onNotFound, onPreconditionFailed, onInternalServerError, this, Pipeline);
