...
namespace Commvault.Powershell.Cmdlets
{
    ...
    /// <remarks>
    /// [OpenAPI] ModifyBlackoutWindow=>PUT:"/V4/BlackoutWindow/{blackoutWindowId}"
    /// </remarks>
    [global::System.Management.Automation.Cmdlet(global::System.Management.Automation.VerbsLifecycle.Invoke, @"ModifyBlackoutWindow_ModifyExpanded", SupportsShouldProcess = true)]
    [global::System.Management.Automation.OutputType(typeof(Commvault.Powershell.Models.IGenericResp))]
    [global::Commvault.Powershell.Description(@"Modify the properties of an existing Blackout Window")]
    [global::Commvault.Powershell.Generated]
    public partial class InvokeModifyBlackoutWindow_ModifyExpanded : global::System.Management.Automation.PSCmdlet,
        Commvault.Powershell.Runtime.IEventListener
    {
        ...
        /// <summary>Id of the Blackout Window to update</summary>
        [global::System.Management.Automation.Parameter(Mandatory = true, HelpMessage = "Id of the Blackout Window to update")]
        [Commvault.Powershell.Runtime.Info(
        Required = true,
        ReadOnly = false,
        ...
        private Commvault.Powershell.Models.IUpdateBlackoutWindow _body= new Commvault.Powershell.Models.UpdateBlackoutWindow();

        /// <summary>
        /// company-refers to company to which the blackout window is associated.Dates have to be provided in unix time format.
        /// </summary>
        private Commvault.Powershell.Models.IUpdateBlackoutWindow Body { get => this._body; set => this._body = value; }
        ...
        /// </summary>
        [global::System.Management.Automation.Parameter(Mandatory = false, HelpMessage = "Allows or Denies submitting a job when the blackout window is in effect. If allowed, the job is submitted and resumed once the blackout window ends.")]
        [global::Commvault.Powershell.Category(global::Commvault.Powershell.ParameterCategory.Body)]
        [Commvault.Powershell.Runtime.Info(
        Required = false,
        ReadOnly = false,
        ...
        [global::System.Management.Automation.Parameter(Mandatory = false, HelpMessage = "Refers to the newName given to the blackout Window.")]
        [global::Commvault.Powershell.Category(global::Commvault.Powershell.ParameterCategory.Body)]
        [Commvault.Powershell.Runtime.Info(
        Required = false,
        ReadOnly = false,
        ...
        /// <summary>
        /// Intializes a new instance of the <see cref="InvokeModifyBlackoutWindow_ModifyExpanded" /> cmdlet class.
        /// </summary>
        public InvokeModifyBlackoutWindow_ModifyExpanded()
        {
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                // work
                if (ShouldProcess($"Call remote 'ModifyBlackoutWindow' operation"))
                {
        ...
        protected async global::System.Threading.Tasks.Task ProcessRecordAsync()
        {
            using( NoSynchronizationContext )
            {
                ...
                try
                {
                    ...
                    await this.Client.ModifyBlackoutWindow(BlackoutWindowId, Body, onOk, onBadRequest, onNotFound, this, Pipeline);
                ...
                {
                    WriteError(new global::System.Management.Automation.ErrorRecord(urexception, urexception.StatusCode.ToString(), global::System.Management.Automation.ErrorCategory.InvalidOperation, new {  BlackoutWindowId=BlackoutWindowId,body=Body})
                    {
