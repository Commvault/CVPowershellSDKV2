...
namespace Commvault.Powershell.Cmdlets
{
    ...
    [global::Commvault.Powershell.Description(@"Get the details of all vmGroup")]
    [global::Commvault.Powershell.Generated]
    public partial class GetVMGroup_Get : global::System.Management.Automation.PSCmdlet,
        Commvault.Powershell.Runtime.IEventListener
    {
        ...
        /// <summary>Intializes a new instance of the <see cref="GetVMGroup_Get" /> cmdlet class.</summary>
        public GetVMGroup_Get()
        {
        ...
        private async global::System.Threading.Tasks.Task onOk(global::System.Net.Http.HttpResponseMessage responseMessage, global::System.Threading.Tasks.Task<Commvault.Powershell.Models.IPaths1Oy9W65V4VmgroupGetResponses200ContentApplicationJsonSchema> response)
        {
            using( NoSynchronizationContext )
            {
                ...
                // response should be returning an array of some kind. +Pageable
                // nested-array / vmGroups / <none>
                WriteObject((await response).VMGroups, true);
            }
        }
    }
}