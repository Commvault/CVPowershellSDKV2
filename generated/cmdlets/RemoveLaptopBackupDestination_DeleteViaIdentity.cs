        ...
        protected async global::System.Threading.Tasks.Task ProcessRecordAsync()
        {
            using( NoSynchronizationContext )
            {
                ...
                try
                {
                    ...
                    await this.Client.DeleteLaptopBackupDestination(InputObject.PlanId ?? default(int), InputObject.BackupDestinationId ?? default(int), onOk, onNotFound, onPreconditionFailed, onInternalServerError, this, Pipeline);
