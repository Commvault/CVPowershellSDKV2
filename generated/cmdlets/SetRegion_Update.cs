...
namespace Commvault.Powershell.Cmdlets
{
    ...
    /// </remarks>
    [global::System.Management.Automation.Cmdlet(global::System.Management.Automation.VerbsCommon.Set, @"Region_Update", SupportsShouldProcess = true)]
    ...
    public partial class SetRegion_Update : global::System.Management.Automation.PSCmdlet,
        Commvault.Powershell.Runtime.IEventListener
    {
        ...
        private Commvault.Powershell.Models.IUpdateRegion _body;
        ...
        /// </summary>
        [global::System.Management.Automation.Parameter(Mandatory = true, HelpMessage = "For newly added location - country, latitude and longitude are mandatory fields. Any existing location added to locations array needs to have all the existing fields. ", ValueFromPipeline = true)]
        ...
        SerializedName = @"body",
        PossibleTypes = new [] { typeof(Commvault.Powershell.Models.IUpdateRegion) })]
        public Commvault.Powershell.Models.IUpdateRegion Body { get => this._body; set => this._body = value; }
        ...
        /// <summary>Intializes a new instance of the <see cref="SetRegion_Update" /> cmdlet class.</summary>
        public SetRegion_Update()
        {
