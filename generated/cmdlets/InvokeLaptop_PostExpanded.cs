...
namespace Commvault.Powershell.Cmdlets
{
    ...
    /// <remarks>
    /// [OpenAPI] PostLaptop=>POST:"/V4/Laptop"
    /// </remarks>
    [global::System.Management.Automation.Cmdlet(global::System.Management.Automation.VerbsLifecycle.Invoke, @"Laptop_PostExpanded", SupportsShouldProcess = true)]
    [global::System.Management.Automation.OutputType(typeof(Commvault.Powershell.Models.IAddLaptopResp))]
    [global::Commvault.Powershell.Description(@"Simplified API to create a laptop")]
    [global::Commvault.Powershell.Generated]
    public partial class InvokeLaptop_PostExpanded : global::System.Management.Automation.PSCmdlet,
        Commvault.Powershell.Runtime.IEventListener
    {
        ...
        private Commvault.Powershell.Models.IAddLaptop _body= new Commvault.Powershell.Models.AddLaptop();

        private Commvault.Powershell.Models.IAddLaptop Body { get => this._body; set => this._body = value; }
        ...
        [global::System.Management.Automation.Parameter(Mandatory = true, HelpMessage = "list of hostName of computers")]
        ...
        public string[] ClientNames { get => Body.ClientNames ?? null /* arrayOf */; set => Body.ClientNames = value; }
        ...
        [global::System.Management.Automation.Parameter(Mandatory = true, HelpMessage = "the os type of computers")]
        [global::Commvault.Powershell.Category(global::Commvault.Powershell.ParameterCategory.Body)]
        [Commvault.Powershell.Runtime.Info(
        Required = true,
        ReadOnly = false,
        ...
        SerializedName = @"os",
        PossibleTypes = new [] { typeof(string) })]
        public string OS { get => Body.OS ?? null; set => Body.OS = value; }
        ...
        [global::System.Management.Automation.Parameter(Mandatory = true, HelpMessage = "password (base64 encoded) required for authentication of jobs")]
        [global::Commvault.Powershell.Category(global::Commvault.Powershell.ParameterCategory.Body)]
        [Commvault.Powershell.Runtime.Info(
        Required = true,
        ReadOnly = false,
        ...
        [global::System.Management.Automation.Parameter(Mandatory = true, HelpMessage = "username required for authentication of jobs")]
        [global::Commvault.Powershell.Category(global::Commvault.Powershell.ParameterCategory.Body)]
        [Commvault.Powershell.Runtime.Info(
        Required = true,
        ReadOnly = false,
        ...
        /// </summary>
        /// <param name="responseMessage">the raw response message as an global::System.Net.Http.HttpResponseMessage.</param>
        /// <param name="response">the body result as a <see cref="Commvault.Powershell.Models.IAddLaptopResp" /> from the remote
        /// call</param>
        /// <param name="returnNow">/// Determines if the rest of the onOk method should be processed, or if the method should return
        /// immediately (set to true to skip further processing )</param>

        partial void overrideOnOk(global::System.Net.Http.HttpResponseMessage responseMessage, global::System.Threading.Tasks.Task<Commvault.Powershell.Models.IAddLaptopResp> response, ref global::System.Threading.Tasks.Task<bool> returnNow);
        ...
        /// <summary>
        /// Intializes a new instance of the <see cref="InvokeLaptop_PostExpanded" /> cmdlet class.
        /// </summary>
        public InvokeLaptop_PostExpanded()
        {
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                // work
                if (ShouldProcess($"Call remote 'PostLaptop' operation"))
                {
        ...
        protected async global::System.Threading.Tasks.Task ProcessRecordAsync()
        {
            using( NoSynchronizationContext )
            {
                ...
                try
                {
                    ...
                    await this.Client.PostLaptop(Body, onOk, onBadRequest, onNotFound, this, Pipeline);
        ...
        /// A <see cref="global::System.Threading.Tasks.Task" /> that will be complete when handling of the method is completed.
        /// </returns>
        private async global::System.Threading.Tasks.Task onOk(global::System.Net.Http.HttpResponseMessage responseMessage, global::System.Threading.Tasks.Task<Commvault.Powershell.Models.IAddLaptopResp> response)
        {
            using( NoSynchronizationContext )
            {
                var _returnNow = global::System.Threading.Tasks.Task<bool>.FromResult(false);
                ...
                // (await response) // should be Commvault.Powershell.Models.IAddLaptopResp
