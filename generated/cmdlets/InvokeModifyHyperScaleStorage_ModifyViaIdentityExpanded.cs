...
namespace Commvault.Powershell.Cmdlets
{
    ...
    /// <remarks>
    /// [OpenAPI] ModifyHyperScaleStorageById=>PUT:"/V4/Storage/HyperScale/{hyperScaleStorageId}"
    /// </remarks>
    [global::System.Management.Automation.Cmdlet(global::System.Management.Automation.VerbsLifecycle.Invoke, @"ModifyHyperScaleStorage_ModifyViaIdentityExpanded", SupportsShouldProcess = true)]
    [global::System.Management.Automation.OutputType(typeof(Commvault.Powershell.Models.IGenericResp))]
    [global::Commvault.Powershell.Description(@"Modify details like name, encryption, security of a specific hyperscale storage")]
    [global::Commvault.Powershell.Generated]
    public partial class InvokeModifyHyperScaleStorage_ModifyViaIdentityExpanded : global::System.Management.Automation.PSCmdlet,
        Commvault.Powershell.Runtime.IEventListener
    {
        ...
        private Commvault.Powershell.Models.IUpdateHyperScaleStorage _body= new Commvault.Powershell.Models.UpdateHyperScaleStorage();

        /// <summary>UpdateHyperScaleStorage</summary>
        private Commvault.Powershell.Models.IUpdateHyperScaleStorage Body { get => this._body; set => this._body = value; }
        ...
        /// </summary>
        [global::System.Management.Automation.Parameter(Mandatory = false, HelpMessage = "The different types of encryption keys that can be used for encrypting the data. The values are case sensitive")]
        ...
        public string EncryptionCipher { get => Body.EncryptionCipher ?? null; set => Body.EncryptionCipher = value; }
        ...
        public global::System.Management.Automation.SwitchParameter EncryptionEncrypt { get => Body.EncryptionEncrypt ?? default(global::System.Management.Automation.SwitchParameter); set => Body.EncryptionEncrypt = value; }
        ...
        /// </summary>
        [global::System.Management.Automation.Parameter(Mandatory = false, HelpMessage = "Different keylengths are present for different kinds of ciphers. Blowfish,Twofish,AES and Serpent all accept both 128 and 256. DES3 accepts only 192. GOST accepts only 256. ")]
        [global::Commvault.Powershell.Category(global::Commvault.Powershell.ParameterCategory.Body)]
        [Commvault.Powershell.Runtime.Info(
        Required = false,
        ReadOnly = false,
        ...
        public int EncryptionKeyLength { get => Body.EncryptionKeyLength ?? default(int); set => Body.EncryptionKeyLength = value; }
        ...
        SerializedName = @"id",
        PossibleTypes = new [] { typeof(int) })]
        public int KeyProviderId { get => Body.KeyProviderId ?? default(int); set => Body.KeyProviderId = value; }
        ...
        SerializedName = @"name",
        PossibleTypes = new [] { typeof(string) })]
        public string KeyProviderName { get => Body.KeyProviderName ?? null; set => Body.KeyProviderName = value; }
        ...
        [global::System.Management.Automation.Parameter(Mandatory = false, HelpMessage = "change the name of the HyperScale storage")]
        [global::Commvault.Powershell.Category(global::Commvault.Powershell.ParameterCategory.Body)]
        [Commvault.Powershell.Runtime.Info(
        Required = false,
        ReadOnly = false,
        ...
        /// <summary>
        /// Intializes a new instance of the <see cref="InvokeModifyHyperScaleStorage_ModifyViaIdentityExpanded" /> cmdlet class.
        /// </summary>
        public InvokeModifyHyperScaleStorage_ModifyViaIdentityExpanded()
        {
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                // work
                if (ShouldProcess($"Call remote 'ModifyHyperScaleStorageById' operation"))
                {
        ...
        protected async global::System.Threading.Tasks.Task ProcessRecordAsync()
        {
            using( NoSynchronizationContext )
            {
                ...
                try
                {
                    ...
                    await this.Client.ModifyHyperScaleStorageById(InputObject.HyperScaleStorageId ?? default(int), Body, onOk, onBadRequest, onNotFound, this, Pipeline);
