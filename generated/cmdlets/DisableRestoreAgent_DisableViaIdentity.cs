        ...
        protected async global::System.Threading.Tasks.Task ProcessRecordAsync()
        {
            using( NoSynchronizationContext )
            {
                ...
                try
                {
                    ...
                    await this.Client.DisableRestoreAgent(InputObject.ServerId ?? default(int), InputObject.AgentId ?? default(int), this.InvocationInformation.BoundParameters.ContainsKey("EnableAfterADelay") ? EnableAfterADelay : default(int?), onOk, onInternalServerError, this, Pipeline);
