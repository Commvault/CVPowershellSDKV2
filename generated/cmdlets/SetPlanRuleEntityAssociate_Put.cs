...
namespace Commvault.Powershell.Cmdlets
{
    ...
    /// </remarks>
    [global::System.Management.Automation.Cmdlet(global::System.Management.Automation.VerbsCommon.Set, @"PlanRuleEntityAssociate_Put", SupportsShouldProcess = true)]
    ...
    public partial class SetPlanRuleEntityAssociate_Put : global::System.Management.Automation.PSCmdlet,
        Commvault.Powershell.Runtime.IEventListener
    {
        ...
        private Commvault.Powershell.Models.IAssociatePlanRuleEntityList _body;

        /// <summary>List of entities that are will be associated to provided plan and said rule</summary>
        [global::System.Management.Automation.Parameter(Mandatory = true, HelpMessage = "List of entities that are will be associated to provided plan and said rule", ValueFromPipeline = true)]
        [Commvault.Powershell.Runtime.Info(
        Required = true,
        ReadOnly = false,
        Description = @"List of entities that are will be associated to provided plan and said rule",
        SerializedName = @"body",
        PossibleTypes = new [] { typeof(Commvault.Powershell.Models.IAssociatePlanRuleEntityList) })]
        public Commvault.Powershell.Models.IAssociatePlanRuleEntityList Body { get => this._body; set => this._body = value; }
        ...
        /// <summary>
        /// Intializes a new instance of the <see cref="SetPlanRuleEntityAssociate_Put" /> cmdlet class.
        /// </summary>
        public SetPlanRuleEntityAssociate_Put()
        {
