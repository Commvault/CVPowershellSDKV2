...
namespace Commvault.Powershell.Cmdlets
{
    ...
    /// <remarks>
    /// [OpenAPI] DeleteCloudStorageMetadataCacheById=>DELETE:"/V4/Storage/Cloud/{cloudStorageId}/MetadataCache/{metadataCacheId}"
    /// </remarks>
    [global::System.Management.Automation.Cmdlet(global::System.Management.Automation.VerbsCommon.Remove, @"CloudStorageMetadataCache_Delete", SupportsShouldProcess = true)]
    [global::System.Management.Automation.OutputType(typeof(Commvault.Powershell.Models.IGenericResp))]
    [global::Commvault.Powershell.Description(@"Delete metadata cache of an existing cloud storage")]
    [global::Commvault.Powershell.Generated]
    public partial class RemoveCloudStorageMetadataCache_Delete : global::System.Management.Automation.PSCmdlet,
        Commvault.Powershell.Runtime.IEventListener
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                // work
                if (ShouldProcess($"Call remote 'DeleteCloudStorageMetadataCacheById' operation"))
                {
        ...
        protected async global::System.Threading.Tasks.Task ProcessRecordAsync()
        {
            using( NoSynchronizationContext )
            {
                ...
                try
                {
                    ...
                    await this.Client.DeleteCloudStorageMetadataCacheById(CloudStorageId, MetadataCacheId, onOk, onNotFound, onInternalServerError, this, Pipeline);
        ...
        /// <summary>
        /// Intializes a new instance of the <see cref="RemoveCloudStorageMetadataCache_Delete" /> cmdlet class.
        /// </summary>
        public RemoveCloudStorageMetadataCache_Delete()
        {
