...
namespace Commvault.Powershell.Cmdlets
{
    ...
    /// </summary>
    /// <remarks>
    /// [OpenAPI] ModifyCloudStorageMetaDataCacheById=>PUT:"/V4/Storage/Cloud/{cloudStorageId}/MetadataCache/{metadataCacheId}"
    /// </remarks>
    [global::System.Management.Automation.Cmdlet(global::System.Management.Automation.VerbsLifecycle.Invoke, @"ModifyCloudStorageMetaDataCache_Modify", SupportsShouldProcess = true)]
    [global::System.Management.Automation.OutputType(typeof(Commvault.Powershell.Models.IGenericResp))]
    [global::Commvault.Powershell.Description(@"Modify details like credentials and path for metadata Cache of a cloud storage based on Id")]
    [global::Commvault.Powershell.Generated]
    public partial class InvokeModifyCloudStorageMetaDataCache_Modify : global::System.Management.Automation.PSCmdlet,
        Commvault.Powershell.Runtime.IEventListener
    {
        ...
        private Commvault.Powershell.Models.IUpdateMetadataCacheConfiguration _body;
        ...
        /// </summary>
        [global::System.Management.Automation.Parameter(Mandatory = true, HelpMessage = "If updating to a network access path, Please add credentials or saved credentials. If both are provided, credentials will be taken into consideration.", ValueFromPipeline = true)]
        ...
        SerializedName = @"body",
        PossibleTypes = new [] { typeof(Commvault.Powershell.Models.IUpdateMetadataCacheConfiguration) })]
        public Commvault.Powershell.Models.IUpdateMetadataCacheConfiguration Body { get => this._body; set => this._body = value; }
        ...
        /// <summary>
        /// Intializes a new instance of the <see cref="InvokeModifyCloudStorageMetaDataCache_Modify" /> cmdlet class.
        /// </summary>
        public InvokeModifyCloudStorageMetaDataCache_Modify()
        {
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                // work
                if (ShouldProcess($"Call remote 'ModifyCloudStorageMetaDataCacheById' operation"))
                {
        ...
        protected async global::System.Threading.Tasks.Task ProcessRecordAsync()
        {
            using( NoSynchronizationContext )
            {
                ...
                try
                {
                    ...
                    await this.Client.ModifyCloudStorageMetaDataCacheById(CloudStorageId, MetadataCacheId, Body, onOk, onNotFound, onInternalServerError, this, Pipeline);
                ...
                {
                    WriteError(new global::System.Management.Automation.ErrorRecord(urexception, urexception.StatusCode.ToString(), global::System.Management.Automation.ErrorCategory.InvalidOperation, new {  CloudStorageId=CloudStorageId,MetadataCacheId=MetadataCacheId,body=Body})
                    {
