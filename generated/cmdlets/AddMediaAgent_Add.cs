...
namespace Commvault.Powershell.Cmdlets
{
    ...
    /// <remarks>
    /// [OpenAPI] AddMediaAgent=>POST:"/V4/Storage/Disk/{storagePoolId}/BackupLocation/{backupLocationId}/AccessPath"
    /// </remarks>
    [global::System.Management.Automation.Cmdlet(global::System.Management.Automation.VerbsCommon.Add, @"MediaAgent_Add", SupportsShouldProcess = true)]
    [global::System.Management.Automation.OutputType(typeof(Commvault.Powershell.Models.IGenericResp))]
    [global::Commvault.Powershell.Description(@"Used to add a media agent to a disk access path")]
    [global::Commvault.Powershell.Generated]
    public partial class AddMediaAgent_Add : global::System.Management.Automation.PSCmdlet,
        Commvault.Powershell.Runtime.IEventListener
    {
        ...
        /// </summary>
        [global::System.Management.Automation.Parameter(Mandatory = true, HelpMessage = "Id of the backup location whose details have to be fetched to add a new access path")]
        ...
        private Commvault.Powershell.Models.IAddDiskAccessPath _body;

        /// <summary>Used to add a new access path to a backup location</summary>
        [global::System.Management.Automation.Parameter(Mandatory = true, HelpMessage = "Used to add a new access path to a backup location", ValueFromPipeline = true)]
        [Commvault.Powershell.Runtime.Info(
        Required = true,
        ReadOnly = false,
        Description = @"Used to add a new access path to a backup location",
        SerializedName = @"body",
        PossibleTypes = new [] { typeof(Commvault.Powershell.Models.IAddDiskAccessPath) })]
        public Commvault.Powershell.Models.IAddDiskAccessPath Body { get => this._body; set => this._body = value; }
        ...
        /// </summary>
        [global::System.Management.Automation.Parameter(Mandatory = true, HelpMessage = "Id of the disk storage pool whose details have to be fetched to add a new access path")]
        [Commvault.Powershell.Runtime.Info(
        Required = true,
        ReadOnly = false,
        ...
        /// <summary>Intializes a new instance of the <see cref="AddMediaAgent_Add" /> cmdlet class.</summary>
        public AddMediaAgent_Add()
        {
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                // work
                if (ShouldProcess($"Call remote 'AddMediaAgent' operation"))
                {
        ...
        protected async global::System.Threading.Tasks.Task ProcessRecordAsync()
        {
            using( NoSynchronizationContext )
            {
                ...
                try
                {
                    ...
                    await this.Client.AddMediaAgent(StoragePoolId, BackupLocationId, Body, onOk, onNotFound, onInternalServerError, this, Pipeline);
