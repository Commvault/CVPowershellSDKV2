...
namespace Commvault.Powershell.Cmdlets
{
    ...
    /// <remarks>
    /// [OpenAPI] ModifyTriggeredAlertsNotes=>PUT:"/V4/TriggeredAlerts/{id}/Notes"
    /// </remarks>
    [global::System.Management.Automation.Cmdlet(global::System.Management.Automation.VerbsLifecycle.Invoke, @"ModifyTriggeredAlertNote_ModifyViaIdentityExpanded", SupportsShouldProcess = true)]
    [global::System.Management.Automation.OutputType(typeof(Commvault.Powershell.Models.IGenericResp))]
    [global::Commvault.Powershell.Description(@"Add, Modify and Delete notes for triggered alerts")]
    [global::Commvault.Powershell.Generated]
    public partial class InvokeModifyTriggeredAlertNote_ModifyViaIdentityExpanded : global::System.Management.Automation.PSCmdlet,
        Commvault.Powershell.Runtime.IEventListener
    {
        ...
        private Commvault.Powershell.Models.IUpdateTriggeredAlertsNotes _body= new Commvault.Powershell.Models.UpdateTriggeredAlertsNotes();

        /// <summary>UpdateTriggeredAlertsNotes</summary>
        private Commvault.Powershell.Models.IUpdateTriggeredAlertsNotes Body { get => this._body; set => this._body = value; }
        ...
        /// </summary>
        [global::System.Management.Automation.Parameter(Mandatory = false, HelpMessage = "Notes that you want to add to the triggered alerts. Leave it empty if you want to delete the alert")]
        ...
        public string Notes { get => Body.Notes ?? null; set => Body.Notes = value; }
        ...
        /// <summary>
        /// Intializes a new instance of the <see cref="InvokeModifyTriggeredAlertNote_ModifyViaIdentityExpanded" /> cmdlet class.
        /// </summary>
        public InvokeModifyTriggeredAlertNote_ModifyViaIdentityExpanded()
        {
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                // work
                if (ShouldProcess($"Call remote 'ModifyTriggeredAlertsNotes' operation"))
                {
        ...
        protected async global::System.Threading.Tasks.Task ProcessRecordAsync()
        {
            using( NoSynchronizationContext )
            {
                ...
                try
                {
                    ...
                    await this.Client.ModifyTriggeredAlertsNotes(InputObject.Id ?? default(int), Body, onOk, onInternalServerError, this, Pipeline);
