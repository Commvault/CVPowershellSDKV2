...
namespace Commvault.Powershell.Cmdlets
{
    ...
    /// <remarks>
    /// [OpenAPI] UpdateRegion=>PUT:"/V4/Regions/{regionId}"
    /// </remarks>
    [global::System.Management.Automation.Cmdlet(global::System.Management.Automation.VerbsCommon.Set, @"Region_UpdateExpanded", SupportsShouldProcess = true)]
    [global::System.Management.Automation.OutputType(typeof(Commvault.Powershell.Models.IGenericResp))]
    [global::Commvault.Powershell.Description(@"Update details of the region")]
    [global::Commvault.Powershell.Generated]
    public partial class SetRegion_UpdateExpanded : global::System.Management.Automation.PSCmdlet,
        Commvault.Powershell.Runtime.IEventListener
    {
        ...
        private Commvault.Powershell.Models.IUpdateRegion _body= new Commvault.Powershell.Models.UpdateRegion();
        ...
        /// </summary>
        private Commvault.Powershell.Models.IUpdateRegion Body { get => this._body; set => this._body = value; }
        ...
        [global::System.Management.Automation.Parameter(Mandatory = false, HelpMessage = "Name of city for the location")]
        ...
        public string LocationCity { get => Body.LocationCity ?? null; set => Body.LocationCity = value; }

        /// <summary>Name of continent for the location</summary>
        [global::System.Management.Automation.Parameter(Mandatory = false, HelpMessage = "Name of continent for the location")]
        [global::Commvault.Powershell.Category(global::Commvault.Powershell.ParameterCategory.Body)]
        [Commvault.Powershell.Runtime.Info(
        Required = false,
        ReadOnly = false,
        ...
        PossibleTypes = new [] { typeof(string) })]
        public string LocationContinent { get => Body.LocationContinent ?? null; set => Body.LocationContinent = value; }

        /// <summary>Name of country for the location</summary>
        [global::System.Management.Automation.Parameter(Mandatory = false, HelpMessage = "Name of country for the location")]
        [global::Commvault.Powershell.Category(global::Commvault.Powershell.ParameterCategory.Body)]
        [Commvault.Powershell.Runtime.Info(
        Required = false,
        ReadOnly = false,
        ...
        PossibleTypes = new [] { typeof(string) })]
        public string LocationCountry { get => Body.LocationCountry ?? null; set => Body.LocationCountry = value; }

        /// <summary>Latitude for the location</summary>
        [global::System.Management.Automation.Parameter(Mandatory = false, HelpMessage = "Latitude for the location")]
        [global::Commvault.Powershell.Category(global::Commvault.Powershell.ParameterCategory.Body)]
        [Commvault.Powershell.Runtime.Info(
        Required = false,
        ReadOnly = false,
        ...
        public double LocationLatitude { get => Body.LocationLatitude ?? default(double); set => Body.LocationLatitude = value; }

        /// <summary>Longitude for the location</summary>
        [global::System.Management.Automation.Parameter(Mandatory = false, HelpMessage = "Longitude for the location")]
        [global::Commvault.Powershell.Category(global::Commvault.Powershell.ParameterCategory.Body)]
        [Commvault.Powershell.Runtime.Info(
        Required = false,
        ReadOnly = false,
        ...
        PossibleTypes = new [] { typeof(double) })]
        public double LocationLongitude { get => Body.LocationLongitude ?? default(double); set => Body.LocationLongitude = value; }

        /// <summary>Name of state for the location</summary>
        [global::System.Management.Automation.Parameter(Mandatory = false, HelpMessage = "Name of state for the location")]
        [global::Commvault.Powershell.Category(global::Commvault.Powershell.ParameterCategory.Body)]
        [Commvault.Powershell.Runtime.Info(
        Required = false,
        ReadOnly = false,
        ...
        PossibleTypes = new [] { typeof(string) })]
        public string LocationState { get => Body.LocationState ?? null; set => Body.LocationState = value; }

        /// <summary>Type of operation to be performed for locations</summary>
        [global::System.Management.Automation.Parameter(Mandatory = false, HelpMessage = "Type of operation to be performed for locations")]
        [global::Commvault.Powershell.Category(global::Commvault.Powershell.ParameterCategory.Body)]
        [Commvault.Powershell.Runtime.Info(
        Required = false,
        ReadOnly = false,
        ...
        PossibleTypes = new [] { typeof(string) })]
        public string LocationsOperationType { get => Body.LocationsOperationType ?? null; set => Body.LocationsOperationType = value; }
        ...
        [global::System.Management.Automation.Parameter(Mandatory = false, HelpMessage = "New name for the region")]
        [global::Commvault.Powershell.Category(global::Commvault.Powershell.ParameterCategory.Body)]
        [Commvault.Powershell.Runtime.Info(
        Required = false,
        ReadOnly = false,
        ...
        SerializedName = @"name",
        PossibleTypes = new [] { typeof(string) })]
        public string ZoneName { get => Body.ZoneName ?? null; set => Body.ZoneName = value; }
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                // work
                if (ShouldProcess($"Call remote 'UpdateRegion' operation"))
                {
        ...
        protected async global::System.Threading.Tasks.Task ProcessRecordAsync()
        {
            using( NoSynchronizationContext )
            {
                ...
                try
                {
                    ...
                    await this.Client.UpdateRegion(RegionId, Body, onOk, onInternalServerError, this, Pipeline);
                ...
                {
                    WriteError(new global::System.Management.Automation.ErrorRecord(urexception, urexception.StatusCode.ToString(), global::System.Management.Automation.ErrorCategory.InvalidOperation, new {  RegionId=RegionId,body=Body})
                    {
        ...
        /// <summary>
        /// Intializes a new instance of the <see cref="SetRegion_UpdateExpanded" /> cmdlet class.
        /// </summary>
        public SetRegion_UpdateExpanded()
        {
