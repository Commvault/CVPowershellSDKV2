...
namespace Commvault.Powershell.Cmdlets
{
    ...
    /// <remarks>
    /// [OpenAPI] DisableRestoreServerGroup=>PUT:"/V4/ServerGroup/{serverGroupId}/Restore/Action/Disable"
    /// </remarks>
    [global::System.Management.Automation.Cmdlet(global::System.Management.Automation.VerbsLifecycle.Disable, @"RestoreServerGroup_DisableViaIdentity", SupportsShouldProcess = true)]
    [global::System.Management.Automation.OutputType(typeof(Commvault.Powershell.Models.IGenericResp))]
    [global::Commvault.Powershell.Description(@"Used to disable restore property for a server group")]
    [global::Commvault.Powershell.Generated]
    public partial class DisableRestoreServerGroup_DisableViaIdentity : global::System.Management.Automation.PSCmdlet,
        Commvault.Powershell.Runtime.IEventListener
    {
        ...
        /// <summary>
        /// Intializes a new instance of the <see cref="DisableRestoreServerGroup_DisableViaIdentity" /> cmdlet class.
        /// </summary>
        public DisableRestoreServerGroup_DisableViaIdentity()
        {
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                // work
                if (ShouldProcess($"Call remote 'DisableRestoreServerGroup' operation"))
                {
        ...
        protected async global::System.Threading.Tasks.Task ProcessRecordAsync()
        {
            using( NoSynchronizationContext )
            {
                ...
                try
                {
                    ...
                    await this.Client.DisableRestoreServerGroup(InputObject.ServerGroupId ?? default(long), this.InvocationInformation.BoundParameters.ContainsKey("EnableAfterADelay") ? EnableAfterADelay : default(long?), onOk, this, Pipeline);
