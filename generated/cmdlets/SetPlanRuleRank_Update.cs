...
namespace Commvault.Powershell.Cmdlets
{
    ...
    /// </remarks>
    [global::System.Management.Automation.Cmdlet(global::System.Management.Automation.VerbsCommon.Set, @"PlanRuleRank_Update", SupportsShouldProcess = true)]
    ...
    public partial class SetPlanRuleRank_Update : global::System.Management.Automation.PSCmdlet,
        Commvault.Powershell.Runtime.IEventListener
    {
        ...
        private Commvault.Powershell.Models.IUpdatePlanEntityRuleRanks _body;

        /// <summary>
        /// Plan entity rule update rank object. Fields in this object need to be populated to suggest what rank need to be set for
        /// the said rule.
        /// </summary>
        [global::System.Management.Automation.Parameter(Mandatory = true, HelpMessage = "Plan entity rule update rank object. Fields in this object need to be populated to suggest what rank need to be set for the said rule.", ValueFromPipeline = true)]
        ...
        SerializedName = @"body",
        PossibleTypes = new [] { typeof(Commvault.Powershell.Models.IUpdatePlanEntityRuleRanks) })]
        public Commvault.Powershell.Models.IUpdatePlanEntityRuleRanks Body { get => this._body; set => this._body = value; }
        ...
        /// <summary>
        /// Intializes a new instance of the <see cref="SetPlanRuleRank_Update" /> cmdlet class.
        /// </summary>
        public SetPlanRuleRank_Update()
        {
