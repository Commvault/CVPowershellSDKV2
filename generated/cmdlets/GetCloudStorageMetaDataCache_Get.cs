...
namespace Commvault.Powershell.Cmdlets
{
    ...
    /// <remarks>
    /// [OpenAPI] GetCloudStorageMetaDataCacheById=>GET:"/V4/Storage/Cloud/{cloudStorageId}/MetadataCache/{metadataCacheId}"
    /// </remarks>
    [global::System.Management.Automation.Cmdlet(global::System.Management.Automation.VerbsCommon.Get, @"CloudStorageMetaDataCache_Get")]
    [global::System.Management.Automation.OutputType(typeof(Commvault.Powershell.Models.IMetadataCacheConfiguration), typeof(Commvault.Powershell.Models.IGenericResp))]
    [global::Commvault.Powershell.Description(@"Get details of metadata Cache of a cloud storage based on Id")]
    [global::Commvault.Powershell.Generated]
    public partial class GetCloudStorageMetaDataCache_Get : global::System.Management.Automation.PSCmdlet,
        Commvault.Powershell.Runtime.IEventListener
    {
        ...
        /// </summary>
        /// <param name="responseMessage">the raw response message as an global::System.Net.Http.HttpResponseMessage.</param>
        /// <param name="response">the body result as a <see cref="Commvault.Powershell.Models.IMetadataCacheConfiguration" /> from
        /// the remote call</param>
        /// <param name="returnNow">/// Determines if the rest of the onOk method should be processed, or if the method should return
        /// immediately (set to true to skip further processing )</param>

        partial void overrideOnOk(global::System.Net.Http.HttpResponseMessage responseMessage, global::System.Threading.Tasks.Task<Commvault.Powershell.Models.IMetadataCacheConfiguration> response, ref global::System.Threading.Tasks.Task<bool> returnNow);
        ...
        /// <summary>
        /// Intializes a new instance of the <see cref="GetCloudStorageMetaDataCache_Get" /> cmdlet class.
        /// </summary>
        public GetCloudStorageMetaDataCache_Get()
        {
        ...
        protected async global::System.Threading.Tasks.Task ProcessRecordAsync()
        {
            using( NoSynchronizationContext )
            {
                ...
                try
                {
                    ...
                    await this.Client.GetCloudStorageMetaDataCacheById(CloudStorageId, MetadataCacheId, onOk, onNotFound, onInternalServerError, this, Pipeline);
                ...
                {
                    WriteError(new global::System.Management.Automation.ErrorRecord(urexception, urexception.StatusCode.ToString(), global::System.Management.Automation.ErrorCategory.InvalidOperation, new {  CloudStorageId=CloudStorageId,MetadataCacheId=MetadataCacheId})
                    {
        ...
        /// A <see cref="global::System.Threading.Tasks.Task" /> that will be complete when handling of the method is completed.
        /// </returns>
        private async global::System.Threading.Tasks.Task onOk(global::System.Net.Http.HttpResponseMessage responseMessage, global::System.Threading.Tasks.Task<Commvault.Powershell.Models.IMetadataCacheConfiguration> response)
        {
            using( NoSynchronizationContext )
            {
                var _returnNow = global::System.Threading.Tasks.Task<bool>.FromResult(false);
                ...
                // (await response) // should be Commvault.Powershell.Models.IMetadataCacheConfiguration
                WriteObject((await response));
            }
        }
    }
