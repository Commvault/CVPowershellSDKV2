...
namespace Commvault.Powershell.Cmdlets
{
    ...
    /// <remarks>
    /// [OpenAPI] CreateArchiveBackupDestination=>POST:"/V4/ArchivePlan/{planId}/BackupDestination"
    /// </remarks>
    [global::System.Management.Automation.Cmdlet(global::System.Management.Automation.VerbsCommon.New, @"ArchiveBackupDestination_CreateExpanded", SupportsShouldProcess = true)]
    [global::System.Management.Automation.OutputType(typeof(Commvault.Powershell.Models.IPlanBackupDestinationResp))]
    [global::Commvault.Powershell.Description(@"Create a Backup Destination for a Plan")]
    [global::Commvault.Powershell.Generated]
    public partial class NewArchiveBackupDestination_CreateExpanded : global::System.Management.Automation.PSCmdlet,
        Commvault.Powershell.Runtime.IEventListener
    {
        ...
        private Commvault.Powershell.Models.ICreateArchivePlanBackupDestinations _body= new Commvault.Powershell.Models.CreateArchivePlanBackupDestinations();

        private Commvault.Powershell.Models.ICreateArchivePlanBackupDestinations Body { get => this._body; set => this._body = value; }
        ...
        [global::System.Management.Automation.Parameter(Mandatory = true, HelpMessage = "List of backup destinations to create")]
        ...
        public Commvault.Powershell.Models.ICreateArchivePlanBackupDestination[] Destinations { get => Body.Destinations ?? null /* arrayOf */; set => Body.Destinations = value; }
        ...
        public string RegionName { get => Body.RegionName ?? null; set => Body.RegionName = value; }
        ...
        /// <summary>
        /// Intializes a new instance of the <see cref="NewArchiveBackupDestination_CreateExpanded" /> cmdlet class.
        /// </summary>
        public NewArchiveBackupDestination_CreateExpanded()
        {
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                // work
                if (ShouldProcess($"Call remote 'CreateArchiveBackupDestination' operation"))
                {
        ...
        protected async global::System.Threading.Tasks.Task ProcessRecordAsync()
        {
            using( NoSynchronizationContext )
            {
                ...
                try
                {
                    ...
                    await this.Client.CreateArchiveBackupDestination(PlanId, Body, onOk, onNotFound, this, Pipeline);
