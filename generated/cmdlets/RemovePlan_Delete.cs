...
namespace Commvault.Powershell.Cmdlets
{
    ...
    /// <remarks>
    /// [OpenAPI] DeletePlan=>DELETE:"/V4/ServerPlan/{planId}"
    /// </remarks>
    [global::System.Management.Automation.Cmdlet(global::System.Management.Automation.VerbsCommon.Remove, @"Plan_Delete", SupportsShouldProcess = true)]
    [global::System.Management.Automation.OutputType(typeof(Commvault.Powershell.Models.IGenericResp))]
    [global::Commvault.Powershell.Description(@"Used to delete an existing server plan")]
    [global::Commvault.Powershell.Generated]
    public partial class RemovePlan_Delete : global::System.Management.Automation.PSCmdlet,
        Commvault.Powershell.Runtime.IEventListener
    {
        ...
        /// <summary>Id of the plan to delete</summary>
        [global::System.Management.Automation.Parameter(Mandatory = true, HelpMessage = "Id of the plan to delete")]
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                // work
                if (ShouldProcess($"Call remote 'DeletePlan' operation"))
                {
        ...
        protected async global::System.Threading.Tasks.Task ProcessRecordAsync()
        {
            using( NoSynchronizationContext )
            {
                ...
                try
                {
                    ...
                    await this.Client.DeletePlan(PlanId, onOk, onNotFound, onInternalServerError, this, Pipeline);
        ...
        /// <summary>Intializes a new instance of the <see cref="RemovePlan_Delete" /> cmdlet class.</summary>
        public RemovePlan_Delete()
        {
