...
namespace Commvault.Powershell.Cmdlets
{
    ...
    /// </summary>
    /// <remarks>
    /// [OpenAPI] UpdateCompanyTimezoneForServers=>PUT:"/V4/Company/{companyId}/Servers/Timezone"
    /// </remarks>
    [global::System.Management.Automation.Cmdlet(global::System.Management.Automation.VerbsCommon.Set, @"CompanyTimezone_UpdateExpanded", SupportsShouldProcess = true)]
    [global::System.Management.Automation.OutputType(typeof(Commvault.Powershell.Models.IGenericResp))]
    [global::Commvault.Powershell.Description(@"Assigns company's timezone as the timezone for servers with no packages installed")]
    [global::Commvault.Powershell.Generated]
    public partial class SetCompanyTimezone_UpdateExpanded : global::System.Management.Automation.PSCmdlet,
        Commvault.Powershell.Runtime.IEventListener
    {
        ...
        private Commvault.Powershell.Models.IUpdateTimezoneForClientsReq _body= new Commvault.Powershell.Models.UpdateTimezoneForClientsReq();

        /// <summary>Request body for updating timezone for clients</summary>
        private Commvault.Powershell.Models.IUpdateTimezoneForClientsReq Body { get => this._body; set => this._body = value; }
        ...
        /// </summary>
        [global::System.Management.Automation.Parameter(Mandatory = true, HelpMessage = "Id of the company whose timezone is used to update timezone of servers (with no packages)")]
        [Commvault.Powershell.Runtime.Info(
        Required = true,
        ReadOnly = false,
        ...
        /// </summary>
        [global::System.Management.Automation.Parameter(Mandatory = false, HelpMessage = "Boolean which determines if all servers(with no package) should be updated with the company timezone.")]
        [global::Commvault.Powershell.Category(global::Commvault.Powershell.ParameterCategory.Body)]
        [Commvault.Powershell.Runtime.Info(
        Required = false,
        ReadOnly = false,
        ...
        public global::System.Management.Automation.SwitchParameter UpdateAll { get => Body.UpdateAll ?? default(global::System.Management.Automation.SwitchParameter); set => Body.UpdateAll = value; }
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                // work
                if (ShouldProcess($"Call remote 'UpdateCompanyTimezoneForServers' operation"))
                {
        ...
        protected async global::System.Threading.Tasks.Task ProcessRecordAsync()
        {
            using( NoSynchronizationContext )
            {
                ...
                try
                {
                    ...
                    await this.Client.UpdateCompanyTimezoneForServers(CompanyId, Body, onOk, this, Pipeline);
        ...
        /// <summary>
        /// Intializes a new instance of the <see cref="SetCompanyTimezone_UpdateExpanded" /> cmdlet class.
        /// </summary>
        public SetCompanyTimezone_UpdateExpanded()
        {
