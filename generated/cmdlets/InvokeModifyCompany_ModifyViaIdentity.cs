...
namespace Commvault.Powershell.Cmdlets
{
    ...
    /// </remarks>
    [global::System.Management.Automation.Cmdlet(global::System.Management.Automation.VerbsLifecycle.Invoke, @"ModifyCompany_ModifyViaIdentity", SupportsShouldProcess = true)]
    ...
    public partial class InvokeModifyCompany_ModifyViaIdentity : global::System.Management.Automation.PSCmdlet,
        Commvault.Powershell.Runtime.IEventListener
    {
        ...
        private Commvault.Powershell.Models.IUpdateCompany _body;

        /// <summary>Used to update the properties of an existing company</summary>
        [global::System.Management.Automation.Parameter(Mandatory = true, HelpMessage = "Used to update the properties of an existing company", ValueFromPipeline = true)]
        [Commvault.Powershell.Runtime.Info(
        Required = true,
        ReadOnly = false,
        Description = @"Used to update the properties of an existing company",
        SerializedName = @"body",
        PossibleTypes = new [] { typeof(Commvault.Powershell.Models.IUpdateCompany) })]
        public Commvault.Powershell.Models.IUpdateCompany Body { get => this._body; set => this._body = value; }
        ...
        /// <summary>
        /// Intializes a new instance of the <see cref="InvokeModifyCompany_ModifyViaIdentity" /> cmdlet class.
        /// </summary>
        public InvokeModifyCompany_ModifyViaIdentity()
        {
        ...
        protected async global::System.Threading.Tasks.Task ProcessRecordAsync()
        {
            using( NoSynchronizationContext )
            {
                ...
                try
                {
                    ...
                    await this.Client.ModifyCompany(InputObject.CompanyId ?? default(int), Body, onOk, onBadRequest, onNotFound, this, Pipeline);
