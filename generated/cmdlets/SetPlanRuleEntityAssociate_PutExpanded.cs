...
namespace Commvault.Powershell.Cmdlets
{
    ...
    /// <remarks>
    /// [OpenAPI] PutPlanRuleEntitiesAssociate=>PUT:"/V4/Plan/Rule/Entities/Associate"
    /// </remarks>
    [global::System.Management.Automation.Cmdlet(global::System.Management.Automation.VerbsCommon.Set, @"PlanRuleEntityAssociate_PutExpanded", SupportsShouldProcess = true)]
    [global::System.Management.Automation.OutputType(typeof(bool))]
    [global::Commvault.Powershell.Description(@"API to associate workloads to selected plan and plan rule")]
    [global::Commvault.Powershell.Generated]
    public partial class SetPlanRuleEntityAssociate_PutExpanded : global::System.Management.Automation.PSCmdlet,
        Commvault.Powershell.Runtime.IEventListener
    {
        ...
        private Commvault.Powershell.Models.IAssociatePlanRuleEntityList _body= new Commvault.Powershell.Models.AssociatePlanRuleEntityList();

        /// <summary>List of entities that are will be associated to provided plan and said rule</summary>
        private Commvault.Powershell.Models.IAssociatePlanRuleEntityList Body { get => this._body; set => this._body = value; }
        ...
        [global::System.Management.Automation.Parameter(Mandatory = false, HelpMessage = "Details of entity that will be associated to plan and rule.")]
        ...
        public Commvault.Powershell.Models.IAssociatePlanRuleEntity[] Entities { get => Body.Entities ?? null /* arrayOf */; set => Body.Entities = value; }
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                // work
                if (ShouldProcess($"Call remote 'PutPlanRuleEntitiesAssociate' operation"))
                {
        ...
        protected async global::System.Threading.Tasks.Task ProcessRecordAsync()
        {
            using( NoSynchronizationContext )
            {
                ...
                try
                {
                    ...
                    await this.Client.PutPlanRuleEntitiesAssociate(Body, onOk, onInternalServerError, this, Pipeline);
        ...
        /// <summary>
        /// Intializes a new instance of the <see cref="SetPlanRuleEntityAssociate_PutExpanded" /> cmdlet class.
        /// </summary>
        public SetPlanRuleEntityAssociate_PutExpanded()
        {
