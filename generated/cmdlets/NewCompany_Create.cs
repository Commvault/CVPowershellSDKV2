...
namespace Commvault.Powershell.Cmdlets
{
    ...
    /// </remarks>
    [global::System.Management.Automation.Cmdlet(global::System.Management.Automation.VerbsCommon.New, @"Company_Create", SupportsShouldProcess = true)]
    ...
    public partial class NewCompany_Create : global::System.Management.Automation.PSCmdlet,
        Commvault.Powershell.Runtime.IEventListener
    {
        ...
        private Commvault.Powershell.Models.ICreateCompany _body;

        /// <summary>Used to create a new company</summary>
        [global::System.Management.Automation.Parameter(Mandatory = true, HelpMessage = "Used to create a new company", ValueFromPipeline = true)]
        [Commvault.Powershell.Runtime.Info(
        Required = true,
        ReadOnly = false,
        Description = @"Used to create a new company",
        SerializedName = @"body",
        PossibleTypes = new [] { typeof(Commvault.Powershell.Models.ICreateCompany) })]
        public Commvault.Powershell.Models.ICreateCompany Body { get => this._body; set => this._body = value; }
        ...
        /// <summary>Intializes a new instance of the <see cref="NewCompany_Create" /> cmdlet class.</summary>
        public NewCompany_Create()
        {
