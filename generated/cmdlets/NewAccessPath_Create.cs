...
namespace Commvault.Powershell.Cmdlets
{
    ...
    /// </summary>
    /// <remarks>
    /// [OpenAPI] CreateAccessPathForBucketOfCloudStorage=>POST:"/V4/Storage/Cloud/{cloudStorageId}/Bucket/{bucketId}/AccessPath"
    /// </remarks>
    [global::System.Management.Automation.Cmdlet(global::System.Management.Automation.VerbsCommon.New, @"AccessPath_Create", SupportsShouldProcess = true)]
    [global::System.Management.Automation.OutputType(typeof(Commvault.Powershell.Models.IGenericResp))]
    [global::Commvault.Powershell.Description(@"Add a new Access path (mediaAgent) to a specific bucket of a specific cloud storage")]
    [global::Commvault.Powershell.Generated]
    public partial class NewAccessPath_Create : global::System.Management.Automation.PSCmdlet,
        Commvault.Powershell.Runtime.IEventListener
    {
        ...
        private Commvault.Powershell.Models.IPaths4Yo4LoV4StorageCloudCloudstorageidBucketBucketidAccesspathPostRequestbodyContentApplicationJsonSchema _body;

        /// <summary>Used to add a new access path to a bucket</summary>
        [global::System.Management.Automation.Parameter(Mandatory = true, HelpMessage = "Used to add a new access path to a bucket", ValueFromPipeline = true)]
        [Commvault.Powershell.Runtime.Info(
        Required = true,
        ReadOnly = false,
        Description = @"Used to add a new access path to a bucket",
        SerializedName = @"body",
        PossibleTypes = new [] { typeof(Commvault.Powershell.Models.IPaths4Yo4LoV4StorageCloudCloudstorageidBucketBucketidAccesspathPostRequestbodyContentApplicationJsonSchema) })]
        public Commvault.Powershell.Models.IPaths4Yo4LoV4StorageCloudCloudstorageidBucketBucketidAccesspathPostRequestbodyContentApplicationJsonSchema Body { get => this._body; set => this._body = value; }
        ...
        /// <summary>
        /// Intializes a new instance of the <see cref="NewAccessPath_Create" /> cmdlet class.
        /// </summary>
        public NewAccessPath_Create()
        {
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                // work
                if (ShouldProcess($"Call remote 'CreateAccessPathForBucketOfCloudStorage' operation"))
                {
        ...
        protected async global::System.Threading.Tasks.Task ProcessRecordAsync()
        {
            using( NoSynchronizationContext )
            {
                ...
                try
                {
                    ...
                    await this.Client.CreateAccessPathForBucketOfCloudStorage(CloudStorageId, BucketId, Body, onOk, onBadRequest, onNotFound, onInternalServerError, this, Pipeline);
