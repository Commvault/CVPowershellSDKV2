        ...
        protected async global::System.Threading.Tasks.Task ProcessRecordAsync()
        {
            using( NoSynchronizationContext )
            {
                ...
                try
                {
                    ...
                    await this.Client.GetHyperScaleStorageById(InputObject.HyperScaleStorageId ?? default(int), this.InvocationInformation.BoundParameters.ContainsKey("ShowInheritedAssociation") ? ShowInheritedAssociation : null, onOk, onNotFound, onInternalServerError, this, Pipeline);
