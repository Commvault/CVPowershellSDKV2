...
namespace Commvault.Powershell.Cmdlets
{
    ...
    /// </remarks>
    [global::System.Management.Automation.Cmdlet(global::System.Management.Automation.VerbsLifecycle.Invoke, @"ModifyUser_Modify", SupportsShouldProcess = true)]
    ...
    public partial class InvokeModifyUser_Modify : global::System.Management.Automation.PSCmdlet,
        Commvault.Powershell.Runtime.IEventListener
    {
        ...
        private Commvault.Powershell.Models.IUpdateUser _body;

        /// <summary>Used to update an existing user.</summary>
        [global::System.Management.Automation.Parameter(Mandatory = true, HelpMessage = "Used to update an existing user.", ValueFromPipeline = true)]
        [Commvault.Powershell.Runtime.Info(
        Required = true,
        ReadOnly = false,
        Description = @"Used to update an existing user.",
        SerializedName = @"body",
        PossibleTypes = new [] { typeof(Commvault.Powershell.Models.IUpdateUser) })]
        public Commvault.Powershell.Models.IUpdateUser Body { get => this._body; set => this._body = value; }
        ...
        /// <summary>
        /// Intializes a new instance of the <see cref="InvokeModifyUser_Modify" /> cmdlet class.
        /// </summary>
        public InvokeModifyUser_Modify()
        {
