...
namespace Commvault.Powershell.Models
{
    ...
    public partial class WasabiHotBucket :
        Commvault.Powershell.Models.IWasabiHotBucket,
        Commvault.Powershell.Models.IWasabiHotBucketInternal,
        Commvault.Powershell.Runtime.IValidates
    {
        ...
        string Commvault.Powershell.Models.IWasabiHotBucketInternal.CloudType { get => this._cloudType; set { {_cloudType = value;} } }

        /// <summary>Internal Acessors for Credentials</summary>
        Commvault.Powershell.Models.IIdName Commvault.Powershell.Models.IWasabiHotBucketInternal.Credentials { get => (this._credentials = this._credentials ?? new Commvault.Powershell.Models.IdName()); set { {_credentials = value;} } }

        /// <summary>Internal Acessors for MediaAgent</summary>
        Commvault.Powershell.Models.IIdName Commvault.Powershell.Models.IWasabiHotBucketInternal.MediaAgent { get => (this._mediaAgent = this._mediaAgent ?? new Commvault.Powershell.Models.IdName()); set { {_mediaAgent = value;} } }
        ...
        /// <summary>Creates an new <see cref="WasabiHotBucket" /> instance.</summary>
        public WasabiHotBucket()
        {
    ...
    /// Wasabi Hot Cloud Storage
    internal partial interface IWasabiHotBucketInternal :
