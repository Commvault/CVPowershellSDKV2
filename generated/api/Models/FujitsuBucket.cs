...
namespace Commvault.Powershell.Models
{
    ...
    public partial class FujitsuBucket :
        Commvault.Powershell.Models.IFujitsuBucket,
        Commvault.Powershell.Models.IFujitsuBucketInternal,
        Commvault.Powershell.Runtime.IValidates
    {
        ...
        string Commvault.Powershell.Models.IFujitsuBucketInternal.CloudType { get => this._cloudType; set { {_cloudType = value;} } }

        /// <summary>Internal Acessors for Credentials</summary>
        Commvault.Powershell.Models.IIdName Commvault.Powershell.Models.IFujitsuBucketInternal.Credentials { get => (this._credentials = this._credentials ?? new Commvault.Powershell.Models.IdName()); set { {_credentials = value;} } }

        /// <summary>Internal Acessors for MediaAgent</summary>
        Commvault.Powershell.Models.IIdName Commvault.Powershell.Models.IFujitsuBucketInternal.MediaAgent { get => (this._mediaAgent = this._mediaAgent ?? new Commvault.Powershell.Models.IdName()); set { {_mediaAgent = value;} } }
        ...
        /// <summary>Creates an new <see cref="FujitsuBucket" /> instance.</summary>
        public FujitsuBucket()
        {
    ...
    /// Fujitsu Storage ETERNUS CD10000
    internal partial interface IFujitsuBucketInternal :
