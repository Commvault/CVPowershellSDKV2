...
namespace Commvault.Powershell.Models
{
    ...
    public partial class EmcAtmosBucket :
        Commvault.Powershell.Models.IEmcAtmosBucket,
        Commvault.Powershell.Models.IEmcAtmosBucketInternal,
        Commvault.Powershell.Runtime.IValidates
    {
        ...
        string Commvault.Powershell.Models.IEmcAtmosBucketInternal.CloudType { get => this._cloudType; set { {_cloudType = value;} } }

        /// <summary>Internal Acessors for Credentials</summary>
        Commvault.Powershell.Models.IIdName Commvault.Powershell.Models.IEmcAtmosBucketInternal.Credentials { get => (this._credentials = this._credentials ?? new Commvault.Powershell.Models.IdName()); set { {_credentials = value;} } }

        /// <summary>Internal Acessors for MediaAgent</summary>
        Commvault.Powershell.Models.IIdName Commvault.Powershell.Models.IEmcAtmosBucketInternal.MediaAgent { get => (this._mediaAgent = this._mediaAgent ?? new Commvault.Powershell.Models.IdName()); set { {_mediaAgent = value;} } }
        ...
        /// <summary>Creates an new <see cref="EmcAtmosBucket" /> instance.</summary>
        public EmcAtmosBucket()
        {
    ...
    /// EMC Atmos
    internal partial interface IEmcAtmosBucketInternal :
