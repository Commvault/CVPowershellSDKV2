...
namespace Commvault.Powershell.Models
{
    ...
    public partial class TapeSummary
    {
        ...
        internal TapeSummary(Commvault.Powershell.Runtime.Json.JsonObject json)
        {
            ...
            {_manufacturer = If( json?.PropertyT<Commvault.Powershell.Runtime.Json.JsonString>("manufacturer"), out var __jsonManufacturer) ? (string)__jsonManufacturer : (string)Manufacturer;}
            {_model = If( json?.PropertyT<Commvault.Powershell.Runtime.Json.JsonString>("model"), out var __jsonModel) ? (string)__jsonModel : (string)Model;}
            AfterFromJson(json);
        }
