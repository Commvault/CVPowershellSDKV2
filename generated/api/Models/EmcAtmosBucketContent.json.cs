...
namespace Commvault.Powershell.Models
{
    ...
    public partial class EmcAtmosBucketContent
    {
        ...
        internal EmcAtmosBucketContent(Commvault.Powershell.Runtime.Json.JsonObject json)
        {
            ...
            {_rootFolder = If( json?.PropertyT<Commvault.Powershell.Runtime.Json.JsonString>("rootFolder"), out var __jsonRootFolder) ? (string)__jsonRootFolder : (string)RootFolder;}
            AfterFromJson(json);
        }
