...
namespace Commvault.Powershell.Models
{
    ...
    public partial class MicrosoftAzureBucket :
        Commvault.Powershell.Models.IMicrosoftAzureBucket,
        Commvault.Powershell.Models.IMicrosoftAzureBucketInternal,
        Commvault.Powershell.Runtime.IValidates
    {
        ...
        string Commvault.Powershell.Models.IMicrosoftAzureBucketInternal.CloudType { get => this._cloudType; set { {_cloudType = value;} } }

        /// <summary>Internal Acessors for Credentials</summary>
        Commvault.Powershell.Models.IIdName Commvault.Powershell.Models.IMicrosoftAzureBucketInternal.Credentials { get => (this._credentials = this._credentials ?? new Commvault.Powershell.Models.IdName()); set { {_credentials = value;} } }

        /// <summary>Internal Acessors for MediaAgent</summary>
        Commvault.Powershell.Models.IIdName Commvault.Powershell.Models.IMicrosoftAzureBucketInternal.MediaAgent { get => (this._mediaAgent = this._mediaAgent ?? new Commvault.Powershell.Models.IdName()); set { {_mediaAgent = value;} } }
        ...
        /// <summary>Creates an new <see cref="MicrosoftAzureBucket" /> instance.</summary>
        public MicrosoftAzureBucket()
        {
    ...
    /// Microsoft Azure Storage
    internal partial interface IMicrosoftAzureBucketInternal :
