...
namespace Commvault.Powershell.Models
{
    ...
    public partial class RackspaceBucket :
        Commvault.Powershell.Models.IRackspaceBucket,
        Commvault.Powershell.Models.IRackspaceBucketInternal,
        Commvault.Powershell.Runtime.IValidates
    {
        ...
        string Commvault.Powershell.Models.IRackspaceBucketInternal.CloudType { get => this._cloudType; set { {_cloudType = value;} } }

        /// <summary>Internal Acessors for Credentials</summary>
        Commvault.Powershell.Models.IIdName Commvault.Powershell.Models.IRackspaceBucketInternal.Credentials { get => (this._credentials = this._credentials ?? new Commvault.Powershell.Models.IdName()); set { {_credentials = value;} } }

        /// <summary>Internal Acessors for MediaAgent</summary>
        Commvault.Powershell.Models.IIdName Commvault.Powershell.Models.IRackspaceBucketInternal.MediaAgent { get => (this._mediaAgent = this._mediaAgent ?? new Commvault.Powershell.Models.IdName()); set { {_mediaAgent = value;} } }
        ...
        /// <summary>Creates an new <see cref="RackspaceBucket" /> instance.</summary>
        public RackspaceBucket()
        {
    ...
    /// Rackspace Cloud Files
    internal partial interface IRackspaceBucketInternal :
