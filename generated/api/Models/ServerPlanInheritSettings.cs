...
namespace Commvault.Powershell.Models
{
    ...
    public partial class ServerPlanInheritSettings :
        Commvault.Powershell.Models.IServerPlanInheritSettings,
        Commvault.Powershell.Models.IServerPlanInheritSettingsInternal
    {
        ...
        Commvault.Powershell.Models.IPlanOverridenOptions Commvault.Powershell.Models.IServerPlanInheritSettingsInternal.BackupContent { get => (this._backupContent = this._backupContent ?? new Commvault.Powershell.Models.PlanOverridenOptions()); set { {_backupContent = value;} } }

        /// <summary>Internal Acessors for BasePlan</summary>
        Commvault.Powershell.Models.IIdName Commvault.Powershell.Models.IServerPlanInheritSettingsInternal.BasePlan { get => (this._basePlan = this._basePlan ?? new Commvault.Powershell.Models.IdName()); set { {_basePlan = value;} } }

        /// <summary>Internal Acessors for Rpo</summary>
        Commvault.Powershell.Models.IPlanOverridenOptions Commvault.Powershell.Models.IServerPlanInheritSettingsInternal.Rpo { get => (this._rpo = this._rpo ?? new Commvault.Powershell.Models.PlanOverridenOptions()); set { {_rpo = value;} } }

        /// <summary>Internal Acessors for StoragePool</summary>
        Commvault.Powershell.Models.IPlanOverridenOptions Commvault.Powershell.Models.IServerPlanInheritSettingsInternal.StoragePool { get => (this._storagePool = this._storagePool ?? new Commvault.Powershell.Models.PlanOverridenOptions()); set { {_storagePool = value;} } }
        ...
        /// <summary>Creates an new <see cref="ServerPlanInheritSettings" /> instance.</summary>
        public ServerPlanInheritSettings()
        {
    ...
    /// ServerPlanInheritSettings
    internal partial interface IServerPlanInheritSettingsInternal
