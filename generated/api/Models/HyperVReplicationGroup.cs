...
namespace Commvault.Powershell.Models
{
    ...
    public partial class HyperVReplicationGroup :
        Commvault.Powershell.Models.IHyperVReplicationGroup,
        Commvault.Powershell.Models.IHyperVReplicationGroupInternal,
        Commvault.Powershell.Runtime.IValidates
    {
        ...
        private Commvault.Powershell.Models.IReplicationGroupAdvOptionsHyperV _advancedOption;

        /// <summary>Advanced options for HyperV replication group</summary>
        [Commvault.Powershell.Origin(Commvault.Powershell.PropertyOrigin.Owned)]
        internal Commvault.Powershell.Models.IReplicationGroupAdvOptionsHyperV AdvancedOption { get => (this._advancedOption = this._advancedOption ?? new Commvault.Powershell.Models.ReplicationGroupAdvOptionsHyperV()); set => this._advancedOption = value; }

        /// <summary>
        /// This will replace the instance at the destination if the instance with the same name already exists.
        /// </summary>
        [Commvault.Powershell.Origin(Commvault.Powershell.PropertyOrigin.Inlined)]
        public bool? AdvancedOptionUnconditionalOverwrite { get => ((Commvault.Powershell.Models.IReplicationGroupAdvOptionsHyperVInternal)AdvancedOption).UnconditionalOverwrite; set => ((Commvault.Powershell.Models.IReplicationGroupAdvOptionsHyperVInternal)AdvancedOption).UnconditionalOverwrite = value ?? default(bool); }

        /// <summary>
        /// Validates that the destination VM is bootable by powering it on and then powering off
        /// </summary>
        [Commvault.Powershell.Origin(Commvault.Powershell.PropertyOrigin.Inlined)]
        public bool? AdvancedOptionValidateDestinationVM { get => ((Commvault.Powershell.Models.IReplicationGroupAdvOptionsHyperVInternal)AdvancedOption).ValidateDestinationVM; set => ((Commvault.Powershell.Models.IReplicationGroupAdvOptionsHyperVInternal)AdvancedOption).ValidateDestinationVM = value ?? default(bool); }

        /// <summary>Internal Acessors for AdvancedOption</summary>
        Commvault.Powershell.Models.IReplicationGroupAdvOptionsHyperV Commvault.Powershell.Models.IHyperVReplicationGroupInternal.AdvancedOption { get => (this._advancedOption = this._advancedOption ?? new Commvault.Powershell.Models.ReplicationGroupAdvOptionsHyperV()); set { {_advancedOption = value;} } }

        /// <summary>Internal Acessors for Vendor</summary>
        string Commvault.Powershell.Models.IHyperVReplicationGroupInternal.Vendor { get => this._vendor; set { {_vendor = value;} } }
        ...
        private Commvault.Powershell.Models.IReplicationConfigurationHyperV[] _replicationConfiguration;

        /// <summary>Replication configuration for a hyperv replication group</summary>
        [Commvault.Powershell.Origin(Commvault.Powershell.PropertyOrigin.Owned)]
        public Commvault.Powershell.Models.IReplicationConfigurationHyperV[] ReplicationConfiguration { get => this._replicationConfiguration; set => this._replicationConfiguration = value; }
        ...
        /// <summary>Creates an new <see cref="HyperVReplicationGroup" /> instance.</summary>
        public HyperVReplicationGroup()
        {
        ...
        Commvault.Powershell.Models.IReplicationGroup
    {
        ...
        PossibleTypes = new [] { typeof(Commvault.Powershell.Models.IReplicationConfigurationHyperV) })]
        Commvault.Powershell.Models.IReplicationConfigurationHyperV[] ReplicationConfiguration { get; set; }
        /// <summary>Vendor type of this replication group. Values in enum are case sensitive</summary>
        [Commvault.Powershell.Runtime.Info(
        Required = true,
        ReadOnly = true,
    ...
    /// Replication group details pertaining to hyperV
    internal partial interface IHyperVReplicationGroupInternal :
        Commvault.Powershell.Models.IReplicationGroupInternal
    {
        /// <summary>Advanced options for HyperV replication group</summary>
        Commvault.Powershell.Models.IReplicationGroupAdvOptionsHyperV AdvancedOption { get; set; }
        /// <summary>
        /// This will replace the instance at the destination if the instance with the same name already exists.
        /// </summary>
        bool? AdvancedOptionUnconditionalOverwrite { get; set; }
