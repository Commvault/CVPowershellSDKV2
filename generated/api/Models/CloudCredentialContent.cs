...
namespace Commvault.Powershell.Models
{
    ...
    public partial class CloudCredentialContent :
        Commvault.Powershell.Models.ICloudCredentialContent,
        Commvault.Powershell.Models.ICloudCredentialContentInternal
    {
        ...
        Commvault.Powershell.Models.IIdName Commvault.Powershell.Models.ICloudCredentialContentInternal.OwnerUser { get => ((Commvault.Powershell.Models.IUpdateCredentialSecurityInternal)Security).OwnerUser; set => ((Commvault.Powershell.Models.IUpdateCredentialSecurityInternal)Security).OwnerUser = value; }

        /// <summary>Internal Acessors for OwnerUserGroup</summary>
        Commvault.Powershell.Models.IIdName Commvault.Powershell.Models.ICloudCredentialContentInternal.OwnerUserGroup { get => ((Commvault.Powershell.Models.IUpdateCredentialSecurityInternal)Security).OwnerUserGroup; set => ((Commvault.Powershell.Models.IUpdateCredentialSecurityInternal)Security).OwnerUserGroup = value; }

        /// <summary>Internal Acessors for Security</summary>
        Commvault.Powershell.Models.IUpdateCredentialSecurity Commvault.Powershell.Models.ICloudCredentialContentInternal.Security { get => (this._security = this._security ?? new Commvault.Powershell.Models.UpdateCredentialSecurity()); set { {_security = value;} } }

        /// <summary>Internal Acessors for SecurityOwner</summary>
        Commvault.Powershell.Models.ICredentialOwner Commvault.Powershell.Models.ICloudCredentialContentInternal.SecurityOwner { get => ((Commvault.Powershell.Models.IUpdateCredentialSecurityInternal)Security).Owner; set => ((Commvault.Powershell.Models.IUpdateCredentialSecurityInternal)Security).Owner = value; }
        ...
        /// <summary>Creates an new <see cref="CloudCredentialContent" /> instance.</summary>
        public CloudCredentialContent()
        {
    ...
    /// ActiveScale, S3 Compatible Storage, Scality RING, Telefonica Open Cloud Object Storage, Verizon Cloud Storage or Wasabi
    /// Hot Cloud Storage
    internal partial interface ICloudCredentialContentInternal
