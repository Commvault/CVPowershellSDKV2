...
namespace Commvault.Powershell.Models
{
    ...
    public partial class NutanixBucket :
        Commvault.Powershell.Models.INutanixBucket,
        Commvault.Powershell.Models.INutanixBucketInternal,
        Commvault.Powershell.Runtime.IValidates
    {
        ...
        string Commvault.Powershell.Models.INutanixBucketInternal.CloudType { get => this._cloudType; set { {_cloudType = value;} } }

        /// <summary>Internal Acessors for Credentials</summary>
        Commvault.Powershell.Models.IIdName Commvault.Powershell.Models.INutanixBucketInternal.Credentials { get => (this._credentials = this._credentials ?? new Commvault.Powershell.Models.IdName()); set { {_credentials = value;} } }

        /// <summary>Internal Acessors for MediaAgent</summary>
        Commvault.Powershell.Models.IIdName Commvault.Powershell.Models.INutanixBucketInternal.MediaAgent { get => (this._mediaAgent = this._mediaAgent ?? new Commvault.Powershell.Models.IdName()); set { {_mediaAgent = value;} } }
        ...
        /// <summary>Creates an new <see cref="NutanixBucket" /> instance.</summary>
        public NutanixBucket()
        {
    ...
    /// Nutanix Objects
    internal partial interface INutanixBucketInternal :
