...
namespace Commvault.Powershell.Models
{
    ...
    public partial class AmazonCredentialContentWithRoleArn :
        Commvault.Powershell.Models.IAmazonCredentialContentWithRoleArn,
        Commvault.Powershell.Models.IAmazonCredentialContentWithRoleArnInternal
    {

        /// <summary>Internal Acessors for OwnerUser</summary>
        Commvault.Powershell.Models.IIdName Commvault.Powershell.Models.IAmazonCredentialContentWithRoleArnInternal.OwnerUser { get => ((Commvault.Powershell.Models.IUpdateCredentialSecurityInternal)Security).OwnerUser; set => ((Commvault.Powershell.Models.IUpdateCredentialSecurityInternal)Security).OwnerUser = value; }

        /// <summary>Internal Acessors for OwnerUserGroup</summary>
        Commvault.Powershell.Models.IIdName Commvault.Powershell.Models.IAmazonCredentialContentWithRoleArnInternal.OwnerUserGroup { get => ((Commvault.Powershell.Models.IUpdateCredentialSecurityInternal)Security).OwnerUserGroup; set => ((Commvault.Powershell.Models.IUpdateCredentialSecurityInternal)Security).OwnerUserGroup = value; }

        /// <summary>Internal Acessors for Security</summary>
        Commvault.Powershell.Models.IUpdateCredentialSecurity Commvault.Powershell.Models.IAmazonCredentialContentWithRoleArnInternal.Security { get => (this._security = this._security ?? new Commvault.Powershell.Models.UpdateCredentialSecurity()); set { {_security = value;} } }

        /// <summary>Internal Acessors for SecurityOwner</summary>
        Commvault.Powershell.Models.ICredentialOwner Commvault.Powershell.Models.IAmazonCredentialContentWithRoleArnInternal.SecurityOwner { get => ((Commvault.Powershell.Models.IUpdateCredentialSecurityInternal)Security).Owner; set => ((Commvault.Powershell.Models.IUpdateCredentialSecurityInternal)Security).Owner = value; }
        ...
        /// <summary>Creates an new <see cref="AmazonCredentialContentWithRoleArn" /> instance.</summary>
        public AmazonCredentialContentWithRoleArn()
        {
    ...
    /// Applicable only for credentials with Cloud Account, Vendor Type as Amazon Web Services and authType is STS Assume Role
    /// with IAM Role Policy
    internal partial interface IAmazonCredentialContentWithRoleArnInternal
