...
namespace Commvault.Powershell.Models
{
    ...
    public partial class CommvaultPowerShellIdentity
    {
        ...
        internal CommvaultPowerShellIdentity(Commvault.Powershell.Runtime.Json.JsonObject json)
        {
            ...
            {_inventoryEntityName = If( json?.PropertyT<Commvault.Powershell.Runtime.Json.JsonString>("InventoryEntityName"), out var __jsonInventoryEntityName) ? (string)__jsonInventoryEntityName : (string)InventoryEntityName;}
            ...
            {_regionId = If( json?.PropertyT<Commvault.Powershell.Runtime.Json.JsonNumber>("regionId"), out var __jsonRegionId) ? (int?)__jsonRegionId : RegionId;}
            ...
            {_entityType = If( json?.PropertyT<Commvault.Powershell.Runtime.Json.JsonNumber>("entityType"), out var __jsonEntityType) ? (int?)__jsonEntityType : EntityType;}
        ...
        public Commvault.Powershell.Runtime.Json.JsonNode ToJson(Commvault.Powershell.Runtime.Json.JsonObject container, Commvault.Powershell.Runtime.SerializationMode serializationMode)
        {
            ...
            AddIf( null != (((object)this._inventoryEntityName)?.ToString()) ? (Commvault.Powershell.Runtime.Json.JsonNode) new Commvault.Powershell.Runtime.Json.JsonString(this._inventoryEntityName.ToString()) : null, "InventoryEntityName" ,container.Add );
            ...
            AddIf( null != this._regionId ? (Commvault.Powershell.Runtime.Json.JsonNode)new Commvault.Powershell.Runtime.Json.JsonNumber((int)this._regionId) : null, "regionId" ,container.Add );
            ...
            AddIf( null != this._entityType ? (Commvault.Powershell.Runtime.Json.JsonNode)new Commvault.Powershell.Runtime.Json.JsonNumber((int)this._entityType) : null, "entityType" ,container.Add );
