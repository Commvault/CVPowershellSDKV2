...
namespace Commvault.Powershell.Models
{
    ...
    public partial class AmazonS3Bucket :
        Commvault.Powershell.Models.IAmazonS3Bucket,
        Commvault.Powershell.Models.IAmazonS3BucketInternal,
        Commvault.Powershell.Runtime.IValidates
    {
        ...
        string Commvault.Powershell.Models.IAmazonS3BucketInternal.CloudType { get => this._cloudType; set { {_cloudType = value;} } }

        /// <summary>Internal Acessors for Credentials</summary>
        Commvault.Powershell.Models.IIdName Commvault.Powershell.Models.IAmazonS3BucketInternal.Credentials { get => (this._credentials = this._credentials ?? new Commvault.Powershell.Models.IdName()); set { {_credentials = value;} } }

        /// <summary>Internal Acessors for MediaAgent</summary>
        Commvault.Powershell.Models.IIdName Commvault.Powershell.Models.IAmazonS3BucketInternal.MediaAgent { get => (this._mediaAgent = this._mediaAgent ?? new Commvault.Powershell.Models.IdName()); set { {_mediaAgent = value;} } }
        ...
        /// <summary>Creates an new <see cref="AmazonS3Bucket" /> instance.</summary>
    ...
    /// Amazon S3
    internal partial interface IAmazonS3BucketInternal :
