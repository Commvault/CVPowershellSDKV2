...
namespace Commvault.Powershell.Models
{
    ...
    public partial class DellEmcBucket :
        Commvault.Powershell.Models.IDellEmcBucket,
        Commvault.Powershell.Models.IDellEmcBucketInternal,
        Commvault.Powershell.Runtime.IValidates
    {
        ...
        string Commvault.Powershell.Models.IDellEmcBucketInternal.CloudType { get => this._cloudType; set { {_cloudType = value;} } }

        /// <summary>Internal Acessors for Credentials</summary>
        Commvault.Powershell.Models.IIdName Commvault.Powershell.Models.IDellEmcBucketInternal.Credentials { get => (this._credentials = this._credentials ?? new Commvault.Powershell.Models.IdName()); set { {_credentials = value;} } }

        /// <summary>Internal Acessors for MediaAgent</summary>
        Commvault.Powershell.Models.IIdName Commvault.Powershell.Models.IDellEmcBucketInternal.MediaAgent { get => (this._mediaAgent = this._mediaAgent ?? new Commvault.Powershell.Models.IdName()); set { {_mediaAgent = value;} } }
        ...
        /// <summary>Creates an new <see cref="DellEmcBucket" /> instance.</summary>
        public DellEmcBucket()
        {
    ...
    /// Dell EMC ECS (S3-compatible)
    internal partial interface IDellEmcBucketInternal :
