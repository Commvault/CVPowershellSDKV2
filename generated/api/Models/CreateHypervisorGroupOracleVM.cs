...
namespace Commvault.Powershell.Models
{
    ...
    public partial class CreateHypervisorGroupOracleVM :
        Commvault.Powershell.Models.ICreateHypervisorGroupOracleVM,
        Commvault.Powershell.Models.ICreateHypervisorGroupOracleVMInternal,
        Commvault.Powershell.Runtime.IValidates
    {
        ...
        string Commvault.Powershell.Models.ICreateHypervisorGroupOracleVMInternal.HypervisorType { get => this._hypervisorType; set { {_hypervisorType = value;} } }
        ...
        private string _hypervisorType= @"ORACLE_VM";
        ...
        /// <summary>Creates an new <see cref="CreateHypervisorGroupOracleVM" /> instance.</summary>
        public CreateHypervisorGroupOracleVM()
        {
    ...
    /// Create a hypervisor group with Oracle VM as the destination vendor
    internal partial interface ICreateHypervisorGroupOracleVMInternal :
