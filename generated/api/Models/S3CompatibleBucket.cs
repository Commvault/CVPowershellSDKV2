...
namespace Commvault.Powershell.Models
{
    ...
    public partial class S3CompatibleBucket :
        Commvault.Powershell.Models.IS3CompatibleBucket,
        Commvault.Powershell.Models.IS3CompatibleBucketInternal,
        Commvault.Powershell.Runtime.IValidates
    {
        ...
        string Commvault.Powershell.Models.IS3CompatibleBucketInternal.CloudType { get => this._cloudType; set { {_cloudType = value;} } }

        /// <summary>Internal Acessors for Credentials</summary>
        Commvault.Powershell.Models.IIdName Commvault.Powershell.Models.IS3CompatibleBucketInternal.Credentials { get => (this._credentials = this._credentials ?? new Commvault.Powershell.Models.IdName()); set { {_credentials = value;} } }

        /// <summary>Internal Acessors for MediaAgent</summary>
        Commvault.Powershell.Models.IIdName Commvault.Powershell.Models.IS3CompatibleBucketInternal.MediaAgent { get => (this._mediaAgent = this._mediaAgent ?? new Commvault.Powershell.Models.IdName()); set { {_mediaAgent = value;} } }
        ...
        /// <summary>Creates an new <see cref="S3CompatibleBucket" /> instance.</summary>
        public S3CompatibleBucket()
        {
    ...
    /// S3 Compatible Storage
    internal partial interface IS3CompatibleBucketInternal :
