...
namespace Commvault.Powershell.Models
{
    ...
    public partial class GoogleCloudBucket :
        Commvault.Powershell.Models.IGoogleCloudBucket,
        Commvault.Powershell.Models.IGoogleCloudBucketInternal,
        Commvault.Powershell.Runtime.IValidates
    {
        ...
        string Commvault.Powershell.Models.IGoogleCloudBucketInternal.CloudType { get => this._cloudType; set { {_cloudType = value;} } }

        /// <summary>Internal Acessors for Credentials</summary>
        Commvault.Powershell.Models.IIdName Commvault.Powershell.Models.IGoogleCloudBucketInternal.Credentials { get => (this._credentials = this._credentials ?? new Commvault.Powershell.Models.IdName()); set { {_credentials = value;} } }

        /// <summary>Internal Acessors for MediaAgent</summary>
        Commvault.Powershell.Models.IIdName Commvault.Powershell.Models.IGoogleCloudBucketInternal.MediaAgent { get => (this._mediaAgent = this._mediaAgent ?? new Commvault.Powershell.Models.IdName()); set { {_mediaAgent = value;} } }
        ...
        /// <summary>Creates an new <see cref="GoogleCloudBucket" /> instance.</summary>
        public GoogleCloudBucket()
        {
    ...
    /// Google Cloud Storage
    internal partial interface IGoogleCloudBucketInternal :
