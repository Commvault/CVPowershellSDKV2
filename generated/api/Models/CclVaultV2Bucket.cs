...
namespace Commvault.Powershell.Models
{
    ...
    public partial class CclVaultV2Bucket :
        Commvault.Powershell.Models.ICclVaultV2Bucket,
        Commvault.Powershell.Models.ICclVaultV2BucketInternal,
        Commvault.Powershell.Runtime.IValidates
    {
        ...
        string Commvault.Powershell.Models.ICclVaultV2BucketInternal.CloudType { get => this._cloudType; set { {_cloudType = value;} } }

        /// <summary>Internal Acessors for Credentials</summary>
        Commvault.Powershell.Models.IIdName Commvault.Powershell.Models.ICclVaultV2BucketInternal.Credentials { get => (this._credentials = this._credentials ?? new Commvault.Powershell.Models.IdName()); set { {_credentials = value;} } }

        /// <summary>Internal Acessors for MediaAgent</summary>
        Commvault.Powershell.Models.IIdName Commvault.Powershell.Models.ICclVaultV2BucketInternal.MediaAgent { get => (this._mediaAgent = this._mediaAgent ?? new Commvault.Powershell.Models.IdName()); set { {_mediaAgent = value;} } }
        ...
        /// <summary>Creates an new <see cref="CclVaultV2Bucket" /> instance.</summary>
        public CclVaultV2Bucket()
        {
    ...
    /// CCL Vault v2
    internal partial interface ICclVaultV2BucketInternal :
