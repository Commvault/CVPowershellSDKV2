...
namespace Commvault.Powershell.Runtime.PowerShell
{
    ...
    {
        Commvault.Powershell.Runtime.SendAsyncStep Wrap(Commvault.Powershell.Runtime.SendAsyncStep func);
        System.Collections.Generic.IEnumerable<Commvault.Powershell.Runtime.SendAsyncStep> Wrap(System.Collections.Generic.IEnumerable<Commvault.Powershell.Runtime.SendAsyncStep> funcs);
    ...
    public class AsyncCommandRuntime : System.Management.Automation.ICommandRuntime2, IAsyncCommandRuntimeExtensions, System.IDisposable
    {
        ...
        public Commvault.Powershell.Runtime.SendAsyncStep Wrap(Commvault.Powershell.Runtime.SendAsyncStep func) => func.Target.GetType().Name != "Closure" ? func : (p1, p2, p3) => ExecuteSync<System.Threading.Tasks.Task<System.Net.Http.HttpResponseMessage>>(() => func(p1, p2, p3));
        public System.Collections.Generic.IEnumerable<Commvault.Powershell.Runtime.SendAsyncStep> Wrap(System.Collections.Generic.IEnumerable<Commvault.Powershell.Runtime.SendAsyncStep> funcs) => funcs?.Select(Wrap);
