...
namespace Commvault.Powershell.Cmdlets
{
    ...
    /// </remarks>
    [global::System.Management.Automation.Cmdlet(global::System.Management.Automation.VerbsLifecycle.Invoke, @"SetupLogin_PostExpanded", SupportsShouldProcess = true)]
    [global::System.Management.Automation.OutputType(typeof(Commvault.Powershell.Models.ILoginResponse))]
    [global::Commvault.Powershell.Description(@"Add your QSDK Authenticated token to your Postman Environment by providing the details in the pre-request script.\n\nYou only need to run this one time because these values are stored in your Postman Environment.")]
    [global::Commvault.Powershell.Generated]
    public partial class InvokeSetupLogin_PostExpanded : global::System.Management.Automation.PSCmdlet,
        Commvault.Powershell.Runtime.IEventListener
    {
        ...
        private Commvault.Powershell.Models.IEnvironmentSetupRequest _bodyParameterBody= new Commvault.Powershell.Models.EnvironmentSetupRequest();

        /// <summary>EnvironmentSetupRequest</summary>
        private Commvault.Powershell.Models.IEnvironmentSetupRequest BodyParameterBody { get => this._bodyParameterBody; set => this._bodyParameterBody = value; }
        ...
        public string Password { get => BodyParameterBody.Password ?? null; set => BodyParameterBody.Password = value; }
        ...
        PossibleTypes = new [] { typeof(string) })]
        public string Username { get => BodyParameterBody.Username ?? null; set => BodyParameterBody.Username = value; }
        ...
        PossibleTypes = new [] { typeof(string) })]
        public string WebServerUrl { get => BodyParameterBody.WebServerUrl ?? null; set => BodyParameterBody.WebServerUrl = value; }
        ...
        /// <param name="response">the body result as a <see cref="Commvault.Powershell.Models.ILoginResponse" /> from the remote call</param>
        /// <param name="returnNow">/// Determines if the rest of the onOk method should be processed, or if the method should return
        /// immediately (set to true to skip further processing )</param>

        partial void overrideOnOk(global::System.Net.Http.HttpResponseMessage responseMessage, global::System.Threading.Tasks.Task<Commvault.Powershell.Models.ILoginResponse> response, ref global::System.Threading.Tasks.Task<bool> returnNow);
        ...
        /// <summary>
        /// Intializes a new instance of the <see cref="InvokeSetupLogin_PostExpanded" /> cmdlet class.
        /// </summary>
        public InvokeSetupLogin_PostExpanded()
        {
        ...
        protected async global::System.Threading.Tasks.Task ProcessRecordAsync()
        {
            using( NoSynchronizationContext )
            {
                ...
                try
                {
                    ...
                    await this.Client.LoginPost(BodyParameterBody, onOk, this, Pipeline);
        ...
        /// A <see cref="global::System.Threading.Tasks.Task" /> that will be complete when handling of the method is completed.
        /// </returns>
        private async global::System.Threading.Tasks.Task onOk(global::System.Net.Http.HttpResponseMessage responseMessage, global::System.Threading.Tasks.Task<Commvault.Powershell.Models.ILoginResponse> response)
        {
            using( NoSynchronizationContext )
            {
                ...
                // (await response) // should be Commvault.Powershell.Models.ILoginResponse
                await response;
                System.Environment.SetEnvironmentVariable("CVToken", response.Result.Token);
