...
.Link
https://docs.microsoft.com/en-us/powershell/module/commvaultpowershell/set-replicationgroup
#>
function Set-ReplicationGroup {
...
begin {
    try {
        ...
        $mapping = @{
            UpdateExpanded = 'CommvaultPowerShell.private\Set-ReplicationGroup_UpdateExpanded';
            UpdateViaIdentityExpanded = 'CommvaultPowerShell.private\Set-ReplicationGroup_UpdateViaIdentityExpanded';
        }
