...
.Link
https://docs.microsoft.com/en-us/powershell/module/commvaultpowershell/remove-archiveplan
#>
function Remove-ArchivePlan {
...
begin {
    try {
        ...
        $mapping = @{
            Delete = 'CommvaultPowerShell.private\Remove-ArchivePlan_Delete';
            DeleteViaIdentity = 'CommvaultPowerShell.private\Remove-ArchivePlan_DeleteViaIdentity';
        }
