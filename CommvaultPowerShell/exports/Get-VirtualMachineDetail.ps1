...
.Link
https://docs.microsoft.com/en-us/powershell/module/commvaultpowershell/get-virtualmachinedetail
#>
function Get-VirtualMachineDetail {
...
begin {
    try {
        ...
        $mapping = @{
            Get = 'CommvaultPowerShell.private\Get-VirtualMachineDetail_Get';
            GetViaIdentity = 'CommvaultPowerShell.private\Get-VirtualMachineDetail_GetViaIdentity';
        }
