...
SECURITY <IUpdateSecurityAssoc[]>: .
  ...
  [UserName <String>]: 
.Link
https://docs.microsoft.com/en-us/powershell/module/commvaultpowershell/set-diskstorage
#>
...
begin {
    try {
        ...
        $mapping = @{
            UpdateExpanded = 'CommvaultPowerShell.private\Set-DiskStorage_UpdateExpanded';
            UpdateViaIdentityExpanded = 'CommvaultPowerShell.private\Set-DiskStorage_UpdateViaIdentityExpanded';
        }
