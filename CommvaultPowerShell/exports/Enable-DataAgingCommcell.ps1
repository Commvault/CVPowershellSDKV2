...
.Link
https://docs.microsoft.com/en-us/powershell/module/commvaultpowershell/enable-dataagingcommcell
#>
function Enable-DataAgingCommcell {
...
begin {
    try {
        ...
        $mapping = @{
            Enable = 'CommvaultPowerShell.private\Enable-DataAgingCommcell_Enable';
        }
