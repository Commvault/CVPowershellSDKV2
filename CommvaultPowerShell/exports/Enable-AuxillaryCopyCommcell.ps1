...
.Link
https://docs.microsoft.com/en-us/powershell/module/commvaultpowershell/enable-auxillarycopycommcell
#>
function Enable-AuxillaryCopyCommcell {
...
begin {
    try {
        ...
        $mapping = @{
            Enable = 'CommvaultPowerShell.private\Enable-AuxillaryCopyCommcell_Enable';
        }
