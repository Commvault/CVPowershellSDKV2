...
MEDIAAGENTS <IIdName[]>: Can add a list of media agents to be added as the disk access path.
  ...
  [Name <String>]: 
.Link
https://docs.microsoft.com/en-us/powershell/module/commvaultpowershell/add-mediaagent
#>
function Add-MediaAgent {
...
begin {
    try {
        ...
        $mapping = @{
            Add = 'CommvaultPowerShell.private\Add-MediaAgent_Add';
            AddExpanded = 'CommvaultPowerShell.private\Add-MediaAgent_AddExpanded';
            AddViaIdentity = 'CommvaultPowerShell.private\Add-MediaAgent_AddViaIdentity';
            AddViaIdentityExpanded = 'CommvaultPowerShell.private\Add-MediaAgent_AddViaIdentityExpanded';
        }
