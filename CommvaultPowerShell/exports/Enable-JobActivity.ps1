...
.Link
https://docs.microsoft.com/en-us/powershell/module/commvaultpowershell/enable-jobactivity
#>
function Enable-JobActivity {
...
begin {
    try {
        ...
        $mapping = @{
            Enable = 'CommvaultPowerShell.private\Enable-JobActivity_Enable';
        }
