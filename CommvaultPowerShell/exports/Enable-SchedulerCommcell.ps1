...
.Link
https://docs.microsoft.com/en-us/powershell/module/commvaultpowershell/enable-schedulercommcell
#>
function Enable-SchedulerCommcell {
...
begin {
    try {
        ...
        $mapping = @{
            Enable = 'CommvaultPowerShell.private\Enable-SchedulerCommcell_Enable';
        }
