...
.Link
https://docs.microsoft.com/en-us/powershell/module/commvaultpowershell/disable-restoreinstance
#>
function Disable-RestoreInstance {
...
begin {
    try {
        ...
        $mapping = @{
            Disable = 'CommvaultPowerShell.private\Disable-RestoreInstance_Disable';
            DisableViaIdentity = 'CommvaultPowerShell.private\Disable-RestoreInstance_DisableViaIdentity';
        }
