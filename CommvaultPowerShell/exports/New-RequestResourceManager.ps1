...
ENTITIES <INameValues[]>: List of personal entities with their values to form the criteria for the request
  ...
  [Values <String[]>]: 
.Link
https://docs.microsoft.com/en-us/powershell/module/commvaultpowershell/new-requestresourcemanager
#>
function New-RequestResourceManager {
...
begin {
    try {
        ...
        $mapping = @{
            CreateExpanded = 'CommvaultPowerShell.private\New-RequestResourceManager_CreateExpanded';
        }
