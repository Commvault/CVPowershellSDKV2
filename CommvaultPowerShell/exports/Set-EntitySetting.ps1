...
ENTITYSETTINGS <IModifyEntitySettingsItem[]>: .
  ...
  [EntityType <String>]: 
.Link
https://docs.microsoft.com/en-us/powershell/module/commvaultpowershell/set-entitysetting
#>
function Set-EntitySetting {
...
begin {
    try {
        ...
        $mapping = @{
            UpdateExpanded = 'CommvaultPowerShell.private\Set-EntitySetting_UpdateExpanded';
        }
