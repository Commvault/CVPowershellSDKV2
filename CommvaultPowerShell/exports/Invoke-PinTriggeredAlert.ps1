...
.Link
https://docs.microsoft.com/en-us/powershell/module/commvaultpowershell/invoke-pintriggeredalert
#>
function Invoke-PinTriggeredAlert {
...
begin {
    try {
        ...
        $mapping = @{
            Pin = 'CommvaultPowerShell.private\Invoke-PinTriggeredAlert_Pin';
            PinViaIdentity = 'CommvaultPowerShell.private\Invoke-PinTriggeredAlert_PinViaIdentity';
        }
