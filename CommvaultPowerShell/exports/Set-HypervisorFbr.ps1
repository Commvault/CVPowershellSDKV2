...
.Link
https://docs.microsoft.com/en-us/powershell/module/commvaultpowershell/set-hypervisorfbr
#>
function Set-HypervisorFbr {
...
begin {
    try {
        ...
        $mapping = @{
            Set = 'CommvaultPowerShell.private\Set-HypervisorFbr_Set';
