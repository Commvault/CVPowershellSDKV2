...
.Link
https://docs.microsoft.com/en-us/powershell/module/commvaultpowershell/get-recoverytarget
#>
function Get-RecoveryTarget {
...
begin {
    try {
        ...
        $mapping = @{
            Get = 'CommvaultPowerShell.private\Get-RecoveryTarget_Get';
            Get1 = 'CommvaultPowerShell.private\Get-RecoveryTarget_Get1';
            GetViaIdentity = 'CommvaultPowerShell.private\Get-RecoveryTarget_GetViaIdentity';
        }
