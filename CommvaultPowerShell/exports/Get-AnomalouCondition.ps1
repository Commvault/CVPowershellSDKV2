...
.Link
https://docs.microsoft.com/en-us/powershell/module/commvaultpowershell/get-anomaloucondition
#>
function Get-AnomalouCondition {
...
begin {
    try {
        ...
        $mapping = @{
            Get = 'CommvaultPowerShell.private\Get-AnomalouCondition_Get';
        }
