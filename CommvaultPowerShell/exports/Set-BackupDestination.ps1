...
.Link
https://docs.microsoft.com/en-us/powershell/module/commvaultpowershell/set-backupdestination
#>
function Set-BackupDestination {
...
begin {
    try {
        ...
        $mapping = @{
            UpdateExpanded = 'CommvaultPowerShell.private\Set-BackupDestination_UpdateExpanded';
            UpdateViaIdentityExpanded = 'CommvaultPowerShell.private\Set-BackupDestination_UpdateViaIdentityExpanded';
        }
