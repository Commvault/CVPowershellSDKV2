...
.Link
https://docs.microsoft.com/en-us/powershell/module/commvaultpowershell/remove-servergroup
#>
function Remove-ServerGroup {
...
begin {
    try {
        ...
        $mapping = @{
            Delete = 'CommvaultPowerShell.private\Remove-ServerGroup_Delete';
            DeleteViaIdentity = 'CommvaultPowerShell.private\Remove-ServerGroup_DeleteViaIdentity';
        }
