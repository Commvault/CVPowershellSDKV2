...
.Link
https://docs.microsoft.com/en-us/powershell/module/commvaultpowershell/remove-bucket
#>
...
begin {
    try {
        ...
        $mapping = @{
            Delete = 'CommvaultPowerShell.private\Remove-Bucket_Delete';
            DeleteViaIdentity = 'CommvaultPowerShell.private\Remove-Bucket_DeleteViaIdentity';
        }
