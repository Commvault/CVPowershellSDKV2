...
.Link
https://docs.microsoft.com/en-us/powershell/module/commvaultpowershell/get-planrule
#>
function Get-PlanRule {
...
begin {
    try {
        ...
        $mapping = @{
            Get = 'CommvaultPowerShell.private\Get-PlanRule_Get';
        }
