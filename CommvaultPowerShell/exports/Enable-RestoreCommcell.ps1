...
.Link
https://docs.microsoft.com/en-us/powershell/module/commvaultpowershell/enable-restorecommcell
#>
function Enable-RestoreCommcell {
...
begin {
    try {
        ...
        $mapping = @{
            Enable = 'CommvaultPowerShell.private\Enable-RestoreCommcell_Enable';
        }
