...
SECURITY <IUpdateSecurityAssoc[]>: .
  ...
  [UserName <String>]: 
.Link
https://docs.microsoft.com/en-us/powershell/module/commvaultpowershell/set-hyperscalestorage
#>
function Set-HyperScaleStorage {
...
begin {
    try {
        ...
        $mapping = @{
            UpdateExpanded = 'CommvaultPowerShell.private\Set-HyperScaleStorage_UpdateExpanded';
            UpdateViaIdentityExpanded = 'CommvaultPowerShell.private\Set-HyperScaleStorage_UpdateViaIdentityExpanded';
        }
