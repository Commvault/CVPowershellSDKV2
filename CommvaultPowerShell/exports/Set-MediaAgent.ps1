...
.Link
https://docs.microsoft.com/en-us/powershell/module/commvaultpowershell/set-mediaagent
#>
function Set-MediaAgent {
...
begin {
    try {
        ...
        $mapping = @{
            UpdateExpanded = 'CommvaultPowerShell.private\Set-MediaAgent_UpdateExpanded';
            UpdateViaIdentityExpanded = 'CommvaultPowerShell.private\Set-MediaAgent_UpdateViaIdentityExpanded';
        }
