...
.Link
https://docs.microsoft.com/en-us/powershell/module/commvaultpowershell/backup-vmgroup
#>
function Backup-VMGroup {
...
begin {
    try {
        ...
        $mapping = @{
            Backup = 'CommvaultPowerShell.private\Backup-VMGroup_Backup';
            BackupViaIdentity = 'CommvaultPowerShell.private\Backup-VMGroup_BackupViaIdentity';
        }
