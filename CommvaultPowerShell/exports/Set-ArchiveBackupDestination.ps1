...
.Link
https://docs.microsoft.com/en-us/powershell/module/commvaultpowershell/set-archivebackupdestination
#>
function Set-ArchiveBackupDestination {
...
begin {
    try {
        ...
        $mapping = @{
            UpdateExpanded = 'CommvaultPowerShell.private\Set-ArchiveBackupDestination_UpdateExpanded';
            UpdateViaIdentityExpanded = 'CommvaultPowerShell.private\Set-ArchiveBackupDestination_UpdateViaIdentityExpanded';
        }
