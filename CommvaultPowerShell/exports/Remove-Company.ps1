...
.Link
https://docs.microsoft.com/en-us/powershell/module/commvaultpowershell/remove-company
#>
...
begin {
    try {
        ...
        $mapping = @{
            Delete = 'CommvaultPowerShell.private\Remove-Company_Delete';
            DeleteViaIdentity = 'CommvaultPowerShell.private\Remove-Company_DeleteViaIdentity';
        }
