...
.Link
https://docs.microsoft.com/en-us/powershell/module/commvaultpowershell/get-plansummarydetail
#>
function Get-PlanSummaryDetail {
...
begin {
    try {
        ...
        $mapping = @{
            Get = 'CommvaultPowerShell.private\Get-PlanSummaryDetail_Get';
            GetViaIdentity = 'CommvaultPowerShell.private\Get-PlanSummaryDetail_GetViaIdentity';
        }
