...
.Link
https://docs.microsoft.com/en-us/powershell/module/commvaultpowershell/set-blackoutwindow
#>
function Set-BlackoutWindow {
...
begin {
    try {
        ...
        $mapping = @{
            UpdateExpanded = 'CommvaultPowerShell.private\Set-BlackoutWindow_UpdateExpanded';
            UpdateViaIdentityExpanded = 'CommvaultPowerShell.private\Set-BlackoutWindow_UpdateViaIdentityExpanded';
        }
