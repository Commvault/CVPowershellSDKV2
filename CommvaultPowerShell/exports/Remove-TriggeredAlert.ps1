...
.Link
https://docs.microsoft.com/en-us/powershell/module/commvaultpowershell/remove-triggeredalert
#>
function Remove-TriggeredAlert {
...
begin {
    try {
        ...
        $mapping = @{
            Delete = 'CommvaultPowerShell.private\Remove-TriggeredAlert_Delete';
            DeleteViaIdentity = 'CommvaultPowerShell.private\Remove-TriggeredAlert_DeleteViaIdentity';
        }
