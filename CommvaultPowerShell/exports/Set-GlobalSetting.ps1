...
.Link
https://docs.microsoft.com/en-us/powershell/module/commvaultpowershell/set-globalsetting
#>
...
begin {
    try {
        ...
        $mapping = @{
            UpdateExpanded = 'CommvaultPowerShell.private\Set-GlobalSetting_UpdateExpanded';
        }
