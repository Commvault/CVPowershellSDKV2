...
SECURITY <IUpdateSecurityAssoc[]>: Used to update the security association for the role
  ...
  [UserName <String>]: 
.Link
https://docs.microsoft.com/en-us/powershell/module/commvaultpowershell/set-role
#>
function Set-Role {
...
begin {
    try {
        ...
        $mapping = @{
            UpdateExpanded = 'CommvaultPowerShell.private\Set-Role_UpdateExpanded';
            UpdateViaIdentityExpanded = 'CommvaultPowerShell.private\Set-Role_UpdateViaIdentityExpanded';
        }
