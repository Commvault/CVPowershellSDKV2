...
.Link
https://docs.microsoft.com/en-us/powershell/module/commvaultpowershell/invoke-invokerefreshnode
#>
function Invoke-InvokeRefreshNode {
...
begin {
    try {
        ...
        $mapping = @{
            Invoke = 'CommvaultPowerShell.private\Invoke-InvokeRefreshNode_Invoke';
            InvokeViaIdentity = 'CommvaultPowerShell.private\Invoke-InvokeRefreshNode_InvokeViaIdentity';
        }
