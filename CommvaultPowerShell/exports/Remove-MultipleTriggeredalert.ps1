...
BODY <IAlertIds>: Array of ids of an entity
  [AlertId <Int64[]>]: 
.Link
https://docs.microsoft.com/en-us/powershell/module/commvaultpowershell/remove-multipletriggeredalert
#>
function Remove-MultipleTriggeredalert {
...
begin {
    try {
        ...
        $mapping = @{
            Delete = 'CommvaultPowerShell.private\Remove-MultipleTriggeredalert_Delete';
            DeleteExpanded = 'CommvaultPowerShell.private\Remove-MultipleTriggeredalert_DeleteExpanded';
        }
