...
REVIEWERS <IIdNameDisplayName[]>: List of reviewers for the request
  ...
  [Name <String>]: 
.Link
https://docs.microsoft.com/en-us/powershell/module/commvaultpowershell/set-requestmanagerconfigurerequest
#>
function Set-RequestManagerConfigureRequest {
...
begin {
    try {
        ...
        $mapping = @{
            UpdateExpanded = 'CommvaultPowerShell.private\Set-RequestManagerConfigureRequest_UpdateExpanded';
            UpdateViaIdentityExpanded = 'CommvaultPowerShell.private\Set-RequestManagerConfigureRequest_UpdateViaIdentityExpanded';
        }
