...
.Link
https://docs.microsoft.com/en-us/powershell/module/commvaultpowershell/get-planruleentityexclude
#>
function Get-PlanRuleEntityExclude {
...
begin {
    try {
        ...
        $mapping = @{
            Get = 'CommvaultPowerShell.private\Get-PlanRuleEntityExclude_Get';
        }
