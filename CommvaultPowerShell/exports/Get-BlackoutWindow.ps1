...
.Link
https://docs.microsoft.com/en-us/powershell/module/commvaultpowershell/get-blackoutwindow
#>
function Get-BlackoutWindow {
[OutputType([Commvault.Powershell.Models.IBlackoutWindowSummary])]
...
begin {
    try {
        ...
        $mapping = @{
            Get = 'CommvaultPowerShell.private\Get-BlackoutWindow_Get';
        }
