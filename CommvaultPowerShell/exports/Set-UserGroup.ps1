...
USERS <IIdName[]>: .
  ...
  [Name <String>]: 
.Link
https://docs.microsoft.com/en-us/powershell/module/commvaultpowershell/set-usergroup
#>
...
begin {
    try {
        ...
        $mapping = @{
            UpdateExpanded = 'CommvaultPowerShell.private\Set-UserGroup_UpdateExpanded';
            UpdateViaIdentityExpanded = 'CommvaultPowerShell.private\Set-UserGroup_UpdateViaIdentityExpanded';
        }
