...
.Link
https://docs.microsoft.com/en-us/powershell/module/commvaultpowershell/remove-blackoutwindow
#>
function Remove-BlackoutWindow {
...
begin {
    try {
        ...
        $mapping = @{
            Delete = 'CommvaultPowerShell.private\Remove-BlackoutWindow_Delete';
            DeleteViaIdentity = 'CommvaultPowerShell.private\Remove-BlackoutWindow_DeleteViaIdentity';
        }
