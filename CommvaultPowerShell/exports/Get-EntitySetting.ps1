...
.Link
https://docs.microsoft.com/en-us/powershell/module/commvaultpowershell/get-entitysetting
#>
function Get-EntitySetting {
...
begin {
    try {
        ...
        $mapping = @{
            Get = 'CommvaultPowerShell.private\Get-EntitySetting_Get';
        }
