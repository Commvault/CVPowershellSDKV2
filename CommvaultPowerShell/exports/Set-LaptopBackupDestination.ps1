...
.Link
https://docs.microsoft.com/en-us/powershell/module/commvaultpowershell/set-laptopbackupdestination
#>
function Set-LaptopBackupDestination {
...
begin {
    try {
        ...
        $mapping = @{
            UpdateExpanded = 'CommvaultPowerShell.private\Set-LaptopBackupDestination_UpdateExpanded';
            UpdateViaIdentityExpanded = 'CommvaultPowerShell.private\Set-LaptopBackupDestination_UpdateViaIdentityExpanded';
        }
