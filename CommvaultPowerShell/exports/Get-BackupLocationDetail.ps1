...
.Link
https://docs.microsoft.com/en-us/powershell/module/commvaultpowershell/get-backuplocationdetail
#>
function Get-BackupLocationDetail {
...
begin {
    try {
        ...
        $mapping = @{
            Get = 'CommvaultPowerShell.private\Get-BackupLocationDetail_Get';
            GetViaIdentity = 'CommvaultPowerShell.private\Get-BackupLocationDetail_GetViaIdentity';
        }
