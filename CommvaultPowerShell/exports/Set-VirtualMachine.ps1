...
.Link
https://docs.microsoft.com/en-us/powershell/module/commvaultpowershell/set-virtualmachine
#>
...
begin {
    try {
        ...
        $mapping = @{
            UpdateExpanded = 'CommvaultPowerShell.private\Set-VirtualMachine_UpdateExpanded';
            UpdateViaIdentityExpanded = 'CommvaultPowerShell.private\Set-VirtualMachine_UpdateViaIdentityExpanded';
        }
