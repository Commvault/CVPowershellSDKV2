...
.Link
https://docs.microsoft.com/en-us/powershell/module/commvaultpowershell/get-archivebackupdestination
#>
function Get-ArchiveBackupDestination {
...
begin {
    try {
        ...
        $mapping = @{
            Get = 'CommvaultPowerShell.private\Get-ArchiveBackupDestination_Get';
            GetViaIdentity = 'CommvaultPowerShell.private\Get-ArchiveBackupDestination_GetViaIdentity';
        }
