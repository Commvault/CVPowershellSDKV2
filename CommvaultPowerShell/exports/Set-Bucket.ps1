...
.Link
https://docs.microsoft.com/en-us/powershell/module/commvaultpowershell/set-bucket
#>
function Set-Bucket {
...
begin {
    try {
        ...
        $mapping = @{
            UpdateExpanded = 'CommvaultPowerShell.private\Set-Bucket_UpdateExpanded';
            UpdateViaIdentityExpanded = 'CommvaultPowerShell.private\Set-Bucket_UpdateViaIdentityExpanded';
        }
