...
.Link
https://docs.microsoft.com/en-us/powershell/module/commvaultpowershell/get-planruleassociatedentity
#>
function Get-PlanRuleAssociatedEntity {
...
begin {
    try {
        ...
        $mapping = @{
            Get = 'CommvaultPowerShell.private\Get-PlanRuleAssociatedEntity_Get';
        }
