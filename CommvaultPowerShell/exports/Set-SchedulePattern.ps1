...
.Link
https://docs.microsoft.com/en-us/powershell/module/commvaultpowershell/set-schedulepattern
#>
function Set-SchedulePattern {
...
begin {
    try {
        ...
        $mapping = @{
            UpdateExpanded = 'CommvaultPowerShell.private\Set-SchedulePattern_UpdateExpanded';
            UpdateViaIdentityExpanded = 'CommvaultPowerShell.private\Set-SchedulePattern_UpdateViaIdentityExpanded';
        }
