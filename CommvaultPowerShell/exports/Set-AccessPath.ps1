...
.Link
https://docs.microsoft.com/en-us/powershell/module/commvaultpowershell/set-accesspath
#>
function Set-AccessPath {
...
begin {
    try {
        ...
        $mapping = @{
            UpdateExpanded = 'CommvaultPowerShell.private\Set-AccessPath_UpdateExpanded';
            UpdateViaIdentityExpanded = 'CommvaultPowerShell.private\Set-AccessPath_UpdateViaIdentityExpanded';
        }
