...
.Link
https://docs.microsoft.com/en-us/powershell/module/commvaultpowershell/enable-contentindexingcommcell
#>
function Enable-ContentIndexingCommcell {
...
begin {
    try {
        ...
        $mapping = @{
            Enable = 'CommvaultPowerShell.private\Enable-ContentIndexingCommcell_Enable';
        }
