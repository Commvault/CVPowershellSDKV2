...
.Link
https://docs.microsoft.com/en-us/powershell/module/commvaultpowershell/remove-cloudstoragemetadatacache
#>
function Remove-CloudStorageMetadataCache {
...
begin {
    try {
        ...
        $mapping = @{
            Delete = 'CommvaultPowerShell.private\Remove-CloudStorageMetadataCache_Delete';
            DeleteViaIdentity = 'CommvaultPowerShell.private\Remove-CloudStorageMetadataCache_DeleteViaIdentity';
        }
