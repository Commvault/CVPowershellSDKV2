...
.Link
https://docs.microsoft.com/en-us/powershell/module/commvaultpowershell/request-managerrequestlist
#>
function Request-ManagerRequestList {
...
begin {
    try {
        ...
        $mapping = @{
            Request = 'CommvaultPowerShell.private\Request-ManagerRequestList_Request';
        }
