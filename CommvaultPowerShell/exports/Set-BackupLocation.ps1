...
.Link
https://docs.microsoft.com/en-us/powershell/module/commvaultpowershell/set-backuplocation
#>
...
begin {
    try {
        ...
        $mapping = @{
            UpdateExpanded = 'CommvaultPowerShell.private\Set-BackupLocation_UpdateExpanded';
            UpdateViaIdentityExpanded = 'CommvaultPowerShell.private\Set-BackupLocation_UpdateViaIdentityExpanded';
        }
