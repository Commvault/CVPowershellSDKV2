...
.Link
https://docs.microsoft.com/en-us/powershell/module/commvaultpowershell/get-distributedsystem
#>
function Get-DistributedSystem {
...
begin {
    try {
        ...
        $mapping = @{
            Get = 'CommvaultPowerShell.private\Get-DistributedSystem_Get';
        }
