...
.Link
https://docs.microsoft.com/en-us/powershell/module/commvaultpowershell/get-servergroupiddetail
#>
function Get-ServerGroupIdDetail {
...
begin {
    try {
        ...
        $mapping = @{
            Get = 'CommvaultPowerShell.private\Get-ServerGroupIdDetail_Get';
            GetViaIdentity = 'CommvaultPowerShell.private\Get-ServerGroupIdDetail_GetViaIdentity';
        }
