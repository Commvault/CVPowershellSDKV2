...
.Link
https://docs.microsoft.com/en-us/powershell/module/commvaultpowershell/enable-restoreagent
#>
function Enable-RestoreAgent {
...
begin {
    try {
        ...
        $mapping = @{
            Enable = 'CommvaultPowerShell.private\Enable-RestoreAgent_Enable';
            EnableViaIdentity = 'CommvaultPowerShell.private\Enable-RestoreAgent_EnableViaIdentity';
        }
