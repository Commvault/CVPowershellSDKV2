...
.Link
https://docs.microsoft.com/en-us/powershell/module/commvaultpowershell/remove-hyperscalestorage
#>
function Remove-HyperScaleStorage {
...
begin {
    try {
        ...
        $mapping = @{
            Delete = 'CommvaultPowerShell.private\Remove-HyperScaleStorage_Delete';
            DeleteViaIdentity = 'CommvaultPowerShell.private\Remove-HyperScaleStorage_DeleteViaIdentity';
        }
