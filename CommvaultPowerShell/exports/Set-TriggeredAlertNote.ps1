...
.Link
https://docs.microsoft.com/en-us/powershell/module/commvaultpowershell/set-triggeredalertnote
#>
function Set-TriggeredAlertNote {
...
begin {
    try {
        ...
        $mapping = @{
            UpdateExpanded = 'CommvaultPowerShell.private\Set-TriggeredAlertNote_UpdateExpanded';
            UpdateViaIdentityExpanded = 'CommvaultPowerShell.private\Set-TriggeredAlertNote_UpdateViaIdentityExpanded';
        }
