...
.Link
https://docs.microsoft.com/en-us/powershell/module/commvaultpowershell/get-alertdefinitiondetail
#>
function Get-AlertDefinitionDetail {
...
begin {
    try {
        ...
        $mapping = @{
            Get = 'CommvaultPowerShell.private\Get-AlertDefinitionDetail_Get';
            GetViaIdentity = 'CommvaultPowerShell.private\Get-AlertDefinitionDetail_GetViaIdentity';
        }
