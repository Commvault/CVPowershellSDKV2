...
namespace Commvault.Powershell.Runtime
{
    ...
    internal static class JsonSerializable
    {
        ...
        internal static JsonNode ToJsonValue(object value)
        {
            ...
            if (value is Commvault.Powershell.Runtime.IJsonSerializable jsonSerializable)
            {
            ...
            {
                return Commvault.Powershell.Runtime.JsonSerializable.ToJson(dictionary, null);
            }
            ...
            if (value is System.Collections.Hashtable hashtable)
            {
                ...
                return Commvault.Powershell.Runtime.JsonSerializable.ToJson(dict, null);
            }
