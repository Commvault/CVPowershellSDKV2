...
namespace Commvault.Powershell.Models
{
        ...
        Commvault.Powershell.Models.IVirtualMachineDetailsInternal
    {
        ...
        private System.Collections.Generic.List<Commvault.Powershell.Models.IActivityControlOptionsProp> _activityControl;

        [Commvault.Powershell.Origin(Commvault.Powershell.PropertyOrigin.Owned)]
        public System.Collections.Generic.List<Commvault.Powershell.Models.IActivityControlOptionsProp> ActivityControl { get => this._activityControl; set => this._activityControl = value; }

        [Commvault.Powershell.Origin(Commvault.Powershell.PropertyOrigin.Inlined)]
        public System.Collections.Generic.List<Commvault.Powershell.Models.IVMAppsDiscovered> ApplicationValidationResultAppsDiscovered { get => ((Commvault.Powershell.Models.IVMApplicationValidationResultsInternal)ApplicationValidationResults).AppsDiscovered; set => ((Commvault.Powershell.Models.IVMApplicationValidationResultsInternal)ApplicationValidationResults).AppsDiscovered = value ?? null /* arrayOf */; }
        ...
        [Commvault.Powershell.Origin(Commvault.Powershell.PropertyOrigin.Inlined)]
        public System.Collections.Generic.List<Commvault.Powershell.Models.IVMSecurityAssoc> SecurityAssociations { get => ((Commvault.Powershell.Models.IVMSecurityInternal)Security).Associations; set => ((Commvault.Powershell.Models.IVMSecurityInternal)Security).Associations = value ?? null /* arrayOf */; }

        [Commvault.Powershell.Origin(Commvault.Powershell.PropertyOrigin.Inlined)]
        public System.Collections.Generic.List<Commvault.Powershell.Models.ISecurityOwnersAssoc> SecurityOwners { get => ((Commvault.Powershell.Models.IVMSecurityInternal)Security).Owners; set => ((Commvault.Powershell.Models.IVMSecurityInternal)Security).Owners = value ?? null /* arrayOf */; }

        [Commvault.Powershell.Origin(Commvault.Powershell.PropertyOrigin.Inlined)]
        public System.Collections.Generic.List<Commvault.Powershell.Models.IPermissionResp> SecurityPermissions { get => ((Commvault.Powershell.Models.IVMSecurityInternal)Security).Permissions; set => ((Commvault.Powershell.Models.IVMSecurityInternal)Security).Permissions = value ?? null /* arrayOf */; }
        ...
        Commvault.Powershell.Runtime.IJsonSerializable
    {
        ...
        System.Collections.Generic.List<Commvault.Powershell.Models.IActivityControlOptionsProp> ActivityControl { get; set; }
        ...
        System.Collections.Generic.List<Commvault.Powershell.Models.IVMAppsDiscovered> ApplicationValidationResultAppsDiscovered { get; set; }
        /// <summary>timestamp(in unix) for the last backup job completed</summary>
        [Commvault.Powershell.Runtime.Info(
        Required = false,
        ReadOnly = false,
        ...
        System.Collections.Generic.List<Commvault.Powershell.Models.IVMSecurityAssoc> SecurityAssociations { get; set; }
        ...
        System.Collections.Generic.List<Commvault.Powershell.Models.ISecurityOwnersAssoc> SecurityOwners { get; set; }
        ...
        System.Collections.Generic.List<Commvault.Powershell.Models.IPermissionResp> SecurityPermissions { get; set; }
        /// <summary>The reason for the current SLA status of the VM client</summary>
        [Commvault.Powershell.Runtime.Info(
        Required = false,
        ReadOnly = false,
