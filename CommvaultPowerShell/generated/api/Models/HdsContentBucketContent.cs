...
namespace Commvault.Powershell.Models
{
    ...
    public partial class HdsContentBucketContent :
        Commvault.Powershell.Models.IHdsContentBucketContent,
        Commvault.Powershell.Models.IHdsContentBucketContentInternal,
        Commvault.Powershell.Runtime.IValidates
    {
        ...
        string Commvault.Powershell.Models.IHdsContentBucketContentInternal.CloudType { get => this._cloudType; set { {_cloudType = value;} } }

        /// <summary>Internal Acessors for Credentials</summary>
        Commvault.Powershell.Models.IIdName Commvault.Powershell.Models.IHdsContentBucketContentInternal.Credentials { get => (this._credentials = this._credentials ?? new Commvault.Powershell.Models.IdName()); set { {_credentials = value;} } }

        /// <summary>Internal Acessors for MediaAgent</summary>
        Commvault.Powershell.Models.IIdName Commvault.Powershell.Models.IHdsContentBucketContentInternal.MediaAgent { get => (this._mediaAgent = this._mediaAgent ?? new Commvault.Powershell.Models.IdName()); set { {_mediaAgent = value;} } }
        ...
        /// <summary>Creates an new <see cref="HdsContentBucketContent" /> instance.</summary>
        public HdsContentBucketContent()
        {
    ...
    /// Hitachi Content Platform
    internal partial interface IHdsContentBucketContentInternal :
