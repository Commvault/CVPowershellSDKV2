...
namespace Commvault.Powershell.Models
{
    ...
    public partial class OracleObjectBucketContent
    {
        ...
        internal OracleObjectBucketContent(Commvault.Powershell.Runtime.Json.JsonObject json)
        {
            ...
            {_useCombinedStorage = If( json?.PropertyT<Commvault.Powershell.Runtime.Json.JsonBoolean>("useCombinedStorage"), out var __jsonUseCombinedStorage) ? (bool?)__jsonUseCombinedStorage : UseCombinedStorage;}
            {_combinedStorageClass = If( json?.PropertyT<Commvault.Powershell.Runtime.Json.JsonString>("combinedStorageClass"), out var __jsonCombinedStorageClass) ? (string)__jsonCombinedStorageClass : (string)CombinedStorageClass;}
            AfterFromJson(json);
        }
