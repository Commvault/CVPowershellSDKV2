...
namespace Commvault.Powershell.Models
{
    ...
    public partial class UpdateHypervisorGroupRhev
    {
        ...
        internal UpdateHypervisorGroupRhev(Commvault.Powershell.Runtime.Json.JsonObject json)
        {
            ...
            {_rhevMManager = If( json?.PropertyT<Commvault.Powershell.Runtime.Json.JsonString>("RhevMManager"), out var __jsonRhevMManager) ? (string)__jsonRhevMManager : (string)RhevMManager;}
