...
namespace Commvault.Powershell.Models
{
    ...
    public partial class CreateHypervisorGroupOpenstack
    {
        ...
        /// <summary>
        /// Deserializes a Commvault.Powershell.Runtime.Json.JsonObject into a new instance of <see cref="CreateHypervisorGroupOpenstack" />.
        /// </summary>
        /// <param name="json">A Commvault.Powershell.Runtime.Json.JsonObject instance to deserialize from.</param>
        internal CreateHypervisorGroupOpenstack(Commvault.Powershell.Runtime.Json.JsonObject json)
        {
            ...
            {_keynoteAddress = If( json?.PropertyT<Commvault.Powershell.Runtime.Json.JsonString>("keynoteAddress"), out var __jsonKeynoteAddress) ? (string)__jsonKeynoteAddress : (string)_keynoteAddress;}
            ...
            {_openstackDomain = If( json?.PropertyT<Commvault.Powershell.Runtime.Json.JsonString>("openstackDomain"), out var __jsonOpenstackDomain) ? (string)__jsonOpenstackDomain : (string)_openstackDomain;}
            AfterFromJson(json);
        }

        /// <summary>
        /// Deserializes a <see cref="Commvault.Powershell.Runtime.Json.JsonNode"/> into an instance of Commvault.Powershell.Models.ICreateHypervisorGroupOpenstack.
        /// </summary>
        /// <param name="node">a <see cref="Commvault.Powershell.Runtime.Json.JsonNode" /> to deserialize from.</param>
        /// <returns>an instance of Commvault.Powershell.Models.ICreateHypervisorGroupOpenstack.</returns>
        public static Commvault.Powershell.Models.ICreateHypervisorGroupOpenstack FromJson(Commvault.Powershell.Runtime.Json.JsonNode node)
        {
            return node is Commvault.Powershell.Runtime.Json.JsonObject json ? new CreateHypervisorGroupOpenstack(json) : null;
        }

        /// <summary>
        /// Serializes this instance of <see cref="CreateHypervisorGroupOpenstack" /> into a <see cref="Commvault.Powershell.Runtime.Json.JsonNode" />.
        /// </summary>
        /// <param name="container">The <see cref="Commvault.Powershell.Runtime.Json.JsonObject"/> container to serialize this object into. If the caller
        /// passes in <c>null</c>, a new instance will be created and returned to the caller.</param>
        /// <param name="serializationMode">Allows the caller to choose the depth of the serialization. See <see cref="Commvault.Powershell.Runtime.SerializationMode"/>.</param>
        /// <returns>
        /// a serialized instance of <see cref="CreateHypervisorGroupOpenstack" /> as a <see cref="Commvault.Powershell.Runtime.Json.JsonNode" />.
        /// </returns>
