...
namespace Commvault.Powershell.Models
{
    ...
    public partial class AdldapDetails
    {
        ...
        internal AdldapDetails(Commvault.Powershell.Runtime.Json.JsonObject json)
        {
            ...
            {_domainName = If( json?.PropertyT<Commvault.Powershell.Runtime.Json.JsonString>("domainName"), out var __jsonDomainName) ? (string)__jsonDomainName : (string)_domainName;}
            {_directoryType = If( json?.PropertyT<Commvault.Powershell.Runtime.Json.JsonString>("directoryType"), out var __jsonDirectoryType) ? (string)__jsonDirectoryType : (string)_directoryType;}
            {_credentials = If( json?.PropertyT<Commvault.Powershell.Runtime.Json.JsonString>("credentials"), out var __jsonCredentials) ? (string)__jsonCredentials : (string)_credentials;}
            {_users = If( json?.PropertyT<Commvault.Powershell.Runtime.Json.JsonNumber>("users"), out var __jsonUsers) ? (long?)__jsonUsers : _users;}
            {_userGroups = If( json?.PropertyT<Commvault.Powershell.Runtime.Json.JsonNumber>("userGroups"), out var __jsonUserGroups) ? (long?)__jsonUserGroups : _userGroups;}
            {_baseDnForCardUsers = If( json?.PropertyT<Commvault.Powershell.Runtime.Json.JsonString>("baseDNForCardUsers"), out var __jsonBaseDnForCardUsers) ? (string)__jsonBaseDnForCardUsers : (string)_baseDnForCardUsers;}
            {_useSecureLdap = If( json?.PropertyT<Commvault.Powershell.Runtime.Json.JsonBoolean>("useSecureLDAP"), out var __jsonUseSecureLdap) ? (bool?)__jsonUseSecureLdap : _useSecureLdap;}
            {_enableSso = If( json?.PropertyT<Commvault.Powershell.Runtime.Json.JsonBoolean>("enableSSO"), out var __jsonEnableSso) ? (bool?)__jsonEnableSso : _enableSso;}
            {_accessViaClient = If( json?.PropertyT<Commvault.Powershell.Runtime.Json.JsonBoolean>("accessViaClient"), out var __jsonAccessViaClient) ? (bool?)__jsonAccessViaClient : _accessViaClient;}
            ...
            {_ldapQueryParameters = If( json?.PropertyT<Commvault.Powershell.Runtime.Json.JsonArray>("LDAPQueryParameters"), out var __jsonLdapQueryParameters) ? If( __jsonLdapQueryParameters as Commvault.Powershell.Runtime.Json.JsonArray, out var __q) ? new global::System.Func<System.Collections.Generic.List<Commvault.Powershell.Models.ILdapAttribute>>(()=> global::System.Linq.Enumerable.ToList(global::System.Linq.Enumerable.Select(__q, (__p)=>(Commvault.Powershell.Models.ILdapAttribute) (Commvault.Powershell.Models.LdapAttribute.FromJson(__p) )) ))() : null : _ldapQueryParameters;}
            {_attributeMap = If( json?.PropertyT<Commvault.Powershell.Runtime.Json.JsonArray>("attributeMap"), out var __jsonAttributeMap) ? If( __jsonAttributeMap as Commvault.Powershell.Runtime.Json.JsonArray, out var __l) ? new global::System.Func<System.Collections.Generic.List<Commvault.Powershell.Models.ILdapAttribute>>(()=> global::System.Linq.Enumerable.ToList(global::System.Linq.Enumerable.Select(__l, (__k)=>(Commvault.Powershell.Models.ILdapAttribute) (Commvault.Powershell.Models.LdapAttribute.FromJson(__k) )) ))() : null : _attributeMap;}
            AfterFromJson(json);
        }
