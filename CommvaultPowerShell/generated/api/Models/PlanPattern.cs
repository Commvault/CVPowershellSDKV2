...
namespace Commvault.Powershell.Models
{
        ...
        Commvault.Powershell.Models.IPlanPatternInternal
    {
        ...
        private System.Collections.Generic.List<string> _weeklyFrequencyDays;

        /// <summary>Days of the week for weekly frequency</summary>
        [Commvault.Powershell.Origin(Commvault.Powershell.PropertyOrigin.Owned)]
        public System.Collections.Generic.List<string> WeeklyFrequencyDays { get => this._weeklyFrequencyDays; set => this._weeklyFrequencyDays = value; }
        ...
        Commvault.Powershell.Runtime.IJsonSerializable
    {
        ...
        PossibleTypes = new [] { typeof(string) })]
        System.Collections.Generic.List<string> WeeklyFrequencyDays { get; set; }
        /// <summary>Only available for incremental backup frequency</summary>
        [Commvault.Powershell.Runtime.Info(
        Required = false,
        ReadOnly = false,
