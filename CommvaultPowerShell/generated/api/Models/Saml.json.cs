...
namespace Commvault.Powershell.Models
{
    ...
    public partial class Saml
    {
        ...
        internal Saml(Commvault.Powershell.Runtime.Json.JsonObject json)
        {
            ...
            {_createdForCompany = If( json?.PropertyT<Commvault.Powershell.Runtime.Json.JsonObject>("createdForCompany"), out var __jsonCreatedForCompany) ? Commvault.Powershell.Models.IdName.FromJson(__jsonCreatedForCompany) : _createdForCompany;}
            {_identityProviderMetaData = If( json?.PropertyT<Commvault.Powershell.Runtime.Json.JsonObject>("identityProviderMetaData"), out var __jsonIdentityProviderMetaData) ? Commvault.Powershell.Models.SamlidpMetaDataResp.FromJson(__jsonIdentityProviderMetaData) : _identityProviderMetaData;}
            {_serviceProviderMetaData = If( json?.PropertyT<Commvault.Powershell.Runtime.Json.JsonObject>("serviceProviderMetaData"), out var __jsonServiceProviderMetaData) ? Commvault.Powershell.Models.SamlspMetaDataResp.FromJson(__jsonServiceProviderMetaData) : _serviceProviderMetaData;}
            ...
            {_appKey = If( json?.PropertyT<Commvault.Powershell.Runtime.Json.JsonString>("appKey"), out var __jsonAppKey) ? (string)__jsonAppKey : (string)_appKey;}
