...
namespace Commvault.Powershell.Models
{
    ...
    public partial class S3Compatible :
        Commvault.Powershell.Models.IS3Compatible,
        Commvault.Powershell.Models.IS3CompatibleInternal,
        Commvault.Powershell.Runtime.IValidates
    {
        ...
        private string _cloudType= @"S3 Compatible Storage";
        ...
        string Commvault.Powershell.Models.IS3CompatibleInternal.CloudType { get => this._cloudType; set { {_cloudType = value;} } }

        /// <summary>Internal Acessors for Credentials</summary>
        Commvault.Powershell.Models.IIdName Commvault.Powershell.Models.IS3CompatibleInternal.Credentials { get => (this._credentials = this._credentials ?? new Commvault.Powershell.Models.IdName()); set { {_credentials = value;} } }
        ...
        /// <summary>Creates an new <see cref="S3Compatible" /> instance.</summary>
        public S3Compatible()
        {
    ...
    /// S3 Compatible Storage
    internal partial interface IS3CompatibleInternal :
