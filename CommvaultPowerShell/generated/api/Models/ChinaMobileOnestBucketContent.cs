...
namespace Commvault.Powershell.Models
{
    ...
    public partial class ChinaMobileOnestBucketContent :
        Commvault.Powershell.Models.IChinaMobileOnestBucketContent,
        ...
        Commvault.Powershell.Runtime.IValidates
    {
        ...
        string Commvault.Powershell.Models.IChinaMobileOnestBucketContentInternal.CloudType { get => this._cloudType; set { {_cloudType = value;} } }

        /// <summary>Internal Acessors for Credentials</summary>
        Commvault.Powershell.Models.IIdName Commvault.Powershell.Models.IChinaMobileOnestBucketContentInternal.Credentials { get => (this._credentials = this._credentials ?? new Commvault.Powershell.Models.IdName()); set { {_credentials = value;} } }

        /// <summary>Internal Acessors for MediaAgent</summary>
        Commvault.Powershell.Models.IIdName Commvault.Powershell.Models.IChinaMobileOnestBucketContentInternal.MediaAgent { get => (this._mediaAgent = this._mediaAgent ?? new Commvault.Powershell.Models.IdName()); set { {_mediaAgent = value;} } }
        ...
        /// <summary>Creates an new <see cref="ChinaMobileOnestBucketContent" /> instance.</summary>
        public ChinaMobileOnestBucketContent()
        {
    ...
    /// China Mobile oNest
    internal partial interface IChinaMobileOnestBucketContentInternal :
