...
namespace Commvault.Powershell.Models
{
    ...
    public partial class LaptopsAdminConsole
    {
        ...
        internal LaptopsAdminConsole(Commvault.Powershell.Runtime.Json.JsonObject json)
        {
            ...
            {_sla = If( json?.PropertyT<Commvault.Powershell.Runtime.Json.JsonObject>("sla"), out var __jsonSla) ? Commvault.Powershell.Models.SlaDetails.FromJson(__jsonSla) : _sla;}
            ...
            {_lastSuccessfulBackup = If( json?.PropertyT<Commvault.Powershell.Runtime.Json.JsonNumber>("lastSuccessfulBackup"), out var __jsonLastSuccessfulBackup) ? (long?)__jsonLastSuccessfulBackup : _lastSuccessfulBackup;}
            {_tags = If( json?.PropertyT<Commvault.Powershell.Runtime.Json.JsonArray>("tags"), out var __jsonTags) ? If( __jsonTags as Commvault.Powershell.Runtime.Json.JsonArray, out var __q) ? new global::System.Func<System.Collections.Generic.List<Commvault.Powershell.Models.IIdNameType>>(()=> global::System.Linq.Enumerable.ToList(global::System.Linq.Enumerable.Select(__q, (__p)=>(Commvault.Powershell.Models.IIdNameType) (Commvault.Powershell.Models.IdNameType.FromJson(__p) )) ))() : null : _tags;}
            AfterFromJson(json);
        }
