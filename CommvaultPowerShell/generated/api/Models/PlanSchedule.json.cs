...
namespace Commvault.Powershell.Models
{
    ...
    public partial class PlanSchedule
    {
        ...
        internal PlanSchedule(Commvault.Powershell.Runtime.Json.JsonObject json)
        {
            ...
            {_schedulePattern = If( json?.PropertyT<Commvault.Powershell.Runtime.Json.JsonObject>("schedulePattern"), out var __jsonSchedulePattern) ? Commvault.Powershell.Models.SchedulePattern.FromJson(__jsonSchedulePattern) : _schedulePattern;}
            {_scheduleOption = If( json?.PropertyT<Commvault.Powershell.Runtime.Json.JsonObject>("scheduleOption"), out var __jsonScheduleOption) ? Commvault.Powershell.Models.ScheduleOption.FromJson(__jsonScheduleOption) : _scheduleOption;}
            ...
            {_scheduleName = If( json?.PropertyT<Commvault.Powershell.Runtime.Json.JsonString>("scheduleName"), out var __jsonScheduleName) ? (string)__jsonScheduleName : (string)_scheduleName;}
            {_policyId = If( json?.PropertyT<Commvault.Powershell.Runtime.Json.JsonNumber>("policyId"), out var __jsonPolicyId) ? (long?)__jsonPolicyId : _policyId;}
            {_scheduleOperation = If( json?.PropertyT<Commvault.Powershell.Runtime.Json.JsonString>("scheduleOperation"), out var __jsonScheduleOperation) ? (string)__jsonScheduleOperation : (string)_scheduleOperation;}
            {_vMOperationType = If( json?.PropertyT<Commvault.Powershell.Runtime.Json.JsonString>("vmOperationType"), out var __jsonVMOperationType) ? (string)__jsonVMOperationType : (string)_vMOperationType;}
            {_backupType = If( json?.PropertyT<Commvault.Powershell.Runtime.Json.JsonString>("backupType"), out var __jsonBackupType) ? (string)__jsonBackupType : (string)_backupType;}
            {_forDatabasesOnly = If( json?.PropertyT<Commvault.Powershell.Runtime.Json.JsonBoolean>("forDatabasesOnly"), out var __jsonForDatabasesOnly) ? (bool?)__jsonForDatabasesOnly : _forDatabasesOnly;}
            {_isRetentionBasedSyntheticFull = If( json?.PropertyT<Commvault.Powershell.Runtime.Json.JsonBoolean>("isRetentionBasedSyntheticFull"), out var __jsonIsRetentionBasedSyntheticFull) ? (bool?)__jsonIsRetentionBasedSyntheticFull : _isRetentionBasedSyntheticFull;}
            {_additionalInfo = If( json?.PropertyT<Commvault.Powershell.Runtime.Json.JsonString>("additionalInfo"), out var __jsonAdditionalInfo) ? (string)__jsonAdditionalInfo : (string)_additionalInfo;}
            AfterFromJson(json);
        }
        ...
        public Commvault.Powershell.Runtime.Json.JsonNode ToJson(Commvault.Powershell.Runtime.Json.JsonObject container, Commvault.Powershell.Runtime.SerializationMode serializationMode)
        {
            ...
            AddIf( null != (((object)this._additionalInfo)?.ToString()) ? (Commvault.Powershell.Runtime.Json.JsonNode) new Commvault.Powershell.Runtime.Json.JsonString(this._additionalInfo.ToString()) : null, "additionalInfo" ,container.Add );
