...
namespace Commvault.Powershell.Models
{
    ...
    public partial class OverrideReplicationOptionsAmazon
    {
        ...
        internal OverrideReplicationOptionsAmazon(Commvault.Powershell.Runtime.Json.JsonObject json)
        {
            ...
            {_guestCreds = If( json?.PropertyT<Commvault.Powershell.Runtime.Json.JsonObject>("guestCreds"), out var __jsonGuestCreds) ? Commvault.Powershell.Models.GuestCredentialsCreate.FromJson(__jsonGuestCreds) : _guestCreds;}
            {_network = If( json?.PropertyT<Commvault.Powershell.Runtime.Json.JsonObject>("network"), out var __jsonNetwork) ? Commvault.Powershell.Models.AmazonNetwork.FromJson(__jsonNetwork) : _network;}
            {_testFailoverNetwork = If( json?.PropertyT<Commvault.Powershell.Runtime.Json.JsonObject>("testFailoverNetwork"), out var __jsonTestFailoverNetwork) ? Commvault.Powershell.Models.AmazonNetwork.FromJson(__jsonTestFailoverNetwork) : _testFailoverNetwork;}
            ...
            {_computerName = If( json?.PropertyT<Commvault.Powershell.Runtime.Json.JsonString>("computerName"), out var __jsonComputerName) ? (string)__jsonComputerName : (string)_computerName;}
