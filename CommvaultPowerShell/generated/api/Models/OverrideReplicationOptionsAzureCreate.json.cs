...
namespace Commvault.Powershell.Models
{
    ...
    public partial class OverrideReplicationOptionsAzureCreate
    {
        ...
        internal OverrideReplicationOptionsAzureCreate(Commvault.Powershell.Runtime.Json.JsonObject json)
        {
            ...
            {_vMDisplayName = If( json?.PropertyT<Commvault.Powershell.Runtime.Json.JsonString>("vmDisplayName"), out var __jsonVMDisplayName) ? (string)__jsonVMDisplayName : (string)_vMDisplayName;}
            {_resourceGroup = If( json?.PropertyT<Commvault.Powershell.Runtime.Json.JsonString>("resourceGroup"), out var __jsonResourceGroup) ? (string)__jsonResourceGroup : (string)_resourceGroup;}
            {_region = If( json?.PropertyT<Commvault.Powershell.Runtime.Json.JsonString>("region"), out var __jsonRegion) ? (string)__jsonRegion : (string)_region;}
            {_storageAccount = If( json?.PropertyT<Commvault.Powershell.Runtime.Json.JsonString>("storageAccount"), out var __jsonStorageAccount) ? (string)__jsonStorageAccount : (string)_storageAccount;}
            {_vMSizeId = If( json?.PropertyT<Commvault.Powershell.Runtime.Json.JsonString>("vmSizeId"), out var __jsonVMSizeId) ? (string)__jsonVMSizeId : (string)_vMSizeId;}
            {_diskTypeId = If( json?.PropertyT<Commvault.Powershell.Runtime.Json.JsonString>("diskTypeId"), out var __jsonDiskTypeId) ? (string)__jsonDiskTypeId : (string)_diskTypeId;}
            {_virtualNetwork = If( json?.PropertyT<Commvault.Powershell.Runtime.Json.JsonArray>("virtualNetwork"), out var __jsonVirtualNetwork) ? If( __jsonVirtualNetwork as Commvault.Powershell.Runtime.Json.JsonArray, out var __v) ? new global::System.Func<System.Collections.Generic.List<Commvault.Powershell.Models.INetworkSubnet>>(()=> global::System.Linq.Enumerable.ToList(global::System.Linq.Enumerable.Select(__v, (__u)=>(Commvault.Powershell.Models.INetworkSubnet) (Commvault.Powershell.Models.NetworkSubnet.FromJson(__u) )) ))() : null : _virtualNetwork;}
            {_createPublicIP = If( json?.PropertyT<Commvault.Powershell.Runtime.Json.JsonBoolean>("createPublicIP"), out var __jsonCreatePublicIP) ? (bool?)__jsonCreatePublicIP : _createPublicIP;}
            {_restoreAsManagedVM = If( json?.PropertyT<Commvault.Powershell.Runtime.Json.JsonBoolean>("restoreAsManagedVM"), out var __jsonRestoreAsManagedVM) ? (bool?)__jsonRestoreAsManagedVM : _restoreAsManagedVM;}
            {_privateIPaddress = If( json?.PropertyT<Commvault.Powershell.Runtime.Json.JsonString>("privateIPaddress"), out var __jsonPrivateIPaddress) ? (string)__jsonPrivateIPaddress : (string)_privateIPaddress;}
            {_publicIPaddress = If( json?.PropertyT<Commvault.Powershell.Runtime.Json.JsonString>("publicIPaddress"), out var __jsonPublicIPaddress) ? (string)__jsonPublicIPaddress : (string)_publicIPaddress;}
            {_publicIPaddressId = If( json?.PropertyT<Commvault.Powershell.Runtime.Json.JsonString>("publicIPaddressID"), out var __jsonPublicIPaddressId) ? (string)__jsonPublicIPaddressId : (string)_publicIPaddressId;}
            AfterFromJson(json);
        }
        ...
        public Commvault.Powershell.Runtime.Json.JsonNode ToJson(Commvault.Powershell.Runtime.Json.JsonObject container, Commvault.Powershell.Runtime.SerializationMode serializationMode)
        {
            ...
            AddIf( null != (((object)this._privateIPaddress)?.ToString()) ? (Commvault.Powershell.Runtime.Json.JsonNode) new Commvault.Powershell.Runtime.Json.JsonString(this._privateIPaddress.ToString()) : null, "privateIPaddress" ,container.Add );
            AddIf( null != (((object)this._publicIPaddress)?.ToString()) ? (Commvault.Powershell.Runtime.Json.JsonNode) new Commvault.Powershell.Runtime.Json.JsonString(this._publicIPaddress.ToString()) : null, "publicIPaddress" ,container.Add );
            AddIf( null != (((object)this._publicIPaddressId)?.ToString()) ? (Commvault.Powershell.Runtime.Json.JsonNode) new Commvault.Powershell.Runtime.Json.JsonString(this._publicIPaddressId.ToString()) : null, "publicIPaddressID" ,container.Add );
