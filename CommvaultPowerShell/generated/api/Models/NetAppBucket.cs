...
namespace Commvault.Powershell.Models
{
    ...
    public partial class NetAppBucket :
        Commvault.Powershell.Models.INetAppBucket,
        Commvault.Powershell.Models.INetAppBucketInternal,
        Commvault.Powershell.Runtime.IValidates
    {
        ...
        string Commvault.Powershell.Models.INetAppBucketInternal.CloudType { get => this._cloudType; set { {_cloudType = value;} } }

        /// <summary>Internal Acessors for Credentials</summary>
        Commvault.Powershell.Models.IIdName Commvault.Powershell.Models.INetAppBucketInternal.Credentials { get => (this._credentials = this._credentials ?? new Commvault.Powershell.Models.IdName()); set { {_credentials = value;} } }

        /// <summary>Internal Acessors for MediaAgent</summary>
        Commvault.Powershell.Models.IIdName Commvault.Powershell.Models.INetAppBucketInternal.MediaAgent { get => (this._mediaAgent = this._mediaAgent ?? new Commvault.Powershell.Models.IdName()); set { {_mediaAgent = value;} } }
        ...
        /// <summary>Creates an new <see cref="NetAppBucket" /> instance.</summary>
        public NetAppBucket()
        {
    ...
    /// NetApp StorageGRID
    internal partial interface INetAppBucketInternal :
