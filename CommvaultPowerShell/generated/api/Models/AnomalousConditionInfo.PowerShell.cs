...
namespace Commvault.Powershell.Models
{
    ...
    public partial class AnomalousConditionInfo
    {
        ...
        internal AnomalousConditionInfo(global::System.Collections.IDictionary content)
        {
            ...
            if (content.Contains("AnomalyType"))
            {
            ...
            if (content.Contains("ClientInfoId"))
            {
            ...
            if (content.Contains("ClientInfoName"))
            {
        ...
        /// <returns>an instance of the <see cref="AnomalousConditionInfo" /> model class.</returns>
