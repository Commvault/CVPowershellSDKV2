...
namespace Commvault.Powershell.Models
{
        ...
        Commvault.Powershell.Models.ICredentialSecurityInternal
    {
        ...
        private System.Collections.Generic.List<Commvault.Powershell.Models.ICredentialSecurityAssociations> _associations;

        [Commvault.Powershell.Origin(Commvault.Powershell.PropertyOrigin.Owned)]
        public System.Collections.Generic.List<Commvault.Powershell.Models.ICredentialSecurityAssociations> Associations { get => this._associations; set => this._associations = value; }

        /// <summary>Internal Acessors for Owner</summary>
        Commvault.Powershell.Models.ICredentialOwner Commvault.Powershell.Models.ICredentialSecurityInternal.Owner { get => (this._owner = this._owner ?? new Commvault.Powershell.Models.CredentialOwner()); set { {_owner = value;} } }

        /// <summary>Internal Acessors for OwnerUser</summary>
        Commvault.Powershell.Models.IIdName Commvault.Powershell.Models.ICredentialSecurityInternal.OwnerUser { get => ((Commvault.Powershell.Models.ICredentialOwnerInternal)Owner).User; set => ((Commvault.Powershell.Models.ICredentialOwnerInternal)Owner).User = value; }

        /// <summary>Internal Acessors for OwnerUserGroup</summary>
        Commvault.Powershell.Models.IIdName Commvault.Powershell.Models.ICredentialSecurityInternal.OwnerUserGroup { get => ((Commvault.Powershell.Models.ICredentialOwnerInternal)Owner).UserGroup; set => ((Commvault.Powershell.Models.ICredentialOwnerInternal)Owner).UserGroup = value; }
        ...
        /// <summary>Creates an new <see cref="CredentialSecurity" /> instance.</summary>
        public CredentialSecurity()
        {
        ...
        Commvault.Powershell.Runtime.IJsonSerializable
    {
        ...
        System.Collections.Generic.List<Commvault.Powershell.Models.ICredentialSecurityAssociations> Associations { get; set; }
    ...
    /// Security association of a list of users and user groups
    internal partial interface ICredentialSecurityInternal
