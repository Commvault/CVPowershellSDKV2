...
namespace Commvault.Powershell.Models
{
    ...
    public partial class HitachiContentCloudBucket :
        Commvault.Powershell.Models.IHitachiContentCloudBucket,
        Commvault.Powershell.Models.IHitachiContentCloudBucketInternal,
        Commvault.Powershell.Runtime.IValidates
    {
        ...
        string Commvault.Powershell.Models.IHitachiContentCloudBucketInternal.CloudType { get => this._cloudType; set { {_cloudType = value;} } }

        /// <summary>Internal Acessors for Credentials</summary>
        Commvault.Powershell.Models.IIdName Commvault.Powershell.Models.IHitachiContentCloudBucketInternal.Credentials { get => (this._credentials = this._credentials ?? new Commvault.Powershell.Models.IdName()); set { {_credentials = value;} } }

        /// <summary>Internal Acessors for MediaAgent</summary>
        Commvault.Powershell.Models.IIdName Commvault.Powershell.Models.IHitachiContentCloudBucketInternal.MediaAgent { get => (this._mediaAgent = this._mediaAgent ?? new Commvault.Powershell.Models.IdName()); set { {_mediaAgent = value;} } }
        ...
        /// <summary>Creates an new <see cref="HitachiContentCloudBucket" /> instance.</summary>
        public HitachiContentCloudBucket()
        {
    ...
    /// Hitachi Content Platform for Cloud Scale
    internal partial interface IHitachiContentCloudBucketInternal :
