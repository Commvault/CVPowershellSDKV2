...
namespace Commvault.Powershell.Models
{
    ...
    public partial class LaptopOwnerInfo
    {
        ...
        /// <summary>
        /// Deserializes a <see cref="Commvault.Powershell.Runtime.Json.JsonNode"/> into an instance of Commvault.Powershell.Models.ILaptopOwnerInfo.
        /// </summary>
        /// <param name="node">a <see cref="Commvault.Powershell.Runtime.Json.JsonNode" /> to deserialize from.</param>
        /// <returns>an instance of Commvault.Powershell.Models.ILaptopOwnerInfo.</returns>
        public static Commvault.Powershell.Models.ILaptopOwnerInfo FromJson(Commvault.Powershell.Runtime.Json.JsonNode node)
        {
            return node is Commvault.Powershell.Runtime.Json.JsonObject json ? new LaptopOwnerInfo(json) : null;
        }

        /// <summary>
        /// Deserializes a Commvault.Powershell.Runtime.Json.JsonObject into a new instance of <see cref="LaptopOwnerInfo" />.
        /// </summary>
        /// <param name="json">A Commvault.Powershell.Runtime.Json.JsonObject instance to deserialize from.</param>
        internal LaptopOwnerInfo(Commvault.Powershell.Runtime.Json.JsonObject json)
        {
            ...
            {_serialNumber = If( json?.PropertyT<Commvault.Powershell.Runtime.Json.JsonString>("serialNumber"), out var __jsonSerialNumber) ? (string)__jsonSerialNumber : (string)_serialNumber;}
            {_laptopName = If( json?.PropertyT<Commvault.Powershell.Runtime.Json.JsonString>("laptopName"), out var __jsonLaptopName) ? (string)__jsonLaptopName : (string)_laptopName;}
            ...
            {_ownerEmail = If( json?.PropertyT<Commvault.Powershell.Runtime.Json.JsonString>("ownerEmail"), out var __jsonOwnerEmail) ? (string)__jsonOwnerEmail : (string)_ownerEmail;}
            {_ownerUpn = If( json?.PropertyT<Commvault.Powershell.Runtime.Json.JsonString>("ownerUPN"), out var __jsonOwnerUpn) ? (string)__jsonOwnerUpn : (string)_ownerUpn;}
        ...
        /// <summary>
        /// Serializes this instance of <see cref="LaptopOwnerInfo" /> into a <see cref="Commvault.Powershell.Runtime.Json.JsonNode" />.
        /// </summary>
        /// <param name="container">The <see cref="Commvault.Powershell.Runtime.Json.JsonObject"/> container to serialize this object into. If the caller
        /// passes in <c>null</c>, a new instance will be created and returned to the caller.</param>
        /// <param name="serializationMode">Allows the caller to choose the depth of the serialization. See <see cref="Commvault.Powershell.Runtime.SerializationMode"/>.</param>
        /// <returns>
        /// a serialized instance of <see cref="LaptopOwnerInfo" /> as a <see cref="Commvault.Powershell.Runtime.Json.JsonNode" />.
        /// </returns>
