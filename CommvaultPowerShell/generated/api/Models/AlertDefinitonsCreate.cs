...
namespace Commvault.Powershell.Models
{
        ...
        Commvault.Powershell.Models.IAlertDefinitonsCreateInternal
    {
        ...
        /// <summary>Internal Acessors for AlertTypeNotificationCriteria</summary>
        Commvault.Powershell.Models.INotificationCriteriaOptions Commvault.Powershell.Models.IAlertDefinitonsCreateInternal.AlertTypeNotificationCriteria { get => ((Commvault.Powershell.Models.IAlertDefinitionsCreateAlertTypeInternal)AlertType).NotificationCriteria; set => ((Commvault.Powershell.Models.IAlertDefinitionsCreateAlertTypeInternal)AlertType).NotificationCriteria = value; }

        /// <summary>Internal Acessors for EventCriteriaDetails</summary>
        Commvault.Powershell.Models.IEventCriteriaDetails Commvault.Powershell.Models.IAlertDefinitonsCreateInternal.EventCriteriaDetails { get => (this._eventCriteriaDetails = this._eventCriteriaDetails ?? new Commvault.Powershell.Models.EventCriteriaDetails()); set { {_eventCriteriaDetails = value;} } }

        /// <summary>Internal Acessors for GlobalConfigInfo</summary>
        Commvault.Powershell.Models.ICreateGlobalConfigInfo Commvault.Powershell.Models.IAlertDefinitonsCreateInternal.GlobalConfigInfo { get => (this._globalConfigInfo = this._globalConfigInfo ?? new Commvault.Powershell.Models.CreateGlobalConfigInfo()); set { {_globalConfigInfo = value;} } }
        ...
        Commvault.Powershell.Models.IWorkflowEntity Commvault.Powershell.Models.IAlertDefinitonsCreateInternal.TemplateWorkflow { get => ((Commvault.Powershell.Models.IAlertDefinitionsTemplateInternal)Templates).Workflow; set => ((Commvault.Powershell.Models.IAlertDefinitionsTemplateInternal)Templates).Workflow = value; }
        ...
        /// </summary>
        [Commvault.Powershell.Origin(Commvault.Powershell.PropertyOrigin.Inlined)]
        public long? NotificationCriterionDelayTime { get => ((Commvault.Powershell.Models.IAlertDefinitionsCreateAlertTypeInternal)AlertType).NotificationCriterionDelayTime; set => ((Commvault.Powershell.Models.IAlertDefinitionsCreateAlertTypeInternal)AlertType).NotificationCriterionDelayTime = value ?? default(long); }

        /// <summary>
        /// Persisting time in seconds when the notification criteria value contains repeated flag
        /// </summary>
        [Commvault.Powershell.Origin(Commvault.Powershell.PropertyOrigin.Inlined)]
        public long? NotificationCriterionPersistTime { get => ((Commvault.Powershell.Models.IAlertDefinitionsCreateAlertTypeInternal)AlertType).NotificationCriterionPersistTime; set => ((Commvault.Powershell.Models.IAlertDefinitionsCreateAlertTypeInternal)AlertType).NotificationCriterionPersistTime = value ?? default(long); }

        /// <summary>
        /// Bit flag indicating notification criteria value. 1 means immediate, 2 means repeated and 8 means delayed
        /// </summary>
        [Commvault.Powershell.Origin(Commvault.Powershell.PropertyOrigin.Inlined)]
        public long? NotificationCriterionValue { get => ((Commvault.Powershell.Models.IAlertDefinitionsCreateAlertTypeInternal)AlertType).NotificationCriterionValue; set => ((Commvault.Powershell.Models.IAlertDefinitionsCreateAlertTypeInternal)AlertType).NotificationCriterionValue = value ?? default(long); }
        ...
        Commvault.Powershell.Runtime.IJsonSerializable
    {
        ...
        System.Collections.Generic.List<Commvault.Powershell.Models.IAlertDefinitionsCriteriaParams> AlertTypeParamsList { get; set; }
        /// <summary>AlertDefinitionsAssociations</summary>
        [Commvault.Powershell.Runtime.Info(
        Required = false,
        ReadOnly = false,
...

    {
        ...
        Commvault.Powershell.Models.INotificationCriteriaOptions AlertTypeNotificationCriteria { get; set; }
