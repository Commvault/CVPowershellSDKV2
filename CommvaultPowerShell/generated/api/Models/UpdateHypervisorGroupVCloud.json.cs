...
namespace Commvault.Powershell.Models
{
    ...
    public partial class UpdateHypervisorGroupVCloud
    {
        ...
        /// <summary>
        /// Deserializes a <see cref="Commvault.Powershell.Runtime.Json.JsonNode"/> into an instance of Commvault.Powershell.Models.IUpdateHypervisorGroupVCloud.
        /// </summary>
        /// <param name="node">a <see cref="Commvault.Powershell.Runtime.Json.JsonNode" /> to deserialize from.</param>
        /// <returns>an instance of Commvault.Powershell.Models.IUpdateHypervisorGroupVCloud.</returns>
        public static Commvault.Powershell.Models.IUpdateHypervisorGroupVCloud FromJson(Commvault.Powershell.Runtime.Json.JsonNode node)
        {
            return node is Commvault.Powershell.Runtime.Json.JsonObject json ? new UpdateHypervisorGroupVCloud(json) : null;
        }

        /// <summary>
        /// Serializes this instance of <see cref="UpdateHypervisorGroupVCloud" /> into a <see cref="Commvault.Powershell.Runtime.Json.JsonNode" />.
        /// </summary>
        /// <param name="container">The <see cref="Commvault.Powershell.Runtime.Json.JsonObject"/> container to serialize this object into. If the caller
        /// passes in <c>null</c>, a new instance will be created and returned to the caller.</param>
        /// <param name="serializationMode">Allows the caller to choose the depth of the serialization. See <see cref="Commvault.Powershell.Runtime.SerializationMode"/>.</param>
        /// <returns>
        /// a serialized instance of <see cref="UpdateHypervisorGroupVCloud" /> as a <see cref="Commvault.Powershell.Runtime.Json.JsonNode" />.
        /// </returns>
        public Commvault.Powershell.Runtime.Json.JsonNode ToJson(Commvault.Powershell.Runtime.Json.JsonObject container, Commvault.Powershell.Runtime.SerializationMode serializationMode)
        {
            ...
            AddIf( null != (((object)this._vcenterHostName)?.ToString()) ? (Commvault.Powershell.Runtime.Json.JsonNode) new Commvault.Powershell.Runtime.Json.JsonString(this._vcenterHostName.ToString()) : null, "vcenterHostName" ,container.Add );
            AddIf( null != (((object)this._vcenterUserName)?.ToString()) ? (Commvault.Powershell.Runtime.Json.JsonNode) new Commvault.Powershell.Runtime.Json.JsonString(this._vcenterUserName.ToString()) : null, "vcenterUserName" ,container.Add );
            AddIf( null != (((object)this._vcenterPassword)?.ToString()) ? (Commvault.Powershell.Runtime.Json.JsonNode) new Commvault.Powershell.Runtime.Json.JsonString(this._vcenterPassword.ToString()) : null, "vcenterPassword" ,container.Add );
        ...
        /// <summary>
        /// Deserializes a Commvault.Powershell.Runtime.Json.JsonObject into a new instance of <see cref="UpdateHypervisorGroupVCloud" />.
        /// </summary>
        /// <param name="json">A Commvault.Powershell.Runtime.Json.JsonObject instance to deserialize from.</param>
        internal UpdateHypervisorGroupVCloud(Commvault.Powershell.Runtime.Json.JsonObject json)
        {
            bool returnNow = false;
            ...
            {_vcenterHostName = If( json?.PropertyT<Commvault.Powershell.Runtime.Json.JsonString>("vcenterHostName"), out var __jsonVcenterHostName) ? (string)__jsonVcenterHostName : (string)_vcenterHostName;}
            {_vcenterUserName = If( json?.PropertyT<Commvault.Powershell.Runtime.Json.JsonString>("vcenterUserName"), out var __jsonVcenterUserName) ? (string)__jsonVcenterUserName : (string)_vcenterUserName;}
            {_vcenterPassword = If( json?.PropertyT<Commvault.Powershell.Runtime.Json.JsonString>("vcenterPassword"), out var __jsonVcenterPassword) ? (string)__jsonVcenterPassword : (string)_vcenterPassword;}
