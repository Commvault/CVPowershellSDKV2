...
namespace Commvault.Powershell.Models
{
        ...
        Commvault.Powershell.Models.IOverrideReplicationOptionsVMWareCreateInternal
    {
        ...
        private System.Collections.Generic.List<Commvault.Powershell.Models.IIPAddressSettingVmwareCreate> _iPAddressSettings;

        /// <summary>
        /// A mapping of IP between the source and the destination VM with an option to configure either a dynamic or a static IP.
        /// </summary>
        [Commvault.Powershell.Origin(Commvault.Powershell.PropertyOrigin.Owned)]
        public System.Collections.Generic.List<Commvault.Powershell.Models.IIPAddressSettingVmwareCreate> IPAddressSettings { get => this._iPAddressSettings; set => this._iPAddressSettings = value; }

        /// <summary>Backing field for <see cref="NetworkSettings" /> property.</summary>
        private System.Collections.Generic.List<Commvault.Powershell.Models.INetworkSetting> _networkSettings;

        /// <summary>Mapping between a source network and a destination network</summary>
        [Commvault.Powershell.Origin(Commvault.Powershell.PropertyOrigin.Owned)]
        public System.Collections.Generic.List<Commvault.Powershell.Models.INetworkSetting> NetworkSettings { get => this._networkSettings; set => this._networkSettings = value; }
        ...
        Commvault.Powershell.Runtime.IJsonSerializable
    {
        ...
        System.Collections.Generic.List<Commvault.Powershell.Models.IIPAddressSettingVmwareCreate> IPAddressSettings { get; set; }
        /// <summary>Mapping between a source network and a destination network</summary>
        [Commvault.Powershell.Runtime.Info(
        Required = false,
        ReadOnly = false,
        ...
        System.Collections.Generic.List<Commvault.Powershell.Models.INetworkSetting> NetworkSettings { get; set; }
        /// <summary>The resource pool that will be used on the destination VM</summary>
        [Commvault.Powershell.Runtime.Info(
        Required = true,
        ReadOnly = false,
