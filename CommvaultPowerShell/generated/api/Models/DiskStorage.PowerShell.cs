...
namespace Commvault.Powershell.Models
{
    ...
    public partial class DiskStorage
    {
        ...
        internal DiskStorage(global::System.Collections.IDictionary content)
        {
            ...
            {
                ((Commvault.Powershell.Models.IDiskStorageInternal)this).EncryptionKeyManagementServer = (Commvault.Powershell.Models.IIdName) content.GetValueForProperty("EncryptionKeyManagementServer",((Commvault.Powershell.Models.IDiskStorageInternal)this).EncryptionKeyManagementServer, Commvault.Powershell.Models.IdNameTypeConverter.ConvertFrom);
            }
            ...
            if (content.Contains("SecurityExternalUserGroup"))
            {
            ...
            if (content.Contains("SecurityIsCreatorAssociation"))
            {
            ...
            if (content.Contains("SecurityPermissionList"))
            {
            ...
            {
                ((Commvault.Powershell.Models.IDiskStorageInternal)this).KeyManagementServerId = (long?) content.GetValueForProperty("KeyManagementServerId",((Commvault.Powershell.Models.IDiskStorageInternal)this).KeyManagementServerId, (__y)=> (long) global::System.Convert.ChangeType(__y, typeof(long)));
            }
            if (content.Contains("KeyManagementServerName"))
            {
                ((Commvault.Powershell.Models.IDiskStorageInternal)this).KeyManagementServerName = (string) content.GetValueForProperty("KeyManagementServerName",((Commvault.Powershell.Models.IDiskStorageInternal)this).KeyManagementServerName, global::System.Convert.ToString);
            }
