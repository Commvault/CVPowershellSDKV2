...
namespace Commvault.Powershell.Models
{
        ...
        Commvault.Powershell.Models.IUpdateRoleInternal
    {
        ...
        private System.Collections.Generic.List<Commvault.Powershell.Models.IPermissions> _permissionList;

        /// <summary>Used to update the list of permissions associated with the role.</summary>
        [Commvault.Powershell.Origin(Commvault.Powershell.PropertyOrigin.Owned)]
        public System.Collections.Generic.List<Commvault.Powershell.Models.IPermissions> PermissionList { get => this._permissionList; set => this._permissionList = value; }
        ...
        Commvault.Powershell.Runtime.IJsonSerializable
    {
        ...
        System.Collections.Generic.List<Commvault.Powershell.Models.IPermissions> PermissionList { get; set; }
        /// <summary>Type of operation to be performed on the permissionList. Default is OVERWRITE.</summary>
        [Commvault.Powershell.Runtime.Info(
        Required = false,
        ReadOnly = false,
