...
namespace Commvault.Powershell.Models
{
    ...
    public partial class Fujitsu :
        Commvault.Powershell.Models.IFujitsu,
        Commvault.Powershell.Models.IFujitsuInternal,
        Commvault.Powershell.Runtime.IValidates
    {
        ...
        private string _cloudType= @"Fujitsu Storage ETERNUS CD10000";
        ...
        string Commvault.Powershell.Models.IFujitsuInternal.CloudType { get => this._cloudType; set { {_cloudType = value;} } }

        /// <summary>Internal Acessors for Credentials</summary>
        Commvault.Powershell.Models.IIdName Commvault.Powershell.Models.IFujitsuInternal.Credentials { get => (this._credentials = this._credentials ?? new Commvault.Powershell.Models.IdName()); set { {_credentials = value;} } }
        ...
        /// <summary>Creates an new <see cref="Fujitsu" /> instance.</summary>
        public Fujitsu()
        {
    ...
    /// Fujitsu Storage ETERNUS CD10000
    internal partial interface IFujitsuInternal :
