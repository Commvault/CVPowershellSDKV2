...
namespace Commvault.Powershell.Models
{
    ...
    public partial class CloudianHyperStoreBucketContent :
        Commvault.Powershell.Models.ICloudianHyperStoreBucketContent,
        ...
        Commvault.Powershell.Runtime.IValidates
    {
        ...
        string Commvault.Powershell.Models.ICloudianHyperStoreBucketContentInternal.CloudType { get => this._cloudType; set { {_cloudType = value;} } }

        /// <summary>Internal Acessors for Credentials</summary>
        Commvault.Powershell.Models.IIdName Commvault.Powershell.Models.ICloudianHyperStoreBucketContentInternal.Credentials { get => (this._credentials = this._credentials ?? new Commvault.Powershell.Models.IdName()); set { {_credentials = value;} } }

        /// <summary>Internal Acessors for MediaAgent</summary>
        Commvault.Powershell.Models.IIdName Commvault.Powershell.Models.ICloudianHyperStoreBucketContentInternal.MediaAgent { get => (this._mediaAgent = this._mediaAgent ?? new Commvault.Powershell.Models.IdName()); set { {_mediaAgent = value;} } }
        ...
        /// <summary>Creates an new <see cref="CloudianHyperStoreBucketContent" /> instance.</summary>
        public CloudianHyperStoreBucketContent()
        {
    ...
    /// Cloudian HyperStore
    internal partial interface ICloudianHyperStoreBucketContentInternal :
