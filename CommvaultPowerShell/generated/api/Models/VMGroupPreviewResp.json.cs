...
namespace Commvault.Powershell.Models
{
    ...
    public partial class VMGroupPreviewResp
    {
        ...
        internal VMGroupPreviewResp(Commvault.Powershell.Runtime.Json.JsonObject json)
        {
            ...
            {_vMList = If( json?.PropertyT<Commvault.Powershell.Runtime.Json.JsonObject>("vmList"), out var __jsonVMList) ? Commvault.Powershell.Models.VMPreviewInfo.FromJson(__jsonVMList) : _vMList;}
            {_protectedVMCount = If( json?.PropertyT<Commvault.Powershell.Runtime.Json.JsonNumber>("ProtectedVMCount"), out var __jsonProtectedVMCount) ? (long?)__jsonProtectedVMCount : _protectedVMCount;}
            {_managementVersion = If( json?.PropertyT<Commvault.Powershell.Runtime.Json.JsonString>("managementVersion"), out var __jsonManagementVersion) ? (string)__jsonManagementVersion : (string)_managementVersion;}
            AfterFromJson(json);
        }
    }
}