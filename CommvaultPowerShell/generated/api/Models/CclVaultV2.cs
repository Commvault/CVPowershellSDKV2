...
namespace Commvault.Powershell.Models
{
    ...
    public partial class CclVaultV2 :
        Commvault.Powershell.Models.ICclVaultV2,
        Commvault.Powershell.Models.ICclVaultV2Internal,
        Commvault.Powershell.Runtime.IValidates
    {
        ...
        private string _cloudType= @"CCL Vault v2";
        ...
        string Commvault.Powershell.Models.ICclVaultV2Internal.CloudType { get => this._cloudType; set { {_cloudType = value;} } }

        /// <summary>Internal Acessors for Credentials</summary>
        Commvault.Powershell.Models.IIdName Commvault.Powershell.Models.ICclVaultV2Internal.Credentials { get => (this._credentials = this._credentials ?? new Commvault.Powershell.Models.IdName()); set { {_credentials = value;} } }
        ...
        /// <summary>Creates an new <see cref="CclVaultV2" /> instance.</summary>
        public CclVaultV2()
        {
    ...
    /// CCL Vault v2
    internal partial interface ICclVaultV2Internal :
