...
namespace Commvault.Powershell.Models
{
    ...
    public partial class IbmBucketContent :
        Commvault.Powershell.Models.IIbmBucketContent,
        Commvault.Powershell.Models.IIbmBucketContentInternal,
        Commvault.Powershell.Runtime.IValidates
    {
        ...
        string Commvault.Powershell.Models.IIbmBucketContentInternal.CloudType { get => this._cloudType; set { {_cloudType = value;} } }

        /// <summary>Internal Acessors for Credentials</summary>
        Commvault.Powershell.Models.IIdName Commvault.Powershell.Models.IIbmBucketContentInternal.Credentials { get => (this._credentials = this._credentials ?? new Commvault.Powershell.Models.IdName()); set { {_credentials = value;} } }

        /// <summary>Internal Acessors for MediaAgent</summary>
        Commvault.Powershell.Models.IIdName Commvault.Powershell.Models.IIbmBucketContentInternal.MediaAgent { get => (this._mediaAgent = this._mediaAgent ?? new Commvault.Powershell.Models.IdName()); set { {_mediaAgent = value;} } }
        ...
        /// <summary>Creates an new <see cref="IbmBucketContent" /> instance.</summary>
        public IbmBucketContent()
        {
    ...
    /// IBM Cloud Object Storage (S3-compatible)
    internal partial interface IIbmBucketContentInternal :
