...
namespace Commvault.Powershell.Models
{
    ...
    public partial class RackspaceBucketContent :
        Commvault.Powershell.Models.IRackspaceBucketContent,
        Commvault.Powershell.Models.IRackspaceBucketContentInternal,
        Commvault.Powershell.Runtime.IValidates
    {
        ...
        string Commvault.Powershell.Models.IRackspaceBucketContentInternal.CloudType { get => this._cloudType; set { {_cloudType = value;} } }

        /// <summary>Internal Acessors for Credentials</summary>
        Commvault.Powershell.Models.IIdName Commvault.Powershell.Models.IRackspaceBucketContentInternal.Credentials { get => (this._credentials = this._credentials ?? new Commvault.Powershell.Models.IdName()); set { {_credentials = value;} } }

        /// <summary>Internal Acessors for MediaAgent</summary>
        Commvault.Powershell.Models.IIdName Commvault.Powershell.Models.IRackspaceBucketContentInternal.MediaAgent { get => (this._mediaAgent = this._mediaAgent ?? new Commvault.Powershell.Models.IdName()); set { {_mediaAgent = value;} } }
        ...
        /// <summary>Creates an new <see cref="RackspaceBucketContent" /> instance.</summary>
        public RackspaceBucketContent()
        {
    ...
    /// Rackspace Cloud Files
    internal partial interface IRackspaceBucketContentInternal :
