...
namespace Commvault.Powershell.Models
{
    ...
    public partial class OpenStackBucket :
        Commvault.Powershell.Models.IOpenStackBucket,
        Commvault.Powershell.Models.IOpenStackBucketInternal,
        Commvault.Powershell.Runtime.IValidates
    {
        ...
        string Commvault.Powershell.Models.IOpenStackBucketInternal.CloudType { get => this._cloudType; set { {_cloudType = value;} } }

        /// <summary>Internal Acessors for Credentials</summary>
        Commvault.Powershell.Models.IIdName Commvault.Powershell.Models.IOpenStackBucketInternal.Credentials { get => (this._credentials = this._credentials ?? new Commvault.Powershell.Models.IdName()); set { {_credentials = value;} } }

        /// <summary>Internal Acessors for MediaAgent</summary>
        Commvault.Powershell.Models.IIdName Commvault.Powershell.Models.IOpenStackBucketInternal.MediaAgent { get => (this._mediaAgent = this._mediaAgent ?? new Commvault.Powershell.Models.IdName()); set { {_mediaAgent = value;} } }
        ...
        /// <summary>Creates an new <see cref="OpenStackBucket" /> instance.</summary>
        public OpenStackBucket()
        {
    ...
    /// OpenStack Object Storage
    internal partial interface IOpenStackBucketInternal :
