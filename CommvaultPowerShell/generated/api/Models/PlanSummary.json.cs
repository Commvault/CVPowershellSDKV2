...
namespace Commvault.Powershell.Models
{
    ...
    public partial class PlanSummary
    {
        ...
        internal PlanSummary(Commvault.Powershell.Runtime.Json.JsonObject json)
        {
            ...
            {_planType = If( json?.PropertyT<Commvault.Powershell.Runtime.Json.JsonString>("planType"), out var __jsonPlanType) ? (string)__jsonPlanType : (string)_planType;}
            {_targetApp = If( json?.PropertyT<Commvault.Powershell.Runtime.Json.JsonArray>("targetApp"), out var __jsonTargetApp) ? If( __jsonTargetApp as Commvault.Powershell.Runtime.Json.JsonArray, out var __v) ? new global::System.Func<System.Collections.Generic.List<string>>(()=> global::System.Linq.Enumerable.ToList(global::System.Linq.Enumerable.Select(__v, (__u)=>(string) (__u is Commvault.Powershell.Runtime.Json.JsonString __t ? (string)(__t.ToString()) : null)) ))() : null : _targetApp;}
            {_associatedEntities = If( json?.PropertyT<Commvault.Powershell.Runtime.Json.JsonNumber>("associatedEntities"), out var __jsonAssociatedEntities) ? (long?)__jsonAssociatedEntities : _associatedEntities;}
            {_rpo = If( json?.PropertyT<Commvault.Powershell.Runtime.Json.JsonNumber>("RPO"), out var __jsonRpo) ? (long?)__jsonRpo : _rpo;}
            {_numberOfCopies = If( json?.PropertyT<Commvault.Powershell.Runtime.Json.JsonNumber>("numberOfCopies"), out var __jsonNumberOfCopies) ? (long?)__jsonNumberOfCopies : _numberOfCopies;}
