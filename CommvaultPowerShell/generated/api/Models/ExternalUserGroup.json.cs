...
namespace Commvault.Powershell.Models
{
    ...
    public partial class ExternalUserGroup
    {
        ...
        internal ExternalUserGroup(Commvault.Powershell.Runtime.Json.JsonObject json)
        {
            ...
            {_providerId = If( json?.PropertyT<Commvault.Powershell.Runtime.Json.JsonNumber>("providerId"), out var __jsonProviderId) ? (long?)__jsonProviderId : _providerId;}
            {_providerName = If( json?.PropertyT<Commvault.Powershell.Runtime.Json.JsonString>("providerName"), out var __jsonProviderName) ? (string)__jsonProviderName : (string)_providerName;}
            AfterFromJson(json);
        }
