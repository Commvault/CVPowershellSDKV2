...
namespace Commvault.Powershell.Models
{
    ...
    public partial class RegionDetails
    {
        ...
        internal RegionDetails(Commvault.Powershell.Runtime.Json.JsonObject json)
        {
            ...
            {_associatedServers = If( json?.PropertyT<Commvault.Powershell.Runtime.Json.JsonObject>("associatedServers"), out var __jsonAssociatedServers) ? Commvault.Powershell.Models.RegionAssociatedServers.FromJson(__jsonAssociatedServers) : _associatedServers;}
            {_associatedRegionBasedPlans = If( json?.PropertyT<Commvault.Powershell.Runtime.Json.JsonObject>("associatedRegionBasedPlans"), out var __jsonAssociatedRegionBasedPlans) ? Commvault.Powershell.Models.AssociatedRegionBasedPlans.FromJson(__jsonAssociatedRegionBasedPlans) : _associatedRegionBasedPlans;}
            ...
            {_regionType = If( json?.PropertyT<Commvault.Powershell.Runtime.Json.JsonString>("regionType"), out var __jsonRegionType) ? (string)__jsonRegionType : (string)_regionType;}
            {_locations = If( json?.PropertyT<Commvault.Powershell.Runtime.Json.JsonArray>("locations"), out var __jsonLocations) ? If( __jsonLocations as Commvault.Powershell.Runtime.Json.JsonArray, out var __v) ? new global::System.Func<System.Collections.Generic.List<Commvault.Powershell.Models.ILocationDetailsWithZone>>(()=> global::System.Linq.Enumerable.ToList(global::System.Linq.Enumerable.Select(__v, (__u)=>(Commvault.Powershell.Models.ILocationDetailsWithZone) (Commvault.Powershell.Models.LocationDetailsWithZone.FromJson(__u) )) ))() : null : _locations;}
            AfterFromJson(json);
        }
