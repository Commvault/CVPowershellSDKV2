...
namespace Commvault.Powershell.Models
{
    ...
    public partial class LicenseInfo
    {
        ...
        internal LicenseInfo(Commvault.Powershell.Runtime.Json.JsonObject json)
        {
            ...
            {_commCellId = If( json?.PropertyT<Commvault.Powershell.Runtime.Json.JsonNumber>("commCellId"), out var __jsonCommCellId) ? (long?)__jsonCommCellId : _commCellId;}
            {_commServeIPAddress = If( json?.PropertyT<Commvault.Powershell.Runtime.Json.JsonString>("commServeIPAddress"), out var __jsonCommServeIPAddress) ? (string)__jsonCommServeIPAddress : (string)_commServeIPAddress;}
            {_licenseIPAddress = If( json?.PropertyT<Commvault.Powershell.Runtime.Json.JsonString>("licenseIPAddress"), out var __jsonLicenseIPAddress) ? (string)__jsonLicenseIPAddress : (string)_licenseIPAddress;}
            {_edition = If( json?.PropertyT<Commvault.Powershell.Runtime.Json.JsonString>("edition"), out var __jsonEdition) ? (string)__jsonEdition : (string)_edition;}
            {_licenseMode = If( json?.PropertyT<Commvault.Powershell.Runtime.Json.JsonString>("licenseMode"), out var __jsonLicenseMode) ? (string)__jsonLicenseMode : (string)_licenseMode;}
            ...
            {_registrationCode = If( json?.PropertyT<Commvault.Powershell.Runtime.Json.JsonString>("registrationCode"), out var __jsonRegistrationCode) ? (string)__jsonRegistrationCode : (string)_registrationCode;}
            {_expiryDate = If( json?.PropertyT<Commvault.Powershell.Runtime.Json.JsonNumber>("expiryDate"), out var __jsonExpiryDate) ? (long?)__jsonExpiryDate : _expiryDate;}
            AfterFromJson(json);
        }
