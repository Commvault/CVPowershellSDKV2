...
namespace Commvault.Powershell.Models
{
    ...
    public partial class NutanixBucketContent :
        Commvault.Powershell.Models.INutanixBucketContent,
        Commvault.Powershell.Models.INutanixBucketContentInternal,
        Commvault.Powershell.Runtime.IValidates
    {
        ...
        string Commvault.Powershell.Models.INutanixBucketContentInternal.CloudType { get => this._cloudType; set { {_cloudType = value;} } }

        /// <summary>Internal Acessors for Credentials</summary>
        Commvault.Powershell.Models.IIdName Commvault.Powershell.Models.INutanixBucketContentInternal.Credentials { get => (this._credentials = this._credentials ?? new Commvault.Powershell.Models.IdName()); set { {_credentials = value;} } }

        /// <summary>Internal Acessors for MediaAgent</summary>
        Commvault.Powershell.Models.IIdName Commvault.Powershell.Models.INutanixBucketContentInternal.MediaAgent { get => (this._mediaAgent = this._mediaAgent ?? new Commvault.Powershell.Models.IdName()); set { {_mediaAgent = value;} } }
        ...
        /// <summary>Creates an new <see cref="NutanixBucketContent" /> instance.</summary>
        public NutanixBucketContent()
        {
    ...
    /// Nutanix Objects
    internal partial interface INutanixBucketContentInternal :
