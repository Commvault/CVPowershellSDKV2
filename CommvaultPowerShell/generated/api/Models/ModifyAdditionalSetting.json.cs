...
namespace Commvault.Powershell.Models
{
    ...
    public partial class ModifyAdditionalSetting
    {
        ...
        internal ModifyAdditionalSetting(Commvault.Powershell.Runtime.Json.JsonObject json)
        {
            ...
            {_newValue = If( json?.PropertyT<Commvault.Powershell.Runtime.Json.JsonString>("newValue"), out var __jsonNewValue) ? (string)__jsonNewValue : (string)_newValue;}
            ...
            {_reset = If( json?.PropertyT<Commvault.Powershell.Runtime.Json.JsonBoolean>("reset"), out var __jsonReset) ? (bool?)__jsonReset : _reset;}
            AfterFromJson(json);
        }
