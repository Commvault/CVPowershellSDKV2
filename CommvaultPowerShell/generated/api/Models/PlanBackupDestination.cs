...
namespace Commvault.Powershell.Models
{
        ...
        Commvault.Powershell.Models.IPlanBackupDestinationInternal
    {
        ...
        /// <summary>Internal Acessors for StoragePoolDeviceType</summary>
        Commvault.Powershell.Models.IDeviceType Commvault.Powershell.Models.IPlanBackupDestinationInternal.StoragePoolDeviceType { get => ((Commvault.Powershell.Models.IStoragePoolInternal)StoragePool).DeviceType; set => ((Commvault.Powershell.Models.IStoragePoolInternal)StoragePool).DeviceType = value; }
        ...
        public long? DeviceTypeId { get => ((Commvault.Powershell.Models.IStoragePoolInternal)StoragePool).DeviceTypeId; set => ((Commvault.Powershell.Models.IStoragePoolInternal)StoragePool).DeviceTypeId = value ?? default(long); }

        /// <summary>Device type of the storage.</summary>
        [Commvault.Powershell.Origin(Commvault.Powershell.PropertyOrigin.Inlined)]
        public string DeviceTypeName { get => ((Commvault.Powershell.Models.IStoragePoolInternal)StoragePool).DeviceTypeName; set => ((Commvault.Powershell.Models.IStoragePoolInternal)StoragePool).DeviceTypeName = value ?? null; }
        ...
        /// <summary>Backing field for <see cref="IsAirgapCopy" /> property.</summary>
        private bool? _isAirgapCopy;

        /// <summary>Set to true if this copy uses Airgap storage</summary>
        [Commvault.Powershell.Origin(Commvault.Powershell.PropertyOrigin.Owned)]
        public bool? IsAirgapCopy { get => this._isAirgapCopy; set => this._isAirgapCopy = value; }
        ...
        /// <summary>Backing field for <see cref="IsCopyInMaintenanceMode" /> property.</summary>
        private bool? _isCopyInMaintenanceMode;

        /// <summary>Is this copy in Maintenance mode?</summary>
        [Commvault.Powershell.Origin(Commvault.Powershell.PropertyOrigin.Owned)]
        public bool? IsCopyInMaintenanceMode { get => this._isCopyInMaintenanceMode; set => this._isCopyInMaintenanceMode = value; }

        /// <summary>Backing field for <see cref="IsCopyPromotionRequestSubmitted" /> property.</summary>
        private bool? _isCopyPromotionRequestSubmitted;

        /// <summary>Is copy promotion request submitted for this copy?</summary>
        [Commvault.Powershell.Origin(Commvault.Powershell.PropertyOrigin.Owned)]
        public bool? IsCopyPromotionRequestSubmitted { get => this._isCopyPromotionRequestSubmitted; set => this._isCopyPromotionRequestSubmitted = value; }
        ...
        /// <summary>Backing field for <see cref="IsImmutableSnapCopy" /> property.</summary>
        private bool? _isImmutableSnapCopy;

        /// <summary>Only for snap copy. Tells if the snap copy has immutable option enabled.</summary>
        [Commvault.Powershell.Origin(Commvault.Powershell.PropertyOrigin.Owned)]
        public bool? IsImmutableSnapCopy { get => this._isImmutableSnapCopy; set => this._isImmutableSnapCopy = value; }
        ...
        private System.Collections.Generic.List<Commvault.Powershell.Models.IIdNameValue> _storageTemplateTags;

        /// <summary>
        /// It is used in Global config template plan creation. Needs in plan creation on global commcell
        /// </summary>
        [Commvault.Powershell.Origin(Commvault.Powershell.PropertyOrigin.Owned)]
        public System.Collections.Generic.List<Commvault.Powershell.Models.IIdNameValue> StorageTemplateTags { get => this._storageTemplateTags; set => this._storageTemplateTags = value; }
        ...
        Commvault.Powershell.Runtime.IJsonSerializable
    {
        ...
        SerializedName = @"isAirgapCopy",
        PossibleTypes = new [] { typeof(bool) })]
        bool? IsAirgapCopy { get; set; }
        /// <summary>Used if the copy is used for replication group</summary>
        [Commvault.Powershell.Runtime.Info(
        Required = false,
        ReadOnly = false,
        ...
        SerializedName = @"isCopyInMaintenanceMode",
        PossibleTypes = new [] { typeof(bool) })]
        bool? IsCopyInMaintenanceMode { get; set; }
        /// <summary>Is copy promotion request submitted for this copy?</summary>
        [Commvault.Powershell.Runtime.Info(
        Required = false,
        ReadOnly = false,
        ...
        SerializedName = @"isCopyPromotionRequestSubmitted",
        PossibleTypes = new [] { typeof(bool) })]
        bool? IsCopyPromotionRequestSubmitted { get; set; }
        /// <summary>Is this a default backup destination?</summary>
        [Commvault.Powershell.Runtime.Info(
        Required = false,
        ReadOnly = false,
        ...
        PossibleTypes = new [] { typeof(bool) })]
        bool? IsImmutableSnapCopy { get; set; }
        /// <summary>Is this a mirror copy?</summary>
        [Commvault.Powershell.Runtime.Info(
        Required = false,
        ReadOnly = false,
        ...
        System.Collections.Generic.List<Commvault.Powershell.Models.IIdNameValue> StorageTemplateTags { get; set; }
        /// <summary>StorageType</summary>
        [Commvault.Powershell.Runtime.Info(
        Required = false,
        ReadOnly = false,
...

    {
        ...
        Commvault.Powershell.Models.IDeviceType StoragePoolDeviceType { get; set; }
        /// <summary>Id of Storage Pool</summary>
        long? StoragePoolId { get; set; }
        /// <summary>Flag indicating whether the storage tier is archive.</summary>
        bool? StoragePoolIsArchiveStorage { get; set; }
