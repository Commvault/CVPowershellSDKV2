...
namespace Commvault.Powershell.Models
{
    ...
    public partial class VMGroupDetailsSummary
    {
        ...
        internal VMGroupDetailsSummary(Commvault.Powershell.Runtime.Json.JsonObject json)
        {
            ...
            {_region = If( json?.PropertyT<Commvault.Powershell.Runtime.Json.JsonObject>("region"), out var __jsonRegion) ? Commvault.Powershell.Models.RegionInfo.FromJson(__jsonRegion) : _region;}
            ...
            {_hypervisorName = If( json?.PropertyT<Commvault.Powershell.Runtime.Json.JsonString>("hypervisorName"), out var __jsonHypervisorName) ? (string)__jsonHypervisorName : (string)_hypervisorName;}
            ...
            {_backupActivityStatus = If( json?.PropertyT<Commvault.Powershell.Runtime.Json.JsonString>("backupActivityStatus"), out var __jsonBackupActivityStatus) ? (string)__jsonBackupActivityStatus : (string)_backupActivityStatus;}
            AfterFromJson(json);
        }
    }
}