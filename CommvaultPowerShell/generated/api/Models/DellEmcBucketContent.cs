...
namespace Commvault.Powershell.Models
{
    ...
    public partial class DellEmcBucketContent :
        Commvault.Powershell.Models.IDellEmcBucketContent,
        Commvault.Powershell.Models.IDellEmcBucketContentInternal,
        Commvault.Powershell.Runtime.IValidates
    {
        ...
        string Commvault.Powershell.Models.IDellEmcBucketContentInternal.CloudType { get => this._cloudType; set { {_cloudType = value;} } }

        /// <summary>Internal Acessors for Credentials</summary>
        Commvault.Powershell.Models.IIdName Commvault.Powershell.Models.IDellEmcBucketContentInternal.Credentials { get => (this._credentials = this._credentials ?? new Commvault.Powershell.Models.IdName()); set { {_credentials = value;} } }

        /// <summary>Internal Acessors for MediaAgent</summary>
        Commvault.Powershell.Models.IIdName Commvault.Powershell.Models.IDellEmcBucketContentInternal.MediaAgent { get => (this._mediaAgent = this._mediaAgent ?? new Commvault.Powershell.Models.IdName()); set { {_mediaAgent = value;} } }
        ...
        /// <summary>Creates an new <see cref="DellEmcBucketContent" /> instance.</summary>
        public DellEmcBucketContent()
        {
    ...
    /// Dell EMC ECS (S3-compatible)
    internal partial interface IDellEmcBucketContentInternal :
