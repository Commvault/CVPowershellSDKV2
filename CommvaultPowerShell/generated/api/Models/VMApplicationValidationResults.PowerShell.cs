...
namespace Commvault.Powershell.Models
{
    ...
    public partial class VMApplicationValidationResults
    {
        ...
        /// <returns>an instance of the <see cref="VMApplicationValidationResults" /> model class.</returns>
        ...
        internal VMApplicationValidationResults(global::System.Collections.IDictionary content)
        {
            ...
            if (content.Contains("BootStatus"))
            {
            ...
            if (content.Contains("LastValidationJobId"))
            {
                ((Commvault.Powershell.Models.IVMApplicationValidationResultsInternal)this).LastValidationJobId = (long?) content.GetValueForProperty("LastValidationJobId",((Commvault.Powershell.Models.IVMApplicationValidationResultsInternal)this).LastValidationJobId, (__y)=> (long) global::System.Convert.ChangeType(__y, typeof(long)));
            }
            if (content.Contains("BackupValidated"))
            {
                ((Commvault.Powershell.Models.IVMApplicationValidationResultsInternal)this).BackupValidated = (long?) content.GetValueForProperty("BackupValidated",((Commvault.Powershell.Models.IVMApplicationValidationResultsInternal)this).BackupValidated, (__y)=> (long) global::System.Convert.ChangeType(__y, typeof(long)));
            }
            if (content.Contains("BackupCompletionDate"))
            {
                ((Commvault.Powershell.Models.IVMApplicationValidationResultsInternal)this).BackupCompletionDate = (long?) content.GetValueForProperty("BackupCompletionDate",((Commvault.Powershell.Models.IVMApplicationValidationResultsInternal)this).BackupCompletionDate, (__y)=> (long) global::System.Convert.ChangeType(__y, typeof(long)));
            }
            if (content.Contains("AppsDiscovered"))
            {
                ((Commvault.Powershell.Models.IVMApplicationValidationResultsInternal)this).AppsDiscovered = (System.Collections.Generic.List<Commvault.Powershell.Models.IVMAppsDiscovered>) content.GetValueForProperty("AppsDiscovered",((Commvault.Powershell.Models.IVMApplicationValidationResultsInternal)this).AppsDiscovered, __y => TypeConverterExtensions.SelectToList<Commvault.Powershell.Models.IVMAppsDiscovered>(__y, Commvault.Powershell.Models.VMAppsDiscoveredTypeConverter.ConvertFrom));
            }
