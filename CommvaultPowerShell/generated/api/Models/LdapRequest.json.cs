...
namespace Commvault.Powershell.Models
{
    ...
    public partial class LdapRequest
    {
        ...
        /// <summary>
        /// Deserializes a <see cref="Commvault.Powershell.Runtime.Json.JsonNode"/> into an instance of Commvault.Powershell.Models.ILdapRequest.
        /// </summary>
        /// <param name="node">a <see cref="Commvault.Powershell.Runtime.Json.JsonNode" /> to deserialize from.</param>
        /// <returns>an instance of Commvault.Powershell.Models.ILdapRequest.</returns>
        public static Commvault.Powershell.Models.ILdapRequest FromJson(Commvault.Powershell.Runtime.Json.JsonNode node)
        {
            return node is Commvault.Powershell.Runtime.Json.JsonObject json ? new LdapRequest(json) : null;
        }

        /// <summary>
        /// Deserializes a Commvault.Powershell.Runtime.Json.JsonObject into a new instance of <see cref="LdapRequest" />.
        /// </summary>
        /// <param name="json">A Commvault.Powershell.Runtime.Json.JsonObject instance to deserialize from.</param>
        internal LdapRequest(Commvault.Powershell.Runtime.Json.JsonObject json)
        {
            ...
            {_doNotValidateNetBiosName = If( json?.PropertyT<Commvault.Powershell.Runtime.Json.JsonBoolean>("doNotValidateNetBIOSName"), out var __jsonDoNotValidateNetBiosName) ? (bool?)__jsonDoNotValidateNetBiosName : _doNotValidateNetBiosName;}
            AfterFromJson(json);
        }

        /// <summary>
        /// Serializes this instance of <see cref="LdapRequest" /> into a <see cref="Commvault.Powershell.Runtime.Json.JsonNode" />.
        /// </summary>
        /// <param name="container">The <see cref="Commvault.Powershell.Runtime.Json.JsonObject"/> container to serialize this object into. If the caller
        /// passes in <c>null</c>, a new instance will be created and returned to the caller.</param>
        /// <param name="serializationMode">Allows the caller to choose the depth of the serialization. See <see cref="Commvault.Powershell.Runtime.SerializationMode"/>.</param>
        /// <returns>
        /// a serialized instance of <see cref="LdapRequest" /> as a <see cref="Commvault.Powershell.Runtime.Json.JsonNode" />.
        /// </returns>
        public Commvault.Powershell.Runtime.Json.JsonNode ToJson(Commvault.Powershell.Runtime.Json.JsonObject container, Commvault.Powershell.Runtime.SerializationMode serializationMode)
        {
            ...
            AddIf( null != this._doNotValidateNetBiosName ? (Commvault.Powershell.Runtime.Json.JsonNode)new Commvault.Powershell.Runtime.Json.JsonBoolean((bool)this._doNotValidateNetBiosName) : null, "doNotValidateNetBIOSName" ,container.Add );
