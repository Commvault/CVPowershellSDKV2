...
namespace Commvault.Powershell.Models
{
    ...
    public partial class CommvaultPowerShellIdentity
    {
        ...
        internal CommvaultPowerShellIdentity(Commvault.Powershell.Runtime.Json.JsonObject json)
        {
            ...
            {_planId = If( json?.PropertyT<Commvault.Powershell.Runtime.Json.JsonNumber>("planId"), out var __jsonPlanId) ? (long?)__jsonPlanId : _planId;}
            {_backupDestinationId = If( json?.PropertyT<Commvault.Powershell.Runtime.Json.JsonNumber>("BackupDestinationId"), out var __jsonBackupDestinationId) ? (long?)__jsonBackupDestinationId : _backupDestinationId;}
            {_regionList = If( json?.PropertyT<Commvault.Powershell.Runtime.Json.JsonString>("regionList"), out var __jsonRegionList) ? (string)__jsonRegionList : (string)_regionList;}
            {_regionId = If( json?.PropertyT<Commvault.Powershell.Runtime.Json.JsonNumber>("regionId"), out var __jsonRegionId) ? (long?)__jsonRegionId : _regionId;}
            {_recoveryEntityId = If( json?.PropertyT<Commvault.Powershell.Runtime.Json.JsonNumber>("recoveryEntityId"), out var __jsonRecoveryEntityId) ? (long?)__jsonRecoveryEntityId : _recoveryEntityId;}
            {_recoveryGroupId = If( json?.PropertyT<Commvault.Powershell.Runtime.Json.JsonNumber>("recoveryGroupId"), out var __jsonRecoveryGroupId) ? (long?)__jsonRecoveryGroupId : _recoveryGroupId;}
            {_entityId = If( json?.PropertyT<Commvault.Powershell.Runtime.Json.JsonNumber>("entityId"), out var __jsonEntityId) ? (long?)__jsonEntityId : _entityId;}
            {_userId = If( json?.PropertyT<Commvault.Powershell.Runtime.Json.JsonNumber>("userId"), out var __jsonUserId) ? (long?)__jsonUserId : _userId;}
            ...
            {_userGroupId = If( json?.PropertyT<Commvault.Powershell.Runtime.Json.JsonNumber>("userGroupId"), out var __jsonUserGroupId) ? (long?)__jsonUserGroupId : _userGroupId;}
            {_storagePoolId = If( json?.PropertyT<Commvault.Powershell.Runtime.Json.JsonNumber>("storagePoolId"), out var __jsonStoragePoolId) ? (long?)__jsonStoragePoolId : _storagePoolId;}
            {_backupLocationId = If( json?.PropertyT<Commvault.Powershell.Runtime.Json.JsonNumber>("backupLocationId"), out var __jsonBackupLocationId) ? (long?)__jsonBackupLocationId : _backupLocationId;}
            {_accessPathId = If( json?.PropertyT<Commvault.Powershell.Runtime.Json.JsonNumber>("accessPathId"), out var __jsonAccessPathId) ? (long?)__jsonAccessPathId : _accessPathId;}
            {_serverGroupId = If( json?.PropertyT<Commvault.Powershell.Runtime.Json.JsonNumber>("serverGroupId"), out var __jsonServerGroupId) ? (long?)__jsonServerGroupId : _serverGroupId;}
            {_serverId = If( json?.PropertyT<Commvault.Powershell.Runtime.Json.JsonNumber>("serverId"), out var __jsonServerId) ? (long?)__jsonServerId : _serverId;}
            {_agentId = If( json?.PropertyT<Commvault.Powershell.Runtime.Json.JsonNumber>("agentId"), out var __jsonAgentId) ? (long?)__jsonAgentId : _agentId;}
            {_subclientId = If( json?.PropertyT<Commvault.Powershell.Runtime.Json.JsonNumber>("subclientId"), out var __jsonSubclientId) ? (long?)__jsonSubclientId : _subclientId;}
            {_cloudStorageId = If( json?.PropertyT<Commvault.Powershell.Runtime.Json.JsonNumber>("cloudStorageId"), out var __jsonCloudStorageId) ? (long?)__jsonCloudStorageId : _cloudStorageId;}
            {_metadataCacheId = If( json?.PropertyT<Commvault.Powershell.Runtime.Json.JsonNumber>("metadataCacheId"), out var __jsonMetadataCacheId) ? (long?)__jsonMetadataCacheId : _metadataCacheId;}
            {_bucketId = If( json?.PropertyT<Commvault.Powershell.Runtime.Json.JsonNumber>("bucketId"), out var __jsonBucketId) ? (long?)__jsonBucketId : _bucketId;}
            {_hyperScaleStorageId = If( json?.PropertyT<Commvault.Powershell.Runtime.Json.JsonNumber>("hyperScaleStorageId"), out var __jsonHyperScaleStorageId) ? (long?)__jsonHyperScaleStorageId : _hyperScaleStorageId;}
            {_nodeId = If( json?.PropertyT<Commvault.Powershell.Runtime.Json.JsonNumber>("nodeId"), out var __jsonNodeId) ? (long?)__jsonNodeId : _nodeId;}
            {_roleId = If( json?.PropertyT<Commvault.Powershell.Runtime.Json.JsonNumber>("roleId"), out var __jsonRoleId) ? (long?)__jsonRoleId : _roleId;}
            {_libraryId = If( json?.PropertyT<Commvault.Powershell.Runtime.Json.JsonNumber>("libraryId"), out var __jsonLibraryId) ? (long?)__jsonLibraryId : _libraryId;}
            {_spareGroupId = If( json?.PropertyT<Commvault.Powershell.Runtime.Json.JsonNumber>("spareGroupId"), out var __jsonSpareGroupId) ? (long?)__jsonSpareGroupId : _spareGroupId;}
            {_driveId = If( json?.PropertyT<Commvault.Powershell.Runtime.Json.JsonNumber>("driveId"), out var __jsonDriveId) ? (long?)__jsonDriveId : _driveId;}
            {_instanceId = If( json?.PropertyT<Commvault.Powershell.Runtime.Json.JsonNumber>("instanceId"), out var __jsonInstanceId) ? (long?)__jsonInstanceId : _instanceId;}
            {_replicationGroupId = If( json?.PropertyT<Commvault.Powershell.Runtime.Json.JsonString>("replicationGroupId"), out var __jsonReplicationGroupId) ? (string)__jsonReplicationGroupId : (string)_replicationGroupId;}
            {_failoverGroupId = If( json?.PropertyT<Commvault.Powershell.Runtime.Json.JsonNumber>("failoverGroupId"), out var __jsonFailoverGroupId) ? (long?)__jsonFailoverGroupId : _failoverGroupId;}
            {_scheduleId = If( json?.PropertyT<Commvault.Powershell.Runtime.Json.JsonNumber>("scheduleId"), out var __jsonScheduleId) ? (long?)__jsonScheduleId : _scheduleId;}
            {_drOperation = If( json?.PropertyT<Commvault.Powershell.Runtime.Json.JsonString>("drOperation"), out var __jsonDrOperation) ? (string)__jsonDrOperation : (string)_drOperation;}
            {_vMGroupId = If( json?.PropertyT<Commvault.Powershell.Runtime.Json.JsonNumber>("VmGroupId"), out var __jsonVMGroupId) ? (long?)__jsonVMGroupId : _vMGroupId;}
            {_vMGuid = If( json?.PropertyT<Commvault.Powershell.Runtime.Json.JsonString>("vmGuid"), out var __jsonVMGuid) ? (string)__jsonVMGuid : (string)_vMGuid;}
            {_vMUuid = If( json?.PropertyT<Commvault.Powershell.Runtime.Json.JsonString>("vmUUID"), out var __jsonVMUuid) ? (string)__jsonVMUuid : (string)_vMUuid;}
            {_mediaAgentId = If( json?.PropertyT<Commvault.Powershell.Runtime.Json.JsonNumber>("mediaAgentId"), out var __jsonMediaAgentId) ? (long?)__jsonMediaAgentId : _mediaAgentId;}
            {_hypervisorId = If( json?.PropertyT<Commvault.Powershell.Runtime.Json.JsonNumber>("hypervisorId"), out var __jsonHypervisorId) ? (long?)__jsonHypervisorId : _hypervisorId;}
            {_topologyId = If( json?.PropertyT<Commvault.Powershell.Runtime.Json.JsonString>("topologyId"), out var __jsonTopologyId) ? (string)__jsonTopologyId : (string)_topologyId;}
            {_ruleId = If( json?.PropertyT<Commvault.Powershell.Runtime.Json.JsonNumber>("ruleId"), out var __jsonRuleId) ? (long?)__jsonRuleId : _ruleId;}
            {_entityType = If( json?.PropertyT<Commvault.Powershell.Runtime.Json.JsonString>("entityType"), out var __jsonEntityType) ? (string)__jsonEntityType : (string)_entityType;}
            {_blackoutWindowId = If( json?.PropertyT<Commvault.Powershell.Runtime.Json.JsonNumber>("blackoutWindowId"), out var __jsonBlackoutWindowId) ? (long?)__jsonBlackoutWindowId : _blackoutWindowId;}
            {_hfsShareId = If( json?.PropertyT<Commvault.Powershell.Runtime.Json.JsonNumber>("HFSShareId"), out var __jsonHfsShareId) ? (long?)__jsonHfsShareId : _hfsShareId;}
            {_clusterId = If( json?.PropertyT<Commvault.Powershell.Runtime.Json.JsonNumber>("clusterId"), out var __jsonClusterId) ? (long?)__jsonClusterId : _clusterId;}
            {_modifierName = If( json?.PropertyT<Commvault.Powershell.Runtime.Json.JsonString>("ModifierName"), out var __jsonModifierName) ? (string)__jsonModifierName : (string)_modifierName;}
            {_alertRuleId = If( json?.PropertyT<Commvault.Powershell.Runtime.Json.JsonNumber>("alertRuleId"), out var __jsonAlertRuleId) ? (long?)__jsonAlertRuleId : _alertRuleId;}
            {_globalSearchEntity = If( json?.PropertyT<Commvault.Powershell.Runtime.Json.JsonString>("globalSearchEntity"), out var __jsonGlobalSearchEntity) ? (string)__jsonGlobalSearchEntity : (string)_globalSearchEntity;}
            {_rpsId = If( json?.PropertyT<Commvault.Powershell.Runtime.Json.JsonString>("rpsId"), out var __jsonRpsId) ? (string)__jsonRpsId : (string)_rpsId;}
            ...
            {_credentialName = If( json?.PropertyT<Commvault.Powershell.Runtime.Json.JsonString>("credentialName"), out var __jsonCredentialName) ? (string)__jsonCredentialName : (string)_credentialName;}
            {_credentialId = If( json?.PropertyT<Commvault.Powershell.Runtime.Json.JsonString>("credentialId"), out var __jsonCredentialId) ? (string)__jsonCredentialId : (string)_credentialId;}
            {_recoveryTargetId = If( json?.PropertyT<Commvault.Powershell.Runtime.Json.JsonNumber>("recoveryTargetId"), out var __jsonRecoveryTargetId) ? (long?)__jsonRecoveryTargetId : _recoveryTargetId;}
            {_domainId = If( json?.PropertyT<Commvault.Powershell.Runtime.Json.JsonNumber>("domainId"), out var __jsonDomainId) ? (long?)__jsonDomainId : _domainId;}
            {_requestId = If( json?.PropertyT<Commvault.Powershell.Runtime.Json.JsonNumber>("requestId"), out var __jsonRequestId) ? (long?)__jsonRequestId : _requestId;}
            {_kmsId = If( json?.PropertyT<Commvault.Powershell.Runtime.Json.JsonNumber>("kmsId"), out var __jsonKmsId) ? (long?)__jsonKmsId : _kmsId;}
            {_pairId = If( json?.PropertyT<Commvault.Powershell.Runtime.Json.JsonNumber>("pairId"), out var __jsonPairId) ? (long?)__jsonPairId : _pairId;}
            {_replicationPairId = If( json?.PropertyT<Commvault.Powershell.Runtime.Json.JsonNumber>("replicationPairId"), out var __jsonReplicationPairId) ? (long?)__jsonReplicationPairId : _replicationPairId;}
            {_id = If( json?.PropertyT<Commvault.Powershell.Runtime.Json.JsonNumber>("id"), out var __jsonId) ? (long?)__jsonId : _id;}
            {_schedulePolicyId = If( json?.PropertyT<Commvault.Powershell.Runtime.Json.JsonNumber>("schedulePolicyId"), out var __jsonSchedulePolicyId) ? (long?)__jsonSchedulePolicyId : _schedulePolicyId;}
            {_inventoryId = If( json?.PropertyT<Commvault.Powershell.Runtime.Json.JsonNumber>("inventoryId"), out var __jsonInventoryId) ? (long?)__jsonInventoryId : _inventoryId;}
            {_indexServerClientId = If( json?.PropertyT<Commvault.Powershell.Runtime.Json.JsonNumber>("indexServerClientId"), out var __jsonIndexServerClientId) ? (long?)__jsonIndexServerClientId : _indexServerClientId;}
            {_assetId = If( json?.PropertyT<Commvault.Powershell.Runtime.Json.JsonString>("assetId"), out var __jsonAssetId) ? (string)__jsonAssetId : (string)_assetId;}
            {_tagId = If( json?.PropertyT<Commvault.Powershell.Runtime.Json.JsonNumber>("tagId"), out var __jsonTagId) ? (long?)__jsonTagId : _tagId;}
            {_arrayId = If( json?.PropertyT<Commvault.Powershell.Runtime.Json.JsonNumber>("arrayId"), out var __jsonArrayId) ? (long?)__jsonArrayId : _arrayId;}
            {_jobId = If( json?.PropertyT<Commvault.Powershell.Runtime.Json.JsonNumber>("jobId"), out var __jsonJobId) ? (long?)__jsonJobId : _jobId;}
            {_vendorId = If( json?.PropertyT<Commvault.Powershell.Runtime.Json.JsonNumber>("vendorId"), out var __jsonVendorId) ? (long?)__jsonVendorId : _vendorId;}
            {_clientId = If( json?.PropertyT<Commvault.Powershell.Runtime.Json.JsonNumber>("clientId"), out var __jsonClientId) ? (long?)__jsonClientId : _clientId;}
            {_tagValue = If( json?.PropertyT<Commvault.Powershell.Runtime.Json.JsonString>("tagValue"), out var __jsonTagValue) ? (string)__jsonTagValue : (string)_tagValue;}
            {_copyId = If( json?.PropertyT<Commvault.Powershell.Runtime.Json.JsonNumber>("copyId"), out var __jsonCopyId) ? (long?)__jsonCopyId : _copyId;}
            {_appId = If( json?.PropertyT<Commvault.Powershell.Runtime.Json.JsonNumber>("appId"), out var __jsonAppId) ? (long?)__jsonAppId : _appId;}
            {_nameSpace = If( json?.PropertyT<Commvault.Powershell.Runtime.Json.JsonString>("nameSpace"), out var __jsonNameSpace) ? (string)__jsonNameSpace : (string)_nameSpace;}
            {_applicationGroupId = If( json?.PropertyT<Commvault.Powershell.Runtime.Json.JsonNumber>("applicationGroupId"), out var __jsonApplicationGroupId) ? (long?)__jsonApplicationGroupId : _applicationGroupId;}
            {_appGuid = If( json?.PropertyT<Commvault.Powershell.Runtime.Json.JsonString>("appGUID"), out var __jsonAppGuid) ? (string)__jsonAppGuid : (string)_appGuid;}
            {_backupDestionationId = If( json?.PropertyT<Commvault.Powershell.Runtime.Json.JsonNumber>("backupDestionationId"), out var __jsonBackupDestionationId) ? (long?)__jsonBackupDestionationId : _backupDestionationId;}
            {_cloneId = If( json?.PropertyT<Commvault.Powershell.Runtime.Json.JsonNumber>("cloneId"), out var __jsonCloneId) ? (long?)__jsonCloneId : _cloneId;}
            {_snapEngineId = If( json?.PropertyT<Commvault.Powershell.Runtime.Json.JsonNumber>("snapEngineId"), out var __jsonSnapEngineId) ? (long?)__jsonSnapEngineId : _snapEngineId;}
            AfterFromJson(json);
        }
        ...
        public Commvault.Powershell.Runtime.Json.JsonNode ToJson(Commvault.Powershell.Runtime.Json.JsonObject container, Commvault.Powershell.Runtime.SerializationMode serializationMode)
        {
            ...
            AddIf( null != this._recoveryEntityId ? (Commvault.Powershell.Runtime.Json.JsonNode)new Commvault.Powershell.Runtime.Json.JsonNumber((long)this._recoveryEntityId) : null, "recoveryEntityId" ,container.Add );
            ...
            AddIf( null != this._spareGroupId ? (Commvault.Powershell.Runtime.Json.JsonNode)new Commvault.Powershell.Runtime.Json.JsonNumber((long)this._spareGroupId) : null, "spareGroupId" ,container.Add );
            ...
            AddIf( null != this._alertRuleId ? (Commvault.Powershell.Runtime.Json.JsonNode)new Commvault.Powershell.Runtime.Json.JsonNumber((long)this._alertRuleId) : null, "alertRuleId" ,container.Add );
            ...
            AddIf( null != this._replicationPairId ? (Commvault.Powershell.Runtime.Json.JsonNode)new Commvault.Powershell.Runtime.Json.JsonNumber((long)this._replicationPairId) : null, "replicationPairId" ,container.Add );
            ...
            AddIf( null != this._snapEngineId ? (Commvault.Powershell.Runtime.Json.JsonNode)new Commvault.Powershell.Runtime.Json.JsonNumber((long)this._snapEngineId) : null, "snapEngineId" ,container.Add );
