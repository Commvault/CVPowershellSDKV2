...
namespace Commvault.Powershell.Models
{
    ...
    public partial class GlobalSettingsItem
    {
        ...
        /// <summary>
        /// Deserializes a <see cref="Commvault.Powershell.Runtime.Json.JsonNode"/> into an instance of Commvault.Powershell.Models.IGlobalSettingsItem.
        /// </summary>
        /// <param name="node">a <see cref="Commvault.Powershell.Runtime.Json.JsonNode" /> to deserialize from.</param>
        /// <returns>an instance of Commvault.Powershell.Models.IGlobalSettingsItem.</returns>
        public static Commvault.Powershell.Models.IGlobalSettingsItem FromJson(Commvault.Powershell.Runtime.Json.JsonNode node)
        {
            return node is Commvault.Powershell.Runtime.Json.JsonObject json ? new GlobalSettingsItem(json) : null;
        }

        /// <summary>
        /// Deserializes a Commvault.Powershell.Runtime.Json.JsonObject into a new instance of <see cref="GlobalSettingsItem" />.
        /// </summary>
        /// <param name="json">A Commvault.Powershell.Runtime.Json.JsonObject instance to deserialize from.</param>
        internal GlobalSettingsItem(Commvault.Powershell.Runtime.Json.JsonObject json)
        {
            ...
            {_displayLabel = If( json?.PropertyT<Commvault.Powershell.Runtime.Json.JsonString>("displayLabel"), out var __jsonDisplayLabel) ? (string)__jsonDisplayLabel : (string)_displayLabel;}
            ...
            {_value = If( json?.PropertyT<Commvault.Powershell.Runtime.Json.JsonString>("value"), out var __jsonValue) ? (string)__jsonValue : (string)_value;}
            {_comment = If( json?.PropertyT<Commvault.Powershell.Runtime.Json.JsonString>("comment"), out var __jsonComment) ? (string)__jsonComment : (string)_comment;}
        ...
        /// <summary>
        /// Serializes this instance of <see cref="GlobalSettingsItem" /> into a <see cref="Commvault.Powershell.Runtime.Json.JsonNode" />.
        /// </summary>
        /// <param name="container">The <see cref="Commvault.Powershell.Runtime.Json.JsonObject"/> container to serialize this object into. If the caller
        /// passes in <c>null</c>, a new instance will be created and returned to the caller.</param>
        /// <param name="serializationMode">Allows the caller to choose the depth of the serialization. See <see cref="Commvault.Powershell.Runtime.SerializationMode"/>.</param>
        /// <returns>
        /// a serialized instance of <see cref="GlobalSettingsItem" /> as a <see cref="Commvault.Powershell.Runtime.Json.JsonNode" />.
        /// </returns>
