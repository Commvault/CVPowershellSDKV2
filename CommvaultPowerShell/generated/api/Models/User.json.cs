...
namespace Commvault.Powershell.Models
{
    ...
    public partial class User
    {
        ...
        internal User(Commvault.Powershell.Runtime.Json.JsonObject json)
        {
            ...
            {_authenticationMethodServer = If( json?.PropertyT<Commvault.Powershell.Runtime.Json.JsonObject>("authenticationMethodServer"), out var __jsonAuthenticationMethodServer) ? Commvault.Powershell.Models.IdNameCompany.FromJson(__jsonAuthenticationMethodServer) : AuthenticationMethodServer;}
            ...
            {_lastLoggedIn = If( json?.PropertyT<Commvault.Powershell.Runtime.Json.JsonNumber>("lastLoggedIn"), out var __jsonLastLoggedIn) ? (long?)__jsonLastLoggedIn : LastLoggedIn;}
