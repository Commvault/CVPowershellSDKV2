...
namespace Commvault.Powershell.Models
{
    ...
    public partial class UpdateBlackoutWindow
    {
        ...
        /// <summary>
        /// Deserializes a <see cref="Commvault.Powershell.Runtime.Json.JsonNode"/> into an instance of Commvault.Powershell.Models.IUpdateBlackoutWindow.
        /// </summary>
        /// <param name="node">a <see cref="Commvault.Powershell.Runtime.Json.JsonNode" /> to deserialize from.</param>
        /// <returns>an instance of Commvault.Powershell.Models.IUpdateBlackoutWindow.</returns>
        public static Commvault.Powershell.Models.IUpdateBlackoutWindow FromJson(Commvault.Powershell.Runtime.Json.JsonNode node)
        {
            return node is Commvault.Powershell.Runtime.Json.JsonObject json ? new UpdateBlackoutWindow(json) : null;
        }

        /// <summary>
        /// Serializes this instance of <see cref="UpdateBlackoutWindow" /> into a <see cref="Commvault.Powershell.Runtime.Json.JsonNode" />.
        /// </summary>
        /// <param name="container">The <see cref="Commvault.Powershell.Runtime.Json.JsonObject"/> container to serialize this object into. If the caller
        /// passes in <c>null</c>, a new instance will be created and returned to the caller.</param>
        /// <param name="serializationMode">Allows the caller to choose the depth of the serialization. See <see cref="Commvault.Powershell.Runtime.SerializationMode"/>.</param>
        /// <returns>
        /// a serialized instance of <see cref="UpdateBlackoutWindow" /> as a <see cref="Commvault.Powershell.Runtime.Json.JsonNode" />.
        /// </returns>
        ...
        /// <summary>
        /// Deserializes a Commvault.Powershell.Runtime.Json.JsonObject into a new instance of <see cref="UpdateBlackoutWindow" />.
        /// </summary>
        /// <param name="json">A Commvault.Powershell.Runtime.Json.JsonObject instance to deserialize from.</param>
        internal UpdateBlackoutWindow(Commvault.Powershell.Runtime.Json.JsonObject json)
        {
            bool returnNow = false;
            ...
            {_betweenDates = If( json?.PropertyT<Commvault.Powershell.Runtime.Json.JsonObject>("betweenDates"), out var __jsonBetweenDates) ? Commvault.Powershell.Models.StartEnd.FromJson(__jsonBetweenDates) : _betweenDates;}
            ...
            {_backupOperations = If( json?.PropertyT<Commvault.Powershell.Runtime.Json.JsonArray>("backupOperations"), out var __jsonBackupOperations) ? If( __jsonBackupOperations as Commvault.Powershell.Runtime.Json.JsonArray, out var __v) ? new global::System.Func<System.Collections.Generic.List<string>>(()=> global::System.Linq.Enumerable.ToList(global::System.Linq.Enumerable.Select(__v, (__u)=>(string) (__u is Commvault.Powershell.Runtime.Json.JsonString __t ? (string)(__t.ToString()) : null)) ))() : null : _backupOperations;}
            {_allDays = If( json?.PropertyT<Commvault.Powershell.Runtime.Json.JsonArray>("allDays"), out var __jsonAllDays) ? If( __jsonAllDays as Commvault.Powershell.Runtime.Json.JsonArray, out var __q) ? new global::System.Func<System.Collections.Generic.List<Commvault.Powershell.Models.IDaysAndTimes>>(()=> global::System.Linq.Enumerable.ToList(global::System.Linq.Enumerable.Select(__q, (__p)=>(Commvault.Powershell.Models.IDaysAndTimes) (Commvault.Powershell.Models.DaysAndTimes.FromJson(__p) )) ))() : null : _allDays;}
            {_weeks = If( json?.PropertyT<Commvault.Powershell.Runtime.Json.JsonArray>("weeks"), out var __jsonWeeks) ? If( __jsonWeeks as Commvault.Powershell.Runtime.Json.JsonArray, out var __l) ? new global::System.Func<System.Collections.Generic.List<string>>(()=> global::System.Linq.Enumerable.ToList(global::System.Linq.Enumerable.Select(__l, (__k)=>(string) (__k is Commvault.Powershell.Runtime.Json.JsonString __j ? (string)(__j.ToString()) : null)) ))() : null : _weeks;}
            {_doNotSubmitJob = If( json?.PropertyT<Commvault.Powershell.Runtime.Json.JsonBoolean>("doNotSubmitJob"), out var __jsonDoNotSubmitJob) ? (bool?)__jsonDoNotSubmitJob : _doNotSubmitJob;}
            AfterFromJson(json);
        }
    }
}