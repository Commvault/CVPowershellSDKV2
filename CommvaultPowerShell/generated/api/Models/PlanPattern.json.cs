...
namespace Commvault.Powershell.Models
{
    ...
    public partial class PlanPattern
    {
        ...
        internal PlanPattern(Commvault.Powershell.Runtime.Json.JsonObject json)
        {
            ...
            {_minuteFrequency = If( json?.PropertyT<Commvault.Powershell.Runtime.Json.JsonNumber>("minuteFrequency"), out var __jsonMinuteFrequency) ? (long?)__jsonMinuteFrequency : _minuteFrequency;}
            {_hourlyFrequency = If( json?.PropertyT<Commvault.Powershell.Runtime.Json.JsonNumber>("hourlyFrequency"), out var __jsonHourlyFrequency) ? (long?)__jsonHourlyFrequency : _hourlyFrequency;}
            {_dailyFrequency = If( json?.PropertyT<Commvault.Powershell.Runtime.Json.JsonNumber>("dailyFrequency"), out var __jsonDailyFrequency) ? (long?)__jsonDailyFrequency : _dailyFrequency;}
            {_weeklyFrequency = If( json?.PropertyT<Commvault.Powershell.Runtime.Json.JsonNumber>("weeklyFrequency"), out var __jsonWeeklyFrequency) ? (long?)__jsonWeeklyFrequency : _weeklyFrequency;}
            {_weeklyFrequencyDays = If( json?.PropertyT<Commvault.Powershell.Runtime.Json.JsonArray>("weeklyFrequencyDays"), out var __jsonWeeklyFrequencyDays) ? If( __jsonWeeklyFrequencyDays as Commvault.Powershell.Runtime.Json.JsonArray, out var __v) ? new global::System.Func<System.Collections.Generic.List<string>>(()=> global::System.Linq.Enumerable.ToList(global::System.Linq.Enumerable.Select(__v, (__u)=>(string) (__u is Commvault.Powershell.Runtime.Json.JsonString __t ? (string)(__t.ToString()) : null)) ))() : null : _weeklyFrequencyDays;}
            {_monthlyFrequency = If( json?.PropertyT<Commvault.Powershell.Runtime.Json.JsonNumber>("monthlyFrequency"), out var __jsonMonthlyFrequency) ? (long?)__jsonMonthlyFrequency : _monthlyFrequency;}
            {_monthlyFrequencyWeekOfMonth = If( json?.PropertyT<Commvault.Powershell.Runtime.Json.JsonString>("monthlyFrequencyWeekOfMonth"), out var __jsonMonthlyFrequencyWeekOfMonth) ? (string)__jsonMonthlyFrequencyWeekOfMonth : (string)_monthlyFrequencyWeekOfMonth;}
            {_monthlyFrequencyDayOfWeek = If( json?.PropertyT<Commvault.Powershell.Runtime.Json.JsonString>("monthlyFrequencyDayOfWeek"), out var __jsonMonthlyFrequencyDayOfWeek) ? (string)__jsonMonthlyFrequencyDayOfWeek : (string)_monthlyFrequencyDayOfWeek;}
            {_monthlyFrequencyDayOfMonth = If( json?.PropertyT<Commvault.Powershell.Runtime.Json.JsonNumber>("monthlyFrequencyDayOfMonth"), out var __jsonMonthlyFrequencyDayOfMonth) ? (long?)__jsonMonthlyFrequencyDayOfMonth : _monthlyFrequencyDayOfMonth;}
            {_yearlyFrequencyWeekOfMonth = If( json?.PropertyT<Commvault.Powershell.Runtime.Json.JsonString>("yearlyFrequencyWeekOfMonth"), out var __jsonYearlyFrequencyWeekOfMonth) ? (string)__jsonYearlyFrequencyWeekOfMonth : (string)_yearlyFrequencyWeekOfMonth;}
            {_yearlyFrequencyDayOfWeek = If( json?.PropertyT<Commvault.Powershell.Runtime.Json.JsonString>("yearlyFrequencyDayOfWeek"), out var __jsonYearlyFrequencyDayOfWeek) ? (string)__jsonYearlyFrequencyDayOfWeek : (string)_yearlyFrequencyDayOfWeek;}
            {_yearlyFrequencyDayOfMonth = If( json?.PropertyT<Commvault.Powershell.Runtime.Json.JsonNumber>("yearlyFrequencyDayOfMonth"), out var __jsonYearlyFrequencyDayOfMonth) ? (long?)__jsonYearlyFrequencyDayOfMonth : _yearlyFrequencyDayOfMonth;}
            {_yearlyFrequencyMonthOfYear = If( json?.PropertyT<Commvault.Powershell.Runtime.Json.JsonString>("yearlyFrequencyMonthOfYear"), out var __jsonYearlyFrequencyMonthOfYear) ? (string)__jsonYearlyFrequencyMonthOfYear : (string)_yearlyFrequencyMonthOfYear;}
