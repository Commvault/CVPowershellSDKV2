...
namespace Commvault.Powershell.Models
{
    ...
    public partial class ScalityRingBucket :
        Commvault.Powershell.Models.IScalityRingBucket,
        Commvault.Powershell.Models.IScalityRingBucketInternal,
        Commvault.Powershell.Runtime.IValidates
    {
        ...
        string Commvault.Powershell.Models.IScalityRingBucketInternal.CloudType { get => this._cloudType; set { {_cloudType = value;} } }

        /// <summary>Internal Acessors for Credentials</summary>
        Commvault.Powershell.Models.IIdName Commvault.Powershell.Models.IScalityRingBucketInternal.Credentials { get => (this._credentials = this._credentials ?? new Commvault.Powershell.Models.IdName()); set { {_credentials = value;} } }

        /// <summary>Internal Acessors for MediaAgent</summary>
        Commvault.Powershell.Models.IIdName Commvault.Powershell.Models.IScalityRingBucketInternal.MediaAgent { get => (this._mediaAgent = this._mediaAgent ?? new Commvault.Powershell.Models.IdName()); set { {_mediaAgent = value;} } }
        ...
        /// <summary>Creates an new <see cref="ScalityRingBucket" /> instance.</summary>
        public ScalityRingBucket()
        {
    ...
    /// Scality RING
    internal partial interface IScalityRingBucketInternal :
