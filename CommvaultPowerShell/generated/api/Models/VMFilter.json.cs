...
namespace Commvault.Powershell.Models
{
    ...
    public partial class VMFilter
    {
        ...
        internal VMFilter(Commvault.Powershell.Runtime.Json.JsonObject json)
        {
            ...
            {_customAttributeName = If( json?.PropertyT<Commvault.Powershell.Runtime.Json.JsonString>("customAttributeName"), out var __jsonCustomAttributeName) ? (string)__jsonCustomAttributeName : (string)CustomAttributeName;}
