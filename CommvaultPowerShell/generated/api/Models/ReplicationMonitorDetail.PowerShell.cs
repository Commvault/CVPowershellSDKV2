...
namespace Commvault.Powershell.Models
{
    ...
    public partial class ReplicationMonitorDetail
    {
        ...
        internal ReplicationMonitorDetail(global::System.Collections.IDictionary content)
        {
            ...
            {
                ((Commvault.Powershell.Models.IReplicationMonitorDetailInternal)this).ReplicationCopyDetails = (System.Collections.Generic.List<Commvault.Powershell.Models.IReplicationMonitorDetailReplicationCopyDetails>) content.GetValueForProperty("ReplicationCopyDetails",((Commvault.Powershell.Models.IReplicationMonitorDetailInternal)this).ReplicationCopyDetails, __y => TypeConverterExtensions.SelectToList<Commvault.Powershell.Models.IReplicationMonitorDetailReplicationCopyDetails>(__y, Commvault.Powershell.Models.ReplicationMonitorDetailReplicationCopyDetailsTypeConverter.ConvertFrom));
            }
            if (content.Contains("Statistics"))
            {
                ((Commvault.Powershell.Models.IReplicationMonitorDetailInternal)this).Statistics = (System.Collections.Generic.List<Commvault.Powershell.Models.IReplicationMonitorDetailStats>) content.GetValueForProperty("Statistics",((Commvault.Powershell.Models.IReplicationMonitorDetailInternal)this).Statistics, __y => TypeConverterExtensions.SelectToList<Commvault.Powershell.Models.IReplicationMonitorDetailStats>(__y, Commvault.Powershell.Models.ReplicationMonitorDetailStatsTypeConverter.ConvertFrom));
            }
            ...
            if (content.Contains("SummaryId"))
            {
                ((Commvault.Powershell.Models.IReplicationMonitorDetailInternal)this).SummaryId = (long?) content.GetValueForProperty("SummaryId",((Commvault.Powershell.Models.IReplicationMonitorDetailInternal)this).SummaryId, (__y)=> (long) global::System.Convert.ChangeType(__y, typeof(long)));
            }
            ...
            if (content.Contains("SummaryEventMessage"))
            {
                ((Commvault.Powershell.Models.IReplicationMonitorDetailInternal)this).SummaryEventMessage = (string) content.GetValueForProperty("SummaryEventMessage",((Commvault.Powershell.Models.IReplicationMonitorDetailInternal)this).SummaryEventMessage, global::System.Convert.ToString);
            }
