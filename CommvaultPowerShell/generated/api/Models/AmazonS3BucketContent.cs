...
namespace Commvault.Powershell.Models
{
    ...
    public partial class AmazonS3BucketContent :
        Commvault.Powershell.Models.IAmazonS3BucketContent,
        Commvault.Powershell.Models.IAmazonS3BucketContentInternal,
        Commvault.Powershell.Runtime.IValidates
    {
        ...
        string Commvault.Powershell.Models.IAmazonS3BucketContentInternal.CloudType { get => this._cloudType; set { {_cloudType = value;} } }

        /// <summary>Internal Acessors for Credentials</summary>
        Commvault.Powershell.Models.IIdName Commvault.Powershell.Models.IAmazonS3BucketContentInternal.Credentials { get => (this._credentials = this._credentials ?? new Commvault.Powershell.Models.IdName()); set { {_credentials = value;} } }

        /// <summary>Internal Acessors for MediaAgent</summary>
        Commvault.Powershell.Models.IIdName Commvault.Powershell.Models.IAmazonS3BucketContentInternal.MediaAgent { get => (this._mediaAgent = this._mediaAgent ?? new Commvault.Powershell.Models.IdName()); set { {_mediaAgent = value;} } }
        ...
        /// <summary>Creates an new <see cref="AmazonS3BucketContent" /> instance.</summary>
        public AmazonS3BucketContent()
        {
    ...
    /// Amazon S3
    internal partial interface IAmazonS3BucketContentInternal :
