...
namespace Commvault.Powershell.Models
{
    ...
    public partial class LaptopPlanDetails
    {
        ...
        internal LaptopPlanDetails(Commvault.Powershell.Runtime.Json.JsonObject json)
        {
            ...
            {_general = If( json?.PropertyT<Commvault.Powershell.Runtime.Json.JsonObject>("general"), out var __jsonGeneral) ? Commvault.Powershell.Models.LaptopPlanGeneralInfo.FromJson(__jsonGeneral) : _general;}
            {_allowedFeatures = If( json?.PropertyT<Commvault.Powershell.Runtime.Json.JsonObject>("allowedFeatures"), out var __jsonAllowedFeatures) ? Commvault.Powershell.Models.AllowedFeatures.FromJson(__jsonAllowedFeatures) : _allowedFeatures;}
            {_rpo = If( json?.PropertyT<Commvault.Powershell.Runtime.Json.JsonObject>("rpo"), out var __jsonRpo) ? Commvault.Powershell.Models.LaptopPlanRpo.FromJson(__jsonRpo) : _rpo;}
            ...
            {_inheritSettings = If( json?.PropertyT<Commvault.Powershell.Runtime.Json.JsonObject>("inheritSettings"), out var __jsonInheritSettings) ? Commvault.Powershell.Models.LaptopPlanInheritSettings.FromJson(__jsonInheritSettings) : _inheritSettings;}
