...
namespace Commvault.Powershell.Models
{
    ...
    public partial class SyslogConfigure
    {
        ...
        /// <summary>
        /// Deserializes a <see cref="Commvault.Powershell.Runtime.Json.JsonNode"/> into an instance of Commvault.Powershell.Models.ISyslogConfigure.
        /// </summary>
        /// <param name="node">a <see cref="Commvault.Powershell.Runtime.Json.JsonNode" /> to deserialize from.</param>
        /// <returns>an instance of Commvault.Powershell.Models.ISyslogConfigure.</returns>
        public static Commvault.Powershell.Models.ISyslogConfigure FromJson(Commvault.Powershell.Runtime.Json.JsonNode node)
        {
            return node is Commvault.Powershell.Runtime.Json.JsonObject json ? new SyslogConfigure(json) : null;
        }

        /// <summary>
        /// Deserializes a Commvault.Powershell.Runtime.Json.JsonObject into a new instance of <see cref="SyslogConfigure" />.
        /// </summary>
        /// <param name="json">A Commvault.Powershell.Runtime.Json.JsonObject instance to deserialize from.</param>
        internal SyslogConfigure(Commvault.Powershell.Runtime.Json.JsonObject json)
        {
            ...
            {_certificateAuthorityContent = If( json?.PropertyT<Commvault.Powershell.Runtime.Json.JsonString>("certificateAuthorityContent"), out var __jsonCertificateAuthorityContent) ? (string)__jsonCertificateAuthorityContent : (string)_certificateAuthorityContent;}
            AfterFromJson(json);
        }

        /// <summary>
        /// Serializes this instance of <see cref="SyslogConfigure" /> into a <see cref="Commvault.Powershell.Runtime.Json.JsonNode" />.
        /// </summary>
        /// <param name="container">The <see cref="Commvault.Powershell.Runtime.Json.JsonObject"/> container to serialize this object into. If the caller
        /// passes in <c>null</c>, a new instance will be created and returned to the caller.</param>
        /// <param name="serializationMode">Allows the caller to choose the depth of the serialization. See <see cref="Commvault.Powershell.Runtime.SerializationMode"/>.</param>
        /// <returns>
        /// a serialized instance of <see cref="SyslogConfigure" /> as a <see cref="Commvault.Powershell.Runtime.Json.JsonNode" />.
        /// </returns>
