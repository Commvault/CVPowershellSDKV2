...
namespace Commvault.Powershell.Models
{
    ...
    public partial class HyperScaleDiskInfo
    {
        ...
        internal HyperScaleDiskInfo(Commvault.Powershell.Runtime.Json.JsonObject json)
        {
            ...
            {_product = If( json?.PropertyT<Commvault.Powershell.Runtime.Json.JsonString>("product"), out var __jsonProduct) ? (string)__jsonProduct : (string)_product;}
            {_fileSystem = If( json?.PropertyT<Commvault.Powershell.Runtime.Json.JsonString>("fileSystem"), out var __jsonFileSystem) ? (string)__jsonFileSystem : (string)_fileSystem;}
