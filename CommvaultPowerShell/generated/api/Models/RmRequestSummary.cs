...
namespace Commvault.Powershell.Models
{
        ...
        Commvault.Powershell.Models.IRmRequestSummaryInternal
    {
        ...
        private System.Collections.Generic.List<Commvault.Powershell.Models.IIdName> _approvers;

        /// <summary>List of the request approvers</summary>
        [Commvault.Powershell.Origin(Commvault.Powershell.PropertyOrigin.Owned)]
        public System.Collections.Generic.List<Commvault.Powershell.Models.IIdName> Approvers { get => this._approvers; set => this._approvers = value; }
        ...
        private System.Collections.Generic.List<Commvault.Powershell.Models.IIdName> _reviewers;

        /// <summary>List of request reviewers</summary>
        [Commvault.Powershell.Origin(Commvault.Powershell.PropertyOrigin.Owned)]
        public System.Collections.Generic.List<Commvault.Powershell.Models.IIdName> Reviewers { get => this._reviewers; set => this._reviewers = value; }
        ...
        Commvault.Powershell.Runtime.IJsonSerializable
    {
        ...
        System.Collections.Generic.List<Commvault.Powershell.Models.IIdName> Approvers { get; set; }
        /// <summary>Request creation time in unix epoch format</summary>
        [Commvault.Powershell.Runtime.Info(
        Required = false,
        ReadOnly = false,
        ...
        PossibleTypes = new [] { typeof(Commvault.Powershell.Models.IIdName) })]
        System.Collections.Generic.List<Commvault.Powershell.Models.IIdName> Reviewers { get; set; }
        /// <summary>Signifies the progress of the request</summary>
        [Commvault.Powershell.Runtime.Info(
        Required = false,
        ReadOnly = false,
