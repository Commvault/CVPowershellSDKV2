...
namespace Commvault.Powershell.Models
{
    ...
    public partial class CreateDiskStorage
    {
        ...
        internal CreateDiskStorage(global::System.Collections.IDictionary content)
        {
            ...
            {
                ((Commvault.Powershell.Models.ICreateDiskStorageInternal)this).Storage = (System.Collections.Generic.List<Commvault.Powershell.Models.IPath>) content.GetValueForProperty("Storage",((Commvault.Powershell.Models.ICreateDiskStorageInternal)this).Storage, __y => TypeConverterExtensions.SelectToList<Commvault.Powershell.Models.IPath>(__y, Commvault.Powershell.Models.PathTypeConverter.ConvertFrom));
            }
            if (content.Contains("EnableDeduplication"))
            {
            ...
            if (content.Contains("DeduplicationDbStorage"))
            {
                ((Commvault.Powershell.Models.ICreateDiskStorageInternal)this).DeduplicationDbStorage = (System.Collections.Generic.List<Commvault.Powershell.Models.IDedupePath>) content.GetValueForProperty("DeduplicationDbStorage",((Commvault.Powershell.Models.ICreateDiskStorageInternal)this).DeduplicationDbStorage, __y => TypeConverterExtensions.SelectToList<Commvault.Powershell.Models.IDedupePath>(__y, Commvault.Powershell.Models.DedupePathTypeConverter.ConvertFrom));
            }
        ...
        /// <returns>an instance of the <see cref="CreateDiskStorage" /> model class.</returns>
