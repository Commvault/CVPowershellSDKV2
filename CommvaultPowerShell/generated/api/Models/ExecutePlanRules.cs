...
namespace Commvault.Powershell.Models
{
        ...
        Commvault.Powershell.Models.IExecutePlanRulesInternal
    {
        ...
        private System.Collections.Generic.List<Commvault.Powershell.Models.IIdName> _backupsets;

        /// <summary>List of backupsets against which plan rules need to be executed and evaluated.</summary>
        [Commvault.Powershell.Origin(Commvault.Powershell.PropertyOrigin.Owned)]
        public System.Collections.Generic.List<Commvault.Powershell.Models.IIdName> Backupsets { get => this._backupsets; set => this._backupsets = value; }

        /// <summary>Backing field for <see cref="Clients" /> property.</summary>
        private System.Collections.Generic.List<Commvault.Powershell.Models.IIdName> _clients;

        /// <summary>List of clients against which plan rules need to be executed and evaluated.</summary>
        [Commvault.Powershell.Origin(Commvault.Powershell.PropertyOrigin.Owned)]
        public System.Collections.Generic.List<Commvault.Powershell.Models.IIdName> Clients { get => this._clients; set => this._clients = value; }
        ...
        private System.Collections.Generic.List<Commvault.Powershell.Models.IIdName> _instances;

        /// <summary>List of instances against which plan rules need to be executed and evaluated.</summary>
        [Commvault.Powershell.Origin(Commvault.Powershell.PropertyOrigin.Owned)]
        public System.Collections.Generic.List<Commvault.Powershell.Models.IIdName> Instances { get => this._instances; set => this._instances = value; }
        ...
        Commvault.Powershell.Runtime.IJsonSerializable
    {
        ...
        System.Collections.Generic.List<Commvault.Powershell.Models.IIdName> Backupsets { get; set; }
        /// <summary>List of clients against which plan rules need to be executed and evaluated.</summary>
        [Commvault.Powershell.Runtime.Info(
        Required = false,
        ReadOnly = false,
        ...
        PossibleTypes = new [] { typeof(Commvault.Powershell.Models.IIdName) })]
        System.Collections.Generic.List<Commvault.Powershell.Models.IIdName> Clients { get; set; }
        /// <summary>
        /// Boolean to indicate if we want to evaluate rule for entities associated to plan. Default is false. Only entities with
        /// no plan associated will be evaluated.
        /// </summary>
        ...
        PossibleTypes = new [] { typeof(Commvault.Powershell.Models.IIdName) })]
        System.Collections.Generic.List<Commvault.Powershell.Models.IIdName> Instances { get; set; }
        /// <summary>
        /// Boolean to indicate if request is to preview list of subclients that will be associated via plan rules
        /// </summary>
        [Commvault.Powershell.Runtime.Info(
