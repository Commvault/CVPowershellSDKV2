...
namespace Commvault.Powershell.Models
{
    ...
    public partial class InstanceSummary
    {
        ...
        internal InstanceSummary(Commvault.Powershell.Runtime.Json.JsonObject json)
        {
            ...
            {_server = If( json?.PropertyT<Commvault.Powershell.Runtime.Json.JsonString>("server"), out var __jsonServer) ? (string)__jsonServer : (string)_server;}
            ...
            {_notReadyReason = If( json?.PropertyT<Commvault.Powershell.Runtime.Json.JsonString>("notReadyReason"), out var __jsonNotReadyReason) ? (string)__jsonNotReadyReason : (string)_notReadyReason;}
