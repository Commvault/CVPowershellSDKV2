...
namespace Commvault.Powershell.Models
{
    ...
    public partial class RecoveryTargetDetails
    {
        ...
        internal RecoveryTargetDetails(Commvault.Powershell.Runtime.Json.JsonObject json)
        {
            ...
            {_entity = If( json?.PropertyT<Commvault.Powershell.Runtime.Json.JsonObject>("entity"), out var __jsonEntity) ? Commvault.Powershell.Models.GetRecoveryTargetListSummary.FromJson(__jsonEntity) : _entity;}
            {_accessNode = If( json?.PropertyT<Commvault.Powershell.Runtime.Json.JsonObject>("accessNode"), out var __jsonAccessNode) ? Commvault.Powershell.Models.IdNameType.FromJson(__jsonAccessNode) : _accessNode;}
            {_vMDisplayName = If( json?.PropertyT<Commvault.Powershell.Runtime.Json.JsonObject>("vmDisplayName"), out var __jsonVMDisplayName) ? Commvault.Powershell.Models.VMDisplayName.FromJson(__jsonVMDisplayName) : _vMDisplayName;}
            {_securityOptions = If( json?.PropertyT<Commvault.Powershell.Runtime.Json.JsonObject>("securityOptions"), out var __jsonSecurityOptions) ? Commvault.Powershell.Models.SecurityOptions.FromJson(__jsonSecurityOptions) : _securityOptions;}
            {_destinationOptions = If( json?.PropertyT<Commvault.Powershell.Runtime.Json.JsonObject>("destinationOptions"), out var __jsonDestinationOptions) ? Commvault.Powershell.Models.DestinationOptions.FromJson(__jsonDestinationOptions) : _destinationOptions;}
            {_networkOptions = If( json?.PropertyT<Commvault.Powershell.Runtime.Json.JsonObject>("networkOptions"), out var __jsonNetworkOptions) ? Commvault.Powershell.Models.NetworkOptions.FromJson(__jsonNetworkOptions) : _networkOptions;}
            {_provisioningOptions = If( json?.PropertyT<Commvault.Powershell.Runtime.Json.JsonObject>("provisioningOptions"), out var __jsonProvisioningOptions) ? Commvault.Powershell.Models.ProvisioningOptions.FromJson(__jsonProvisioningOptions) : _provisioningOptions;}
            {_cloudDestinationOptions = If( json?.PropertyT<Commvault.Powershell.Runtime.Json.JsonObject>("cloudDestinationOptions"), out var __jsonCloudDestinationOptions) ? Commvault.Powershell.Models.CloudDestinationOptions.FromJson(__jsonCloudDestinationOptions) : _cloudDestinationOptions;}
            {_zone = If( json?.PropertyT<Commvault.Powershell.Runtime.Json.JsonObject>("zone"), out var __jsonZone) ? Commvault.Powershell.Models.Zone.FromJson(__jsonZone) : _zone;}
            {_associatedClientGroup = If( json?.PropertyT<Commvault.Powershell.Runtime.Json.JsonObject>("associatedClientGroup"), out var __jsonAssociatedClientGroup) ? Commvault.Powershell.Models.IdName.FromJson(__jsonAssociatedClientGroup) : _associatedClientGroup;}
            {_liveMountOptions = If( json?.PropertyT<Commvault.Powershell.Runtime.Json.JsonObject>("liveMountOptions"), out var __jsonLiveMountOptions) ? Commvault.Powershell.Models.LiveMountOptions.FromJson(__jsonLiveMountOptions) : _liveMountOptions;}
            {_virtualLabOptions = If( json?.PropertyT<Commvault.Powershell.Runtime.Json.JsonObject>("virtualLabOptions"), out var __jsonVirtualLabOptions) ? Commvault.Powershell.Models.VirtualLabOptions.FromJson(__jsonVirtualLabOptions) : _virtualLabOptions;}
            {_vMStoragePolicyName = If( json?.PropertyT<Commvault.Powershell.Runtime.Json.JsonString>("vmStoragePolicyName"), out var __jsonVMStoragePolicyName) ? (string)__jsonVMStoragePolicyName : (string)_vMStoragePolicyName;}
            {_isoInfo = If( json?.PropertyT<Commvault.Powershell.Runtime.Json.JsonArray>("isoInfo"), out var __jsonIsoInfo) ? If( __jsonIsoInfo as Commvault.Powershell.Runtime.Json.JsonArray, out var __v) ? new global::System.Func<System.Collections.Generic.List<Commvault.Powershell.Models.IIsoInfo>>(()=> global::System.Linq.Enumerable.ToList(global::System.Linq.Enumerable.Select(__v, (__u)=>(Commvault.Powershell.Models.IIsoInfo) (Commvault.Powershell.Models.IsoInfo.FromJson(__u) )) ))() : null : _isoInfo;}
            AfterFromJson(json);
        }
