...
namespace Commvault.Powershell.Models
{
    ...
    public partial class HypervisorSettings
    {
        ...
        internal HypervisorSettings(Commvault.Powershell.Runtime.Json.JsonObject json)
        {
            ...
            {_regionInfo = If( json?.PropertyT<Commvault.Powershell.Runtime.Json.JsonObject>("regionInfo"), out var __jsonRegionInfo) ? Commvault.Powershell.Models.RegionInfo.FromJson(__jsonRegionInfo) : _regionInfo;}
            ...
            {_metricsMonitoringPolicy = If( json?.PropertyT<Commvault.Powershell.Runtime.Json.JsonObject>("metricsMonitoringPolicy"), out var __jsonMetricsMonitoringPolicy) ? Commvault.Powershell.Models.HypervisorMonitoringPolicy.FromJson(__jsonMetricsMonitoringPolicy) : _metricsMonitoringPolicy;}
            {_guestCredentials = If( json?.PropertyT<Commvault.Powershell.Runtime.Json.JsonObject>("guestCredentials"), out var __jsonGuestCredentials) ? Commvault.Powershell.Models.UserNamePassword.FromJson(__jsonGuestCredentials) : _guestCredentials;}
            {_applicationCredentials = If( json?.PropertyT<Commvault.Powershell.Runtime.Json.JsonObject>("applicationCredentials"), out var __jsonApplicationCredentials) ? Commvault.Powershell.Models.UserNamePassword.FromJson(__jsonApplicationCredentials) : _applicationCredentials;}
            {_mountAccessNode = If( json?.PropertyT<Commvault.Powershell.Runtime.Json.JsonObject>("mountAccessNode"), out var __jsonMountAccessNode) ? Commvault.Powershell.Models.IdName.FromJson(__jsonMountAccessNode) : _mountAccessNode;}
            {_customAttributes = If( json?.PropertyT<Commvault.Powershell.Runtime.Json.JsonArray>("customAttributes"), out var __jsonCustomAttributes) ? If( __jsonCustomAttributes as Commvault.Powershell.Runtime.Json.JsonArray, out var __v) ? new global::System.Func<System.Collections.Generic.List<Commvault.Powershell.Models.IHypervisorCustomAttribute>>(()=> global::System.Linq.Enumerable.ToList(global::System.Linq.Enumerable.Select(__v, (__u)=>(Commvault.Powershell.Models.IHypervisorCustomAttribute) (Commvault.Powershell.Models.HypervisorCustomAttribute.FromJson(__u) )) ))() : null : _customAttributes;}
            AfterFromJson(json);
        }
