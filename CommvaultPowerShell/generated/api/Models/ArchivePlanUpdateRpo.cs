...
namespace Commvault.Powershell.Models
{
    ...
    public partial class ArchivePlanUpdateRpo :
        Commvault.Powershell.Models.IArchivePlanUpdateRpo,
        Commvault.Powershell.Models.IArchivePlanUpdateRpoInternal
    {
        ...
        [Commvault.Powershell.Origin(Commvault.Powershell.PropertyOrigin.Inlined)]
        public System.Collections.Generic.List<string> BackupFrequencyWeeklyDays { get => ((Commvault.Powershell.Models.IBackupFrequencyPatternInternal)BackupFrequency).WeeklyDays; set => ((Commvault.Powershell.Models.IBackupFrequencyPatternInternal)BackupFrequency).WeeklyDays = value ?? null /* arrayOf */; }
        ...
        Commvault.Powershell.Models.IBackupFrequencyPattern Commvault.Powershell.Models.IArchivePlanUpdateRpoInternal.BackupFrequency { get => (this._backupFrequency = this._backupFrequency ?? new Commvault.Powershell.Models.BackupFrequencyPattern()); set { {_backupFrequency = value;} } }

        /// <summary>Internal Acessors for Sla</summary>
        Commvault.Powershell.Models.ISlaUpdateOptions Commvault.Powershell.Models.IArchivePlanUpdateRpoInternal.Sla { get => (this._sla = this._sla ?? new Commvault.Powershell.Models.SlaUpdateOptions()); set { {_sla = value;} } }
        ...
        /// <summary>Creates an new <see cref="ArchivePlanUpdateRpo" /> instance.</summary>
    ...
    /// Recovery Point Objective (RPO) is the maximum amount of time that data can be lost during a service disruption. Your RPO
    /// determines the frequency of your backup jobs.
    internal partial interface IArchivePlanUpdateRpoInternal
