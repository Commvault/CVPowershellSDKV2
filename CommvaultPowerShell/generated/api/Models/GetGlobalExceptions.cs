...
namespace Commvault.Powershell.Models
{
        ...
        Commvault.Powershell.Models.IGetGlobalExceptionsInternal
    {
        ...
        private System.Collections.Generic.List<string> _unixGlobalExceptions;

        /// <summary>List of global unix execptions</summary>
        [Commvault.Powershell.Origin(Commvault.Powershell.PropertyOrigin.Owned)]
        public System.Collections.Generic.List<string> UnixGlobalExceptions { get => this._unixGlobalExceptions; set => this._unixGlobalExceptions = value; }
        ...
        private System.Collections.Generic.List<string> _windowsGlobalExceptions;

        /// <summary>gives list of all the windowsglobal execptions</summary>
        [Commvault.Powershell.Origin(Commvault.Powershell.PropertyOrigin.Owned)]
        public System.Collections.Generic.List<string> WindowsGlobalExceptions { get => this._windowsGlobalExceptions; set => this._windowsGlobalExceptions = value; }
        ...
        Commvault.Powershell.Runtime.IJsonSerializable
    {
        ...
        System.Collections.Generic.List<string> UnixGlobalExceptions { get; set; }
        /// <summary>Boolean which signifies application of global execption on all subclients</summary>
        [Commvault.Powershell.Runtime.Info(
        Required = false,
        ReadOnly = false,
        ...
        PossibleTypes = new [] { typeof(string) })]
        System.Collections.Generic.List<string> WindowsGlobalExceptions { get; set; }
