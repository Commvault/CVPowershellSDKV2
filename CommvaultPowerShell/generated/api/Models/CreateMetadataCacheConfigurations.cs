...
namespace Commvault.Powershell.Models
{
    ...
    public partial class CreateMetadataCacheConfigurations :
        ...
        Commvault.Powershell.Models.ICreateMetadataCacheConfigurationsInternal
    {

        /// <summary>Internal Acessors for Credentials</summary>
        Commvault.Powershell.Models.IUserNamePassword Commvault.Powershell.Models.ICreateMetadataCacheConfigurationsInternal.Credentials { get => (this._credentials = this._credentials ?? new Commvault.Powershell.Models.UserNamePassword()); set { {_credentials = value;} } }

        /// <summary>Internal Acessors for MediaAgent</summary>
        Commvault.Powershell.Models.IIdName Commvault.Powershell.Models.ICreateMetadataCacheConfigurationsInternal.MediaAgent { get => (this._mediaAgent = this._mediaAgent ?? new Commvault.Powershell.Models.IdName()); set { {_mediaAgent = value;} } }

        /// <summary>Internal Acessors for SavedCredentials</summary>
        Commvault.Powershell.Models.IIdName Commvault.Powershell.Models.ICreateMetadataCacheConfigurationsInternal.SavedCredentials { get => (this._savedCredentials = this._savedCredentials ?? new Commvault.Powershell.Models.IdName()); set { {_savedCredentials = value;} } }
        ...
        /// <summary>Creates an new <see cref="CreateMetadataCacheConfigurations" /> instance.</summary>
        public CreateMetadataCacheConfigurations()
        {
    ...
    /// If adding a network access path, Please add credentials or saved credentials. If both are provided, credentials will be
    /// taken into consideration.
    internal partial interface ICreateMetadataCacheConfigurationsInternal
