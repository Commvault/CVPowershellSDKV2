...
namespace Commvault.Powershell.Models
{
    ...
    public partial class AlibabaBucketContent :
        Commvault.Powershell.Models.IAlibabaBucketContent,
        Commvault.Powershell.Models.IAlibabaBucketContentInternal,
        Commvault.Powershell.Runtime.IValidates
    {
        ...
        string Commvault.Powershell.Models.IAlibabaBucketContentInternal.CloudType { get => this._cloudType; set { {_cloudType = value;} } }

        /// <summary>Internal Acessors for Credentials</summary>
        Commvault.Powershell.Models.IIdName Commvault.Powershell.Models.IAlibabaBucketContentInternal.Credentials { get => (this._credentials = this._credentials ?? new Commvault.Powershell.Models.IdName()); set { {_credentials = value;} } }

        /// <summary>Internal Acessors for MediaAgent</summary>
        Commvault.Powershell.Models.IIdName Commvault.Powershell.Models.IAlibabaBucketContentInternal.MediaAgent { get => (this._mediaAgent = this._mediaAgent ?? new Commvault.Powershell.Models.IdName()); set { {_mediaAgent = value;} } }
        ...
        /// <summary>Creates an new <see cref="AlibabaBucketContent" /> instance.</summary>
        public AlibabaBucketContent()
        {
    ...
    /// Alibaba Cloud Object Storage Service
    internal partial interface IAlibabaBucketContentInternal :
