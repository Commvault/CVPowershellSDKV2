...
namespace Commvault.Powershell.Models
{
    ...
    public partial class AlertTriggeredSummary
    {
        ...
        internal AlertTriggeredSummary(Commvault.Powershell.Runtime.Json.JsonObject json)
        {
            ...
            {_detectedCriterion = If( json?.PropertyT<Commvault.Powershell.Runtime.Json.JsonString>("detectedCriterion"), out var __jsonDetectedCriterion) ? (string)__jsonDetectedCriterion : (string)_detectedCriterion;}
            {_info = If( json?.PropertyT<Commvault.Powershell.Runtime.Json.JsonString>("info"), out var __jsonInfo) ? (string)__jsonInfo : (string)_info;}
            {_notes = If( json?.PropertyT<Commvault.Powershell.Runtime.Json.JsonString>("notes"), out var __jsonNotes) ? (string)__jsonNotes : (string)_notes;}
            ...
            {_detectedTime = If( json?.PropertyT<Commvault.Powershell.Runtime.Json.JsonNumber>("detectedTime"), out var __jsonDetectedTime) ? (long?)__jsonDetectedTime : _detectedTime;}
            {_readStatus = If( json?.PropertyT<Commvault.Powershell.Runtime.Json.JsonBoolean>("readStatus"), out var __jsonReadStatus) ? (bool?)__jsonReadStatus : _readStatus;}
            {_pinStatus = If( json?.PropertyT<Commvault.Powershell.Runtime.Json.JsonBoolean>("pinStatus"), out var __jsonPinStatus) ? (bool?)__jsonPinStatus : _pinStatus;}
