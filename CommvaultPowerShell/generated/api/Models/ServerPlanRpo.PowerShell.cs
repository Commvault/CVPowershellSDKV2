...
namespace Commvault.Powershell.Models
{
    ...
    public partial class ServerPlanRpo
    {
        ...
        internal ServerPlanRpo(global::System.Collections.IDictionary content)
        {
            ...
            {
                ((Commvault.Powershell.Models.IServerPlanRpoInternal)this).BackupWindow = (System.Collections.Generic.List<Commvault.Powershell.Models.IDayAndTime>) content.GetValueForProperty("BackupWindow",((Commvault.Powershell.Models.IServerPlanRpoInternal)this).BackupWindow, __y => TypeConverterExtensions.SelectToList<Commvault.Powershell.Models.IDayAndTime>(__y, Commvault.Powershell.Models.DayAndTimeTypeConverter.ConvertFrom));
            }
            if (content.Contains("FullBackupWindow"))
            {
                ((Commvault.Powershell.Models.IServerPlanRpoInternal)this).FullBackupWindow = (System.Collections.Generic.List<Commvault.Powershell.Models.IDayAndTime>) content.GetValueForProperty("FullBackupWindow",((Commvault.Powershell.Models.IServerPlanRpoInternal)this).FullBackupWindow, __y => TypeConverterExtensions.SelectToList<Commvault.Powershell.Models.IDayAndTime>(__y, Commvault.Powershell.Models.DayAndTimeTypeConverter.ConvertFrom));
            }
            if (content.Contains("BackupFrequencySchedules"))
            {
                ((Commvault.Powershell.Models.IServerPlanRpoInternal)this).BackupFrequencySchedules = (System.Collections.Generic.List<Commvault.Powershell.Models.IPlanSchedule>) content.GetValueForProperty("BackupFrequencySchedules",((Commvault.Powershell.Models.IServerPlanRpoInternal)this).BackupFrequencySchedules, __y => TypeConverterExtensions.SelectToList<Commvault.Powershell.Models.IPlanSchedule>(__y, Commvault.Powershell.Models.PlanScheduleTypeConverter.ConvertFrom));
            }
