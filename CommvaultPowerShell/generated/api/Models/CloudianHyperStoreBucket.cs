...
namespace Commvault.Powershell.Models
{
    ...
    public partial class CloudianHyperStoreBucket :
        Commvault.Powershell.Models.ICloudianHyperStoreBucket,
        Commvault.Powershell.Models.ICloudianHyperStoreBucketInternal,
        Commvault.Powershell.Runtime.IValidates
    {
        ...
        string Commvault.Powershell.Models.ICloudianHyperStoreBucketInternal.CloudType { get => this._cloudType; set { {_cloudType = value;} } }

        /// <summary>Internal Acessors for Credentials</summary>
        Commvault.Powershell.Models.IIdName Commvault.Powershell.Models.ICloudianHyperStoreBucketInternal.Credentials { get => (this._credentials = this._credentials ?? new Commvault.Powershell.Models.IdName()); set { {_credentials = value;} } }

        /// <summary>Internal Acessors for MediaAgent</summary>
        Commvault.Powershell.Models.IIdName Commvault.Powershell.Models.ICloudianHyperStoreBucketInternal.MediaAgent { get => (this._mediaAgent = this._mediaAgent ?? new Commvault.Powershell.Models.IdName()); set { {_mediaAgent = value;} } }
        ...
        /// <summary>Creates an new <see cref="CloudianHyperStoreBucket" /> instance.</summary>
        public CloudianHyperStoreBucket()
        {
    ...
    /// Cloudian HyperStore
    internal partial interface ICloudianHyperStoreBucketInternal :
