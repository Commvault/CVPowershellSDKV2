...
namespace Commvault.Powershell.Models
{
    ...
    public partial class MediaAgentSummary
    {
        ...
        /// <summary>
        /// Deserializes a <see cref="Commvault.Powershell.Runtime.Json.JsonNode"/> into an instance of Commvault.Powershell.Models.IMediaAgentSummary.
        /// </summary>
        /// <param name="node">a <see cref="Commvault.Powershell.Runtime.Json.JsonNode" /> to deserialize from.</param>
        /// <returns>an instance of Commvault.Powershell.Models.IMediaAgentSummary.</returns>
        public static Commvault.Powershell.Models.IMediaAgentSummary FromJson(Commvault.Powershell.Runtime.Json.JsonNode node)
        {
            return node is Commvault.Powershell.Runtime.Json.JsonObject json ? new MediaAgentSummary(json) : null;
        }

        /// <summary>
        /// Deserializes a Commvault.Powershell.Runtime.Json.JsonObject into a new instance of <see cref="MediaAgentSummary" />.
        /// </summary>
        /// <param name="json">A Commvault.Powershell.Runtime.Json.JsonObject instance to deserialize from.</param>
        internal MediaAgentSummary(Commvault.Powershell.Runtime.Json.JsonObject json)
        {
            ...
            {_operatingSystem = If( json?.PropertyT<Commvault.Powershell.Runtime.Json.JsonObject>("operatingSystem"), out var __jsonOperatingSystem) ? Commvault.Powershell.Models.IdNameType.FromJson(__jsonOperatingSystem) : _operatingSystem;}
            ...
            {_isUnlicensedMa = If( json?.PropertyT<Commvault.Powershell.Runtime.Json.JsonBoolean>("isUnlicensedMA"), out var __jsonIsUnlicensedMa) ? (bool?)__jsonIsUnlicensedMa : _isUnlicensedMa;}
            {_offlineReason = If( json?.PropertyT<Commvault.Powershell.Runtime.Json.JsonString>("offlineReason"), out var __jsonOfflineReason) ? (string)__jsonOfflineReason : (string)_offlineReason;}
            {_offlineReasonValue = If( json?.PropertyT<Commvault.Powershell.Runtime.Json.JsonNumber>("offlineReasonValue"), out var __jsonOfflineReasonValue) ? (long?)__jsonOfflineReasonValue : _offlineReasonValue;}
            ...
            {_releaseId = If( json?.PropertyT<Commvault.Powershell.Runtime.Json.JsonNumber>("releaseId"), out var __jsonReleaseId) ? (long?)__jsonReleaseId : _releaseId;}
        ...
        /// <summary>
        /// Serializes this instance of <see cref="MediaAgentSummary" /> into a <see cref="Commvault.Powershell.Runtime.Json.JsonNode" />.
        /// </summary>
        /// <param name="container">The <see cref="Commvault.Powershell.Runtime.Json.JsonObject"/> container to serialize this object into. If the caller
        /// passes in <c>null</c>, a new instance will be created and returned to the caller.</param>
        /// <param name="serializationMode">Allows the caller to choose the depth of the serialization. See <see cref="Commvault.Powershell.Runtime.SerializationMode"/>.</param>
        /// <returns>
        /// a serialized instance of <see cref="MediaAgentSummary" /> as a <see cref="Commvault.Powershell.Runtime.Json.JsonNode" />.
        /// </returns>
        public Commvault.Powershell.Runtime.Json.JsonNode ToJson(Commvault.Powershell.Runtime.Json.JsonObject container, Commvault.Powershell.Runtime.SerializationMode serializationMode)
        {
            ...
            AddIf( null != this._operatingSystem ? (Commvault.Powershell.Runtime.Json.JsonNode) this._operatingSystem.ToJson(null,serializationMode) : null, "operatingSystem" ,container.Add );
