...
namespace Commvault.Powershell.Models
{
    ...
    public partial class DeactivationOptions
    {
        ...
        internal DeactivationOptions(Commvault.Powershell.Runtime.Json.JsonObject json)
        {
            ...
            {_disableBackup = If( json?.PropertyT<Commvault.Powershell.Runtime.Json.JsonBoolean>("disableBackup"), out var __jsonDisableBackup) ? (bool?)__jsonDisableBackup : _disableBackup;}
            {_disableRestore = If( json?.PropertyT<Commvault.Powershell.Runtime.Json.JsonBoolean>("disableRestore"), out var __jsonDisableRestore) ? (bool?)__jsonDisableRestore : _disableRestore;}
            {_disableLogin = If( json?.PropertyT<Commvault.Powershell.Runtime.Json.JsonBoolean>("disableLogin"), out var __jsonDisableLogin) ? (bool?)__jsonDisableLogin : _disableLogin;}
            AfterFromJson(json);
        }
