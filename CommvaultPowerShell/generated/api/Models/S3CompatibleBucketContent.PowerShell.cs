...
namespace Commvault.Powershell.Models
{
    ...
    public partial class S3CompatibleBucketContent
    {
        ...
        /// <returns>an instance of the <see cref="S3CompatibleBucketContent" /> model class.</returns>
        ...
        internal S3CompatibleBucketContent(global::System.Collections.IDictionary content)
        {
            ...
            {
                ((Commvault.Powershell.Models.IS3CompatibleBucketContentInternal)this).MediaAgent = (Commvault.Powershell.Models.IIdName) content.GetValueForProperty("MediaAgent",((Commvault.Powershell.Models.IS3CompatibleBucketContentInternal)this).MediaAgent, Commvault.Powershell.Models.IdNameTypeConverter.ConvertFrom);
            }
            ...
            {
                ((Commvault.Powershell.Models.IS3CompatibleBucketContentInternal)this).MediaAgentId = (long?) content.GetValueForProperty("MediaAgentId",((Commvault.Powershell.Models.IS3CompatibleBucketContentInternal)this).MediaAgentId, (__y)=> (long) global::System.Convert.ChangeType(__y, typeof(long)));
            }
            if (content.Contains("MediaAgentName"))
            {
                ((Commvault.Powershell.Models.IS3CompatibleBucketContentInternal)this).MediaAgentName = (string) content.GetValueForProperty("MediaAgentName",((Commvault.Powershell.Models.IS3CompatibleBucketContentInternal)this).MediaAgentName, global::System.Convert.ToString);
            }
            if (content.Contains("CredentialsId"))
            {
                ((Commvault.Powershell.Models.IS3CompatibleBucketContentInternal)this).CredentialsId = (long?) content.GetValueForProperty("CredentialsId",((Commvault.Powershell.Models.IS3CompatibleBucketContentInternal)this).CredentialsId, (__y)=> (long) global::System.Convert.ChangeType(__y, typeof(long)));
            }
