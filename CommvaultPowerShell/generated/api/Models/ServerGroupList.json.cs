...
namespace Commvault.Powershell.Models
{
    ...
    public partial class ServerGroupList
    {
        ...
        internal ServerGroupList(Commvault.Powershell.Runtime.Json.JsonObject json)
        {
            ...
            {_association = If( json?.PropertyT<Commvault.Powershell.Runtime.Json.JsonString>("association"), out var __jsonAssociation) ? (string)__jsonAssociation : (string)_association;}
            {_isSyncInProgress = If( json?.PropertyT<Commvault.Powershell.Runtime.Json.JsonBoolean>("isSyncInProgress"), out var __jsonIsSyncInProgress) ? (bool?)__jsonIsSyncInProgress : _isSyncInProgress;}
            {_isCompanySmartClientGroup = If( json?.PropertyT<Commvault.Powershell.Runtime.Json.JsonBoolean>("isCompanySmartClientGroup"), out var __jsonIsCompanySmartClientGroup) ? (bool?)__jsonIsCompanySmartClientGroup : _isCompanySmartClientGroup;}
