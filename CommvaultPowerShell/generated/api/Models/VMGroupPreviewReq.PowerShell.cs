...
namespace Commvault.Powershell.Models
{
    ...
    public partial class VMGroupPreviewReq
    {
        ...
        internal VMGroupPreviewReq(global::System.Collections.IDictionary content)
        {
            ...
            ((Commvault.Powershell.Models.IVMGroupPreviewReqInternal)this).Filters = (Commvault.Powershell.Models.IVMContent) content.GetValueForProperty("Filters",((Commvault.Powershell.Models.IVMGroupPreviewReqInternal)this).Filters, Commvault.Powershell.Models.VMContentTypeConverter.ConvertFrom);
            ((Commvault.Powershell.Models.IVMGroupPreviewReqInternal)this).DiskFilters = (Commvault.Powershell.Models.IVMDiskFilterProp) content.GetValueForProperty("DiskFilters",((Commvault.Powershell.Models.IVMGroupPreviewReqInternal)this).DiskFilters, Commvault.Powershell.Models.VMDiskFilterPropTypeConverter.ConvertFrom);
            ...
            ((Commvault.Powershell.Models.IVMGroupPreviewReqInternal)this).FilterOverwrite = (bool?) content.GetValueForProperty("FilterOverwrite",((Commvault.Powershell.Models.IVMGroupPreviewReqInternal)this).FilterOverwrite, (__y)=> (bool) global::System.Convert.ChangeType(__y, typeof(bool)));
            ((Commvault.Powershell.Models.IVMGroupPreviewReqInternal)this).FilterVirtualMachines = (Commvault.Powershell.Models.IVirtualMachinecontent[]) content.GetValueForProperty("FilterVirtualMachines",((Commvault.Powershell.Models.IVMGroupPreviewReqInternal)this).FilterVirtualMachines, __y => TypeConverterExtensions.SelectToArray<Commvault.Powershell.Models.IVirtualMachinecontent>(__y, Commvault.Powershell.Models.VirtualMachinecontentTypeConverter.ConvertFrom));
            ((Commvault.Powershell.Models.IVMGroupPreviewReqInternal)this).FilterRuleGroups = (Commvault.Powershell.Models.IRuleGroupContent[]) content.GetValueForProperty("FilterRuleGroups",((Commvault.Powershell.Models.IVMGroupPreviewReqInternal)this).FilterRuleGroups, __y => TypeConverterExtensions.SelectToArray<Commvault.Powershell.Models.IRuleGroupContent>(__y, Commvault.Powershell.Models.RuleGroupContentTypeConverter.ConvertFrom));
            ((Commvault.Powershell.Models.IVMGroupPreviewReqInternal)this).DiskFilterOverwrite = (bool?) content.GetValueForProperty("DiskFilterOverwrite",((Commvault.Powershell.Models.IVMGroupPreviewReqInternal)this).DiskFilterOverwrite, (__y)=> (bool) global::System.Convert.ChangeType(__y, typeof(bool)));
            ((Commvault.Powershell.Models.IVMGroupPreviewReqInternal)this).DiskFilterRules = (Commvault.Powershell.Models.IVMDiskFilter[]) content.GetValueForProperty("DiskFilterRules",((Commvault.Powershell.Models.IVMGroupPreviewReqInternal)this).DiskFilterRules, __y => TypeConverterExtensions.SelectToArray<Commvault.Powershell.Models.IVMDiskFilter>(__y, Commvault.Powershell.Models.VMDiskFilterTypeConverter.ConvertFrom));
