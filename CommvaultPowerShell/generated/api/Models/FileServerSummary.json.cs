...
namespace Commvault.Powershell.Models
{
    ...
    public partial class FileServerSummary
    {
        ...
        /// <summary>
        /// Deserializes a Commvault.Powershell.Runtime.Json.JsonObject into a new instance of <see cref="FileServerSummary" />.
        /// </summary>
        /// <param name="json">A Commvault.Powershell.Runtime.Json.JsonObject instance to deserialize from.</param>
        internal FileServerSummary(Commvault.Powershell.Runtime.Json.JsonObject json)
        {
            ...
            {_lastBackup = If( json?.PropertyT<Commvault.Powershell.Runtime.Json.JsonObject>("lastBackup"), out var __jsonLastBackup) ? Commvault.Powershell.Models.LastBackupJobInfoWithLastSuccessfulBackup.FromJson(__jsonLastBackup) : _lastBackup;}
            ...
            {_sla = If( json?.PropertyT<Commvault.Powershell.Runtime.Json.JsonObject>("SLA"), out var __jsonSla) ? Commvault.Powershell.Models.SlaDetailsWithReasonEntity.FromJson(__jsonSla) : _sla;}
            ...
            {_commcellName = If( json?.PropertyT<Commvault.Powershell.Runtime.Json.JsonString>("commcellName"), out var __jsonCommcellName) ? (string)__jsonCommcellName : (string)_commcellName;}
        ...
        /// <summary>
        /// Deserializes a <see cref="Commvault.Powershell.Runtime.Json.JsonNode"/> into an instance of Commvault.Powershell.Models.IFileServerSummary.
        /// </summary>
        /// <param name="node">a <see cref="Commvault.Powershell.Runtime.Json.JsonNode" /> to deserialize from.</param>
        /// <returns>an instance of Commvault.Powershell.Models.IFileServerSummary.</returns>
        public static Commvault.Powershell.Models.IFileServerSummary FromJson(Commvault.Powershell.Runtime.Json.JsonNode node)
        {
            return node is Commvault.Powershell.Runtime.Json.JsonObject json ? new FileServerSummary(json) : null;
        }

        /// <summary>
        /// Serializes this instance of <see cref="FileServerSummary" /> into a <see cref="Commvault.Powershell.Runtime.Json.JsonNode" />.
        /// </summary>
        /// <param name="container">The <see cref="Commvault.Powershell.Runtime.Json.JsonObject"/> container to serialize this object into. If the caller
        /// passes in <c>null</c>, a new instance will be created and returned to the caller.</param>
        /// <param name="serializationMode">Allows the caller to choose the depth of the serialization. See <see cref="Commvault.Powershell.Runtime.SerializationMode"/>.</param>
        /// <returns>
        /// a serialized instance of <see cref="FileServerSummary" /> as a <see cref="Commvault.Powershell.Runtime.Json.JsonNode" />.
        /// </returns>
