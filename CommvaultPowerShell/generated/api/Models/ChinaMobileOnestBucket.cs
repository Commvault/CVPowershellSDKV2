...
namespace Commvault.Powershell.Models
{
    ...
    public partial class ChinaMobileOnestBucket :
        Commvault.Powershell.Models.IChinaMobileOnestBucket,
        Commvault.Powershell.Models.IChinaMobileOnestBucketInternal,
        Commvault.Powershell.Runtime.IValidates
    {
        ...
        string Commvault.Powershell.Models.IChinaMobileOnestBucketInternal.CloudType { get => this._cloudType; set { {_cloudType = value;} } }

        /// <summary>Internal Acessors for Credentials</summary>
        Commvault.Powershell.Models.IIdName Commvault.Powershell.Models.IChinaMobileOnestBucketInternal.Credentials { get => (this._credentials = this._credentials ?? new Commvault.Powershell.Models.IdName()); set { {_credentials = value;} } }

        /// <summary>Internal Acessors for MediaAgent</summary>
        Commvault.Powershell.Models.IIdName Commvault.Powershell.Models.IChinaMobileOnestBucketInternal.MediaAgent { get => (this._mediaAgent = this._mediaAgent ?? new Commvault.Powershell.Models.IdName()); set { {_mediaAgent = value;} } }
        ...
        /// <summary>Creates an new <see cref="ChinaMobileOnestBucket" /> instance.</summary>
        public ChinaMobileOnestBucket()
        {
    ...
    /// China Mobile oNest
    internal partial interface IChinaMobileOnestBucketInternal :
