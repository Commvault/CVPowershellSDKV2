...
namespace Commvault.Powershell.Models
{
        ...
        Commvault.Powershell.Models.IPlanFileSearchInternal
    {
        ...
        private System.Collections.Generic.List<Commvault.Powershell.Models.IPlanFileSearchSetupError> _errors;

        /// <summary>
        /// File search was enabled on plan but failed to process some of the storage pool(s) with these errors
        /// </summary>
        [Commvault.Powershell.Origin(Commvault.Powershell.PropertyOrigin.Owned)]
        public System.Collections.Generic.List<Commvault.Powershell.Models.IPlanFileSearchSetupError> Errors { get => this._errors; set => this._errors = value; }
        ...
        Commvault.Powershell.Runtime.IJsonSerializable
    {
        ...
        System.Collections.Generic.List<Commvault.Powershell.Models.IPlanFileSearchSetupError> Errors { get; set; }
        /// <summary>Type of indexing status.</summary>
        [Commvault.Powershell.Runtime.Info(
        Required = false,
        ReadOnly = false,
