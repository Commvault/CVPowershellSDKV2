...
namespace Commvault.Powershell.Models
{
    ...
    public partial class UpdateAdldap
    {
        ...
        internal UpdateAdldap(Commvault.Powershell.Runtime.Json.JsonObject json)
        {
            ...
            {_osxServerName = If( json?.PropertyT<Commvault.Powershell.Runtime.Json.JsonString>("OSXServerName"), out var __jsonOsxServerName) ? (string)__jsonOsxServerName : (string)_osxServerName;}
            {_netbiosName = If( json?.PropertyT<Commvault.Powershell.Runtime.Json.JsonString>("NETBIOSName"), out var __jsonNetbiosName) ? (string)__jsonNetbiosName : (string)_netbiosName;}
