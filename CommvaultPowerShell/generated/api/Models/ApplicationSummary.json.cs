...
namespace Commvault.Powershell.Models
{
    ...
    public partial class ApplicationSummary
    {
        ...
        internal ApplicationSummary(Commvault.Powershell.Runtime.Json.JsonObject json)
        {
            ...
            {_cluster = If( json?.PropertyT<Commvault.Powershell.Runtime.Json.JsonObject>("cluster"), out var __jsonCluster) ? Commvault.Powershell.Models.IdName.FromJson(__jsonCluster) : _cluster;}
            ...
            {_k8ApplicationSize = If( json?.PropertyT<Commvault.Powershell.Runtime.Json.JsonNumber>("K8applicationSize"), out var __jsonK8ApplicationSize) ? (long?)__jsonK8ApplicationSize : _k8ApplicationSize;}
            AfterFromJson(json);
        }
