...
namespace Commvault.Powershell.Models
{
    ...
    public partial class EmcAtmosBucketContent :
        Commvault.Powershell.Models.IEmcAtmosBucketContent,
        Commvault.Powershell.Models.IEmcAtmosBucketContentInternal,
        Commvault.Powershell.Runtime.IValidates
    {
        ...
        string Commvault.Powershell.Models.IEmcAtmosBucketContentInternal.CloudType { get => this._cloudType; set { {_cloudType = value;} } }

        /// <summary>Internal Acessors for Credentials</summary>
        Commvault.Powershell.Models.IIdName Commvault.Powershell.Models.IEmcAtmosBucketContentInternal.Credentials { get => (this._credentials = this._credentials ?? new Commvault.Powershell.Models.IdName()); set { {_credentials = value;} } }

        /// <summary>Internal Acessors for MediaAgent</summary>
        Commvault.Powershell.Models.IIdName Commvault.Powershell.Models.IEmcAtmosBucketContentInternal.MediaAgent { get => (this._mediaAgent = this._mediaAgent ?? new Commvault.Powershell.Models.IdName()); set { {_mediaAgent = value;} } }
        ...
        /// <summary>Creates an new <see cref="EmcAtmosBucketContent" /> instance.</summary>
        public EmcAtmosBucketContent()
        {
    ...
    /// EMC Atmos
    internal partial interface IEmcAtmosBucketContentInternal :
