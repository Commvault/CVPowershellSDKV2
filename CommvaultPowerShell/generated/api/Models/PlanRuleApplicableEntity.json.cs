...
namespace Commvault.Powershell.Models
{
    ...
    public partial class PlanRuleApplicableEntity
    {
        ...
        internal PlanRuleApplicableEntity(Commvault.Powershell.Runtime.Json.JsonObject json)
        {
            ...
            {_evaluatedPlan = If( json?.PropertyT<Commvault.Powershell.Runtime.Json.JsonObject>("evaluatedPlan"), out var __jsonEvaluatedPlan) ? Commvault.Powershell.Models.IdName.FromJson(__jsonEvaluatedPlan) : _evaluatedPlan;}
            {_currentPlan = If( json?.PropertyT<Commvault.Powershell.Runtime.Json.JsonObject>("currentPlan"), out var __jsonCurrentPlan) ? Commvault.Powershell.Models.IdName.FromJson(__jsonCurrentPlan) : _currentPlan;}
            {_ruleDetails = If( json?.PropertyT<Commvault.Powershell.Runtime.Json.JsonObject>("ruleDetails"), out var __jsonRuleDetails) ? Commvault.Powershell.Models.PlanEntityRuleInfo.FromJson(__jsonRuleDetails) : _ruleDetails;}
            AfterFromJson(json);
        }
