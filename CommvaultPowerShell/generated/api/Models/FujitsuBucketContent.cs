...
namespace Commvault.Powershell.Models
{
    ...
    public partial class FujitsuBucketContent :
        Commvault.Powershell.Models.IFujitsuBucketContent,
        Commvault.Powershell.Models.IFujitsuBucketContentInternal,
        Commvault.Powershell.Runtime.IValidates
    {
        ...
        string Commvault.Powershell.Models.IFujitsuBucketContentInternal.CloudType { get => this._cloudType; set { {_cloudType = value;} } }

        /// <summary>Internal Acessors for Credentials</summary>
        Commvault.Powershell.Models.IIdName Commvault.Powershell.Models.IFujitsuBucketContentInternal.Credentials { get => (this._credentials = this._credentials ?? new Commvault.Powershell.Models.IdName()); set { {_credentials = value;} } }

        /// <summary>Internal Acessors for MediaAgent</summary>
        Commvault.Powershell.Models.IIdName Commvault.Powershell.Models.IFujitsuBucketContentInternal.MediaAgent { get => (this._mediaAgent = this._mediaAgent ?? new Commvault.Powershell.Models.IdName()); set { {_mediaAgent = value;} } }
        ...
        /// <summary>Creates an new <see cref="FujitsuBucketContent" /> instance.</summary>
        public FujitsuBucketContent()
        {
    ...
    /// Fujitsu Storage ETERNUS CD10000
    internal partial interface IFujitsuBucketContentInternal :
