...
namespace Commvault.Powershell.Models
{
    ...
    public partial class OverrideReplicationOptionsHyperV
    {
        ...
        internal OverrideReplicationOptionsHyperV(Commvault.Powershell.Runtime.Json.JsonObject json)
        {
            ...
            {_registerVMWithFailoverCluster = If( json?.PropertyT<Commvault.Powershell.Runtime.Json.JsonString>("registerVMWithFailoverCluster"), out var __jsonRegisterVMWithFailoverCluster) ? (string)__jsonRegisterVMWithFailoverCluster : (string)_registerVMWithFailoverCluster;}
            {_networkAdapter = If( json?.PropertyT<Commvault.Powershell.Runtime.Json.JsonArray>("networkAdapter"), out var __jsonNetworkAdapter) ? If( __jsonNetworkAdapter as Commvault.Powershell.Runtime.Json.JsonArray, out var __v) ? new global::System.Func<System.Collections.Generic.List<Commvault.Powershell.Models.INetworkName>>(()=> global::System.Linq.Enumerable.ToList(global::System.Linq.Enumerable.Select(__v, (__u)=>(Commvault.Powershell.Models.INetworkName) (Commvault.Powershell.Models.NetworkName.FromJson(__u) )) ))() : null : _networkAdapter;}
            AfterFromJson(json);
        }
