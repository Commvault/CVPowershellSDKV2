...
namespace Commvault.Powershell.Models
{
    ...
    public partial class ReplicationConfigurationHyperV
    {
        ...
        internal ReplicationConfigurationHyperV(Commvault.Powershell.Runtime.Json.JsonObject json)
        {
            ...
            {_overrideReplicationOptions = If( json?.PropertyT<Commvault.Powershell.Runtime.Json.JsonObject>("overrideReplicationOptions"), out var __jsonOverrideReplicationOptions) ? Commvault.Powershell.Models.OverrideReplicationOptionsHyperV.FromJson(__jsonOverrideReplicationOptions) : _overrideReplicationOptions;}
            ...
            {_hypervHost = If( json?.PropertyT<Commvault.Powershell.Runtime.Json.JsonString>("hypervHost"), out var __jsonHypervHost) ? (string)__jsonHypervHost : (string)_hypervHost;}
            {_destinationVolume = If( json?.PropertyT<Commvault.Powershell.Runtime.Json.JsonString>("destinationVolume"), out var __jsonDestinationVolume) ? (string)__jsonDestinationVolume : (string)_destinationVolume;}
            AfterFromJson(json);
        }
