...
namespace Commvault.Powershell.Models
{
    ...
    public partial class S3CompatibleBucketContent :
        Commvault.Powershell.Models.IS3CompatibleBucketContent,
        Commvault.Powershell.Models.IS3CompatibleBucketContentInternal,
        Commvault.Powershell.Runtime.IValidates
    {
        ...
        string Commvault.Powershell.Models.IS3CompatibleBucketContentInternal.CloudType { get => this._cloudType; set { {_cloudType = value;} } }

        /// <summary>Internal Acessors for Credentials</summary>
        Commvault.Powershell.Models.IIdName Commvault.Powershell.Models.IS3CompatibleBucketContentInternal.Credentials { get => (this._credentials = this._credentials ?? new Commvault.Powershell.Models.IdName()); set { {_credentials = value;} } }

        /// <summary>Internal Acessors for MediaAgent</summary>
        Commvault.Powershell.Models.IIdName Commvault.Powershell.Models.IS3CompatibleBucketContentInternal.MediaAgent { get => (this._mediaAgent = this._mediaAgent ?? new Commvault.Powershell.Models.IdName()); set { {_mediaAgent = value;} } }
        ...
        /// <summary>Creates an new <see cref="S3CompatibleBucketContent" /> instance.</summary>
        public S3CompatibleBucketContent()
        {
    ...
    /// S3 Compatible Storage
    internal partial interface IS3CompatibleBucketContentInternal :
