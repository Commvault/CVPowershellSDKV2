...
namespace Commvault.Powershell.Models
{
    ...
    public partial class DatabaseSummary
    {
        ...
        /// <summary>
        /// Deserializes a Commvault.Powershell.Runtime.Json.JsonObject into a new instance of <see cref="DatabaseSummary" />.
        /// </summary>
        /// <param name="json">A Commvault.Powershell.Runtime.Json.JsonObject instance to deserialize from.</param>
        internal DatabaseSummary(Commvault.Powershell.Runtime.Json.JsonObject json)
        {
            ...
            {_server = If( json?.PropertyT<Commvault.Powershell.Runtime.Json.JsonObject>("server"), out var __jsonServer) ? Commvault.Powershell.Models.IdName.FromJson(__jsonServer) : _server;}
            ...
            {_applicationId = If( json?.PropertyT<Commvault.Powershell.Runtime.Json.JsonNumber>("applicationId"), out var __jsonApplicationId) ? (long?)__jsonApplicationId : _applicationId;}
            ...
            {_databaseEngine = If( json?.PropertyT<Commvault.Powershell.Runtime.Json.JsonString>("databaseEngine"), out var __jsonDatabaseEngine) ? (string)__jsonDatabaseEngine : (string)_databaseEngine;}
            {_recoveryModel = If( json?.PropertyT<Commvault.Powershell.Runtime.Json.JsonString>("recoveryModel"), out var __jsonRecoveryModel) ? (string)__jsonRecoveryModel : (string)_recoveryModel;}
            {_slaStatus = If( json?.PropertyT<Commvault.Powershell.Runtime.Json.JsonString>("SLAStatus"), out var __jsonSlaStatus) ? (string)__jsonSlaStatus : (string)_slaStatus;}
            {_lastBackupSize = If( json?.PropertyT<Commvault.Powershell.Runtime.Json.JsonNumber>("lastBackupSize"), out var __jsonLastBackupSize) ? (long?)__jsonLastBackupSize : _lastBackupSize;}
            {_lastBackupTime = If( json?.PropertyT<Commvault.Powershell.Runtime.Json.JsonNumber>("lastBackupTime"), out var __jsonLastBackupTime) ? (long?)__jsonLastBackupTime : _lastBackupTime;}
            AfterFromJson(json);
        }

        /// <summary>
        /// Deserializes a <see cref="Commvault.Powershell.Runtime.Json.JsonNode"/> into an instance of Commvault.Powershell.Models.IDatabaseSummary.
        /// </summary>
        /// <param name="node">a <see cref="Commvault.Powershell.Runtime.Json.JsonNode" /> to deserialize from.</param>
        /// <returns>an instance of Commvault.Powershell.Models.IDatabaseSummary.</returns>
        public static Commvault.Powershell.Models.IDatabaseSummary FromJson(Commvault.Powershell.Runtime.Json.JsonNode node)
        {
            return node is Commvault.Powershell.Runtime.Json.JsonObject json ? new DatabaseSummary(json) : null;
        }

        /// <summary>
        /// Serializes this instance of <see cref="DatabaseSummary" /> into a <see cref="Commvault.Powershell.Runtime.Json.JsonNode" />.
        /// </summary>
        /// <param name="container">The <see cref="Commvault.Powershell.Runtime.Json.JsonObject"/> container to serialize this object into. If the caller
        /// passes in <c>null</c>, a new instance will be created and returned to the caller.</param>
        /// <param name="serializationMode">Allows the caller to choose the depth of the serialization. See <see cref="Commvault.Powershell.Runtime.SerializationMode"/>.</param>
        /// <returns>
        /// a serialized instance of <see cref="DatabaseSummary" /> as a <see cref="Commvault.Powershell.Runtime.Json.JsonNode" />.
        /// </returns>
        public Commvault.Powershell.Runtime.Json.JsonNode ToJson(Commvault.Powershell.Runtime.Json.JsonObject container, Commvault.Powershell.Runtime.SerializationMode serializationMode)
        {
            ...
            AddIf( null != (((object)this._recoveryModel)?.ToString()) ? (Commvault.Powershell.Runtime.Json.JsonNode) new Commvault.Powershell.Runtime.Json.JsonString(this._recoveryModel.ToString()) : null, "recoveryModel" ,container.Add );
