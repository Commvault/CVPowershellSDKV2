...
namespace Commvault.Powershell.Models
{
    ...
    public partial class InstantClonesSummary
    {
        ...
        internal InstantClonesSummary(Commvault.Powershell.Runtime.Json.JsonObject json)
        {
            ...
            {_mountedHost = If( json?.PropertyT<Commvault.Powershell.Runtime.Json.JsonObject>("mountedHost"), out var __jsonMountedHost) ? Commvault.Powershell.Models.IdName.FromJson(__jsonMountedHost) : _mountedHost;}
            {_targetInstance = If( json?.PropertyT<Commvault.Powershell.Runtime.Json.JsonObject>("targetInstance"), out var __jsonTargetInstance) ? Commvault.Powershell.Models.IdName.FromJson(__jsonTargetInstance) : _targetInstance;}
            ...
            {_cloneJobId = If( json?.PropertyT<Commvault.Powershell.Runtime.Json.JsonNumber>("cloneJobId"), out var __jsonCloneJobId) ? (long?)__jsonCloneJobId : _cloneJobId;}
            {_sqlRecoveryId = If( json?.PropertyT<Commvault.Powershell.Runtime.Json.JsonNumber>("sqlRecoveryId"), out var __jsonSqlRecoveryId) ? (long?)__jsonSqlRecoveryId : _sqlRecoveryId;}
            {_databaseAsOfTime = If( json?.PropertyT<Commvault.Powershell.Runtime.Json.JsonNumber>("databaseAsOfTime"), out var __jsonDatabaseAsOfTime) ? (long?)__jsonDatabaseAsOfTime : _databaseAsOfTime;}
            ...
            {_expirationDate = If( json?.PropertyT<Commvault.Powershell.Runtime.Json.JsonNumber>("expirationDate"), out var __jsonExpirationDate) ? (long?)__jsonExpirationDate : _expirationDate;}
