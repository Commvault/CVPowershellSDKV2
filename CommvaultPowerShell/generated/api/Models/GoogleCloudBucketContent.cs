...
namespace Commvault.Powershell.Models
{
    ...
    public partial class GoogleCloudBucketContent :
        Commvault.Powershell.Models.IGoogleCloudBucketContent,
        Commvault.Powershell.Models.IGoogleCloudBucketContentInternal,
        Commvault.Powershell.Runtime.IValidates
    {
        ...
        string Commvault.Powershell.Models.IGoogleCloudBucketContentInternal.CloudType { get => this._cloudType; set { {_cloudType = value;} } }

        /// <summary>Internal Acessors for Credentials</summary>
        Commvault.Powershell.Models.IIdName Commvault.Powershell.Models.IGoogleCloudBucketContentInternal.Credentials { get => (this._credentials = this._credentials ?? new Commvault.Powershell.Models.IdName()); set { {_credentials = value;} } }

        /// <summary>Internal Acessors for MediaAgent</summary>
        Commvault.Powershell.Models.IIdName Commvault.Powershell.Models.IGoogleCloudBucketContentInternal.MediaAgent { get => (this._mediaAgent = this._mediaAgent ?? new Commvault.Powershell.Models.IdName()); set { {_mediaAgent = value;} } }
        ...
        /// <summary>Creates an new <see cref="GoogleCloudBucketContent" /> instance.</summary>
        public GoogleCloudBucketContent()
        {
    ...
    /// Google Cloud Storage
    internal partial interface IGoogleCloudBucketContentInternal :
