...
namespace Commvault.Powershell.Models
{
    ...
    public partial class HitachiContentCloudBucketContent :
        Commvault.Powershell.Models.IHitachiContentCloudBucketContent,
        Commvault.Powershell.Models.IHitachiContentCloudBucketContentInternal,
        Commvault.Powershell.Runtime.IValidates
    {
        ...
        string Commvault.Powershell.Models.IHitachiContentCloudBucketContentInternal.CloudType { get => this._cloudType; set { {_cloudType = value;} } }

        /// <summary>Internal Acessors for Credentials</summary>
        Commvault.Powershell.Models.IIdName Commvault.Powershell.Models.IHitachiContentCloudBucketContentInternal.Credentials { get => (this._credentials = this._credentials ?? new Commvault.Powershell.Models.IdName()); set { {_credentials = value;} } }

        /// <summary>Internal Acessors for MediaAgent</summary>
        Commvault.Powershell.Models.IIdName Commvault.Powershell.Models.IHitachiContentCloudBucketContentInternal.MediaAgent { get => (this._mediaAgent = this._mediaAgent ?? new Commvault.Powershell.Models.IdName()); set { {_mediaAgent = value;} } }
        ...
        /// <summary>Creates an new <see cref="HitachiContentCloudBucketContent" /> instance.</summary>
        public HitachiContentCloudBucketContent()
        {
    ...
    /// Hitachi Content Platform for Cloud Scale
    internal partial interface IHitachiContentCloudBucketContentInternal :
