...
namespace Commvault.Powershell.Models
{
    ...
    public partial class CreateUser
    {
        ...
        /// <summary>
        /// Deserializes a Commvault.Powershell.Runtime.Json.JsonObject into a new instance of <see cref="CreateUser" />.
        /// </summary>
        /// <param name="json">A Commvault.Powershell.Runtime.Json.JsonObject instance to deserialize from.</param>
        internal CreateUser(Commvault.Powershell.Runtime.Json.JsonObject json)
        {
            ...
            {_externalProviderId = If( json?.PropertyT<Commvault.Powershell.Runtime.Json.JsonNumber>("externalProviderId"), out var __jsonExternalProviderId) ? (long?)__jsonExternalProviderId : _externalProviderId;}
            ...
            {_useSystemGeneratePassword = If( json?.PropertyT<Commvault.Powershell.Runtime.Json.JsonBoolean>("useSystemGeneratePassword"), out var __jsonUseSystemGeneratePassword) ? (bool?)__jsonUseSystemGeneratePassword : _useSystemGeneratePassword;}
            ...
            {_inviteUser = If( json?.PropertyT<Commvault.Powershell.Runtime.Json.JsonBoolean>("inviteUser"), out var __jsonInviteUser) ? (bool?)__jsonInviteUser : _inviteUser;}
            AfterFromJson(json);
        }

        /// <summary>
        /// Deserializes a <see cref="Commvault.Powershell.Runtime.Json.JsonNode"/> into an instance of Commvault.Powershell.Models.ICreateUser.
        /// </summary>
        /// <param name="node">a <see cref="Commvault.Powershell.Runtime.Json.JsonNode" /> to deserialize from.</param>
        /// <returns>an instance of Commvault.Powershell.Models.ICreateUser.</returns>
        public static Commvault.Powershell.Models.ICreateUser FromJson(Commvault.Powershell.Runtime.Json.JsonNode node)
        {
            return node is Commvault.Powershell.Runtime.Json.JsonObject json ? new CreateUser(json) : null;
        }

        /// <summary>
        /// Serializes this instance of <see cref="CreateUser" /> into a <see cref="Commvault.Powershell.Runtime.Json.JsonNode" />.
        /// </summary>
        /// <param name="container">The <see cref="Commvault.Powershell.Runtime.Json.JsonObject"/> container to serialize this object into. If the caller
        /// passes in <c>null</c>, a new instance will be created and returned to the caller.</param>
        /// <param name="serializationMode">Allows the caller to choose the depth of the serialization. See <see cref="Commvault.Powershell.Runtime.SerializationMode"/>.</param>
        /// <returns>
        /// a serialized instance of <see cref="CreateUser" /> as a <see cref="Commvault.Powershell.Runtime.Json.JsonNode" />.
        /// </returns>
        public Commvault.Powershell.Runtime.Json.JsonNode ToJson(Commvault.Powershell.Runtime.Json.JsonObject container, Commvault.Powershell.Runtime.SerializationMode serializationMode)
        {
            ...
            AddIf( null != this._useSystemGeneratePassword ? (Commvault.Powershell.Runtime.Json.JsonNode)new Commvault.Powershell.Runtime.Json.JsonBoolean((bool)this._useSystemGeneratePassword) : null, "useSystemGeneratePassword" ,container.Add );
            ...
            AddIf( null != this._inviteUser ? (Commvault.Powershell.Runtime.Json.JsonNode)new Commvault.Powershell.Runtime.Json.JsonBoolean((bool)this._inviteUser) : null, "inviteUser" ,container.Add );
