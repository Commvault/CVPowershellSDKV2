...
namespace Commvault.Powershell.Models
{
    ...
    public partial class HypervisorPropertiesResp
    {
        ...
        internal HypervisorPropertiesResp(Commvault.Powershell.Runtime.Json.JsonObject json)
        {
            ...
            {_general = If( json?.PropertyT<Commvault.Powershell.Runtime.Json.JsonObject>("general"), out var __jsonGeneral) ? Commvault.Powershell.Models.HypervisorGeneralProperties.FromJson(__jsonGeneral) : _general;}
            {_accountDetails = If( json?.PropertyT<Commvault.Powershell.Runtime.Json.JsonObject>("accountDetails"), out var __jsonAccountDetails) ? Commvault.Powershell.Models.HypervisorAccountDetails.FromJson(__jsonAccountDetails) : _accountDetails;}
            ...
            {_hypervisorCommonProperties = If( json?.PropertyT<Commvault.Powershell.Runtime.Json.JsonObject>("hypervisorCommonProperties"), out var __jsonHypervisorCommonProperties) ? Commvault.Powershell.Models.HypervisorCommonProps.FromJson(__jsonHypervisorCommonProperties) : _hypervisorCommonProperties;}
