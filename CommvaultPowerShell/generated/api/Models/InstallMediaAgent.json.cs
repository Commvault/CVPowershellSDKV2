...
namespace Commvault.Powershell.Models
{
    ...
    public partial class InstallMediaAgent
    {
        ...
        internal InstallMediaAgent(Commvault.Powershell.Runtime.Json.JsonObject json)
        {
            ...
            {_installLocation = If( json?.PropertyT<Commvault.Powershell.Runtime.Json.JsonString>("installLocation"), out var __jsonInstallLocation) ? (string)__jsonInstallLocation : (string)_installLocation;}
            {_rebootIfRequired = If( json?.PropertyT<Commvault.Powershell.Runtime.Json.JsonBoolean>("rebootIfRequired"), out var __jsonRebootIfRequired) ? (bool?)__jsonRebootIfRequired : _rebootIfRequired;}
            {_sshKeyPath = If( json?.PropertyT<Commvault.Powershell.Runtime.Json.JsonString>("SSHKeyPath"), out var __jsonSshKeyPath) ? (string)__jsonSshKeyPath : (string)_sshKeyPath;}
            {_sshKeyFilePassphrase = If( json?.PropertyT<Commvault.Powershell.Runtime.Json.JsonString>("SSHKeyFilePassphrase"), out var __jsonSshKeyFilePassphrase) ? (string)__jsonSshKeyFilePassphrase : (string)_sshKeyFilePassphrase;}
            AfterFromJson(json);
        }
