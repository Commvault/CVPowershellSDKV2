...
namespace Commvault.Powershell.Models
{
    ...
    public partial class HyperScaleStorageGeneralInfo
    {
        ...
        /// <summary>
        /// Deserializes a <see cref="Commvault.Powershell.Runtime.Json.JsonNode"/> into an instance of Commvault.Powershell.Models.IHyperScaleStorageGeneralInfo.
        /// </summary>
        /// <param name="node">a <see cref="Commvault.Powershell.Runtime.Json.JsonNode" /> to deserialize from.</param>
        /// <returns>an instance of Commvault.Powershell.Models.IHyperScaleStorageGeneralInfo.</returns>
        public static Commvault.Powershell.Models.IHyperScaleStorageGeneralInfo FromJson(Commvault.Powershell.Runtime.Json.JsonNode node)
        {
            return node is Commvault.Powershell.Runtime.Json.JsonObject json ? new HyperScaleStorageGeneralInfo(json) : null;
        }

        /// <summary>
        /// Deserializes a Commvault.Powershell.Runtime.Json.JsonObject into a new instance of <see cref="HyperScaleStorageGeneralInfo" />.
        /// </summary>
        /// <param name="json">A Commvault.Powershell.Runtime.Json.JsonObject instance to deserialize from.</param>
        internal HyperScaleStorageGeneralInfo(Commvault.Powershell.Runtime.Json.JsonObject json)
        {
            ...
            {_libraryName = If( json?.PropertyT<Commvault.Powershell.Runtime.Json.JsonString>("libraryName"), out var __jsonLibraryName) ? (string)__jsonLibraryName : (string)_libraryName;}
            {_devicePath = If( json?.PropertyT<Commvault.Powershell.Runtime.Json.JsonString>("devicePath"), out var __jsonDevicePath) ? (string)__jsonDevicePath : (string)_devicePath;}
            ...
            {_totalFreeSpace = If( json?.PropertyT<Commvault.Powershell.Runtime.Json.JsonNumber>("totalFreeSpace"), out var __jsonTotalFreeSpace) ? (long?)__jsonTotalFreeSpace : _totalFreeSpace;}
            {_sizeOndisk = If( json?.PropertyT<Commvault.Powershell.Runtime.Json.JsonNumber>("sizeOndisk"), out var __jsonSizeOndisk) ? (long?)__jsonSizeOndisk : _sizeOndisk;}
            {_resiliency = If( json?.PropertyT<Commvault.Powershell.Runtime.Json.JsonString>("resiliency"), out var __jsonResiliency) ? (string)__jsonResiliency : (string)_resiliency;}
            {_deduplicationSavings = If( json?.PropertyT<Commvault.Powershell.Runtime.Json.JsonString>("deduplicationSavings"), out var __jsonDeduplicationSavings) ? (string)__jsonDeduplicationSavings : (string)_deduplicationSavings;}
        ...
        /// <summary>
        /// Serializes this instance of <see cref="HyperScaleStorageGeneralInfo" /> into a <see cref="Commvault.Powershell.Runtime.Json.JsonNode" />.
        /// </summary>
        /// <param name="container">The <see cref="Commvault.Powershell.Runtime.Json.JsonObject"/> container to serialize this object into. If the caller
        /// passes in <c>null</c>, a new instance will be created and returned to the caller.</param>
        /// <param name="serializationMode">Allows the caller to choose the depth of the serialization. See <see cref="Commvault.Powershell.Runtime.SerializationMode"/>.</param>
        /// <returns>
        /// a serialized instance of <see cref="HyperScaleStorageGeneralInfo" /> as a <see cref="Commvault.Powershell.Runtime.Json.JsonNode" />.
        /// </returns>
