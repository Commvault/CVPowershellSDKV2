...
namespace Commvault.Powershell.Models
{
        ...
        Commvault.Powershell.Models.ICommvaultPowerShellIdentityInternal
    {
        ...
        /// <summary>Backing field for <see cref="AlertRuleId" /> property.</summary>
        private long? _alertRuleId;

        /// <summary>Unique Id of the alert custom rule to get details</summary>
        [Commvault.Powershell.Origin(Commvault.Powershell.PropertyOrigin.Owned)]
        public long? AlertRuleId { get => this._alertRuleId; set => this._alertRuleId = value; }
        ...
        /// <summary>Backing field for <see cref="RecoveryEntityId" /> property.</summary>
        private long? _recoveryEntityId;

        /// <summary>Recovery entity Id</summary>
        [Commvault.Powershell.Origin(Commvault.Powershell.PropertyOrigin.Owned)]
        public long? RecoveryEntityId { get => this._recoveryEntityId; set => this._recoveryEntityId = value; }
        ...
        /// <summary>Backing field for <see cref="ReplicationPairId" /> property.</summary>
        private long? _replicationPairId;

        /// <summary>Replication pair id of the Pair</summary>
        [Commvault.Powershell.Origin(Commvault.Powershell.PropertyOrigin.Owned)]
        public long? ReplicationPairId { get => this._replicationPairId; set => this._replicationPairId = value; }
        ...
        /// <summary>Backing field for <see cref="SnapEngineId" /> property.</summary>
        private long? _snapEngineId;

        /// <summary>Snap Engine Id</summary>
        [Commvault.Powershell.Origin(Commvault.Powershell.PropertyOrigin.Owned)]
        public long? SnapEngineId { get => this._snapEngineId; set => this._snapEngineId = value; }

        /// <summary>Backing field for <see cref="SpareGroupId" /> property.</summary>
        private long? _spareGroupId;
        ...
        /// </summary>
        [Commvault.Powershell.Origin(Commvault.Powershell.PropertyOrigin.Owned)]
        public long? SpareGroupId { get => this._spareGroupId; set => this._spareGroupId = value; }
        ...
        Commvault.Powershell.Runtime.IJsonSerializable
    {
        ...
        Update = true,
        Description = @"Recovery entity Id",
        SerializedName = @"recoveryEntityId",
        PossibleTypes = new [] { typeof(long) })]
        long? RecoveryEntityId { get; set; }
        /// <summary>Recovery group Id</summary>
        [Commvault.Powershell.Runtime.Info(
        Required = false,
        ReadOnly = false,
        ...
        PossibleTypes = new [] { typeof(long) })]
        long? ReplicationPairId { get; set; }
        /// <summary>Unique identifier for the request</summary>
        [Commvault.Powershell.Runtime.Info(
        Required = false,
        ReadOnly = false,
