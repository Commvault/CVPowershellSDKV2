...
namespace Commvault.Powershell.Models
{
    ...
    public partial class CreateUserGroup
    {
        ...
        internal CreateUserGroup(global::System.Collections.IDictionary content)
        {
            ...
            {
                ((Commvault.Powershell.Models.ICreateUserGroupInternal)this).QuotaLimitInGb = (long?) content.GetValueForProperty("QuotaLimitInGb",((Commvault.Powershell.Models.ICreateUserGroupInternal)this).QuotaLimitInGb, (__y)=> (long) global::System.Convert.ChangeType(__y, typeof(long)));
            }
            if (content.Contains("LocalUserGroups"))
            {
                ((Commvault.Powershell.Models.ICreateUserGroupInternal)this).LocalUserGroups = (System.Collections.Generic.List<Commvault.Powershell.Models.IIdName>) content.GetValueForProperty("LocalUserGroups",((Commvault.Powershell.Models.ICreateUserGroupInternal)this).LocalUserGroups, __y => TypeConverterExtensions.SelectToList<Commvault.Powershell.Models.IIdName>(__y, Commvault.Powershell.Models.IdNameTypeConverter.ConvertFrom));
            }
            if (content.Contains("GlobalConfigInfoName"))
            {
                ((Commvault.Powershell.Models.ICreateUserGroupInternal)this).GlobalConfigInfoName = (string) content.GetValueForProperty("GlobalConfigInfoName",((Commvault.Powershell.Models.ICreateUserGroupInternal)this).GlobalConfigInfoName, global::System.Convert.ToString);
            }
            if (content.Contains("GlobalConfigInfoCommcells"))
            {
                ((Commvault.Powershell.Models.ICreateUserGroupInternal)this).GlobalConfigInfoCommcells = (System.Collections.Generic.List<Commvault.Powershell.Models.IGlobalConfigCommcellInfo>) content.GetValueForProperty("GlobalConfigInfoCommcells",((Commvault.Powershell.Models.ICreateUserGroupInternal)this).GlobalConfigInfoCommcells, __y => TypeConverterExtensions.SelectToList<Commvault.Powershell.Models.IGlobalConfigCommcellInfo>(__y, Commvault.Powershell.Models.GlobalConfigCommcellInfoTypeConverter.ConvertFrom));
            }
            if (content.Contains("GlobalConfigInfoScope"))
            {
                ((Commvault.Powershell.Models.ICreateUserGroupInternal)this).GlobalConfigInfoScope = (string) content.GetValueForProperty("GlobalConfigInfoScope",((Commvault.Powershell.Models.ICreateUserGroupInternal)this).GlobalConfigInfoScope, global::System.Convert.ToString);
            }
            if (content.Contains("GlobalConfigInfoScopeFilterQuery"))
            {
                ((Commvault.Powershell.Models.ICreateUserGroupInternal)this).GlobalConfigInfoScopeFilterQuery = (string) content.GetValueForProperty("GlobalConfigInfoScopeFilterQuery",((Commvault.Powershell.Models.ICreateUserGroupInternal)this).GlobalConfigInfoScopeFilterQuery, global::System.Convert.ToString);
            }
            if (content.Contains("GlobalConfigInfoApplyOnAllCommCells"))
            {
                ((Commvault.Powershell.Models.ICreateUserGroupInternal)this).GlobalConfigInfoApplyOnAllCommCells = (bool?) content.GetValueForProperty("GlobalConfigInfoApplyOnAllCommCells",((Commvault.Powershell.Models.ICreateUserGroupInternal)this).GlobalConfigInfoApplyOnAllCommCells, (__y)=> (bool) global::System.Convert.ChangeType(__y, typeof(bool)));
            }
            if (content.Contains("GlobalConfigInfoActionOnLocalEntity"))
            {
                ((Commvault.Powershell.Models.ICreateUserGroupInternal)this).GlobalConfigInfoActionOnLocalEntity = (string) content.GetValueForProperty("GlobalConfigInfoActionOnLocalEntity",((Commvault.Powershell.Models.ICreateUserGroupInternal)this).GlobalConfigInfoActionOnLocalEntity, global::System.Convert.ToString);
            }
        ...
        /// <returns>an instance of the <see cref="CreateUserGroup" /> model class.</returns>
