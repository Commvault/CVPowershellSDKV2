...
namespace Commvault.Powershell.Models
{
    ...
    public partial class MediaAgentForDdbSummary
    {
        ...
        /// <summary>
        /// Deserializes a <see cref="Commvault.Powershell.Runtime.Json.JsonNode"/> into an instance of Commvault.Powershell.Models.IMediaAgentForDdbSummary.
        /// </summary>
        /// <param name="node">a <see cref="Commvault.Powershell.Runtime.Json.JsonNode" /> to deserialize from.</param>
        /// <returns>an instance of Commvault.Powershell.Models.IMediaAgentForDdbSummary.</returns>
        public static Commvault.Powershell.Models.IMediaAgentForDdbSummary FromJson(Commvault.Powershell.Runtime.Json.JsonNode node)
        {
            return node is Commvault.Powershell.Runtime.Json.JsonObject json ? new MediaAgentForDdbSummary(json) : null;
        }

        /// <summary>
        /// Deserializes a Commvault.Powershell.Runtime.Json.JsonObject into a new instance of <see cref="MediaAgentForDdbSummary" />.
        /// </summary>
        /// <param name="json">A Commvault.Powershell.Runtime.Json.JsonObject instance to deserialize from.</param>
        internal MediaAgentForDdbSummary(Commvault.Powershell.Runtime.Json.JsonObject json)
        {
            ...
            {_simosId = If( json?.PropertyT<Commvault.Powershell.Runtime.Json.JsonNumber>("SIMOSId"), out var __jsonSimosId) ? (long?)__jsonSimosId : _simosId;}
            {_isDdbSubclientConfigured = If( json?.PropertyT<Commvault.Powershell.Runtime.Json.JsonBoolean>("isDDBSubclientConfigured"), out var __jsonIsDdbSubclientConfigured) ? (bool?)__jsonIsDdbSubclientConfigured : _isDdbSubclientConfigured;}
            {_oSType = If( json?.PropertyT<Commvault.Powershell.Runtime.Json.JsonString>("OSType"), out var __jsonOSType) ? (string)__jsonOSType : (string)_oSType;}
            {_isConfigured = If( json?.PropertyT<Commvault.Powershell.Runtime.Json.JsonBoolean>("isConfigured"), out var __jsonIsConfigured) ? (bool?)__jsonIsConfigured : _isConfigured;}
            {_ddbDisks = If( json?.PropertyT<Commvault.Powershell.Runtime.Json.JsonArray>("DDBDisks"), out var __jsonDdbDisks) ? If( __jsonDdbDisks as Commvault.Powershell.Runtime.Json.JsonArray, out var __v) ? new global::System.Func<System.Collections.Generic.List<Commvault.Powershell.Models.IDdbDiskInfo>>(()=> global::System.Linq.Enumerable.ToList(global::System.Linq.Enumerable.Select(__v, (__u)=>(Commvault.Powershell.Models.IDdbDiskInfo) (Commvault.Powershell.Models.DdbDiskInfo.FromJson(__u) )) ))() : null : _ddbDisks;}
            AfterFromJson(json);
        }

        /// <summary>
        /// Serializes this instance of <see cref="MediaAgentForDdbSummary" /> into a <see cref="Commvault.Powershell.Runtime.Json.JsonNode" />.
        /// </summary>
        /// <param name="container">The <see cref="Commvault.Powershell.Runtime.Json.JsonObject"/> container to serialize this object into. If the caller
        /// passes in <c>null</c>, a new instance will be created and returned to the caller.</param>
        /// <param name="serializationMode">Allows the caller to choose the depth of the serialization. See <see cref="Commvault.Powershell.Runtime.SerializationMode"/>.</param>
        /// <returns>
        /// a serialized instance of <see cref="MediaAgentForDdbSummary" /> as a <see cref="Commvault.Powershell.Runtime.Json.JsonNode" />.
        /// </returns>
