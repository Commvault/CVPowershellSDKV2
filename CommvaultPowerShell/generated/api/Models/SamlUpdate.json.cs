...
namespace Commvault.Powershell.Models
{
    ...
    public partial class SamlUpdate
    {
        ...
        /// <summary>
        /// Deserializes a <see cref="Commvault.Powershell.Runtime.Json.JsonNode"/> into an instance of Commvault.Powershell.Models.ISamlUpdate.
        /// </summary>
        /// <param name="node">a <see cref="Commvault.Powershell.Runtime.Json.JsonNode" /> to deserialize from.</param>
        /// <returns>an instance of Commvault.Powershell.Models.ISamlUpdate.</returns>
        public static Commvault.Powershell.Models.ISamlUpdate FromJson(Commvault.Powershell.Runtime.Json.JsonNode node)
        {
            return node is Commvault.Powershell.Runtime.Json.JsonObject json ? new SamlUpdate(json) : null;
        }

        /// <summary>
        /// Deserializes a Commvault.Powershell.Runtime.Json.JsonObject into a new instance of <see cref="SamlUpdate" />.
        /// </summary>
        /// <param name="json">A Commvault.Powershell.Runtime.Json.JsonObject instance to deserialize from.</param>
        internal SamlUpdate(Commvault.Powershell.Runtime.Json.JsonObject json)
        {
            ...
            {_identityProviderMetaData = If( json?.PropertyT<Commvault.Powershell.Runtime.Json.JsonObject>("identityProviderMetaData"), out var __jsonIdentityProviderMetaData) ? Commvault.Powershell.Models.SamlidpMetaDataReq.FromJson(__jsonIdentityProviderMetaData) : _identityProviderMetaData;}
            {_serviceProviderMetaData = If( json?.PropertyT<Commvault.Powershell.Runtime.Json.JsonObject>("serviceProviderMetaData"), out var __jsonServiceProviderMetaData) ? Commvault.Powershell.Models.SamlspMetaData.FromJson(__jsonServiceProviderMetaData) : _serviceProviderMetaData;}
            {_associations = If( json?.PropertyT<Commvault.Powershell.Runtime.Json.JsonObject>("associations"), out var __jsonAssociations) ? Commvault.Powershell.Models.SamlAssociations.FromJson(__jsonAssociations) : _associations;}
            ...
            {_autoCreateUser = If( json?.PropertyT<Commvault.Powershell.Runtime.Json.JsonBoolean>("autoCreateUser"), out var __jsonAutoCreateUser) ? (bool?)__jsonAutoCreateUser : _autoCreateUser;}
            {_userGroups = If( json?.PropertyT<Commvault.Powershell.Runtime.Json.JsonArray>("userGroups"), out var __jsonUserGroups) ? If( __jsonUserGroups as Commvault.Powershell.Runtime.Json.JsonArray, out var __v) ? new global::System.Func<System.Collections.Generic.List<Commvault.Powershell.Models.ICompanyWithUserGroupAssocDetails>>(()=> global::System.Linq.Enumerable.ToList(global::System.Linq.Enumerable.Select(__v, (__u)=>(Commvault.Powershell.Models.ICompanyWithUserGroupAssocDetails) (Commvault.Powershell.Models.CompanyWithUserGroupAssocDetails.FromJson(__u) )) ))() : null : _userGroups;}
            {_nameIdAttribute = If( json?.PropertyT<Commvault.Powershell.Runtime.Json.JsonString>("nameIDAttribute"), out var __jsonNameIdAttribute) ? (string)__jsonNameIdAttribute : (string)_nameIdAttribute;}
            {_attributeMappings = If( json?.PropertyT<Commvault.Powershell.Runtime.Json.JsonArray>("attributeMappings"), out var __jsonAttributeMappings) ? If( __jsonAttributeMappings as Commvault.Powershell.Runtime.Json.JsonArray, out var __q) ? new global::System.Func<System.Collections.Generic.List<Commvault.Powershell.Models.ISamlAttributes>>(()=> global::System.Linq.Enumerable.ToList(global::System.Linq.Enumerable.Select(__q, (__p)=>(Commvault.Powershell.Models.ISamlAttributes) (Commvault.Powershell.Models.SamlAttributes.FromJson(__p) )) ))() : null : _attributeMappings;}
            AfterFromJson(json);
        }

        /// <summary>
        /// Serializes this instance of <see cref="SamlUpdate" /> into a <see cref="Commvault.Powershell.Runtime.Json.JsonNode" />.
        /// </summary>
        /// <param name="container">The <see cref="Commvault.Powershell.Runtime.Json.JsonObject"/> container to serialize this object into. If the caller
        /// passes in <c>null</c>, a new instance will be created and returned to the caller.</param>
        /// <param name="serializationMode">Allows the caller to choose the depth of the serialization. See <see cref="Commvault.Powershell.Runtime.SerializationMode"/>.</param>
        /// <returns>
        /// a serialized instance of <see cref="SamlUpdate" /> as a <see cref="Commvault.Powershell.Runtime.Json.JsonNode" />.
        /// </returns>
