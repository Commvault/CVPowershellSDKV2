...
namespace Commvault.Powershell.Models
{
    ...
    public partial class MigrationSource
    {
        ...
        /// <returns>an instance of the <see cref="MigrationSource" /> model class.</returns>
        ...
        internal MigrationSource(global::System.Collections.IDictionary content)
        {
            ...
            {
                ((Commvault.Powershell.Models.IMigrationSourceInternal)this).AccessNode = (System.Collections.Generic.List<Commvault.Powershell.Models.IAccessNodes>) content.GetValueForProperty("AccessNode",((Commvault.Powershell.Models.IMigrationSourceInternal)this).AccessNode, __y => TypeConverterExtensions.SelectToList<Commvault.Powershell.Models.IAccessNodes>(__y, Commvault.Powershell.Models.AccessNodesTypeConverter.ConvertFrom));
            }
            if (content.Contains("SourceCredentialsId"))
            {
                ((Commvault.Powershell.Models.IMigrationSourceInternal)this).SourceCredentialsId = (long?) content.GetValueForProperty("SourceCredentialsId",((Commvault.Powershell.Models.IMigrationSourceInternal)this).SourceCredentialsId, (__y)=> (long) global::System.Convert.ChangeType(__y, typeof(long)));
            }
