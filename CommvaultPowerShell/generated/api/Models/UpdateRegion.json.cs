...
namespace Commvault.Powershell.Models
{
    ...
    public partial class UpdateRegion
    {
        ...
        internal UpdateRegion(Commvault.Powershell.Runtime.Json.JsonObject json)
        {
            ...
            {_locationsOperationType = If( json?.PropertyT<Commvault.Powershell.Runtime.Json.JsonString>("locationsOperationType"), out var __jsonLocationsOperationType) ? (string)__jsonLocationsOperationType : (string)_locationsOperationType;}
