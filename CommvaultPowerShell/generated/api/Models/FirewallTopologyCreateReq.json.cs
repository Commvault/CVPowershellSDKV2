...
namespace Commvault.Powershell.Models
{
    ...
    public partial class FirewallTopologyCreateReq
    {
        ...
        internal FirewallTopologyCreateReq(Commvault.Powershell.Runtime.Json.JsonObject json)
        {
            ...
            {_topologyName = If( json?.PropertyT<Commvault.Powershell.Runtime.Json.JsonString>("topologyName"), out var __jsonTopologyName) ? (string)__jsonTopologyName : (string)_topologyName;}
