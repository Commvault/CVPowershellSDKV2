...
namespace Commvault.Powershell.Models
{
        ...
        Commvault.Powershell.Models.IDiskStorageInternal
    {
        ...
        private System.Collections.Generic.List<Commvault.Powershell.Models.IIdName> _associatedPlanList;

        /// <summary>Provides the list of plans associated with the storage pool.</summary>
        [Commvault.Powershell.Origin(Commvault.Powershell.PropertyOrigin.Owned)]
        public System.Collections.Generic.List<Commvault.Powershell.Models.IIdName> AssociatedPlanList { get => this._associatedPlanList; set => this._associatedPlanList = value; }

        /// <summary>Backing field for <see cref="BackupLocations" /> property.</summary>
        private System.Collections.Generic.List<Commvault.Powershell.Models.IIdNameStatus> _backupLocations;

        /// <summary>Gives backup location/mount path details for the storage pool.</summary>
        [Commvault.Powershell.Origin(Commvault.Powershell.PropertyOrigin.Owned)]
        public System.Collections.Generic.List<Commvault.Powershell.Models.IIdNameStatus> BackupLocations { get => this._backupLocations; set => this._backupLocations = value; }
        ...
        Commvault.Powershell.Runtime.IJsonSerializable
    {
        ...
        System.Collections.Generic.List<Commvault.Powershell.Models.IIdName> AssociatedPlanList { get; set; }
        /// <summary>Gives backup location/mount path details for the storage pool.</summary>
        [Commvault.Powershell.Runtime.Info(
        Required = false,
        ReadOnly = false,
        ...
        System.Collections.Generic.List<Commvault.Powershell.Models.IIdNameStatus> BackupLocations { get; set; }
        /// <summary>
        /// The different types of encryption keys that can be used for encrypting the data. The values are case sensitive
        /// </summary>
        [Commvault.Powershell.Runtime.Info(
