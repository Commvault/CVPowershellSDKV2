...
namespace Commvault.Powershell.Models
{
    ...
    public partial class OracleObjectBucket :
        Commvault.Powershell.Models.IOracleObjectBucket,
        Commvault.Powershell.Models.IOracleObjectBucketInternal,
        Commvault.Powershell.Runtime.IValidates
    {
        ...
        string Commvault.Powershell.Models.IOracleObjectBucketInternal.CloudType { get => this._cloudType; set { {_cloudType = value;} } }

        /// <summary>Internal Acessors for Credentials</summary>
        Commvault.Powershell.Models.IIdName Commvault.Powershell.Models.IOracleObjectBucketInternal.Credentials { get => (this._credentials = this._credentials ?? new Commvault.Powershell.Models.IdName()); set { {_credentials = value;} } }

        /// <summary>Internal Acessors for MediaAgent</summary>
        Commvault.Powershell.Models.IIdName Commvault.Powershell.Models.IOracleObjectBucketInternal.MediaAgent { get => (this._mediaAgent = this._mediaAgent ?? new Commvault.Powershell.Models.IdName()); set { {_mediaAgent = value;} } }
        ...
        /// <summary>Creates an new <see cref="OracleObjectBucket" /> instance.</summary>
        public OracleObjectBucket()
        {
    ...
    /// Oracle Cloud Infrastructure Object Storage
    internal partial interface IOracleObjectBucketInternal :
