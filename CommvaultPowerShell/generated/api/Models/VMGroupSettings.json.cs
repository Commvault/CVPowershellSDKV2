...
namespace Commvault.Powershell.Models
{
    ...
    public partial class VMGroupSettings
    {
        ...
        public Commvault.Powershell.Runtime.Json.JsonNode ToJson(Commvault.Powershell.Runtime.Json.JsonObject container, Commvault.Powershell.Runtime.SerializationMode serializationMode)
        {
            ...
            AddIf( null != this._quiesceGuestFileSystemAndApplications ? (Commvault.Powershell.Runtime.Json.JsonNode)new Commvault.Powershell.Runtime.Json.JsonBoolean((bool)this._quiesceGuestFileSystemAndApplications) : null, "quiesceGuestFileSystemAndApplications" ,container.Add );
            AddIf( null != this._useBackupsetDiskFilters ? (Commvault.Powershell.Runtime.Json.JsonNode)new Commvault.Powershell.Runtime.Json.JsonBoolean((bool)this._useBackupsetDiskFilters) : null, "useBackupsetDiskFilters" ,container.Add );
        ...
        internal VMGroupSettings(Commvault.Powershell.Runtime.Json.JsonObject json)
        {
            ...
            {_crossAccount = If( json?.PropertyT<Commvault.Powershell.Runtime.Json.JsonObject>("crossAccount"), out var __jsonCrossAccount) ? Commvault.Powershell.Models.AmazonCrossAccount.FromJson(__jsonCrossAccount) : _crossAccount;}
            {_useChangedBlockTrackingOnVM = If( json?.PropertyT<Commvault.Powershell.Runtime.Json.JsonBoolean>("useChangedBlockTrackingOnVM"), out var __jsonUseChangedBlockTrackingOnVM) ? (bool?)__jsonUseChangedBlockTrackingOnVM : _useChangedBlockTrackingOnVM;}
            {_customSnapshotResourceGroup = If( json?.PropertyT<Commvault.Powershell.Runtime.Json.JsonString>("customSnapshotResourceGroup"), out var __jsonCustomSnapshotResourceGroup) ? (string)__jsonCustomSnapshotResourceGroup : (string)_customSnapshotResourceGroup;}
            {_customSnapshotTags = If( json?.PropertyT<Commvault.Powershell.Runtime.Json.JsonArray>("customSnapshotTags"), out var __jsonCustomSnapshotTags) ? If( __jsonCustomSnapshotTags as Commvault.Powershell.Runtime.Json.JsonArray, out var __v) ? new global::System.Func<System.Collections.Generic.List<Commvault.Powershell.Models.IResourceTag>>(()=> global::System.Linq.Enumerable.ToList(global::System.Linq.Enumerable.Select(__v, (__u)=>(Commvault.Powershell.Models.IResourceTag) (Commvault.Powershell.Models.ResourceTag.FromJson(__u) )) ))() : null : _customSnapshotTags;}
            {_regionalSnapshot = If( json?.PropertyT<Commvault.Powershell.Runtime.Json.JsonBoolean>("regionalSnapshot"), out var __jsonRegionalSnapshot) ? (bool?)__jsonRegionalSnapshot : _regionalSnapshot;}
            {_autoDetectVMOwner = If( json?.PropertyT<Commvault.Powershell.Runtime.Json.JsonBoolean>("autoDetectVMOwner"), out var __jsonAutoDetectVMOwner) ? (bool?)__jsonAutoDetectVMOwner : _autoDetectVMOwner;}
            {_allowEmptySubclient = If( json?.PropertyT<Commvault.Powershell.Runtime.Json.JsonBoolean>("allowEmptySubclient"), out var __jsonAllowEmptySubclient) ? (bool?)__jsonAllowEmptySubclient : _allowEmptySubclient;}
            {_noOfReaders = If( json?.PropertyT<Commvault.Powershell.Runtime.Json.JsonNumber>("noOfReaders"), out var __jsonNoOfReaders) ? (long?)__jsonNoOfReaders : _noOfReaders;}
            {_isVMGroupDiskFiltersIncluded = If( json?.PropertyT<Commvault.Powershell.Runtime.Json.JsonBoolean>("isVMGroupDiskFiltersIncluded"), out var __jsonIsVMGroupDiskFiltersIncluded) ? (bool?)__jsonIsVMGroupDiskFiltersIncluded : _isVMGroupDiskFiltersIncluded;}
            {_vMBackupType = If( json?.PropertyT<Commvault.Powershell.Runtime.Json.JsonString>("vmBackupType"), out var __jsonVMBackupType) ? (string)__jsonVMBackupType : (string)_vMBackupType;}
            {_isApplicationAware = If( json?.PropertyT<Commvault.Powershell.Runtime.Json.JsonBoolean>("isApplicationAware"), out var __jsonIsApplicationAware) ? (bool?)__jsonIsApplicationAware : _isApplicationAware;}
            {_useVMCheckpointSetting = If( json?.PropertyT<Commvault.Powershell.Runtime.Json.JsonBoolean>("useVMCheckpointSetting"), out var __jsonUseVMCheckpointSetting) ? (bool?)__jsonUseVMCheckpointSetting : _useVMCheckpointSetting;}
            {_transportMode = If( json?.PropertyT<Commvault.Powershell.Runtime.Json.JsonString>("transportMode"), out var __jsonTransportMode) ? (string)__jsonTransportMode : (string)_transportMode;}
            {_datastoreFreespaceCheck = If( json?.PropertyT<Commvault.Powershell.Runtime.Json.JsonBoolean>("datastoreFreespaceCheck"), out var __jsonDatastoreFreespaceCheck) ? (bool?)__jsonDatastoreFreespaceCheck : _datastoreFreespaceCheck;}
            {_datastoreFreespaceRequired = If( json?.PropertyT<Commvault.Powershell.Runtime.Json.JsonNumber>("datastoreFreespaceRequired"), out var __jsonDatastoreFreespaceRequired) ? (long?)__jsonDatastoreFreespaceRequired : _datastoreFreespaceRequired;}
            {_collectFileDetailsforGranularRecovery = If( json?.PropertyT<Commvault.Powershell.Runtime.Json.JsonBoolean>("collectFileDetailsforGranularRecovery"), out var __jsonCollectFileDetailsforGranularRecovery) ? (bool?)__jsonCollectFileDetailsforGranularRecovery : _collectFileDetailsforGranularRecovery;}
            {_collectFileDetailsFromSnapshotCopy = If( json?.PropertyT<Commvault.Powershell.Runtime.Json.JsonBoolean>("collectFileDetailsFromSnapshotCopy"), out var __jsonCollectFileDetailsFromSnapshotCopy) ? (bool?)__jsonCollectFileDetailsFromSnapshotCopy : _collectFileDetailsFromSnapshotCopy;}
            {_jobStartTime = If( json?.PropertyT<Commvault.Powershell.Runtime.Json.JsonNumber>("jobStartTime"), out var __jsonJobStartTime) ? (long?)__jsonJobStartTime : _jobStartTime;}
            {_quiesceGuestFileSystemAndApplications = If( json?.PropertyT<Commvault.Powershell.Runtime.Json.JsonBoolean>("quiesceGuestFileSystemAndApplications"), out var __jsonQuiesceGuestFileSystemAndApplications) ? (bool?)__jsonQuiesceGuestFileSystemAndApplications : _quiesceGuestFileSystemAndApplications;}
            {_useBackupsetDiskFilters = If( json?.PropertyT<Commvault.Powershell.Runtime.Json.JsonBoolean>("useBackupsetDiskFilters"), out var __jsonUseBackupsetDiskFilters) ? (bool?)__jsonUseBackupsetDiskFilters : _useBackupsetDiskFilters;}
            AfterFromJson(json);
        }
    }
}