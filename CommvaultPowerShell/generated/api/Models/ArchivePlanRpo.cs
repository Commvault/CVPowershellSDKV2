...
namespace Commvault.Powershell.Models
{
        ...
        Commvault.Powershell.Models.IArchivePlanRpoInternal
    {
        ...
        [Commvault.Powershell.Origin(Commvault.Powershell.PropertyOrigin.Inlined)]
        public System.Collections.Generic.List<string> ArchiveFrequencyWeeklyDays { get => ((Commvault.Powershell.Models.IBackupFrequencyPatternInternal)ArchiveFrequency).WeeklyDays; set => ((Commvault.Powershell.Models.IBackupFrequencyPatternInternal)ArchiveFrequency).WeeklyDays = value ?? null /* arrayOf */; }

        /// <summary>Backing field for <see cref="ArchiveWindow" /> property.</summary>
        private System.Collections.Generic.List<Commvault.Powershell.Models.IDayAndTime> _archiveWindow;

        /// <summary>Archive job will run only in the specified archive window</summary>
        [Commvault.Powershell.Origin(Commvault.Powershell.PropertyOrigin.Owned)]
        public System.Collections.Generic.List<Commvault.Powershell.Models.IDayAndTime> ArchiveWindow { get => this._archiveWindow; set => this._archiveWindow = value; }
        ...
        Commvault.Powershell.Runtime.IJsonSerializable
    {
        ...
        System.Collections.Generic.List<Commvault.Powershell.Models.IDayAndTime> ArchiveWindow { get; set; }
