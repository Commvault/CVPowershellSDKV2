...
namespace Commvault.Powershell.Models
{
    ...
    public partial class OracleArchiveBucketContent
    {
        ...
        /// <returns>an instance of the <see cref="OracleArchiveBucketContent" /> model class.</returns>
        ...
        internal OracleArchiveBucketContent(global::System.Collections.IDictionary content)
        {
            ...
            {
                ((Commvault.Powershell.Models.IOracleArchiveBucketContentInternal)this).MediaAgent = (Commvault.Powershell.Models.IIdName) content.GetValueForProperty("MediaAgent",((Commvault.Powershell.Models.IOracleArchiveBucketContentInternal)this).MediaAgent, Commvault.Powershell.Models.IdNameTypeConverter.ConvertFrom);
            }
            if (content.Contains("Credentials"))
            {
                ((Commvault.Powershell.Models.IOracleArchiveBucketContentInternal)this).Credentials = (Commvault.Powershell.Models.IIdName) content.GetValueForProperty("Credentials",((Commvault.Powershell.Models.IOracleArchiveBucketContentInternal)this).Credentials, Commvault.Powershell.Models.IdNameTypeConverter.ConvertFrom);
            }
            ...
            {
                ((Commvault.Powershell.Models.IOracleArchiveBucketContentInternal)this).MediaAgentId = (long?) content.GetValueForProperty("MediaAgentId",((Commvault.Powershell.Models.IOracleArchiveBucketContentInternal)this).MediaAgentId, (__y)=> (long) global::System.Convert.ChangeType(__y, typeof(long)));
            }
            if (content.Contains("MediaAgentName"))
            {
                ((Commvault.Powershell.Models.IOracleArchiveBucketContentInternal)this).MediaAgentName = (string) content.GetValueForProperty("MediaAgentName",((Commvault.Powershell.Models.IOracleArchiveBucketContentInternal)this).MediaAgentName, global::System.Convert.ToString);
            }
            if (content.Contains("CredentialsId"))
            {
                ((Commvault.Powershell.Models.IOracleArchiveBucketContentInternal)this).CredentialsId = (long?) content.GetValueForProperty("CredentialsId",((Commvault.Powershell.Models.IOracleArchiveBucketContentInternal)this).CredentialsId, (__y)=> (long) global::System.Convert.ChangeType(__y, typeof(long)));
            }
            if (content.Contains("CredentialsName"))
            {
                ((Commvault.Powershell.Models.IOracleArchiveBucketContentInternal)this).CredentialsName = (string) content.GetValueForProperty("CredentialsName",((Commvault.Powershell.Models.IOracleArchiveBucketContentInternal)this).CredentialsName, global::System.Convert.ToString);
            }
