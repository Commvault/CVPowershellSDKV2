...
namespace Commvault.Powershell.Models
{
    ...
    public partial class ScalityRingBucketContent :
        Commvault.Powershell.Models.IScalityRingBucketContent,
        Commvault.Powershell.Models.IScalityRingBucketContentInternal,
        Commvault.Powershell.Runtime.IValidates
    {
        ...
        string Commvault.Powershell.Models.IScalityRingBucketContentInternal.CloudType { get => this._cloudType; set { {_cloudType = value;} } }

        /// <summary>Internal Acessors for Credentials</summary>
        Commvault.Powershell.Models.IIdName Commvault.Powershell.Models.IScalityRingBucketContentInternal.Credentials { get => (this._credentials = this._credentials ?? new Commvault.Powershell.Models.IdName()); set { {_credentials = value;} } }

        /// <summary>Internal Acessors for MediaAgent</summary>
        Commvault.Powershell.Models.IIdName Commvault.Powershell.Models.IScalityRingBucketContentInternal.MediaAgent { get => (this._mediaAgent = this._mediaAgent ?? new Commvault.Powershell.Models.IdName()); set { {_mediaAgent = value;} } }
        ...
        /// <summary>Creates an new <see cref="ScalityRingBucketContent" /> instance.</summary>
        public ScalityRingBucketContent()
        {
    ...
    /// Scality RING
    internal partial interface IScalityRingBucketContentInternal :
