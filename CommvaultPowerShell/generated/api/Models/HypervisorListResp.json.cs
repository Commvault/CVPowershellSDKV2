...
namespace Commvault.Powershell.Models
{
    ...
    public partial class HypervisorListResp
    {
        ...
        internal HypervisorListResp(Commvault.Powershell.Runtime.Json.JsonObject json)
        {
            ...
            {_clientActivityControl = If( json?.PropertyT<Commvault.Powershell.Runtime.Json.JsonObject>("clientActivityControl"), out var __jsonClientActivityControl) ? Commvault.Powershell.Models.ActivityControlOptionsProp.FromJson(__jsonClientActivityControl) : _clientActivityControl;}
            ...
            {_manageSnapshot = If( json?.PropertyT<Commvault.Powershell.Runtime.Json.JsonObject>("manageSnapshot"), out var __jsonManageSnapshot) ? Commvault.Powershell.Models.IdName.FromJson(__jsonManageSnapshot) : _manageSnapshot;}
            ...
            {_isManagedIdentity = If( json?.PropertyT<Commvault.Powershell.Runtime.Json.JsonBoolean>("isManagedIdentity"), out var __jsonIsManagedIdentity) ? (bool?)__jsonIsManagedIdentity : _isManagedIdentity;}
