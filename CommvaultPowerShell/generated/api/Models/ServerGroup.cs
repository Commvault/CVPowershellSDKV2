...
namespace Commvault.Powershell.Models
{
        ...
        Commvault.Powershell.Models.IServerGroupInternal
    {
        ...
        private System.Collections.Generic.List<Commvault.Powershell.Models.IServerDetails> _associatedServers;

        [Commvault.Powershell.Origin(Commvault.Powershell.PropertyOrigin.Owned)]
        public System.Collections.Generic.List<Commvault.Powershell.Models.IServerDetails> AssociatedServers { get => this._associatedServers; set => this._associatedServers = value; }

        /// <summary>Backing field for <see cref="BlackoutWindow" /> property.</summary>
        private System.Collections.Generic.List<Commvault.Powershell.Models.IBlackoutWindowDetails> _blackoutWindow;

        [Commvault.Powershell.Origin(Commvault.Powershell.PropertyOrigin.Owned)]
        public System.Collections.Generic.List<Commvault.Powershell.Models.IBlackoutWindowDetails> BlackoutWindow { get => this._blackoutWindow; set => this._blackoutWindow = value; }
        ...
        [Commvault.Powershell.Origin(Commvault.Powershell.PropertyOrigin.Inlined)]
        public System.Collections.Generic.List<string> FileExceptionUnixFilters { get => ((Commvault.Powershell.Models.IFileExceptionsDetailInternal)FileExceptions).UnixFilters; set => ((Commvault.Powershell.Models.IFileExceptionsDetailInternal)FileExceptions).UnixFilters = value ?? null /* arrayOf */; }
        ...
        [Commvault.Powershell.Origin(Commvault.Powershell.PropertyOrigin.Inlined)]
        public System.Collections.Generic.List<string> FileExceptionWindowsFilters { get => ((Commvault.Powershell.Models.IFileExceptionsDetailInternal)FileExceptions).WindowsFilters; set => ((Commvault.Powershell.Models.IFileExceptionsDetailInternal)FileExceptions).WindowsFilters = value ?? null /* arrayOf */; }
        ...
        Commvault.Powershell.Runtime.IJsonSerializable
    {
        ...
        System.Collections.Generic.List<Commvault.Powershell.Models.IServerDetails> AssociatedServers { get; set; }
        ...
        System.Collections.Generic.List<Commvault.Powershell.Models.IBlackoutWindowDetails> BlackoutWindow { get; set; }
        ...
        PossibleTypes = new [] { typeof(string) })]
        System.Collections.Generic.List<string> FileExceptionUnixFilters { get; set; }
        /// <summary>To apply the filters to all the subclients in the server group.</summary>
        [Commvault.Powershell.Runtime.Info(
        Required = false,
        ReadOnly = false,
        ...
        PossibleTypes = new [] { typeof(string) })]
        System.Collections.Generic.List<string> FileExceptionWindowsFilters { get; set; }
        /// <summary>
        /// if enabled then after every 24 hours, according to each server's individual Commvault service schedule, the software discovers
        /// the applications on each server and installs a Commvault software package for each application that is found.
        /// </summary>
