...
namespace Commvault.Powershell.Models
{
    ...
    public partial class VMGroupCommonProperties
    {
        ...
        internal VMGroupCommonProperties(Commvault.Powershell.Runtime.Json.JsonObject json)
        {
            ...
            {_indexingInfo = If( json?.PropertyT<Commvault.Powershell.Runtime.Json.JsonObject>("indexingInfo"), out var __jsonIndexingInfo) ? Commvault.Powershell.Models.IndexingInfo.FromJson(__jsonIndexingInfo) : _indexingInfo;}
            ...
            {_backupset = If( json?.PropertyT<Commvault.Powershell.Runtime.Json.JsonObject>("backupset"), out var __jsonBackupset) ? Commvault.Powershell.Models.IdName.FromJson(__jsonBackupset) : _backupset;}
            {_iDataAgent = If( json?.PropertyT<Commvault.Powershell.Runtime.Json.JsonObject>("iDataAgent"), out var __jsonIDataAgent) ? Commvault.Powershell.Models.IdName.FromJson(__jsonIDataAgent) : _iDataAgent;}
            {_dataBackupStoragePolicy = If( json?.PropertyT<Commvault.Powershell.Runtime.Json.JsonObject>("dataBackupStoragePolicy"), out var __jsonDataBackupStoragePolicy) ? Commvault.Powershell.Models.IdName.FromJson(__jsonDataBackupStoragePolicy) : _dataBackupStoragePolicy;}
            {_isIndexingV2 = If( json?.PropertyT<Commvault.Powershell.Runtime.Json.JsonBoolean>("isIndexingV2"), out var __jsonIsIndexingV2) ? (bool?)__jsonIsIndexingV2 : _isIndexingV2;}
            {_isDeletedHypervisor = If( json?.PropertyT<Commvault.Powershell.Runtime.Json.JsonBoolean>("isDeletedHypervisor"), out var __jsonIsDeletedHypervisor) ? (bool?)__jsonIsDeletedHypervisor : _isDeletedHypervisor;}
            {_isEtcdSubclient = If( json?.PropertyT<Commvault.Powershell.Runtime.Json.JsonBoolean>("isETCDSubclient"), out var __jsonIsEtcdSubclient) ? (bool?)__jsonIsEtcdSubclient : _isEtcdSubclient;}
            {_showFullBackupLevel = If( json?.PropertyT<Commvault.Powershell.Runtime.Json.JsonBoolean>("showFullBackupLevel"), out var __jsonShowFullBackupLevel) ? (bool?)__jsonShowFullBackupLevel : _showFullBackupLevel;}
            {_isHypervisorDeconfigured = If( json?.PropertyT<Commvault.Powershell.Runtime.Json.JsonBoolean>("isHypervisorDeconfigured"), out var __jsonIsHypervisorDeconfigured) ? (bool?)__jsonIsHypervisorDeconfigured : _isHypervisorDeconfigured;}
            ...
            {_hypervisor = If( json?.PropertyT<Commvault.Powershell.Runtime.Json.JsonObject>("hypervisor"), out var __jsonHypervisor) ? Commvault.Powershell.Models.HypervisorvmGroupCommonProp.FromJson(__jsonHypervisor) : _hypervisor;}
            AfterFromJson(json);
        }
    }
}