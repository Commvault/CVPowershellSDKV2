...
namespace Commvault.Powershell.Models
{
    ...
    public partial class GetRecoveryTargetListSummary
    {
        ...
        internal GetRecoveryTargetListSummary(Commvault.Powershell.Runtime.Json.JsonObject json)
        {
            ...
            {_destinationHypervisor = If( json?.PropertyT<Commvault.Powershell.Runtime.Json.JsonObject>("destinationHypervisor"), out var __jsonDestinationHypervisor) ? Commvault.Powershell.Models.IdName.FromJson(__jsonDestinationHypervisor) : _destinationHypervisor;}
            ...
            {_policyType = If( json?.PropertyT<Commvault.Powershell.Runtime.Json.JsonString>("policyType"), out var __jsonPolicyType) ? (string)__jsonPolicyType : (string)_policyType;}
            {_applicationType = If( json?.PropertyT<Commvault.Powershell.Runtime.Json.JsonString>("applicationType"), out var __jsonApplicationType) ? (string)__jsonApplicationType : (string)_applicationType;}
            AfterFromJson(json);
        }
