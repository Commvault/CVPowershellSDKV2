...
namespace Commvault.Powershell.Models
{
    ...
    public partial class CreateDiskStorage
    {
        ...
        internal CreateDiskStorage(Commvault.Powershell.Runtime.Json.JsonObject json)
        {
            ...
            {_storage = If( json?.PropertyT<Commvault.Powershell.Runtime.Json.JsonArray>("storage"), out var __jsonStorage) ? If( __jsonStorage as Commvault.Powershell.Runtime.Json.JsonArray, out var __v) ? new global::System.Func<System.Collections.Generic.List<Commvault.Powershell.Models.IPath>>(()=> global::System.Linq.Enumerable.ToList(global::System.Linq.Enumerable.Select(__v, (__u)=>(Commvault.Powershell.Models.IPath) (Commvault.Powershell.Models.Path.FromJson(__u) )) ))() : null : _storage;}
            {_enableDeduplication = If( json?.PropertyT<Commvault.Powershell.Runtime.Json.JsonBoolean>("enableDeduplication"), out var __jsonEnableDeduplication) ? (bool)__jsonEnableDeduplication : _enableDeduplication;}
            {_deduplicationDbStorage = If( json?.PropertyT<Commvault.Powershell.Runtime.Json.JsonArray>("deduplicationDBStorage"), out var __jsonDeduplicationDbStorage) ? If( __jsonDeduplicationDbStorage as Commvault.Powershell.Runtime.Json.JsonArray, out var __q) ? new global::System.Func<System.Collections.Generic.List<Commvault.Powershell.Models.IDedupePath>>(()=> global::System.Linq.Enumerable.ToList(global::System.Linq.Enumerable.Select(__q, (__p)=>(Commvault.Powershell.Models.IDedupePath) (Commvault.Powershell.Models.DedupePath.FromJson(__p) )) ))() : null : _deduplicationDbStorage;}
            AfterFromJson(json);
        }
