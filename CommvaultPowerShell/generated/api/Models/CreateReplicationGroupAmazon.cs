...
namespace Commvault.Powershell.Models
{
    ...
    public partial class CreateReplicationGroupAmazon :
        Commvault.Powershell.Models.ICreateReplicationGroupAmazon,
        Commvault.Powershell.Models.ICreateReplicationGroupAmazonInternal,
        Commvault.Powershell.Runtime.IValidates
    {
        ...
        public bool? AdvancedOptionUnconditionalOverwrite { get => ((Commvault.Powershell.Models.IReplicationGroupAdvOptionsAmazonInternal)AdvancedOptions).UnconditionalOverwrite; set => ((Commvault.Powershell.Models.IReplicationGroupAdvOptionsAmazonInternal)AdvancedOptions).UnconditionalOverwrite = value ?? default(bool); }

        /// <summary>
        /// Validates that the destination VM is bootable by powering it on and then powering off
        /// </summary>
        [Commvault.Powershell.Origin(Commvault.Powershell.PropertyOrigin.Inlined)]
        public bool? AdvancedOptionValidateDestinationVM { get => ((Commvault.Powershell.Models.IReplicationGroupAdvOptionsAmazonInternal)AdvancedOptions).ValidateDestinationVM; set => ((Commvault.Powershell.Models.IReplicationGroupAdvOptionsAmazonInternal)AdvancedOptions).ValidateDestinationVM = value ?? default(bool); }

        /// <summary>Backing field for <see cref="AdvancedOptions" /> property.</summary>
        private Commvault.Powershell.Models.IReplicationGroupAdvOptionsAmazon _advancedOptions;

        /// <summary>Advanced options for Amazon replication group</summary>
        [Commvault.Powershell.Origin(Commvault.Powershell.PropertyOrigin.Owned)]
        internal Commvault.Powershell.Models.IReplicationGroupAdvOptionsAmazon AdvancedOptions { get => (this._advancedOptions = this._advancedOptions ?? new Commvault.Powershell.Models.ReplicationGroupAdvOptionsAmazon()); set => this._advancedOptions = value; }

        /// <summary>Internal Acessors for AdvancedOptions</summary>
        Commvault.Powershell.Models.IReplicationGroupAdvOptionsAmazon Commvault.Powershell.Models.ICreateReplicationGroupAmazonInternal.AdvancedOptions { get => (this._advancedOptions = this._advancedOptions ?? new Commvault.Powershell.Models.ReplicationGroupAdvOptionsAmazon()); set { {_advancedOptions = value;} } }

        /// <summary>Internal Acessors for DestVendor</summary>
        string Commvault.Powershell.Models.ICreateReplicationGroupAmazonInternal.DestVendor { get => this._destVendor; set { {_destVendor = value;} } }

        /// <summary>Internal Acessors for RecoveryTarget</summary>
        Commvault.Powershell.Models.IIdName Commvault.Powershell.Models.ICreateReplicationGroupInternal.RecoveryTarget { get => ((Commvault.Powershell.Models.ICreateReplicationGroupInternal)__createReplicationGroup).RecoveryTarget; set => ((Commvault.Powershell.Models.ICreateReplicationGroupInternal)__createReplicationGroup).RecoveryTarget = value; }

        /// <summary>Internal Acessors for SourceHypervisor</summary>
        Commvault.Powershell.Models.IIdName Commvault.Powershell.Models.ICreateReplicationGroupInternal.SourceHypervisor { get => ((Commvault.Powershell.Models.ICreateReplicationGroupInternal)__createReplicationGroup).SourceHypervisor; set => ((Commvault.Powershell.Models.ICreateReplicationGroupInternal)__createReplicationGroup).SourceHypervisor = value; }

        /// <summary>Backing field for <see cref="DestVendor" /> property.</summary>
        private string _destVendor= @"Amazon";
        ...
        private System.Collections.Generic.List<Commvault.Powershell.Models.IOverrideReplicationOptionsAmazonCreate> _overrideReplicationOptions;
        ...
        /// </summary>
        [Commvault.Powershell.Origin(Commvault.Powershell.PropertyOrigin.Owned)]
        public System.Collections.Generic.List<Commvault.Powershell.Models.IOverrideReplicationOptionsAmazonCreate> OverrideReplicationOptions { get => this._overrideReplicationOptions; set => this._overrideReplicationOptions = value; }

        [Commvault.Powershell.Origin(Commvault.Powershell.PropertyOrigin.Inherited)]
        internal Commvault.Powershell.Models.IIdName RecoveryTarget { get => ((Commvault.Powershell.Models.ICreateReplicationGroupInternal)__createReplicationGroup).RecoveryTarget; set => ((Commvault.Powershell.Models.ICreateReplicationGroupInternal)__createReplicationGroup).RecoveryTarget = value ; }
        ...
        [Commvault.Powershell.Origin(Commvault.Powershell.PropertyOrigin.Inherited)]
        internal Commvault.Powershell.Models.IIdName SourceHypervisor { get => ((Commvault.Powershell.Models.ICreateReplicationGroupInternal)__createReplicationGroup).SourceHypervisor; set => ((Commvault.Powershell.Models.ICreateReplicationGroupInternal)__createReplicationGroup).SourceHypervisor = value ; }
        ...
        /// </summary>
        [Commvault.Powershell.Origin(Commvault.Powershell.PropertyOrigin.Inherited)]
        public System.Collections.Generic.List<Commvault.Powershell.Models.IStorageCopyCreate> Storage { get => ((Commvault.Powershell.Models.ICreateReplicationGroupInternal)__createReplicationGroup).Storage; set => ((Commvault.Powershell.Models.ICreateReplicationGroupInternal)__createReplicationGroup).Storage = value ; }

        /// <summary>A list of name and GUID of all the virtual machines that have to be replicated</summary>
        [Commvault.Powershell.Origin(Commvault.Powershell.PropertyOrigin.Inherited)]
        public System.Collections.Generic.List<Commvault.Powershell.Models.INameGuid> Vms { get => ((Commvault.Powershell.Models.ICreateReplicationGroupInternal)__createReplicationGroup).Vms; set => ((Commvault.Powershell.Models.ICreateReplicationGroupInternal)__createReplicationGroup).Vms = value ; }

        /// <summary>Creates an new <see cref="CreateReplicationGroupAmazon" /> instance.</summary>
        public CreateReplicationGroupAmazon()
        {
        ...
        Commvault.Powershell.Models.ICreateReplicationGroup
    {
        ...
        PossibleTypes = new [] { typeof(Commvault.Powershell.Models.IOverrideReplicationOptionsAmazonCreate) })]
        System.Collections.Generic.List<Commvault.Powershell.Models.IOverrideReplicationOptionsAmazonCreate> OverrideReplicationOptions { get; set; }

    }
    /// Create a replication group with Amazon as the destination vendor. SourceHypervisor is the hypervisor that has the VM's
    /// to be backed up. Recovery target contains the replication options that will be applied to the selected VM's. ID is mandatory
    /// for sourceHypervisor and recovery target. Provide both the id and the name for the storage and the vms.
    internal partial interface ICreateReplicationGroupAmazonInternal :
        Commvault.Powershell.Models.ICreateReplicationGroupInternal
    {
        ...
        bool? AdvancedOptionValidateDestinationVM { get; set; }
        /// <summary>Advanced options for Amazon replication group</summary>
        Commvault.Powershell.Models.IReplicationGroupAdvOptionsAmazon AdvancedOptions { get; set; }
