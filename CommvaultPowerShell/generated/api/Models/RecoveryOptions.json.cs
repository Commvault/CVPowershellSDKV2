...
namespace Commvault.Powershell.Models
{
    ...
    public partial class RecoveryOptions
    {
        ...
        internal RecoveryOptions(Commvault.Powershell.Runtime.Json.JsonObject json)
        {
            ...
            {_recoveryPointStore = If( json?.PropertyT<Commvault.Powershell.Runtime.Json.JsonString>("recoveryPointStore"), out var __jsonRecoveryPointStore) ? (string)__jsonRecoveryPointStore : (string)_recoveryPointStore;}
            {_crashConsistentRpInterval = If( json?.PropertyT<Commvault.Powershell.Runtime.Json.JsonNumber>("crashConsistentRpInterval"), out var __jsonCrashConsistentRpInterval) ? (long?)__jsonCrashConsistentRpInterval : _crashConsistentRpInterval;}
            ...
            {_recoveryPointInterval = If( json?.PropertyT<Commvault.Powershell.Runtime.Json.JsonNumber>("recoveryPointInterval"), out var __jsonRecoveryPointInterval) ? (long?)__jsonRecoveryPointInterval : _recoveryPointInterval;}
            {_pruneAndMergeRecoveryPoints = If( json?.PropertyT<Commvault.Powershell.Runtime.Json.JsonBoolean>("pruneAndMergeRecoveryPoints"), out var __jsonPruneAndMergeRecoveryPoints) ? (bool?)__jsonPruneAndMergeRecoveryPoints : _pruneAndMergeRecoveryPoints;}
            AfterFromJson(json);
        }
