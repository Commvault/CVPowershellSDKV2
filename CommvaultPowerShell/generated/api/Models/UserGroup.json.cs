...
namespace Commvault.Powershell.Models
{
    ...
    public partial class UserGroup
    {
        ...
        public Commvault.Powershell.Runtime.Json.JsonNode ToJson(Commvault.Powershell.Runtime.Json.JsonObject container, Commvault.Powershell.Runtime.SerializationMode serializationMode)
        {
            ...
            if (serializationMode.HasFlag(Commvault.Powershell.Runtime.SerializationMode.IncludeRead))
            {
            ...
            if (null != this._restrictedConsoleTypes)
            {
                ...
                foreach( var __d in this._restrictedConsoleTypes )
                {
                    AddIf(__d?.ToJson(null, serializationMode) ,__c.Add);
                }
                container.Add("restrictedConsoleTypes",__c);
            }
            ...
            if (serializationMode.HasFlag(Commvault.Powershell.Runtime.SerializationMode.IncludeRead))
            {
                AddIf( null != this._showAzureGuidOption ? (Commvault.Powershell.Runtime.Json.JsonNode)new Commvault.Powershell.Runtime.Json.JsonBoolean((bool)this._showAzureGuidOption) : null, "showAzureGuidOption" ,container.Add );
            }
        ...
        internal UserGroup(Commvault.Powershell.Runtime.Json.JsonObject json)
        {
            ...
            {_id = If( json?.PropertyT<Commvault.Powershell.Runtime.Json.JsonString>("id"), out var __jsonId) ? (string)__jsonId : (string)_id;}
            ...
            {_associatedEntities = If( json?.PropertyT<Commvault.Powershell.Runtime.Json.JsonArray>("associatedEntities"), out var __jsonAssociatedEntities) ? If( __jsonAssociatedEntities as Commvault.Powershell.Runtime.Json.JsonArray, out var __g) ? new global::System.Func<System.Collections.Generic.List<Commvault.Powershell.Models.IAssocEntity>>(()=> global::System.Linq.Enumerable.ToList(global::System.Linq.Enumerable.Select(__g, (__f)=>(Commvault.Powershell.Models.IAssocEntity) (Commvault.Powershell.Models.AssocEntity.FromJson(__f) )) ))() : null : _associatedEntities;}
            {_eligibleToAllowMultipleCompanyMembers = If( json?.PropertyT<Commvault.Powershell.Runtime.Json.JsonBoolean>("eligibleToAllowMultipleCompanyMembers"), out var __jsonEligibleToAllowMultipleCompanyMembers) ? (bool?)__jsonEligibleToAllowMultipleCompanyMembers : _eligibleToAllowMultipleCompanyMembers;}
            ...
            {_showAzureGuidOption = If( json?.PropertyT<Commvault.Powershell.Runtime.Json.JsonBoolean>("showAzureGuidOption"), out var __jsonShowAzureGuidOption) ? (bool?)__jsonShowAzureGuidOption : _showAzureGuidOption;}
            AfterFromJson(json);
        }
    }
}