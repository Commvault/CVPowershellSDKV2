...
namespace Commvault.Powershell.Models
{
    ...
    public partial class RegionSummary
    {
        ...
        internal RegionSummary(Commvault.Powershell.Runtime.Json.JsonObject json)
        {
            ...
            {_locations = If( json?.PropertyT<Commvault.Powershell.Runtime.Json.JsonArray>("locations"), out var __jsonLocations) ? If( __jsonLocations as Commvault.Powershell.Runtime.Json.JsonArray, out var __v) ? new global::System.Func<System.Collections.Generic.List<Commvault.Powershell.Models.ILocationSummary>>(()=> global::System.Linq.Enumerable.ToList(global::System.Linq.Enumerable.Select(__v, (__u)=>(Commvault.Powershell.Models.ILocationSummary) (Commvault.Powershell.Models.LocationSummary.FromJson(__u) )) ))() : null : _locations;}
            {_associatedServers = If( json?.PropertyT<Commvault.Powershell.Runtime.Json.JsonNumber>("associatedServers"), out var __jsonAssociatedServers) ? (long?)__jsonAssociatedServers : _associatedServers;}
            {_associatedRegionBasedPlans = If( json?.PropertyT<Commvault.Powershell.Runtime.Json.JsonNumber>("associatedRegionBasedPlans"), out var __jsonAssociatedRegionBasedPlans) ? (long?)__jsonAssociatedRegionBasedPlans : _associatedRegionBasedPlans;}
            AfterFromJson(json);
        }
