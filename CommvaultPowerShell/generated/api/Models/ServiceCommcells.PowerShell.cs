...
namespace Commvault.Powershell.Models
{
    ...
    public partial class ServiceCommcells
    {
        ...
        /// <returns>an instance of the <see cref="ServiceCommcells" /> model class.</returns>
        ...
        internal ServiceCommcells(global::System.Collections.IDictionary content)
        {
            ...
            if (content.Contains("UseUniversalCommandCenter"))
            {
            ...
            if (content.Contains("SyncStatusErrorMessage"))
            {
                ((Commvault.Powershell.Models.IServiceCommcellsInternal)this).SyncStatusErrorMessage = (System.Collections.Generic.List<Commvault.Powershell.Models.INameMessage>) content.GetValueForProperty("SyncStatusErrorMessage",((Commvault.Powershell.Models.IServiceCommcellsInternal)this).SyncStatusErrorMessage, __y => TypeConverterExtensions.SelectToList<Commvault.Powershell.Models.INameMessage>(__y, Commvault.Powershell.Models.NameMessageTypeConverter.ConvertFrom));
            }
            if (content.Contains("SyncStatusStatus"))
            {
            ...
            if (content.Contains("SyncStatusLastSyncedWithIdp"))
            {
