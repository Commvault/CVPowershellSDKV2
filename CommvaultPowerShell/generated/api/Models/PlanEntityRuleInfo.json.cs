...
namespace Commvault.Powershell.Models
{
    ...
    public partial class PlanEntityRuleInfo
    {
        ...
        internal PlanEntityRuleInfo(Commvault.Powershell.Runtime.Json.JsonObject json)
        {
            ...
            {_rule = If( json?.PropertyT<Commvault.Powershell.Runtime.Json.JsonObject>("rule"), out var __jsonRule) ? Commvault.Powershell.Models.IdName.FromJson(__jsonRule) : _rule;}
            {_plan = If( json?.PropertyT<Commvault.Powershell.Runtime.Json.JsonObject>("plan"), out var __jsonPlan) ? Commvault.Powershell.Models.IdNameGuid.FromJson(__jsonPlan) : _plan;}
            ...
            {_regions = If( json?.PropertyT<Commvault.Powershell.Runtime.Json.JsonArray>("regions"), out var __jsonRegions) ? If( __jsonRegions as Commvault.Powershell.Runtime.Json.JsonArray, out var __q) ? new global::System.Func<System.Collections.Generic.List<Commvault.Powershell.Models.IIdNameGuid>>(()=> global::System.Linq.Enumerable.ToList(global::System.Linq.Enumerable.Select(__q, (__p)=>(Commvault.Powershell.Models.IIdNameGuid) (Commvault.Powershell.Models.IdNameGuid.FromJson(__p) )) ))() : null : _regions;}
            {_tags = If( json?.PropertyT<Commvault.Powershell.Runtime.Json.JsonArray>("tags"), out var __jsonTags) ? If( __jsonTags as Commvault.Powershell.Runtime.Json.JsonArray, out var __l) ? new global::System.Func<System.Collections.Generic.List<Commvault.Powershell.Models.IPlanEntityRuleTag>>(()=> global::System.Linq.Enumerable.ToList(global::System.Linq.Enumerable.Select(__l, (__k)=>(Commvault.Powershell.Models.IPlanEntityRuleTag) (Commvault.Powershell.Models.PlanEntityRuleTag.FromJson(__k) )) ))() : null : _tags;}
            {_serverGroups = If( json?.PropertyT<Commvault.Powershell.Runtime.Json.JsonArray>("serverGroups"), out var __jsonServerGroups) ? If( __jsonServerGroups as Commvault.Powershell.Runtime.Json.JsonArray, out var __g) ? new global::System.Func<System.Collections.Generic.List<Commvault.Powershell.Models.IIdNameGuid>>(()=> global::System.Linq.Enumerable.ToList(global::System.Linq.Enumerable.Select(__g, (__f)=>(Commvault.Powershell.Models.IIdNameGuid) (Commvault.Powershell.Models.IdNameGuid.FromJson(__f) )) ))() : null : _serverGroups;}
            {_rank = If( json?.PropertyT<Commvault.Powershell.Runtime.Json.JsonNumber>("rank"), out var __jsonRank) ? (long?)__jsonRank : _rank;}
            {_solutions = If( json?.PropertyT<Commvault.Powershell.Runtime.Json.JsonArray>("solutions"), out var __jsonSolutions) ? If( __jsonSolutions as Commvault.Powershell.Runtime.Json.JsonArray, out var __b) ? new global::System.Func<System.Collections.Generic.List<Commvault.Powershell.Models.IIdName>>(()=> global::System.Linq.Enumerable.ToList(global::System.Linq.Enumerable.Select(__b, (__a)=>(Commvault.Powershell.Models.IIdName) (Commvault.Powershell.Models.IdName.FromJson(__a) )) ))() : null : _solutions;}
            AfterFromJson(json);
        }
