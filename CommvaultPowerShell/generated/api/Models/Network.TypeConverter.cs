...
namespace Commvault.Powershell.Models
{
    ...
    public partial class NetworkTypeConverter : global::System.Management.Automation.PSTypeConverter
    {
        ...
        /// an instance of <see cref="Network" />, or <c>null</c> if there is no suitable conversion.
        /// </returns>
        public static Commvault.Powershell.Models.INetwork ConvertFrom(dynamic sourceValue)
        {
            if (null == sourceValue)
            {
                return null;
            ...
            global::System.Type type = sourceValue.GetType();
            if (typeof(Commvault.Powershell.Models.INetwork).IsAssignableFrom(type))
            {
                return sourceValue;
            }
            try
