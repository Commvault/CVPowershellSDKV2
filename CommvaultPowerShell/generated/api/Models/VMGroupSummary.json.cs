...
namespace Commvault.Powershell.Models
{
    ...
    public partial class VMGroupSummary
    {
        ...
        internal VMGroupSummary(Commvault.Powershell.Runtime.Json.JsonObject json)
        {
            ...
            {_hypervisor = If( json?.PropertyT<Commvault.Powershell.Runtime.Json.JsonObject>("hypervisor"), out var __jsonHypervisor) ? Commvault.Powershell.Models.IdNameDisplayName.FromJson(__jsonHypervisor) : _hypervisor;}
            ...
            {_plan = If( json?.PropertyT<Commvault.Powershell.Runtime.Json.JsonObject>("plan"), out var __jsonPlan) ? Commvault.Powershell.Models.PlanIdNameType.FromJson(__jsonPlan) : _plan;}
            ...
            {_replicationGroup = If( json?.PropertyT<Commvault.Powershell.Runtime.Json.JsonObject>("replicationGroup"), out var __jsonReplicationGroup) ? Commvault.Powershell.Models.IdName.FromJson(__jsonReplicationGroup) : _replicationGroup;}
            ...
            {_isDefaultVMGroup = If( json?.PropertyT<Commvault.Powershell.Runtime.Json.JsonBoolean>("isDefaultVMGroup"), out var __jsonIsDefaultVMGroup) ? (bool?)__jsonIsDefaultVMGroup : _isDefaultVMGroup;}
