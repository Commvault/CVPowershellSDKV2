...
namespace Commvault.Powershell.Models
{
    ...
    public partial class ResourcePoolSummary
    {
        ...
        /// <summary>
        /// Deserializes a <see cref="Commvault.Powershell.Runtime.Json.JsonNode"/> into an instance of Commvault.Powershell.Models.IResourcePoolSummary.
        /// </summary>
        /// <param name="node">a <see cref="Commvault.Powershell.Runtime.Json.JsonNode" /> to deserialize from.</param>
        /// <returns>an instance of Commvault.Powershell.Models.IResourcePoolSummary.</returns>
        public static Commvault.Powershell.Models.IResourcePoolSummary FromJson(Commvault.Powershell.Runtime.Json.JsonNode node)
        {
            return node is Commvault.Powershell.Runtime.Json.JsonObject json ? new ResourcePoolSummary(json) : null;
        }

        /// <summary>
        /// Deserializes a Commvault.Powershell.Runtime.Json.JsonObject into a new instance of <see cref="ResourcePoolSummary" />.
        /// </summary>
        /// <param name="json">A Commvault.Powershell.Runtime.Json.JsonObject instance to deserialize from.</param>
        internal ResourcePoolSummary(Commvault.Powershell.Runtime.Json.JsonObject json)
        {
            ...
            {_solutionType = If( json?.PropertyT<Commvault.Powershell.Runtime.Json.JsonString>("solutionType"), out var __jsonSolutionType) ? (string)__jsonSolutionType : (string)_solutionType;}
            ...
            {_associatedPlans = If( json?.PropertyT<Commvault.Powershell.Runtime.Json.JsonNumber>("associatedPlans"), out var __jsonAssociatedPlans) ? (long?)__jsonAssociatedPlans : _associatedPlans;}
            {_isIndexingEnabledOnAnyPlan = If( json?.PropertyT<Commvault.Powershell.Runtime.Json.JsonBoolean>("isIndexingEnabledOnAnyPlan"), out var __jsonIsIndexingEnabledOnAnyPlan) ? (bool?)__jsonIsIndexingEnabledOnAnyPlan : _isIndexingEnabledOnAnyPlan;}
            AfterFromJson(json);
        }

        /// <summary>
        /// Serializes this instance of <see cref="ResourcePoolSummary" /> into a <see cref="Commvault.Powershell.Runtime.Json.JsonNode" />.
        /// </summary>
        /// <param name="container">The <see cref="Commvault.Powershell.Runtime.Json.JsonObject"/> container to serialize this object into. If the caller
        /// passes in <c>null</c>, a new instance will be created and returned to the caller.</param>
        /// <param name="serializationMode">Allows the caller to choose the depth of the serialization. See <see cref="Commvault.Powershell.Runtime.SerializationMode"/>.</param>
        /// <returns>
        /// a serialized instance of <see cref="ResourcePoolSummary" /> as a <see cref="Commvault.Powershell.Runtime.Json.JsonNode" />.
        /// </returns>
