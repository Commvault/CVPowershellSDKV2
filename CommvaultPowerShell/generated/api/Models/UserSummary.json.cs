...
namespace Commvault.Powershell.Models
{
    ...
    public partial class UserSummary
    {
        ...
        /// <summary>
        /// Deserializes a <see cref="Commvault.Powershell.Runtime.Json.JsonNode"/> into an instance of Commvault.Powershell.Models.IUserSummary.
        /// </summary>
        /// <param name="node">a <see cref="Commvault.Powershell.Runtime.Json.JsonNode" /> to deserialize from.</param>
        /// <returns>an instance of Commvault.Powershell.Models.IUserSummary.</returns>
        public static Commvault.Powershell.Models.IUserSummary FromJson(Commvault.Powershell.Runtime.Json.JsonNode node)
        {
            return node is Commvault.Powershell.Runtime.Json.JsonObject json ? new UserSummary(json) : null;
        }

        /// <summary>
        /// Serializes this instance of <see cref="UserSummary" /> into a <see cref="Commvault.Powershell.Runtime.Json.JsonNode" />.
        /// </summary>
        /// <param name="container">The <see cref="Commvault.Powershell.Runtime.Json.JsonObject"/> container to serialize this object into. If the caller
        /// passes in <c>null</c>, a new instance will be created and returned to the caller.</param>
        /// <param name="serializationMode">Allows the caller to choose the depth of the serialization. See <see cref="Commvault.Powershell.Runtime.SerializationMode"/>.</param>
        /// <returns>
        /// a serialized instance of <see cref="UserSummary" /> as a <see cref="Commvault.Powershell.Runtime.Json.JsonNode" />.
        /// </returns>
        public Commvault.Powershell.Runtime.Json.JsonNode ToJson(Commvault.Powershell.Runtime.Json.JsonObject container, Commvault.Powershell.Runtime.SerializationMode serializationMode)
        {
            ...
            AddIf( null != this._numberOfLaptops ? (Commvault.Powershell.Runtime.Json.JsonNode)new Commvault.Powershell.Runtime.Json.JsonNumber((long)this._numberOfLaptops) : null, "numberOfLaptops" ,container.Add );
        ...
        /// <summary>
        /// Deserializes a Commvault.Powershell.Runtime.Json.JsonObject into a new instance of <see cref="UserSummary" />.
        /// </summary>
        /// <param name="json">A Commvault.Powershell.Runtime.Json.JsonObject instance to deserialize from.</param>
        internal UserSummary(Commvault.Powershell.Runtime.Json.JsonObject json)
        {
            bool returnNow = false;
            ...
            {_lockInfo = If( json?.PropertyT<Commvault.Powershell.Runtime.Json.JsonObject>("lockInfo"), out var __jsonLockInfo) ? Commvault.Powershell.Models.LockProperties.FromJson(__jsonLockInfo) : LockInfo;}
            ...
            {_numberOfLaptops = If( json?.PropertyT<Commvault.Powershell.Runtime.Json.JsonNumber>("numberOfLaptops"), out var __jsonNumberOfLaptops) ? (long?)__jsonNumberOfLaptops : NumberOfLaptops;}
