...
namespace Commvault.Powershell.Models
{
        ...
        Commvault.Powershell.Models.IPlanBackupDestinationRespInternal
    {
        ...
        private System.Collections.Generic.List<string> _failedDestinations;

        /// <summary>List of destinations for which the operation failed</summary>
        [Commvault.Powershell.Origin(Commvault.Powershell.PropertyOrigin.Owned)]
        public System.Collections.Generic.List<string> FailedDestinations { get => this._failedDestinations; set => this._failedDestinations = value; }

        /// <summary>Backing field for <see cref="PlanBackupDestination" /> property.</summary>
        private System.Collections.Generic.List<Commvault.Powershell.Models.IIdName> _planBackupDestination;

        /// <summary>List of destinations effected or created</summary>
        [Commvault.Powershell.Origin(Commvault.Powershell.PropertyOrigin.Owned)]
        public System.Collections.Generic.List<Commvault.Powershell.Models.IIdName> PlanBackupDestination { get => this._planBackupDestination; set => this._planBackupDestination = value; }
        ...
        Commvault.Powershell.Runtime.IJsonSerializable
    {
        ...
        PossibleTypes = new [] { typeof(string) })]
        System.Collections.Generic.List<string> FailedDestinations { get; set; }
        /// <summary>List of destinations effected or created</summary>
        [Commvault.Powershell.Runtime.Info(
        Required = false,
        ReadOnly = false,
        ...
        System.Collections.Generic.List<Commvault.Powershell.Models.IIdName> PlanBackupDestination { get; set; }
