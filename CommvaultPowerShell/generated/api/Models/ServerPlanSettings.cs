...
namespace Commvault.Powershell.Models
{
        ...
        Commvault.Powershell.Models.IServerPlanSettingsInternal
    {
        ...
        /// <summary>Backing field for <see cref="DeviceStreams" /> property.</summary>
        private long? _deviceStreams;

        /// <summary>
        /// For each region, the data to backup is divided into these many streams while writing to backup destination.
        /// </summary>
        [Commvault.Powershell.Origin(Commvault.Powershell.PropertyOrigin.Owned)]
        public long? DeviceStreams { get => this._deviceStreams; set => this._deviceStreams = value; }
        ...
        /// </summary>
        [Commvault.Powershell.Origin(Commvault.Powershell.PropertyOrigin.Inlined)]
        public System.Collections.Generic.List<Commvault.Powershell.Models.IPlanFileSearchSetupError> FileSearchErrors { get => ((Commvault.Powershell.Models.IPlanFileSearchInternal)FileSearch).Errors; set => ((Commvault.Powershell.Models.IPlanFileSearchInternal)FileSearch).Errors = value ?? null /* arrayOf */; }
