...
namespace Commvault.Powershell.Models
{
    ...
    public partial class MigrationGroupDetails
    {
        ...
        internal MigrationGroupDetails(Commvault.Powershell.Runtime.Json.JsonObject json)
        {
            ...
            {_sourceClient = If( json?.PropertyT<Commvault.Powershell.Runtime.Json.JsonObject>("sourceClient"), out var __jsonSourceClient) ? Commvault.Powershell.Models.IdName.FromJson(__jsonSourceClient) : _sourceClient;}
            {_destinationClient = If( json?.PropertyT<Commvault.Powershell.Runtime.Json.JsonObject>("destinationClient"), out var __jsonDestinationClient) ? Commvault.Powershell.Models.IdName.FromJson(__jsonDestinationClient) : _destinationClient;}
            {_credentials = If( json?.PropertyT<Commvault.Powershell.Runtime.Json.JsonObject>("credentials"), out var __jsonCredentials) ? Commvault.Powershell.Models.Credentials.FromJson(__jsonCredentials) : _credentials;}
            {_updateFrequency = If( json?.PropertyT<Commvault.Powershell.Runtime.Json.JsonObject>("updateFrequency"), out var __jsonUpdateFrequency) ? Commvault.Powershell.Models.PlanPattern.FromJson(__jsonUpdateFrequency) : _updateFrequency;}
            {_sourceBackupset = If( json?.PropertyT<Commvault.Powershell.Runtime.Json.JsonObject>("sourceBackupset"), out var __jsonSourceBackupset) ? Commvault.Powershell.Models.IdName.FromJson(__jsonSourceBackupset) : _sourceBackupset;}
            {_destinationBackupset = If( json?.PropertyT<Commvault.Powershell.Runtime.Json.JsonObject>("destinationBackupset"), out var __jsonDestinationBackupset) ? Commvault.Powershell.Models.IdName.FromJson(__jsonDestinationBackupset) : _destinationBackupset;}
            {_sourceInstance = If( json?.PropertyT<Commvault.Powershell.Runtime.Json.JsonObject>("sourceInstance"), out var __jsonSourceInstance) ? Commvault.Powershell.Models.IdName.FromJson(__jsonSourceInstance) : _sourceInstance;}
            {_destinationInstance = If( json?.PropertyT<Commvault.Powershell.Runtime.Json.JsonObject>("destinationInstance"), out var __jsonDestinationInstance) ? Commvault.Powershell.Models.IdName.FromJson(__jsonDestinationInstance) : _destinationInstance;}
            {_sourceSubclient = If( json?.PropertyT<Commvault.Powershell.Runtime.Json.JsonObject>("sourceSubclient"), out var __jsonSourceSubclient) ? Commvault.Powershell.Models.IdName.FromJson(__jsonSourceSubclient) : _sourceSubclient;}
            {_destinationSubclient = If( json?.PropertyT<Commvault.Powershell.Runtime.Json.JsonObject>("destinationSubclient"), out var __jsonDestinationSubclient) ? Commvault.Powershell.Models.IdName.FromJson(__jsonDestinationSubclient) : _destinationSubclient;}
            {_sourceApplication = If( json?.PropertyT<Commvault.Powershell.Runtime.Json.JsonObject>("sourceApplication"), out var __jsonSourceApplication) ? Commvault.Powershell.Models.IdName.FromJson(__jsonSourceApplication) : _sourceApplication;}
            {_destinationApplication = If( json?.PropertyT<Commvault.Powershell.Runtime.Json.JsonObject>("destinationApplication"), out var __jsonDestinationApplication) ? Commvault.Powershell.Models.IdName.FromJson(__jsonDestinationApplication) : _destinationApplication;}
            {_backupSchedulePolicy = If( json?.PropertyT<Commvault.Powershell.Runtime.Json.JsonObject>("backupSchedulePolicy"), out var __jsonBackupSchedulePolicy) ? Commvault.Powershell.Models.IdName.FromJson(__jsonBackupSchedulePolicy) : _backupSchedulePolicy;}
            {_backupSchedule = If( json?.PropertyT<Commvault.Powershell.Runtime.Json.JsonObject>("backupSchedule"), out var __jsonBackupSchedule) ? Commvault.Powershell.Models.IdName.FromJson(__jsonBackupSchedule) : _backupSchedule;}
            {_region = If( json?.PropertyT<Commvault.Powershell.Runtime.Json.JsonObject>("region"), out var __jsonRegion) ? Commvault.Powershell.Models.IdName.FromJson(__jsonRegion) : _region;}
            {_sourceAccessNode = If( json?.PropertyT<Commvault.Powershell.Runtime.Json.JsonArray>("sourceAccessNode"), out var __jsonSourceAccessNode) ? If( __jsonSourceAccessNode as Commvault.Powershell.Runtime.Json.JsonArray, out var __v) ? new global::System.Func<System.Collections.Generic.List<Commvault.Powershell.Models.IAccessNodes>>(()=> global::System.Linq.Enumerable.ToList(global::System.Linq.Enumerable.Select(__v, (__u)=>(Commvault.Powershell.Models.IAccessNodes) (Commvault.Powershell.Models.AccessNodes.FromJson(__u) )) ))() : null : _sourceAccessNode;}
            {_destinationAccessNode = If( json?.PropertyT<Commvault.Powershell.Runtime.Json.JsonArray>("destinationAccessNode"), out var __jsonDestinationAccessNode) ? If( __jsonDestinationAccessNode as Commvault.Powershell.Runtime.Json.JsonArray, out var __q) ? new global::System.Func<System.Collections.Generic.List<Commvault.Powershell.Models.IAccessNodes>>(()=> global::System.Linq.Enumerable.ToList(global::System.Linq.Enumerable.Select(__q, (__p)=>(Commvault.Powershell.Models.IAccessNodes) (Commvault.Powershell.Models.AccessNodes.FromJson(__p) )) ))() : null : _destinationAccessNode;}
            {_migrationGroupName = If( json?.PropertyT<Commvault.Powershell.Runtime.Json.JsonString>("migrationGroupName"), out var __jsonMigrationGroupName) ? (string)__jsonMigrationGroupName : (string)_migrationGroupName;}
            {_migrationMonitors = If( json?.PropertyT<Commvault.Powershell.Runtime.Json.JsonArray>("migrationMonitors"), out var __jsonMigrationMonitors) ? If( __jsonMigrationMonitors as Commvault.Powershell.Runtime.Json.JsonArray, out var __l) ? new global::System.Func<System.Collections.Generic.List<Commvault.Powershell.Models.IMigrationMonitor>>(()=> global::System.Linq.Enumerable.ToList(global::System.Linq.Enumerable.Select(__l, (__k)=>(Commvault.Powershell.Models.IMigrationMonitor) (Commvault.Powershell.Models.MigrationMonitor.FromJson(__k) )) ))() : null : _migrationMonitors;}
            {_migrationGroupState = If( json?.PropertyT<Commvault.Powershell.Runtime.Json.JsonBoolean>("migrationGroupState"), out var __jsonMigrationGroupState) ? (bool?)__jsonMigrationGroupState : _migrationGroupState;}
            {_migrationSize = If( json?.PropertyT<Commvault.Powershell.Runtime.Json.JsonNumber>("migrationSize"), out var __jsonMigrationSize) ? (long?)__jsonMigrationSize : _migrationSize;}
            {_numOfFiles = If( json?.PropertyT<Commvault.Powershell.Runtime.Json.JsonNumber>("numOfFiles"), out var __jsonNumOfFiles) ? (long?)__jsonNumOfFiles : _numOfFiles;}
            {_failures = If( json?.PropertyT<Commvault.Powershell.Runtime.Json.JsonString>("failures"), out var __jsonFailures) ? (string)__jsonFailures : (string)_failures;}
            {_backupJobId = If( json?.PropertyT<Commvault.Powershell.Runtime.Json.JsonNumber>("backupJobId"), out var __jsonBackupJobId) ? (long?)__jsonBackupJobId : _backupJobId;}
            {_restoreJobId = If( json?.PropertyT<Commvault.Powershell.Runtime.Json.JsonNumber>("restoreJobId"), out var __jsonRestoreJobId) ? (long?)__jsonRestoreJobId : _restoreJobId;}
            {_migrationStatus = If( json?.PropertyT<Commvault.Powershell.Runtime.Json.JsonString>("migrationStatus"), out var __jsonMigrationStatus) ? (string)__jsonMigrationStatus : (string)_migrationStatus;}
            {_lastSyncTime = If( json?.PropertyT<Commvault.Powershell.Runtime.Json.JsonNumber>("lastSyncTime"), out var __jsonLastSyncTime) ? (long?)__jsonLastSyncTime : _lastSyncTime;}
            {_failureReason = If( json?.PropertyT<Commvault.Powershell.Runtime.Json.JsonString>("failureReason"), out var __jsonFailureReason) ? (string)__jsonFailureReason : (string)_failureReason;}
            AfterFromJson(json);
        }
