...
namespace Commvault.Powershell.Models
{
    ...
    public partial class General
    {
        ...
        internal General(Commvault.Powershell.Runtime.Json.JsonObject json)
        {
            ...
            {_twoFactorAuth = If( json?.PropertyT<Commvault.Powershell.Runtime.Json.JsonObject>("twoFactorAuth"), out var __jsonTwoFactorAuth) ? Commvault.Powershell.Models.TwoFactorAuth.FromJson(__jsonTwoFactorAuth) : _twoFactorAuth;}
            {_newAlias = If( json?.PropertyT<Commvault.Powershell.Runtime.Json.JsonString>("newAlias"), out var __jsonNewAlias) ? (string)__jsonNewAlias : (string)_newAlias;}
            ...
            {_authcodeForInstallation = If( json?.PropertyT<Commvault.Powershell.Runtime.Json.JsonBoolean>("authcodeForInstallation"), out var __jsonAuthcodeForInstallation) ? (bool?)__jsonAuthcodeForInstallation : _authcodeForInstallation;}
            {_upnInsteadOfEmail = If( json?.PropertyT<Commvault.Powershell.Runtime.Json.JsonBoolean>("upnInsteadOfEmail"), out var __jsonUpnInsteadOfEmail) ? (bool?)__jsonUpnInsteadOfEmail : _upnInsteadOfEmail;}
            {_resellerMode = If( json?.PropertyT<Commvault.Powershell.Runtime.Json.JsonBoolean>("resellerMode"), out var __jsonResellerMode) ? (bool?)__jsonResellerMode : _resellerMode;}
            {_enableDataEncryption = If( json?.PropertyT<Commvault.Powershell.Runtime.Json.JsonBoolean>("enableDataEncryption"), out var __jsonEnableDataEncryption) ? (bool?)__jsonEnableDataEncryption : _enableDataEncryption;}
            {_autoDiscoverApp = If( json?.PropertyT<Commvault.Powershell.Runtime.Json.JsonBoolean>("autoDiscoverApp"), out var __jsonAutoDiscoverApp) ? (bool?)__jsonAutoDiscoverApp : _autoDiscoverApp;}
            {_infrastructureType = If( json?.PropertyT<Commvault.Powershell.Runtime.Json.JsonString>("infrastructureType"), out var __jsonInfrastructureType) ? (string)__jsonInfrastructureType : (string)_infrastructureType;}
            {_supportedSolutions = If( json?.PropertyT<Commvault.Powershell.Runtime.Json.JsonArray>("supportedSolutions"), out var __jsonSupportedSolutions) ? If( __jsonSupportedSolutions as Commvault.Powershell.Runtime.Json.JsonArray, out var __v) ? new global::System.Func<System.Collections.Generic.List<string>>(()=> global::System.Linq.Enumerable.ToList(global::System.Linq.Enumerable.Select(__v, (__u)=>(string) (__u is Commvault.Powershell.Runtime.Json.JsonString __t ? (string)(__t.ToString()) : null)) ))() : null : _supportedSolutions;}
            {_assignLaptopOwners = If( json?.PropertyT<Commvault.Powershell.Runtime.Json.JsonString>("assignLaptopOwners"), out var __jsonAssignLaptopOwners) ? (string)__jsonAssignLaptopOwners : (string)_assignLaptopOwners;}
