...
namespace Commvault.Powershell.Models
{
    ...
    public partial class UpdateRole
    {
        ...
        internal UpdateRole(Commvault.Powershell.Runtime.Json.JsonObject json)
        {
            ...
            {_permissionList = If( json?.PropertyT<Commvault.Powershell.Runtime.Json.JsonArray>("permissionList"), out var __jsonPermissionList) ? If( __jsonPermissionList as Commvault.Powershell.Runtime.Json.JsonArray, out var __v) ? new global::System.Func<System.Collections.Generic.List<Commvault.Powershell.Models.IPermissions>>(()=> global::System.Linq.Enumerable.ToList(global::System.Linq.Enumerable.Select(__v, (__u)=>(Commvault.Powershell.Models.IPermissions) (Commvault.Powershell.Models.Permissions.FromJson(__u) )) ))() : null : _permissionList;}
            {_permissionOperationType = If( json?.PropertyT<Commvault.Powershell.Runtime.Json.JsonString>("permissionOperationType"), out var __jsonPermissionOperationType) ? (string)__jsonPermissionOperationType : (string)_permissionOperationType;}
            ...
            {_visibleToAll = If( json?.PropertyT<Commvault.Powershell.Runtime.Json.JsonBoolean>("visibleToAll"), out var __jsonVisibleToAll) ? (bool?)__jsonVisibleToAll : _visibleToAll;}
            {_security = If( json?.PropertyT<Commvault.Powershell.Runtime.Json.JsonArray>("security"), out var __jsonSecurity) ? If( __jsonSecurity as Commvault.Powershell.Runtime.Json.JsonArray, out var __q) ? new global::System.Func<System.Collections.Generic.List<Commvault.Powershell.Models.IUpdateSecurityAssoc>>(()=> global::System.Linq.Enumerable.ToList(global::System.Linq.Enumerable.Select(__q, (__p)=>(Commvault.Powershell.Models.IUpdateSecurityAssoc) (Commvault.Powershell.Models.UpdateSecurityAssoc.FromJson(__p) )) ))() : null : _security;}
            AfterFromJson(json);
        }
    }
}