...
namespace Commvault.Powershell.Models
{
    ...
    public partial class ReplicationConfigurationAzure
    {
        ...
        internal ReplicationConfigurationAzure(global::System.Collections.IDictionary content)
        {
            ...
            {
                ((Commvault.Powershell.Models.IReplicationConfigurationAzureInternal)this).DiskType = (string) content.GetValueForProperty("DiskType",((Commvault.Powershell.Models.IReplicationConfigurationAzureInternal)this).DiskType, global::System.Convert.ToString);
            }
            if (content.Contains("SourceVMGuid"))
            {
                ((Commvault.Powershell.Models.IReplicationConfigurationAzureInternal)this).SourceVMGuid = (string) content.GetValueForProperty("SourceVMGuid",((Commvault.Powershell.Models.IReplicationConfigurationAzureInternal)this).SourceVMGuid, global::System.Convert.ToString);
            }
            if (content.Contains("Region"))
            {
                ((Commvault.Powershell.Models.IReplicationConfigurationAzureInternal)this).Region = (string) content.GetValueForProperty("Region",((Commvault.Powershell.Models.IReplicationConfigurationAzureInternal)this).Region, global::System.Convert.ToString);
            }
            if (content.Contains("TestFailoverVMSize"))
            {
                ((Commvault.Powershell.Models.IReplicationConfigurationAzureInternal)this).TestFailoverVMSize = (string) content.GetValueForProperty("TestFailoverVMSize",((Commvault.Powershell.Models.IReplicationConfigurationAzureInternal)this).TestFailoverVMSize, global::System.Convert.ToString);
            }
