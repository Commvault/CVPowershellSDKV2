...
namespace Commvault.Powershell.Models
{
    ...
    public partial class CreateHypervisorGroupAzureStack
    {
        ...
        internal CreateHypervisorGroupAzureStack(Commvault.Powershell.Runtime.Json.JsonObject json)
        {
            ...
            {_resourceManagerUrl = If( json?.PropertyT<Commvault.Powershell.Runtime.Json.JsonString>("resourceManagerURL"), out var __jsonResourceManagerUrl) ? (string)__jsonResourceManagerUrl : (string)ResourceManagerUrl;}
