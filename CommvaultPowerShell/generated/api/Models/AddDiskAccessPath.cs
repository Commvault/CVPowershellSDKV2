...
namespace Commvault.Powershell.Models
{
        ...
        Commvault.Powershell.Models.IAddDiskAccessPathInternal
    {
        ...
        private System.Collections.Generic.List<Commvault.Powershell.Models.IIdName> _mediaAgents;

        /// <summary>Can add a list of media agents to be added as the disk access path.</summary>
        [Commvault.Powershell.Origin(Commvault.Powershell.PropertyOrigin.Owned)]
        public System.Collections.Generic.List<Commvault.Powershell.Models.IIdName> MediaAgents { get => this._mediaAgents; set => this._mediaAgents = value; }
        ...
        Commvault.Powershell.Runtime.IJsonSerializable
    {
        ...
        System.Collections.Generic.List<Commvault.Powershell.Models.IIdName> MediaAgents { get; set; }
