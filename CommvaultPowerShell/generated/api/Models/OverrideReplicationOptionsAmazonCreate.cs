...
namespace Commvault.Powershell.Models
{
        ...
        Commvault.Powershell.Models.IOverrideReplicationOptionsAmazonCreateInternal
    {
        ...
        /// <summary>The private IP address of the network</summary>
        [Commvault.Powershell.Origin(Commvault.Powershell.PropertyOrigin.Inlined)]
        public string NetworkPrivateIPaddress { get => ((Commvault.Powershell.Models.INetworkVpcSubnetInternal)Network).PrivateIPaddress; set => ((Commvault.Powershell.Models.INetworkVpcSubnetInternal)Network).PrivateIPaddress = value ?? null; }
        ...
        private System.Collections.Generic.List<Commvault.Powershell.Models.ISecurityGroup> _securityGroups;

        /// <summary>
        /// The security group to be applied to the destination instance that acts as a virtual firewall. Default value is Auto
        /// </summary>
        [Commvault.Powershell.Origin(Commvault.Powershell.PropertyOrigin.Owned)]
        public System.Collections.Generic.List<Commvault.Powershell.Models.ISecurityGroup> SecurityGroups { get => this._securityGroups; set => this._securityGroups = value; }
        ...
        Commvault.Powershell.Runtime.IJsonSerializable
    {
        ...
        System.Collections.Generic.List<Commvault.Powershell.Models.ISecurityGroup> SecurityGroups { get; set; }
