...
namespace Commvault.Powershell.Models
{
    ...
    public partial class ReplicationGroupSummary
    {
        ...
        internal ReplicationGroupSummary(Commvault.Powershell.Runtime.Json.JsonObject json)
        {
            ...
            {_destinationVendor = If( json?.PropertyT<Commvault.Powershell.Runtime.Json.JsonString>("destinationVendor"), out var __jsonDestinationVendor) ? (string)__jsonDestinationVendor : (string)DestinationVendor;}
