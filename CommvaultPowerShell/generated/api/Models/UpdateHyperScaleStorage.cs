...
namespace Commvault.Powershell.Models
{
    ...
    public partial class UpdateHyperScaleStorage :
        ...
        Commvault.Powershell.Models.IUpdateHyperScaleStorageInternal
    {

        /// <summary>Internal Acessors for Encryption</summary>
        Commvault.Powershell.Models.IEncryption Commvault.Powershell.Models.IUpdateHyperScaleStorageInternal.Encryption { get => (this._encryption = this._encryption ?? new Commvault.Powershell.Models.Encryption()); set { {_encryption = value;} } }

        /// <summary>Internal Acessors for EncryptionKeyProvider</summary>
        Commvault.Powershell.Models.IIdName Commvault.Powershell.Models.IUpdateHyperScaleStorageInternal.EncryptionKeyProvider { get => ((Commvault.Powershell.Models.IEncryptionInternal)Encryption).KeyProvider; set => ((Commvault.Powershell.Models.IEncryptionInternal)Encryption).KeyProvider = value; }
        ...
        /// <summary>Creates an new <see cref="UpdateHyperScaleStorage" /> instance.</summary>
        public UpdateHyperScaleStorage()
        {
    ...
    /// UpdateHyperScaleStorage
    internal partial interface IUpdateHyperScaleStorageInternal
