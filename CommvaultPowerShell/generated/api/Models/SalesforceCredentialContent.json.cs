...
namespace Commvault.Powershell.Models
{
    ...
    public partial class SalesforceCredentialContent
    {
        ...
        /// <summary>
        /// Deserializes a <see cref="Commvault.Powershell.Runtime.Json.JsonNode"/> into an instance of Commvault.Powershell.Models.ISalesforceCredentialContent.
        /// </summary>
        /// <param name="node">a <see cref="Commvault.Powershell.Runtime.Json.JsonNode" /> to deserialize from.</param>
        /// <returns>an instance of Commvault.Powershell.Models.ISalesforceCredentialContent.</returns>
        public static Commvault.Powershell.Models.ISalesforceCredentialContent FromJson(Commvault.Powershell.Runtime.Json.JsonNode node)
        {
            return node is Commvault.Powershell.Runtime.Json.JsonObject json ? new SalesforceCredentialContent(json) : null;
        }

        /// <summary>
        /// Deserializes a Commvault.Powershell.Runtime.Json.JsonObject into a new instance of <see cref="SalesforceCredentialContent" />.
        /// </summary>
        /// <param name="json">A Commvault.Powershell.Runtime.Json.JsonObject instance to deserialize from.</param>
        internal SalesforceCredentialContent(Commvault.Powershell.Runtime.Json.JsonObject json)
        {
            ...
            {_consumerKey = If( json?.PropertyT<Commvault.Powershell.Runtime.Json.JsonString>("consumerKey"), out var __jsonConsumerKey) ? (string)__jsonConsumerKey : (string)_consumerKey;}
            {_consumerSecret = If( json?.PropertyT<Commvault.Powershell.Runtime.Json.JsonString>("consumerSecret"), out var __jsonConsumerSecret) ? (string)__jsonConsumerSecret : (string)_consumerSecret;}
        ...
        /// <summary>
        /// Serializes this instance of <see cref="SalesforceCredentialContent" /> into a <see cref="Commvault.Powershell.Runtime.Json.JsonNode" />.
        /// </summary>
        /// <param name="container">The <see cref="Commvault.Powershell.Runtime.Json.JsonObject"/> container to serialize this object into. If the caller
        /// passes in <c>null</c>, a new instance will be created and returned to the caller.</param>
        /// <param name="serializationMode">Allows the caller to choose the depth of the serialization. See <see cref="Commvault.Powershell.Runtime.SerializationMode"/>.</param>
        /// <returns>
        /// a serialized instance of <see cref="SalesforceCredentialContent" /> as a <see cref="Commvault.Powershell.Runtime.Json.JsonNode" />.
        /// </returns>
