...
namespace Commvault.Powershell.Models
{
        ...
        Commvault.Powershell.Models.IOverrideReplicationOptionsHyperVInternal
    {
        ...
        private System.Collections.Generic.List<Commvault.Powershell.Models.INetworkName> _networkAdapter;

        /// <summary>Select a network interface from the Network adapter list</summary>
        [Commvault.Powershell.Origin(Commvault.Powershell.PropertyOrigin.Owned)]
        public System.Collections.Generic.List<Commvault.Powershell.Models.INetworkName> NetworkAdapter { get => this._networkAdapter; set => this._networkAdapter = value; }
        ...
        Commvault.Powershell.Runtime.IJsonSerializable
    {
        ...
        System.Collections.Generic.List<Commvault.Powershell.Models.INetworkName> NetworkAdapter { get; set; }
        /// <summary>
        /// Register replicated virtual machines to the failover cluster for the destination client.
        /// </summary>
        [Commvault.Powershell.Runtime.Info(
