...
namespace Commvault.Powershell.Models
{
    ...
    public partial class UpdateUserGroup
    {
        ...
        internal UpdateUserGroup(Commvault.Powershell.Runtime.Json.JsonObject json)
        {
            ...
            {_laptopPlan = If( json?.PropertyT<Commvault.Powershell.Runtime.Json.JsonObject>("laptopPlan"), out var __jsonLaptopPlan) ? Commvault.Powershell.Models.IdName.FromJson(__jsonLaptopPlan) : _laptopPlan;}
            {_restrictConsoleTypes = If( json?.PropertyT<Commvault.Powershell.Runtime.Json.JsonObject>("restrictConsoleTypes"), out var __jsonRestrictConsoleTypes) ? Commvault.Powershell.Models.RestrictConsoleTypes.FromJson(__jsonRestrictConsoleTypes) : _restrictConsoleTypes;}
            ...
            {_newDescription = If( json?.PropertyT<Commvault.Powershell.Runtime.Json.JsonString>("newDescription"), out var __jsonNewDescription) ? (string)__jsonNewDescription : (string)_newDescription;}
            {_planOperationType = If( json?.PropertyT<Commvault.Powershell.Runtime.Json.JsonString>("planOperationType"), out var __jsonPlanOperationType) ? (string)__jsonPlanOperationType : (string)_planOperationType;}
            ...
            {_enableTwoFactorAuthentication = If( json?.PropertyT<Commvault.Powershell.Runtime.Json.JsonString>("enableTwoFactorAuthentication"), out var __jsonEnableTwoFactorAuthentication) ? (string)__jsonEnableTwoFactorAuthentication : (string)_enableTwoFactorAuthentication;}
            {_enableLocalAuthentication = If( json?.PropertyT<Commvault.Powershell.Runtime.Json.JsonString>("enableLocalAuthentication"), out var __jsonEnableLocalAuthentication) ? (string)__jsonEnableLocalAuthentication : (string)_enableLocalAuthentication;}
            {_associatedExternalGroups = If( json?.PropertyT<Commvault.Powershell.Runtime.Json.JsonArray>("associatedExternalGroups"), out var __jsonAssociatedExternalGroups) ? If( __jsonAssociatedExternalGroups as Commvault.Powershell.Runtime.Json.JsonArray, out var __v) ? new global::System.Func<System.Collections.Generic.List<Commvault.Powershell.Models.IIdName>>(()=> global::System.Linq.Enumerable.ToList(global::System.Linq.Enumerable.Select(__v, (__u)=>(Commvault.Powershell.Models.IIdName) (Commvault.Powershell.Models.IdName.FromJson(__u) )) ))() : null : _associatedExternalGroups;}
            {_externalUserGroupsOperationType = If( json?.PropertyT<Commvault.Powershell.Runtime.Json.JsonString>("externalUserGroupsOperationType"), out var __jsonExternalUserGroupsOperationType) ? (string)__jsonExternalUserGroupsOperationType : (string)_externalUserGroupsOperationType;}
            {_laptopAdmins = If( json?.PropertyT<Commvault.Powershell.Runtime.Json.JsonBoolean>("laptopAdmins"), out var __jsonLaptopAdmins) ? (bool?)__jsonLaptopAdmins : _laptopAdmins;}
            {_associatedLocalGroups = If( json?.PropertyT<Commvault.Powershell.Runtime.Json.JsonArray>("associatedLocalGroups"), out var __jsonAssociatedLocalGroups) ? If( __jsonAssociatedLocalGroups as Commvault.Powershell.Runtime.Json.JsonArray, out var __q) ? new global::System.Func<System.Collections.Generic.List<Commvault.Powershell.Models.IIdName>>(()=> global::System.Linq.Enumerable.ToList(global::System.Linq.Enumerable.Select(__q, (__p)=>(Commvault.Powershell.Models.IIdName) (Commvault.Powershell.Models.IdName.FromJson(__p) )) ))() : null : _associatedLocalGroups;}
            {_localUserGroupsOperationType = If( json?.PropertyT<Commvault.Powershell.Runtime.Json.JsonString>("localUserGroupsOperationType"), out var __jsonLocalUserGroupsOperationType) ? (string)__jsonLocalUserGroupsOperationType : (string)_localUserGroupsOperationType;}
            {_users = If( json?.PropertyT<Commvault.Powershell.Runtime.Json.JsonArray>("users"), out var __jsonUsers) ? If( __jsonUsers as Commvault.Powershell.Runtime.Json.JsonArray, out var __l) ? new global::System.Func<System.Collections.Generic.List<Commvault.Powershell.Models.IIdName>>(()=> global::System.Linq.Enumerable.ToList(global::System.Linq.Enumerable.Select(__l, (__k)=>(Commvault.Powershell.Models.IIdName) (Commvault.Powershell.Models.IdName.FromJson(__k) )) ))() : null : _users;}
            {_userOperationType = If( json?.PropertyT<Commvault.Powershell.Runtime.Json.JsonString>("userOperationType"), out var __jsonUserOperationType) ? (string)__jsonUserOperationType : (string)_userOperationType;}
            {_allowMultipleCompanyMembers = If( json?.PropertyT<Commvault.Powershell.Runtime.Json.JsonBoolean>("allowMultipleCompanyMembers"), out var __jsonAllowMultipleCompanyMembers) ? (bool?)__jsonAllowMultipleCompanyMembers : _allowMultipleCompanyMembers;}
            {_doNotInheritRestrictConsoleTypes = If( json?.PropertyT<Commvault.Powershell.Runtime.Json.JsonBoolean>("doNotInheritRestrictConsoleTypes"), out var __jsonDoNotInheritRestrictConsoleTypes) ? (bool?)__jsonDoNotInheritRestrictConsoleTypes : _doNotInheritRestrictConsoleTypes;}
            {_consoleTypeOperationType = If( json?.PropertyT<Commvault.Powershell.Runtime.Json.JsonString>("consoleTypeOperationType"), out var __jsonConsoleTypeOperationType) ? (string)__jsonConsoleTypeOperationType : (string)_consoleTypeOperationType;}
            {_azureGuid = If( json?.PropertyT<Commvault.Powershell.Runtime.Json.JsonString>("azureGUID"), out var __jsonAzureGuid) ? (string)__jsonAzureGuid : (string)_azureGuid;}
            AfterFromJson(json);
        }
    }
}