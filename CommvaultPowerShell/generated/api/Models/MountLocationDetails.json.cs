...
namespace Commvault.Powershell.Models
{
    ...
    public partial class MountLocationDetails
    {
        ...
        /// <summary>
        /// Deserializes a <see cref="Commvault.Powershell.Runtime.Json.JsonNode"/> into an instance of Commvault.Powershell.Models.IMountLocationDetails.
        /// </summary>
        /// <param name="node">a <see cref="Commvault.Powershell.Runtime.Json.JsonNode" /> to deserialize from.</param>
        /// <returns>an instance of Commvault.Powershell.Models.IMountLocationDetails.</returns>
        public static Commvault.Powershell.Models.IMountLocationDetails FromJson(Commvault.Powershell.Runtime.Json.JsonNode node)
        {
            return node is Commvault.Powershell.Runtime.Json.JsonObject json ? new MountLocationDetails(json) : null;
        }

        /// <summary>
        /// Deserializes a Commvault.Powershell.Runtime.Json.JsonObject into a new instance of <see cref="MountLocationDetails" />.
        /// </summary>
        /// <param name="json">A Commvault.Powershell.Runtime.Json.JsonObject instance to deserialize from.</param>
        internal MountLocationDetails(Commvault.Powershell.Runtime.Json.JsonObject json)
        {
            ...
            {_mountPath = If( json?.PropertyT<Commvault.Powershell.Runtime.Json.JsonObject>("mountPath"), out var __jsonMountPath) ? Commvault.Powershell.Models.IdName.FromJson(__jsonMountPath) : _mountPath;}
            ...
            {_dataServerType = If( json?.PropertyT<Commvault.Powershell.Runtime.Json.JsonString>("dataServerType"), out var __jsonDataServerType) ? (string)__jsonDataServerType : (string)_dataServerType;}
            {_deviceId = If( json?.PropertyT<Commvault.Powershell.Runtime.Json.JsonNumber>("deviceId"), out var __jsonDeviceId) ? (long?)__jsonDeviceId : _deviceId;}
            AfterFromJson(json);
        }

        /// <summary>
        /// Serializes this instance of <see cref="MountLocationDetails" /> into a <see cref="Commvault.Powershell.Runtime.Json.JsonNode" />.
        /// </summary>
        /// <param name="container">The <see cref="Commvault.Powershell.Runtime.Json.JsonObject"/> container to serialize this object into. If the caller
        /// passes in <c>null</c>, a new instance will be created and returned to the caller.</param>
        /// <param name="serializationMode">Allows the caller to choose the depth of the serialization. See <see cref="Commvault.Powershell.Runtime.SerializationMode"/>.</param>
        /// <returns>
        /// a serialized instance of <see cref="MountLocationDetails" /> as a <see cref="Commvault.Powershell.Runtime.Json.JsonNode" />.
        /// </returns>
