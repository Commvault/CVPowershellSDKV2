...
namespace Commvault.Powershell.Models
{
        ...
        Commvault.Powershell.Models.IUpdateBlackoutWindowInternal
    {
        ...
        Commvault.Powershell.Models.IStartEnd Commvault.Powershell.Models.IUpdateBlackoutWindowInternal.BetweenDates { get => (this._betweenDates = this._betweenDates ?? new Commvault.Powershell.Models.StartEnd()); set { {_betweenDates = value;} } }

        /// <summary>Internal Acessors for Company</summary>
        Commvault.Powershell.Models.IIdName Commvault.Powershell.Models.IUpdateBlackoutWindowInternal.Company { get => (this._company = this._company ?? new Commvault.Powershell.Models.IdName()); set { {_company = value;} } }
        ...
        /// <summary>Creates an new <see cref="UpdateBlackoutWindow" /> instance.</summary>
        public UpdateBlackoutWindow()
        {
