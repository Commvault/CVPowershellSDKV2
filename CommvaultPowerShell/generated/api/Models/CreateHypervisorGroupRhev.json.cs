...
namespace Commvault.Powershell.Models
{
    ...
    public partial class CreateHypervisorGroupRhev
    {
        ...
        /// <summary>
        /// Deserializes a Commvault.Powershell.Runtime.Json.JsonObject into a new instance of <see cref="CreateHypervisorGroupRhev" />.
        /// </summary>
        /// <param name="json">A Commvault.Powershell.Runtime.Json.JsonObject instance to deserialize from.</param>
        internal CreateHypervisorGroupRhev(Commvault.Powershell.Runtime.Json.JsonObject json)
        {
            ...
            {_rhevMManager = If( json?.PropertyT<Commvault.Powershell.Runtime.Json.JsonString>("RhevMManager"), out var __jsonRhevMManager) ? (string)__jsonRhevMManager : (string)_rhevMManager;}
        ...
        /// <summary>
        /// Deserializes a <see cref="Commvault.Powershell.Runtime.Json.JsonNode"/> into an instance of Commvault.Powershell.Models.ICreateHypervisorGroupRhev.
        /// </summary>
        /// <param name="node">a <see cref="Commvault.Powershell.Runtime.Json.JsonNode" /> to deserialize from.</param>
        /// <returns>an instance of Commvault.Powershell.Models.ICreateHypervisorGroupRhev.</returns>
        public static Commvault.Powershell.Models.ICreateHypervisorGroupRhev FromJson(Commvault.Powershell.Runtime.Json.JsonNode node)
        {
            return node is Commvault.Powershell.Runtime.Json.JsonObject json ? new CreateHypervisorGroupRhev(json) : null;
        }

        /// <summary>
        /// Serializes this instance of <see cref="CreateHypervisorGroupRhev" /> into a <see cref="Commvault.Powershell.Runtime.Json.JsonNode" />.
        /// </summary>
        /// <param name="container">The <see cref="Commvault.Powershell.Runtime.Json.JsonObject"/> container to serialize this object into. If the caller
        /// passes in <c>null</c>, a new instance will be created and returned to the caller.</param>
        /// <param name="serializationMode">Allows the caller to choose the depth of the serialization. See <see cref="Commvault.Powershell.Runtime.SerializationMode"/>.</param>
        /// <returns>
        /// a serialized instance of <see cref="CreateHypervisorGroupRhev" /> as a <see cref="Commvault.Powershell.Runtime.Json.JsonNode" />.
        /// </returns>
        public Commvault.Powershell.Runtime.Json.JsonNode ToJson(Commvault.Powershell.Runtime.Json.JsonObject container, Commvault.Powershell.Runtime.SerializationMode serializationMode)
        {
            ...
            AddIf( null != (((object)this._rhevMManager)?.ToString()) ? (Commvault.Powershell.Runtime.Json.JsonNode) new Commvault.Powershell.Runtime.Json.JsonString(this._rhevMManager.ToString()) : null, "RhevMManager" ,container.Add );
