...
namespace Commvault.Powershell.Cmdlets
{
    ...
    /// <summary>Create a replication group</summary>
    /// <remarks>
    /// [OpenAPI] CreateReplicationGroup=>POST:"/V4/ReplicationGroup"
    /// </remarks>
    [global::System.Management.Automation.Cmdlet(global::System.Management.Automation.VerbsCommon.New, @"ReplicationGroup_CreateExpanded", SupportsShouldProcess = true)]
    [global::System.Management.Automation.OutputType(typeof(Commvault.Powershell.Models.IIdName))]
    [global::Commvault.Powershell.Description(@"Create a replication group")]
    [global::Commvault.Powershell.Generated]
    public partial class NewReplicationGroup_CreateExpanded : global::System.Management.Automation.PSCmdlet,
        Commvault.Powershell.Runtime.IEventListener
    {
        ...
        private Commvault.Powershell.Models.IPaths1R2Cxj5V4ReplicationgroupPostRequestbodyContentApplicationJsonSchema _body= new Commvault.Powershell.Models.Paths1R2Cxj5V4ReplicationgroupPostRequestbodyContentApplicationJsonSchema();

        private Commvault.Powershell.Models.IPaths1R2Cxj5V4ReplicationgroupPostRequestbodyContentApplicationJsonSchema Body { get => this._body; set => this._body = value; }
        ...
        /// <summary>
        /// Intializes a new instance of the <see cref="NewReplicationGroup_CreateExpanded" /> cmdlet class.
        /// </summary>
        public NewReplicationGroup_CreateExpanded()
        {
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                // work
                if (ShouldProcess($"Call remote 'CreateReplicationGroup' operation"))
                {
        ...
        protected async global::System.Threading.Tasks.Task ProcessRecordAsync()
        {
            using( NoSynchronizationContext )
            {
                ...
                try
                {
                    ...
                    await this.Client.CreateReplicationGroup(Body, onOk, onBadRequest, onInternalServerError, this, Pipeline);
