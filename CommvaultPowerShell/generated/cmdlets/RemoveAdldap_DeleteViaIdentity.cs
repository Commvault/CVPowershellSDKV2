...
namespace Commvault.Powershell.Cmdlets
{
    ...
    /// <remarks>
    /// [OpenAPI] DeleteAdldap=>DELETE:"/V4/LDAP/{domainId}"
    /// </remarks>
    [global::System.Management.Automation.Cmdlet(global::System.Management.Automation.VerbsCommon.Remove, @"Adldap_DeleteViaIdentity", SupportsShouldProcess = true)]
    [global::System.Management.Automation.OutputType(typeof(Commvault.Powershell.Models.IGenericResp))]
    [global::Commvault.Powershell.Description(@"Delete an AD/LDAP domain")]
    [global::Commvault.Powershell.Generated]
    public partial class RemoveAdldap_DeleteViaIdentity : global::System.Management.Automation.PSCmdlet,
        Commvault.Powershell.Runtime.IEventListener
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                // work
                if (ShouldProcess($"Call remote 'DeleteAdldap' operation"))
                {
        ...
        protected async global::System.Threading.Tasks.Task ProcessRecordAsync()
        {
            using( NoSynchronizationContext )
            {
                ...
                try
                {
                    ...
                    await this.Client.DeleteAdldap(InputObject.DomainId ?? default(long), this.InvocationInformation.BoundParameters.ContainsKey("TransferToUserId") ? TransferToUserId : default(long?), this.InvocationInformation.BoundParameters.ContainsKey("TransferToUserGroupId") ? TransferToUserGroupId : default(long?), onOk, this, Pipeline);
        ...
        /// <summary>
        /// Intializes a new instance of the <see cref="RemoveAdldap_DeleteViaIdentity" /> cmdlet class.
        /// </summary>
        public RemoveAdldap_DeleteViaIdentity()
        {
