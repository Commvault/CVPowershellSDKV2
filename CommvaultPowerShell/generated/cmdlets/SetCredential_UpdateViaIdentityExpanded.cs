...
namespace Commvault.Powershell.Cmdlets
{
    ...
    /// <summary>Edit credential whose name has been provided by credential owner</summary>
    /// <remarks>
    /// [OpenAPI] UpdateCredential=>PUT:"/V4/Credential/{credentialName}"
    /// </remarks>
    [global::System.Management.Automation.Cmdlet(global::System.Management.Automation.VerbsCommon.Set, @"Credential_UpdateViaIdentityExpanded", SupportsShouldProcess = true)]
    [global::System.Management.Automation.OutputType(typeof(Commvault.Powershell.Models.IAny))]
    [global::Commvault.Powershell.Description(@"Edit credential whose name has been provided by credential owner")]
    [global::Commvault.Powershell.Generated]
    public partial class SetCredential_UpdateViaIdentityExpanded : global::System.Management.Automation.PSCmdlet,
        Commvault.Powershell.Runtime.IEventListener
    {
        ...
        private Commvault.Powershell.Models.IPathsK1U2EeV4CredentialCredentialnamePutRequestbodyContentApplicationJsonSchema _body= new Commvault.Powershell.Models.PathsK1U2EeV4CredentialCredentialnamePutRequestbodyContentApplicationJsonSchema();

        private Commvault.Powershell.Models.IPathsK1U2EeV4CredentialCredentialnamePutRequestbodyContentApplicationJsonSchema Body { get => this._body; set => this._body = value; }
        ...
        /// </summary>
        /// <param name="responseMessage">the raw response message as an global::System.Net.Http.HttpResponseMessage.</param>
        /// <param name="response">the body result as a <see cref="Commvault.Powershell.Models.IAny" /> from the remote call</param>
        /// <param name="returnNow">/// Determines if the rest of the onOk method should be processed, or if the method should return
        /// immediately (set to true to skip further processing )</param>

        partial void overrideOnOk(global::System.Net.Http.HttpResponseMessage responseMessage, global::System.Threading.Tasks.Task<Commvault.Powershell.Models.IAny> response, ref global::System.Threading.Tasks.Task<bool> returnNow);
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                // work
                if (ShouldProcess($"Call remote 'UpdateCredential' operation"))
                {
        ...
        protected async global::System.Threading.Tasks.Task ProcessRecordAsync()
        {
            using( NoSynchronizationContext )
            {
                ...
                try
                {
                    ...
                    if (null == InputObject.CredentialName)
                    {
                        ThrowTerminatingError( new global::System.Management.Automation.ErrorRecord(new global::System.Exception("InputObject has null value for InputObject.CredentialName"),string.Empty, global::System.Management.Automation.ErrorCategory.InvalidArgument, InputObject) );
                    }
                    await this.Client.UpdateCredential(InputObject.CredentialName ?? null, Body, onOk, onBadRequest, onNotFound, this, Pipeline);
        ...
        /// <summary>
        /// Intializes a new instance of the <see cref="SetCredential_UpdateViaIdentityExpanded" /> cmdlet class.
        /// </summary>
        public SetCredential_UpdateViaIdentityExpanded()
        {
        ...
        /// A <see cref="global::System.Threading.Tasks.Task" /> that will be complete when handling of the method is completed.
        /// </returns>
        private async global::System.Threading.Tasks.Task onOk(global::System.Net.Http.HttpResponseMessage responseMessage, global::System.Threading.Tasks.Task<Commvault.Powershell.Models.IAny> response)
        {
            using( NoSynchronizationContext )
            {
                var _returnNow = global::System.Threading.Tasks.Task<bool>.FromResult(false);
                ...
                // (await response) // should be Commvault.Powershell.Models.IAny
