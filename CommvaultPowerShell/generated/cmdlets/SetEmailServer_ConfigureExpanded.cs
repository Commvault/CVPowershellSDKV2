...
namespace Commvault.Powershell.Cmdlets
{
    ...
    /// <remarks>
    /// [OpenAPI] ConfigureEmailServer=>POST:"/V4/EmailServer"
    /// </remarks>
    [global::System.Management.Automation.Cmdlet(global::System.Management.Automation.VerbsCommon.Set, @"EmailServer_ConfigureExpanded", SupportsShouldProcess = true)]
    [global::System.Management.Automation.OutputType(typeof(Commvault.Powershell.Models.IGenericResp))]
    [global::Commvault.Powershell.Description(@"Configure SMTP server settings.")]
    [global::Commvault.Powershell.Generated]
    public partial class SetEmailServer_ConfigureExpanded : global::System.Management.Automation.PSCmdlet,
        Commvault.Powershell.Runtime.IEventListener
    {
        ...
        private Commvault.Powershell.Models.IConfigureSmtpServerReq _body= new Commvault.Powershell.Models.ConfigureSmtpServerReq();

        /// <summary>ConfigureSMTPServerReq</summary>
        private Commvault.Powershell.Models.IConfigureSmtpServerReq Body { get => this._body; set => this._body = value; }
        ...
        /// option is required.
        /// </summary>
        [global::System.Management.Automation.Parameter(Mandatory = false, HelpMessage = "Password must be in base64 encoded format. Similar to username, if authentication on the mail server is required, this option is required.")]
        [global::Commvault.Powershell.Category(global::Commvault.Powershell.ParameterCategory.Body)]
        [Commvault.Powershell.Runtime.Info(
        Required = false,
        ReadOnly = false,
        ...
        [global::System.Management.Automation.Parameter(Mandatory = false, HelpMessage = "This option is used when authentication on the mail server is required")]
        [global::Commvault.Powershell.Category(global::Commvault.Powershell.ParameterCategory.Body)]
        [Commvault.Powershell.Runtime.Info(
        Required = false,
        ReadOnly = false,
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                // work
                if (ShouldProcess($"Call remote 'ConfigureEmailServer' operation"))
                {
        ...
        protected async global::System.Threading.Tasks.Task ProcessRecordAsync()
        {
            using( NoSynchronizationContext )
            {
                ...
                try
                {
                    ...
                    await this.Client.ConfigureEmailServer(Body, onOk, onBadRequest, onUnauthorized, this, Pipeline);
        ...
        /// <summary>
        /// Intializes a new instance of the <see cref="SetEmailServer_ConfigureExpanded" /> cmdlet class.
        /// </summary>
        public SetEmailServer_ConfigureExpanded()
        {
