...
namespace Commvault.Powershell.Cmdlets
{
    ...
    /// <remarks>
    /// [OpenAPI] VirtualMachineBackup=>POST:"/V4/VirtualMachines/{vmUUID}/backup"
    /// </remarks>
    [global::System.Management.Automation.Cmdlet(global::System.Management.Automation.VerbsLifecycle.Invoke, @"Machine_Machine", SupportsShouldProcess = true)]
    ...
    public partial class InvokeMachine_Machine : global::System.Management.Automation.PSCmdlet,
        Commvault.Powershell.Runtime.IEventListener
    {
        ...
        /// <summary>
        /// Intializes a new instance of the <see cref="InvokeMachine_Machine" /> cmdlet class.
        /// </summary>
        public InvokeMachine_Machine()
        {
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                // work
                if (ShouldProcess($"Call remote 'VirtualMachineBackup' operation"))
                {
        ...
        protected async global::System.Threading.Tasks.Task ProcessRecordAsync()
        {
            using( NoSynchronizationContext )
            {
                ...
                try
                {
                    ...
                    await this.Client.VirtualMachineBackup(VMUuid, this.InvocationInformation.BoundParameters.ContainsKey("BackupLevel") ? BackupLevel : null, onOk, onNotFound, onInternalServerError, this, Pipeline);
