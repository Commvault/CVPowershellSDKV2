...
namespace Commvault.Powershell.Cmdlets
{
    ...
    /// </remarks>
    [global::System.Management.Automation.Cmdlet(global::System.Management.Automation.VerbsData.Edit, @"AlertDefinition_EditViaIdentity", SupportsShouldProcess = true)]
    ...
    public partial class EditAlertDefinition_EditViaIdentity : global::System.Management.Automation.PSCmdlet,
        Commvault.Powershell.Runtime.IEventListener
    {
        ...
        private Commvault.Powershell.Models.IAlertDefinitionsEdit _body;

        /// <summary>AlertDefinitionsEdit</summary>
        [global::System.Management.Automation.Parameter(Mandatory = true, HelpMessage = "AlertDefinitionsEdit", ValueFromPipeline = true)]
        [Commvault.Powershell.Runtime.Info(
        Required = true,
        ReadOnly = false,
        Description = @"AlertDefinitionsEdit",
        SerializedName = @"body",
        PossibleTypes = new [] { typeof(Commvault.Powershell.Models.IAlertDefinitionsEdit) })]
        public Commvault.Powershell.Models.IAlertDefinitionsEdit Body { get => this._body; set => this._body = value; }
        ...
        /// <summary>
        /// Intializes a new instance of the <see cref="EditAlertDefinition_EditViaIdentity" /> cmdlet class.
        /// </summary>
        public EditAlertDefinition_EditViaIdentity()
        {
