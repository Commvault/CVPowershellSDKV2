...
namespace Commvault.Powershell.Cmdlets
{
    ...
    /// <remarks>
    /// [OpenAPI] UpdateVirtualMachine=>PUT:"/V4/VirtualMachines/{vmUUID}"
    /// </remarks>
    [global::System.Management.Automation.Cmdlet(global::System.Management.Automation.VerbsCommon.Set, @"VirtualMachine_UpdateExpanded", SupportsShouldProcess = true)]
    ...
    public partial class SetVirtualMachine_UpdateExpanded : global::System.Management.Automation.PSCmdlet,
        Commvault.Powershell.Runtime.IEventListener
    {
        ...
        public long AuthKeyRestoreExpirationTime { get => Body.AuthKeyRestoreExpirationTime ?? default(long); set => Body.AuthKeyRestoreExpirationTime = value; }
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                // work
                if (ShouldProcess($"Call remote 'UpdateVirtualMachine' operation"))
                {
        ...
        protected async global::System.Threading.Tasks.Task ProcessRecordAsync()
        {
            using( NoSynchronizationContext )
            {
                ...
                try
                {
                    ...
                    await this.Client.UpdateVirtualMachine(VMUuid, Body, onOk, onUnauthorized, onNotFound, this, Pipeline);
        ...
        /// <summary>
        /// Intializes a new instance of the <see cref="SetVirtualMachine_UpdateExpanded" /> cmdlet class.
        /// </summary>
        public SetVirtualMachine_UpdateExpanded()
        {
