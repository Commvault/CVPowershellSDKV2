...
namespace Commvault.Powershell.Cmdlets
{
    ...
    /// <remarks>
    /// [OpenAPI] ReConfigureHypervisor=>POST:"/V4/Hypervisor/{hypervisorId}/Reconfigure"
    /// </remarks>
    [global::System.Management.Automation.Cmdlet(global::System.Management.Automation.VerbsLifecycle.Invoke, @"ReConfigureHypervisor_Re", SupportsShouldProcess = true)]
    [global::System.Management.Automation.OutputType(typeof(Commvault.Powershell.Models.IGenericResp))]
    [global::Commvault.Powershell.Description(@"REconfigures and Renew License for  the hypervisor client")]
    [global::Commvault.Powershell.Generated]
    public partial class InvokeReConfigureHypervisor_Re : global::System.Management.Automation.PSCmdlet,
        Commvault.Powershell.Runtime.IEventListener
    {
        ...
        /// <summary>
        /// Intializes a new instance of the <see cref="InvokeReConfigureHypervisor_Re" /> cmdlet class.
        /// </summary>
        public InvokeReConfigureHypervisor_Re()
        {
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                // work
                if (ShouldProcess($"Call remote 'ReConfigureHypervisor' operation"))
                {
        ...
        protected async global::System.Threading.Tasks.Task ProcessRecordAsync()
        {
            using( NoSynchronizationContext )
            {
                ...
                try
                {
                    ...
                    await this.Client.ReConfigureHypervisor(HypervisorId, onOk, onNotFound, onInternalServerError, this, Pipeline);
