...
namespace Commvault.Powershell.Cmdlets
{
    ...
    /// <summary>Create a Cloud Storage</summary>
    /// <remarks>
    /// [OpenAPI] CreateCloudStorage=>POST:"/V4/Storage/Cloud"
    /// </remarks>
    [global::System.Management.Automation.Cmdlet(global::System.Management.Automation.VerbsCommon.New, @"CloudStorage_CreateExpanded", SupportsShouldProcess = true)]
    [global::System.Management.Automation.OutputType(typeof(Commvault.Powershell.Models.ICloudStorageResp), typeof(Commvault.Powershell.Models.IGenericResp))]
    [global::Commvault.Powershell.Description(@"Create a Cloud Storage")]
    [global::Commvault.Powershell.Generated]
    public partial class NewCloudStorage_CreateExpanded : global::System.Management.Automation.PSCmdlet,
        Commvault.Powershell.Runtime.IEventListener
    {
        ...
        private Commvault.Powershell.Models.IPaths3Dcoq4V4StorageCloudPostRequestbodyContentApplicationJsonSchema _body= new Commvault.Powershell.Models.Paths3Dcoq4V4StorageCloudPostRequestbodyContentApplicationJsonSchema();

        private Commvault.Powershell.Models.IPaths3Dcoq4V4StorageCloudPostRequestbodyContentApplicationJsonSchema Body { get => this._body; set => this._body = value; }
        ...
        /// </summary>
        /// <param name="responseMessage">the raw response message as an global::System.Net.Http.HttpResponseMessage.</param>
        /// <param name="response">the body result as a <see cref="Commvault.Powershell.Models.ICloudStorageResp" /> from the remote
        /// call</param>
        /// <param name="returnNow">/// Determines if the rest of the onOk method should be processed, or if the method should return
        /// immediately (set to true to skip further processing )</param>

        partial void overrideOnOk(global::System.Net.Http.HttpResponseMessage responseMessage, global::System.Threading.Tasks.Task<Commvault.Powershell.Models.ICloudStorageResp> response, ref global::System.Threading.Tasks.Task<bool> returnNow);
        ...
        /// <summary>
        /// Intializes a new instance of the <see cref="NewCloudStorage_CreateExpanded" /> cmdlet class.
        /// </summary>
        public NewCloudStorage_CreateExpanded()
        {
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                // work
                if (ShouldProcess($"Call remote 'CreateCloudStorage' operation"))
                {
        ...
        protected async global::System.Threading.Tasks.Task ProcessRecordAsync()
        {
            using( NoSynchronizationContext )
            {
                ...
                try
                {
                    ...
                    await this.Client.CreateCloudStorage(Body, onOk, onBadRequest, onInternalServerError, this, Pipeline);
        ...
        /// A <see cref="global::System.Threading.Tasks.Task" /> that will be complete when handling of the method is completed.
        /// </returns>
        private async global::System.Threading.Tasks.Task onOk(global::System.Net.Http.HttpResponseMessage responseMessage, global::System.Threading.Tasks.Task<Commvault.Powershell.Models.ICloudStorageResp> response)
        {
            using( NoSynchronizationContext )
            {
                var _returnNow = global::System.Threading.Tasks.Task<bool>.FromResult(false);
                ...
                // (await response) // should be Commvault.Powershell.Models.ICloudStorageResp
                WriteObject((await response));
            }
        }
    }
