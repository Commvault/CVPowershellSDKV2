...
namespace Commvault.Powershell.Cmdlets
{
    ...
    /// <remarks>
    /// [OpenAPI] DeleteRoles=>DELETE:"/V4/Role/{roleId}"
    /// </remarks>
    [global::System.Management.Automation.Cmdlet(global::System.Management.Automation.VerbsCommon.Remove, @"Role_DeleteViaIdentity", SupportsShouldProcess = true)]
    [global::System.Management.Automation.OutputType(typeof(Commvault.Powershell.Models.IGenericResp))]
    [global::Commvault.Powershell.Description(@"Used to delete a role")]
    [global::Commvault.Powershell.Generated]
    public partial class RemoveRole_DeleteViaIdentity : global::System.Management.Automation.PSCmdlet,
        Commvault.Powershell.Runtime.IEventListener
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                // work
                if (ShouldProcess($"Call remote 'DeleteRoles' operation"))
                {
        ...
        protected async global::System.Threading.Tasks.Task ProcessRecordAsync()
        {
            using( NoSynchronizationContext )
            {
                ...
                try
                {
                    ...
                    await this.Client.DeleteRoles(InputObject.RoleId ?? default(long), onOk, onNotFound, onInternalServerError, this, Pipeline);
        ...
        /// <summary>
        /// Intializes a new instance of the <see cref="RemoveRole_DeleteViaIdentity" /> cmdlet class.
        /// </summary>
        public RemoveRole_DeleteViaIdentity()
        {
