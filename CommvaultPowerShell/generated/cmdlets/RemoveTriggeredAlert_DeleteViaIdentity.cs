...
namespace Commvault.Powershell.Cmdlets
{
    ...
    /// <remarks>
    /// [OpenAPI] DeleteTriggeredAlerts=>DELETE:"/V4/TriggeredAlerts/{id}"
    /// </remarks>
    [global::System.Management.Automation.Cmdlet(global::System.Management.Automation.VerbsCommon.Remove, @"TriggeredAlert_DeleteViaIdentity", SupportsShouldProcess = true)]
    [global::System.Management.Automation.OutputType(typeof(Commvault.Powershell.Models.IGenericResp))]
    [global::Commvault.Powershell.Description(@"Delete Triggered Alerts")]
    [global::Commvault.Powershell.Generated]
    public partial class RemoveTriggeredAlert_DeleteViaIdentity : global::System.Management.Automation.PSCmdlet,
        Commvault.Powershell.Runtime.IEventListener
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                // work
                if (ShouldProcess($"Call remote 'DeleteTriggeredAlerts' operation"))
                {
        ...
        protected async global::System.Threading.Tasks.Task ProcessRecordAsync()
        {
            using( NoSynchronizationContext )
            {
                ...
                try
                {
                    ...
                    await this.Client.DeleteTriggeredAlerts(InputObject.Id ?? default(long), onOk, onInternalServerError, this, Pipeline);
        ...
        /// <summary>
        /// Intializes a new instance of the <see cref="RemoveTriggeredAlert_DeleteViaIdentity" /> cmdlet class.
        /// </summary>
        public RemoveTriggeredAlert_DeleteViaIdentity()
        {
