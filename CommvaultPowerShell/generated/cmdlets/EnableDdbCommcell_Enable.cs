...
namespace Commvault.Powershell.Cmdlets
{
    ...
    /// <remarks>
    /// [OpenAPI] EnableDDBCommcell=>PUT:"/V4/Commcell/DDB/Action/Enable"
    /// </remarks>
    [global::System.Management.Automation.Cmdlet(global::System.Management.Automation.VerbsLifecycle.Enable, @"DdbCommcell_Enable", SupportsShouldProcess = true)]
    [global::System.Management.Automation.OutputType(typeof(Commvault.Powershell.Models.IGenericResp))]
    [global::Commvault.Powershell.Description(@"Used to enable DDB property for commcell")]
    [global::Commvault.Powershell.Generated]
    public partial class EnableDdbCommcell_Enable : global::System.Management.Automation.PSCmdlet,
        Commvault.Powershell.Runtime.IEventListener
    {
        ...
        /// <summary>
        /// Intializes a new instance of the <see cref="EnableDdbCommcell_Enable" /> cmdlet class.
        /// </summary>
        public EnableDdbCommcell_Enable()
        {
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                // work
                if (ShouldProcess($"Call remote 'EnableDdbCommcell' operation"))
                {
        ...
        protected async global::System.Threading.Tasks.Task ProcessRecordAsync()
        {
            using( NoSynchronizationContext )
            {
                ...
                try
                {
                    ...
                    await this.Client.EnableDdbCommcell(onOk, this, Pipeline);
