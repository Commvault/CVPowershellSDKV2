...
namespace Commvault.Powershell.Cmdlets
{
    ...
    /// </remarks>
    [global::System.Management.Automation.Cmdlet(global::System.Management.Automation.VerbsCommunications.Send, @"TestMailReq_Send", SupportsShouldProcess = true)]
    ...
    public partial class SendTestMailReq_Send : global::System.Management.Automation.PSCmdlet,
        Commvault.Powershell.Runtime.IEventListener
    {
        ...
        private Commvault.Powershell.Models.ISendTestMailReq _body;
        ...
        Description = @"",
        SerializedName = @"body",
        PossibleTypes = new [] { typeof(Commvault.Powershell.Models.ISendTestMailReq) })]
        public Commvault.Powershell.Models.ISendTestMailReq Body { get => this._body; set => this._body = value; }
        ...
        /// <summary>
        /// Intializes a new instance of the <see cref="SendTestMailReq_Send" /> cmdlet class.
        /// </summary>
        public SendTestMailReq_Send()
        {
