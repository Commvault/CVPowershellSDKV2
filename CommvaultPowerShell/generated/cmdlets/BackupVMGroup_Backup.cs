...
namespace Commvault.Powershell.Cmdlets
{
    ...
    /// <remarks>
    /// [OpenAPI] BackupVMGroup=>POST:"/V4/VmGroup/{VmGroupId}/backup"
    /// </remarks>
    [global::System.Management.Automation.Cmdlet(global::System.Management.Automation.VerbsData.Backup, @"VMGroup_Backup", SupportsShouldProcess = true)]
    ...
    public partial class BackupVMGroup_Backup : global::System.Management.Automation.PSCmdlet,
        Commvault.Powershell.Runtime.IEventListener
    {
        ...
        /// <summary>Id of the VMgroup to backup</summary>
        [global::System.Management.Automation.Parameter(Mandatory = true, HelpMessage = "Id of the VMgroup to backup")]
        [Commvault.Powershell.Runtime.Info(
        Required = true,
        ReadOnly = false,
        ...
        /// <summary>
        /// Intializes a new instance of the <see cref="BackupVMGroup_Backup" /> cmdlet class.
        /// </summary>
        public BackupVMGroup_Backup()
        {
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                // work
                if (ShouldProcess($"Call remote 'BackupVMGroup' operation"))
                {
        ...
        protected async global::System.Threading.Tasks.Task ProcessRecordAsync()
        {
            using( NoSynchronizationContext )
            {
                ...
                try
                {
                    ...
                    await this.Client.BackupVMGroup(VMGroupId, this.InvocationInformation.BoundParameters.ContainsKey("BackupLevel") ? BackupLevel : null, onOk, onNotFound, onInternalServerError, this, Pipeline);
                ...
                {
                    WriteError(new global::System.Management.Automation.ErrorRecord(urexception, urexception.StatusCode.ToString(), global::System.Management.Automation.ErrorCategory.InvalidOperation, new {  VMGroupId=VMGroupId,BackupLevel=this.InvocationInformation.BoundParameters.ContainsKey("BackupLevel") ? BackupLevel : null})
                    {
