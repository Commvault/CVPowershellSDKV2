...
namespace Commvault.Powershell.Cmdlets
{
    ...
    /// <remarks>
    /// [OpenAPI] PreviewVMGroup=>POST:"/V4/VmGroup/Preview"
    /// </remarks>
    [global::System.Management.Automation.Cmdlet(global::System.Management.Automation.VerbsLifecycle.Invoke, @"PreviewVMGroup_Preview", SupportsShouldProcess = true)]
    [global::System.Management.Automation.OutputType(typeof(Commvault.Powershell.Models.IVMGroupPreviewResp), typeof(Commvault.Powershell.Models.IGenericResp))]
    [global::Commvault.Powershell.Description(@"Preview of the vm to be protected in VMGroup")]
    [global::Commvault.Powershell.Generated]
    public partial class InvokePreviewVMGroup_Preview : global::System.Management.Automation.PSCmdlet,
        Commvault.Powershell.Runtime.IEventListener
    {
        ...
        private Commvault.Powershell.Models.IVMGroupPreviewReq _body;

        /// <summary>vmGroupPreviewReq</summary>
        [global::System.Management.Automation.Parameter(Mandatory = true, HelpMessage = "vmGroupPreviewReq", ValueFromPipeline = true)]
        [Commvault.Powershell.Runtime.Info(
        Required = true,
        ReadOnly = false,
        Description = @"vmGroupPreviewReq",
        SerializedName = @"body",
        PossibleTypes = new [] { typeof(Commvault.Powershell.Models.IVMGroupPreviewReq) })]
        public Commvault.Powershell.Models.IVMGroupPreviewReq Body { get => this._body; set => this._body = value; }
        ...
        /// <summary>Hypervisor Id of VMGroup</summary>
        [global::System.Management.Automation.Parameter(Mandatory = false, HelpMessage = "Hypervisor Id of VMGroup")]
        [Commvault.Powershell.Runtime.Info(
        Required = false,
        ReadOnly = false,
        ...
        /// </summary>
        /// <param name="responseMessage">the raw response message as an global::System.Net.Http.HttpResponseMessage.</param>
        /// <param name="response">the body result as a <see cref="Commvault.Powershell.Models.IVMGroupPreviewResp" /> from the remote
        /// call</param>
        /// <param name="returnNow">/// Determines if the rest of the onOk method should be processed, or if the method should return
        /// immediately (set to true to skip further processing )</param>

        partial void overrideOnOk(global::System.Net.Http.HttpResponseMessage responseMessage, global::System.Threading.Tasks.Task<Commvault.Powershell.Models.IVMGroupPreviewResp> response, ref global::System.Threading.Tasks.Task<bool> returnNow);
        ...
        /// <summary>
        /// Intializes a new instance of the <see cref="InvokePreviewVMGroup_Preview" /> cmdlet class.
        /// </summary>
        public InvokePreviewVMGroup_Preview()
        {
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                // work
                if (ShouldProcess($"Call remote 'PreviewVMGroup' operation"))
                {
        ...
        protected async global::System.Threading.Tasks.Task ProcessRecordAsync()
        {
            using( NoSynchronizationContext )
            {
                ...
                try
                {
                    ...
                    await this.Client.PreviewVMGroup(this.InvocationInformation.BoundParameters.ContainsKey("HypervisorId") ? HypervisorId : default(long?), Body, onOk, onInternalServerError, this, Pipeline);
                ...
                {
                    WriteError(new global::System.Management.Automation.ErrorRecord(urexception, urexception.StatusCode.ToString(), global::System.Management.Automation.ErrorCategory.InvalidOperation, new {  HypervisorId=this.InvocationInformation.BoundParameters.ContainsKey("HypervisorId") ? HypervisorId : default(long?),body=Body})
                    {
        ...
        /// A <see cref="global::System.Threading.Tasks.Task" /> that will be complete when handling of the method is completed.
        /// </returns>
        private async global::System.Threading.Tasks.Task onOk(global::System.Net.Http.HttpResponseMessage responseMessage, global::System.Threading.Tasks.Task<Commvault.Powershell.Models.IVMGroupPreviewResp> response)
        {
            using( NoSynchronizationContext )
            {
                var _returnNow = global::System.Threading.Tasks.Task<bool>.FromResult(false);
                ...
                // (await response) // should be Commvault.Powershell.Models.IVMGroupPreviewResp
                WriteObject((await response));
            }
        }
    }
