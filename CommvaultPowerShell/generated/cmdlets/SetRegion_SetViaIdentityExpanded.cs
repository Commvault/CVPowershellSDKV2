...
namespace Commvault.Powershell.Cmdlets
{
    ...
    /// <remarks>
    /// [OpenAPI] SetRegionForEntity=>PUT:"/V4/entity/{entityType}/{entityId}/region"
    /// </remarks>
    [global::System.Management.Automation.Cmdlet(global::System.Management.Automation.VerbsCommon.Set, @"Region_SetViaIdentityExpanded", SupportsShouldProcess = true)]
    [global::System.Management.Automation.OutputType(typeof(Commvault.Powershell.Models.IGenericResp))]
    [global::Commvault.Powershell.Description(@"Api to set region for an entity.")]
    [global::Commvault.Powershell.Generated]
    public partial class SetRegion_SetViaIdentityExpanded : global::System.Management.Automation.PSCmdlet,
        Commvault.Powershell.Runtime.IEventListener
    {
        ...
        private Commvault.Powershell.Models.IEntityRegionInfo _body= new Commvault.Powershell.Models.EntityRegionInfo();

        private Commvault.Powershell.Models.IEntityRegionInfo Body { get => this._body; set => this._body = value; }
        ...
        public string EntityRegionType { get => Body.EntityRegionType ?? null; set => Body.EntityRegionType = value; }
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                // work
                if (ShouldProcess($"Call remote 'SetRegionForEntity' operation"))
                {
        ...
        protected async global::System.Threading.Tasks.Task ProcessRecordAsync()
        {
            using( NoSynchronizationContext )
            {
                ...
                try
                {
                    ...
                    await this.Client.SetRegionForEntity(InputObject.EntityType ?? default(long), InputObject.EntityId ?? default(long), Body, onOk, onBadRequest, onInternalServerError, this, Pipeline);
        ...
        /// <summary>
        /// Intializes a new instance of the <see cref="SetRegion_SetViaIdentityExpanded" /> cmdlet class.
        /// </summary>
        public SetRegion_SetViaIdentityExpanded()
        {
