...
namespace Commvault.Powershell.Cmdlets
{
    ...
    /// <remarks>
    /// [OpenAPI] PinTriggeredAlerts=>PUT:"/V4/TriggeredAlerts/{id}/Pin"
    /// </remarks>
    [global::System.Management.Automation.Cmdlet(global::System.Management.Automation.VerbsLifecycle.Invoke, @"PinTriggeredAlert_PinViaIdentity", SupportsShouldProcess = true)]
    [global::System.Management.Automation.OutputType(typeof(Commvault.Powershell.Models.IGenericResp))]
    [global::Commvault.Powershell.Description(@"Pin triggered alerts")]
    [global::Commvault.Powershell.Generated]
    public partial class InvokePinTriggeredAlert_PinViaIdentity : global::System.Management.Automation.PSCmdlet,
        Commvault.Powershell.Runtime.IEventListener
    {
        ...
        /// <summary>
        /// Intializes a new instance of the <see cref="InvokePinTriggeredAlert_PinViaIdentity" /> cmdlet class.
        /// </summary>
        public InvokePinTriggeredAlert_PinViaIdentity()
        {
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                // work
                if (ShouldProcess($"Call remote 'PinTriggeredAlerts' operation"))
                {
        ...
        protected async global::System.Threading.Tasks.Task ProcessRecordAsync()
        {
            using( NoSynchronizationContext )
            {
                ...
                try
                {
                    ...
                    await this.Client.PinTriggeredAlerts(InputObject.Id ?? default(long), onOk, onInternalServerError, this, Pipeline);
