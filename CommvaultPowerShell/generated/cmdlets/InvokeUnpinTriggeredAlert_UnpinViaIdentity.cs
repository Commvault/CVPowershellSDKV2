...
namespace Commvault.Powershell.Cmdlets
{
    ...
    /// <remarks>
    /// [OpenAPI] UnpinTriggeredAlerts=>PUT:"/V4/TriggeredAlerts/{id}/Unpin"
    /// </remarks>
    [global::System.Management.Automation.Cmdlet(global::System.Management.Automation.VerbsLifecycle.Invoke, @"UnpinTriggeredAlert_UnpinViaIdentity", SupportsShouldProcess = true)]
    [global::System.Management.Automation.OutputType(typeof(Commvault.Powershell.Models.IGenericResp))]
    [global::Commvault.Powershell.Description(@"Unpin triggered alerts")]
    [global::Commvault.Powershell.Generated]
    public partial class InvokeUnpinTriggeredAlert_UnpinViaIdentity : global::System.Management.Automation.PSCmdlet,
        Commvault.Powershell.Runtime.IEventListener
    {
        ...
        /// <summary>
        /// Intializes a new instance of the <see cref="InvokeUnpinTriggeredAlert_UnpinViaIdentity" /> cmdlet class.
        /// </summary>
        public InvokeUnpinTriggeredAlert_UnpinViaIdentity()
        {
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                // work
                if (ShouldProcess($"Call remote 'UnpinTriggeredAlerts' operation"))
                {
        ...
        protected async global::System.Threading.Tasks.Task ProcessRecordAsync()
        {
            using( NoSynchronizationContext )
            {
                ...
                try
                {
                    ...
                    await this.Client.UnpinTriggeredAlerts(InputObject.Id ?? default(long), onOk, onInternalServerError, this, Pipeline);
