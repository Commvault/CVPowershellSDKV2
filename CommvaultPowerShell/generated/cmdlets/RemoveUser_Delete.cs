...
namespace Commvault.Powershell.Cmdlets
{
    ...
    /// <remarks>
    /// [OpenAPI] DeleteUser=>DELETE:"/V4/user/{userId}"
    /// </remarks>
    [global::System.Management.Automation.Cmdlet(global::System.Management.Automation.VerbsCommon.Remove, @"User_Delete", SupportsShouldProcess = true)]
    [global::System.Management.Automation.OutputType(typeof(Commvault.Powershell.Models.IGenericResp))]
    [global::Commvault.Powershell.Description(@"Used to delete a user")]
    [global::Commvault.Powershell.Generated]
    public partial class RemoveUser_Delete : global::System.Management.Automation.PSCmdlet,
        Commvault.Powershell.Runtime.IEventListener
    {
        ...
        /// <summary>Backing field for <see cref="SkipOwnerShipTransfer" /> property.</summary>
        private global::System.Management.Automation.SwitchParameter _skipOwnerShipTransfer;

        /// <summary>If user properties needn't be transferred to other user or usergroup</summary>
        [global::System.Management.Automation.Parameter(Mandatory = false, HelpMessage = "If user properties needn't be transferred to other user or usergroup")]
        [Commvault.Powershell.Runtime.Info(
        Required = false,
        ReadOnly = false,
        Description = @"If user properties needn't be transferred to other user or usergroup",
        SerializedName = @"skipOwnerShipTransfer",
        ...
        /// <summary>If user properties needs to be transferred to other user</summary>
        [global::System.Management.Automation.Parameter(Mandatory = false, HelpMessage = "If user properties needs to be transferred to other user")]
        [Commvault.Powershell.Runtime.Info(
        Required = false,
        ReadOnly = false,
        ...
        /// <summary>If user properties needs to be transferred to other userGroup</summary>
        [global::System.Management.Automation.Parameter(Mandatory = false, HelpMessage = "If user properties needs to be transferred to other userGroup")]
        [Commvault.Powershell.Runtime.Info(
        Required = false,
        ReadOnly = false,
        ...
        /// <summary>Id of the user to delete</summary>
        [global::System.Management.Automation.Parameter(Mandatory = true, HelpMessage = "Id of the user to delete")]
        [Commvault.Powershell.Runtime.Info(
        Required = true,
        ReadOnly = false,
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                // work
                if (ShouldProcess($"Call remote 'DeleteUser' operation"))
                {
        ...
        /// <summary>Intializes a new instance of the <see cref="RemoveUser_Delete" /> cmdlet class.</summary>
        public RemoveUser_Delete()
        {
