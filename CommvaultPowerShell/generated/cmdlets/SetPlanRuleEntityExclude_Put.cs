...
namespace Commvault.Powershell.Cmdlets
{
    ...
    /// <remarks>
    /// [OpenAPI] PutPlanRuleEntitiesExclude=>PUT:"/V4/Plan/Rule/Entities/Exclude"
    /// </remarks>
    [global::System.Management.Automation.Cmdlet(global::System.Management.Automation.VerbsCommon.Set, @"PlanRuleEntityExclude_Put", SupportsShouldProcess = true)]
    [global::System.Management.Automation.OutputType(typeof(Commvault.Powershell.Models.IGenericResp))]
    [global::Commvault.Powershell.Description(@"API to exclude workloads from plan rule evaluation framework")]
    [global::Commvault.Powershell.Generated]
    public partial class SetPlanRuleEntityExclude_Put : global::System.Management.Automation.PSCmdlet,
        Commvault.Powershell.Runtime.IEventListener
    {
        ...
        private Commvault.Powershell.Models.IExcludeEntitiesFromPlanRuleEvaluation _body;

        /// <summary>Entities that need to be excluded from plan rule evaluation</summary>
        [global::System.Management.Automation.Parameter(Mandatory = true, HelpMessage = "Entities that need to be excluded from plan rule evaluation", ValueFromPipeline = true)]
        [Commvault.Powershell.Runtime.Info(
        Required = true,
        ReadOnly = false,
        Description = @"Entities that need to be excluded from plan rule evaluation",
        SerializedName = @"body",
        PossibleTypes = new [] { typeof(Commvault.Powershell.Models.IExcludeEntitiesFromPlanRuleEvaluation) })]
        public Commvault.Powershell.Models.IExcludeEntitiesFromPlanRuleEvaluation Body { get => this._body; set => this._body = value; }
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                // work
                if (ShouldProcess($"Call remote 'PutPlanRuleEntitiesExclude' operation"))
                {
        ...
        protected async global::System.Threading.Tasks.Task ProcessRecordAsync()
        {
            using( NoSynchronizationContext )
            {
                ...
                try
                {
                    ...
                    await this.Client.PutPlanRuleEntitiesExclude(Body, onOk, onForbidden, onInternalServerError, this, Pipeline);
        ...
        /// <summary>
        /// Intializes a new instance of the <see cref="SetPlanRuleEntityExclude_Put" /> cmdlet class.
        /// </summary>
        public SetPlanRuleEntityExclude_Put()
        {
