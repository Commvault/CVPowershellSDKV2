...
namespace Commvault.Powershell.Cmdlets
{
    ...
    /// <remarks>
    /// [OpenAPI] DeleteKeyManagementServers=>DELETE:"/V4/KeyManagementServers/{kmsId}"
    /// </remarks>
    [global::System.Management.Automation.Cmdlet(global::System.Management.Automation.VerbsCommon.Remove, @"KeyManagementServer_DeleteViaIdentity", SupportsShouldProcess = true)]
    [global::System.Management.Automation.OutputType(typeof(Commvault.Powershell.Models.IGenericResp))]
    [global::Commvault.Powershell.Description(@"Delete key management server based on Id")]
    [global::Commvault.Powershell.Generated]
    public partial class RemoveKeyManagementServer_DeleteViaIdentity : global::System.Management.Automation.PSCmdlet,
        Commvault.Powershell.Runtime.IEventListener
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                // work
                if (ShouldProcess($"Call remote 'DeleteKeyManagementServers' operation"))
                {
        ...
        protected async global::System.Threading.Tasks.Task ProcessRecordAsync()
        {
            using( NoSynchronizationContext )
            {
                ...
                try
                {
                    ...
                    if (null == InputObject.KmsId)
                    {
                        ThrowTerminatingError( new global::System.Management.Automation.ErrorRecord(new global::System.Exception("InputObject has null value for InputObject.KmsId"),string.Empty, global::System.Management.Automation.ErrorCategory.InvalidArgument, InputObject) );
                    }
                    await this.Client.DeleteKeyManagementServers(InputObject.KmsId ?? default(long), onOk, onNotFound, this, Pipeline);
        ...
        /// <summary>
        /// Intializes a new instance of the <see cref="RemoveKeyManagementServer_DeleteViaIdentity" /> cmdlet class.
        /// </summary>
        public RemoveKeyManagementServer_DeleteViaIdentity()
        {
