...
namespace Commvault.Powershell.Cmdlets
{
    ...
    /// <remarks>
    /// [OpenAPI] UpdateMediaAgent=>PUT:"/V4/mediaAgent/{mediaAgentId}"
    /// </remarks>
    [global::System.Management.Automation.Cmdlet(global::System.Management.Automation.VerbsCommon.Set, @"MediaAgent_UpdateExpanded", SupportsShouldProcess = true)]
    ...
    public partial class SetMediaAgent_UpdateExpanded : global::System.Management.Automation.PSCmdlet,
        Commvault.Powershell.Runtime.IEventListener
    {
        ...
        public long ControlParallelDataTransferOperations { get => Body.ControlParallelDataTransferOperations ?? default(long); set => Body.ControlParallelDataTransferOperations = value; }
        ...
        SerializedName = @"id",
        PossibleTypes = new [] { typeof(long) })]
        public long RoleId { get => Body.RoleId ?? default(long); set => Body.RoleId = value; }
        ...
        SerializedName = @"id",
        PossibleTypes = new [] { typeof(long) })]
        public long UserGroupId { get => Body.UserGroupId ?? default(long); set => Body.UserGroupId = value; }
        ...
        SerializedName = @"id",
        PossibleTypes = new [] { typeof(long) })]
        public long UserId { get => Body.UserId ?? default(long); set => Body.UserId = value; }
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                // work
                if (ShouldProcess($"Call remote 'UpdateMediaAgent' operation"))
                {
        ...
        protected async global::System.Threading.Tasks.Task ProcessRecordAsync()
        {
            using( NoSynchronizationContext )
            {
                ...
                try
                {
                    ...
                    await this.Client.UpdateMediaAgent(MediaAgentId, Body, onOk, onBadRequest, onNotFound, this, Pipeline);
        ...
        /// <summary>
        /// Intializes a new instance of the <see cref="SetMediaAgent_UpdateExpanded" /> cmdlet class.
        /// </summary>
        public SetMediaAgent_UpdateExpanded()
        {
