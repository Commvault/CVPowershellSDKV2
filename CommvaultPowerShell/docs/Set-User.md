...
online version: https://docs.microsoft.com/en-us/powershell/module/commvaultpowershell/set-user
schema: 2.0.0
---
...
```
Set-User -UserId <Int64> [-Email <String>] [-Enabled] [-FullName <String>] [-NewName <String>]
...
```
Set-User -InputObject <ICommvaultPowerShellIdentity> [-Email <String>] [-Enabled] [-FullName <String>]
