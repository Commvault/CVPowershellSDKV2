...
online version: https://learn.microsoft.com/powershell/module/commvaultpowershell/get-cvhypervisorfilter
schema: 2.0.0
---

# Get-CVHypervisorFilter
...
### Get (Default)
```
Get-CVHypervisorFilter -HypervisorId <Int64> [-BackupsetId <String>] [<CommonParameters>]
```

### GetViaIdentity
```
Get-CVHypervisorFilter -InputObject <ICommvaultPowerShellIdentity> [-BackupsetId <String>]
 [<CommonParameters>]
```
...
### Commvault.Powershell.Models.IGetHypervisorFilterResp
