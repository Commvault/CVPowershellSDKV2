...
online version: https://learn.microsoft.com/powershell/module/commvaultpowershell/get-cvcvfs3bucket
schema: 2.0.0
---
...
### Get (Default)
```
Get-CVCvfS3Bucket -Id <Int64> [<CommonParameters>]
```

### GetViaIdentity
```
Get-CVCvfS3Bucket -InputObject <ICommvaultPowerShellIdentity> [<CommonParameters>]
```
