...
online version: https://learn.microsoft.com/powershell/module/commvaultpowershell/remove-cvblackoutwindow
schema: 2.0.0
---
...
### Delete (Default)
```
Remove-CVBlackoutWindow -BlackoutWindowId <Int64> [-PassThru] [-Confirm] [-WhatIf] [<CommonParameters>]
```

### __AllParameterSets
```
Remove-CVBlackoutWindow [-Id] <Int32> [-Force] [-Confirm] [-WhatIf] [<CommonParameters>]
```

### DeleteViaIdentity
```
Remove-CVBlackoutWindow -InputObject <ICommvaultPowerShellIdentity> [-PassThru] [-Confirm] [-WhatIf]
 [<CommonParameters>]
```
