...
online version: https://learn.microsoft.com/powershell/module/commvaultpowershell/get-cvexchangemailbox
schema: 2.0.0
---

# Get-CVExchangeMailbox
...
### Get (Default)
```
Get-CVExchangeMailbox -AppId <Int64> [-PageNumber <Int64>] [-PageSize <Int64>] [-PropertyLevel <String>]
 [-SearchKey <String>] [-Sort <String>] [<CommonParameters>]
```

### GetViaIdentity
```
Get-CVExchangeMailbox -InputObject <ICommvaultPowerShellIdentity> [-PageNumber <Int64>] [-PageSize <Int64>]
 [-PropertyLevel <String>] [-SearchKey <String>] [-Sort <String>] [<CommonParameters>]
```
...
### Commvault.Powershell.Models.IOffice365MailboxesResp
