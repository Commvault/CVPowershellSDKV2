...
online version: https://learn.microsoft.com/powershell/module/commvaultpowershell/enable-cvmaintenance
schema: 2.0.0
---

# Enable-CVMaintenance
...
### Enable (Default)
```
Enable-CVMaintenance -StoragePoolId <Int64> [-SuspendRunningJobs] [-Confirm] [-WhatIf] [<CommonParameters>]
```

### EnableViaIdentity
```
Enable-CVMaintenance -InputObject <ICommvaultPowerShellIdentity> [-SuspendRunningJobs] [-Confirm] [-WhatIf]
 [<CommonParameters>]
```
