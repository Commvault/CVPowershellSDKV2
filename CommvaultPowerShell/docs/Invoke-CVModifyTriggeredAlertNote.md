...
online version: https://docs.microsoft.com/en-us/powershell/module/commvaultpowershell/invoke-cvmodifytriggeredalertnote
schema: 2.0.0
---

# Invoke-CVModifyTriggeredAlertNote
...
```
Invoke-CVModifyTriggeredAlertNote -Id <Int64> [-Notes <String>] [-PassThru] [-Confirm] [-WhatIf]
 [<CommonParameters>]
```

### Modify
```
Invoke-CVModifyTriggeredAlertNote -Id <Int64> -Body <IUpdateTriggeredAlertsNotes> [-PassThru] [-Confirm]
 [-WhatIf] [<CommonParameters>]
```

### ModifyViaIdentity
```
Invoke-CVModifyTriggeredAlertNote -InputObject <ICommvaultPowerShellIdentity>
 -Body <IUpdateTriggeredAlertsNotes> [-PassThru] [-Confirm] [-WhatIf] [<CommonParameters>]
```

### ModifyViaIdentityExpanded
```
Invoke-CVModifyTriggeredAlertNote -InputObject <ICommvaultPowerShellIdentity> [-Notes <String>] [-PassThru]
...
```yaml
Type: Commvault.Powershell.Models.IUpdateTriggeredAlertsNotes
