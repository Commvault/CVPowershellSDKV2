...
online version: https://docs.microsoft.com/en-us/powershell/module/commvaultpowershell/get-laptopbackupdestination
schema: 2.0.0
---

# Get-LaptopBackupDestination
...
### Get (Default)
```
Get-LaptopBackupDestination -PlanId <Int64> [-PassThru] [<CommonParameters>]
```

### GetViaIdentity
```
Get-LaptopBackupDestination -InputObject <ICommvaultPowerShellIdentity> [-PassThru] [<CommonParameters>]
```
