...
online version: https://learn.microsoft.com/powershell/module/commvaultpowershell/remove-cvs3bucketclone
schema: 2.0.0
---
...
### Delete (Default)
```
Remove-CVS3BucketClone -CloneId <Int64> -Id <Int64> [-Confirm] [-WhatIf] [<CommonParameters>]
```

### DeleteViaIdentity
```
Remove-CVS3BucketClone -InputObject <ICommvaultPowerShellIdentity> [-Confirm] [-WhatIf] [<CommonParameters>]
```
