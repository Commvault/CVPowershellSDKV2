...
online version: https://learn.microsoft.com/powershell/module/commvaultpowershell/set-cvbackupdestinationwithoutplaninfo
schema: 2.0.0
---

# Set-CVBackupDestinationWithoutPlanInfo
...
```
Set-CVBackupDestinationWithoutPlanInfo -BackupDestinationId <Int64> [-BackupStartTime <Int64>]
 ...
 [-Id <Int64>] [-Mappings <ISnapshotCopyMapping[]>] [-Name <String>] [-OverrideRetentionSettings]
 [-RegionId <Int64>] [-RegionName <String>] [-RetentionPeriodDays <Int64>] [-RetentionRuleType <String>]
...
```
Set-CVBackupDestinationWithoutPlanInfo -InputObject <ICommvaultPowerShellIdentity> [-BackupStartTime <Int64>]
 [-BackupsToCopy <String>] [-EnableDataAging] [-FirstExtendedRetentionRuleIsInfiniteRetention]
 [-FirstExtendedRetentionRuleRetentionPeriodDays <Int64>] [-FirstExtendedRetentionRuleType <String>]
 [-Id <Int64>] [-Mappings <ISnapshotCopyMapping[]>] [-Name <String>] [-OverrideRetentionSettings]
 [-RegionId <Int64>] [-RegionName <String>] [-RetentionPeriodDays <Int64>] [-RetentionRuleType <String>]
