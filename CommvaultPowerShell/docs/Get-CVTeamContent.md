...
online version: https://learn.microsoft.com/powershell/module/commvaultpowershell/get-cvteamcontent
schema: 2.0.0
---
...
### Get (Default)
```
Get-CVTeamContent -AppId <Int64> [-PageNumber <Int64>] [-PageSize <Int64>] [-SearchKey <String>]
 [-Sort <String>] [<CommonParameters>]
```

### GetViaIdentity
```
Get-CVTeamContent -InputObject <ICommvaultPowerShellIdentity> [-PageNumber <Int64>] [-PageSize <Int64>]
...
### Commvault.Powershell.Models.IOffice365TeamsContentResp
