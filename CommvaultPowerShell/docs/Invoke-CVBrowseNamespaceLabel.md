...
online version: https://learn.microsoft.com/powershell/module/commvaultpowershell/invoke-cvbrowsenamespacelabel
schema: 2.0.0
---

# Invoke-CVBrowseNamespaceLabel
...
### Browse (Default)
```
Invoke-CVBrowseNamespaceLabel -ClusterId <Int64> -NameSpace <String> [<CommonParameters>]
```

### BrowseViaIdentity
```
Invoke-CVBrowseNamespaceLabel -InputObject <ICommvaultPowerShellIdentity> [<CommonParameters>]
```
