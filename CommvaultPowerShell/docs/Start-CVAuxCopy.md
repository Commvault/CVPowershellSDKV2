...
online version: https://learn.microsoft.com/powershell/module/commvaultpowershell/start-cvauxcopy
schema: 2.0.0
---
...
### Run (Default)
```
Start-CVAuxCopy -BackupDestinationId <Int64> -PlanId <Int64> [-IncludeAllCopies] [-Confirm] [-WhatIf]
 [<CommonParameters>]
```

### RunViaIdentity
```
Start-CVAuxCopy -InputObject <ICommvaultPowerShellIdentity> [-IncludeAllCopies] [-Confirm] [-WhatIf]
 [<CommonParameters>]
```
