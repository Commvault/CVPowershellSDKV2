...
online version: https://learn.microsoft.com/powershell/module/commvaultpowershell/invoke-cvforce
schema: 2.0.0
---
...
```
Invoke-CVForce -ArrayId <Int64> [-MountVolumeIds <Int64[]>] [-Volume <ISnapVolumes[]>] [-Confirm] [-WhatIf]
 [<CommonParameters>]
```

### Force
```
Invoke-CVForce -ArrayId <Int64> -Body <ISnapNodeReq> [-Confirm] [-WhatIf] [<CommonParameters>]
```

### ForceViaIdentity
```
Invoke-CVForce -InputObject <ICommvaultPowerShellIdentity> -Body <ISnapNodeReq> [-Confirm] [-WhatIf]
 [<CommonParameters>]
```

### ForceViaIdentityExpanded
```
Invoke-CVForce -InputObject <ICommvaultPowerShellIdentity> [-MountVolumeIds <Int64[]>]
...
`BODY <ISnapNodeReq>`: Request template for multi node unmount and instant clone delete
  - `[MountVolumeIds <List<Int64>>]`: Volume Ids of the Snaps to include for multi node unmount or instant clone delete
  - `[Volume <List<ISnapVolumes>>]`: Array of volumes to include for the operation
