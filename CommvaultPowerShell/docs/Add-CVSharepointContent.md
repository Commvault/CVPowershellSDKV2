...
online version: https://learn.microsoft.com/powershell/module/commvaultpowershell/add-cvsharepointcontent
schema: 2.0.0
---
...
### AddExpanded (Default)
```
Add-CVSharepointContent -AppId <Int64> [-Office365PlanId <Int64>] [-Office365PlanName <String>]
...
```
Add-CVSharepointContent -InputObject <ICommvaultPowerShellIdentity> [-Office365PlanId <Int64>]
 [-Office365PlanName <String>] [-Type <String>] [-Confirm] [-WhatIf] [<CommonParameters>]
```
