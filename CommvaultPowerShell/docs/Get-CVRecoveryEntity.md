...
online version: https://learn.microsoft.com/powershell/module/commvaultpowershell/get-cvrecoveryentity
schema: 2.0.0
---

# Get-CVRecoveryEntity
...
### Get (Default)
```
Get-CVRecoveryEntity -RecoveryEntityId <Int64> [<CommonParameters>]
```

### GetViaIdentity
```
Get-CVRecoveryEntity -InputObject <ICommvaultPowerShellIdentity> [<CommonParameters>]
```
