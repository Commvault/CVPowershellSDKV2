...
online version: https://learn.microsoft.com/powershell/module/commvaultpowershell/invoke-cvsnapforcedelete
schema: 2.0.0
---

# Invoke-CVSnapForceDelete
...
```
Invoke-CVSnapForceDelete -ArrayId <Int64> [-Volumes <ISnapVolumes[]>] [-PassThru] [-Confirm] [-WhatIf]
 [<CommonParameters>]
```

### Snap
```
Invoke-CVSnapForceDelete -ArrayId <Int64> -Body <ISnapForceReq> [-PassThru] [-Confirm] [-WhatIf]
 [<CommonParameters>]
```

### SnapViaIdentity
```
Invoke-CVSnapForceDelete -InputObject <ICommvaultPowerShellIdentity> -Body <ISnapForceReq> [-PassThru]
 [-Confirm] [-WhatIf] [<CommonParameters>]
```

### SnapViaIdentityExpanded
```
Invoke-CVSnapForceDelete -InputObject <ICommvaultPowerShellIdentity> [-Volumes <ISnapVolumes[]>] [-PassThru]
 [-Confirm] [-WhatIf] [<CommonParameters>]
```
