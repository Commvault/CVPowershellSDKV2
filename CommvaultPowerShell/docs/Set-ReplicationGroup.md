...
online version: https://docs.microsoft.com/en-us/powershell/module/commvaultpowershell/set-replicationgroup
schema: 2.0.0
---
...
```
Set-ReplicationGroup -ReplicationGroupId <String> [-Enable] [-NewName <String>] [-PassThru] [-Confirm]
 [-WhatIf] [<CommonParameters>]
```

### UpdateViaIdentityExpanded
```
Set-ReplicationGroup -InputObject <ICommvaultPowerShellIdentity> [-Enable] [-NewName <String>] [-PassThru]
