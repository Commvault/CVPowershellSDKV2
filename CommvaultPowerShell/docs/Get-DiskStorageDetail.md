...
online version: https://docs.microsoft.com/en-us/powershell/module/commvaultpowershell/get-diskstoragedetail
schema: 2.0.0
---

# Get-DiskStorageDetail
...
### Get (Default)
```
Get-DiskStorageDetail -StoragePoolId <Int64> [-ShowInheritedAssociation] [-PassThru] [<CommonParameters>]
```

### GetViaIdentity
```
Get-DiskStorageDetail -InputObject <ICommvaultPowerShellIdentity> [-ShowInheritedAssociation] [-PassThru]
 [<CommonParameters>]
```
