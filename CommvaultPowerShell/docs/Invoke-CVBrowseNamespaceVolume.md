...
online version: https://learn.microsoft.com/powershell/module/commvaultpowershell/invoke-cvbrowsenamespacevolume
schema: 2.0.0
---

# Invoke-CVBrowseNamespaceVolume
...
### Browse (Default)
```
Invoke-CVBrowseNamespaceVolume -ClusterId <Int64> -NameSpace <String> [<CommonParameters>]
```

### BrowseViaIdentity
```
Invoke-CVBrowseNamespaceVolume -InputObject <ICommvaultPowerShellIdentity> [<CommonParameters>]
```
