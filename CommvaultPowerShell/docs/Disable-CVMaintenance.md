...
online version: https://learn.microsoft.com/powershell/module/commvaultpowershell/disable-cvmaintenance
schema: 2.0.0
---

# Disable-CVMaintenance
...
### Disable (Default)
```
Disable-CVMaintenance -StoragePoolId <Int64> [-Confirm] [-WhatIf] [<CommonParameters>]
```

### DisableViaIdentity
```
Disable-CVMaintenance -InputObject <ICommvaultPowerShellIdentity> [-Confirm] [-WhatIf] [<CommonParameters>]
```
