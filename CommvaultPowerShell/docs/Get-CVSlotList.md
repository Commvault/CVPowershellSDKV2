...
online version: https://learn.microsoft.com/powershell/module/commvaultpowershell/get-cvslotlist
schema: 2.0.0
---
...
### Get (Default)
```
Get-CVSlotList -LibraryId <Int64> -SlotType <String> [<CommonParameters>]
```

### GetViaIdentity
```
Get-CVSlotList -InputObject <ICommvaultPowerShellIdentity> -SlotType <String> [<CommonParameters>]
```
...
### Commvault.Powershell.Models.IGetSlotListResp
