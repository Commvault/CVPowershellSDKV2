...
online version: https://learn.microsoft.com/powershell/module/commvaultpowershell/invoke-cvretireclientpackage
schema: 2.0.0
---

# Invoke-CVRetireClientPackage
...
```
Invoke-CVRetireClientPackage -ClientId <Int64> [-Packages <IIdName[]>] [-RetireClient] [-Confirm] [-WhatIf]
 [<CommonParameters>]
```

### Retire
```
Invoke-CVRetireClientPackage -ClientId <Int64> -Body <IRetireClientRequest> [-Confirm] [-WhatIf]
 [<CommonParameters>]
```

### RetireViaIdentity
```
Invoke-CVRetireClientPackage -InputObject <ICommvaultPowerShellIdentity> -Body <IRetireClientRequest>
 [-Confirm] [-WhatIf] [<CommonParameters>]
```

### RetireViaIdentityExpanded
```
Invoke-CVRetireClientPackage -InputObject <ICommvaultPowerShellIdentity> [-Packages <IIdName[]>]
 [-RetireClient] [-Confirm] [-WhatIf] [<CommonParameters>]
```
...
```yaml
Type: Commvault.Powershell.Models.IRetireClientRequest
Parameter Sets: Retire, RetireViaIdentity
Aliases:
...
```yaml
Type: System.Int64
Parameter Sets: Retire, RetireExpanded
Aliases:
...
Parameter Sets: RetireViaIdentity, RetireViaIdentityExpanded
Aliases:
...
Parameter Sets: RetireExpanded, RetireViaIdentityExpanded
Aliases:
