...
online version: https://learn.microsoft.com/powershell/module/commvaultpowershell/set-cvbackuplocation
schema: 2.0.0
---

# Set-CVBackupLocation
...
```
Set-CVBackupLocation -BackupLocationId <Int64> -StoragePoolId <Int64> [-Access <String>]
 [-BackupLocation <String>] [-ConfigurationDisableBackupLocationforFutureBackups]
 [-ConfigurationEnableBackupLocation] [-ConfigurationPrepareForRetirement] [-CredentialsName <String>]
 [-CredentialsPassword <String>] [-Enabled] [-MediaAgentId <Int64>] [-MediaAgentName <String>]
 [-SavedCredentialsId <Int64>] [-SavedCredentialsName <String>] [-PassThru] [-Confirm] [-WhatIf]
 [<CommonParameters>]
```

### UpdateViaIdentityExpanded
```
Set-CVBackupLocation -InputObject <ICommvaultPowerShellIdentity> [-Access <String>] [-BackupLocation <String>]
 [-ConfigurationDisableBackupLocationforFutureBackups] [-ConfigurationEnableBackupLocation]
 [-ConfigurationPrepareForRetirement] [-CredentialsName <String>] [-CredentialsPassword <String>] [-Enabled]
 [-MediaAgentId <Int64>] [-MediaAgentName <String>] [-SavedCredentialsId <Int64>]
 [-SavedCredentialsName <String>] [-PassThru] [-Confirm] [-WhatIf] [<CommonParameters>]
```
