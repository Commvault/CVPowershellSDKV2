...
online version: https://learn.microsoft.com/powershell/module/commvaultpowershell/set-cvuser
schema: 2.0.0
---
...
```
Set-CVUser -UserId <Int64> [-AuthenticationMethod <String>] [-Email <String>] [-Enabled] [-FullName <String>]
 [-NewName <String>] [-NewPassword <String>] [-PlanId <Int64>] [-PlanName <String>]
...
```
Set-CVUser -InputObject <ICommvaultPowerShellIdentity> [-AuthenticationMethod <String>] [-Email <String>]
 [-Enabled] [-FullName <String>] [-NewName <String>] [-NewPassword <String>] [-PlanId <Int64>]
 [-PlanName <String>] [-UserGroupOperation <String>] [-UserGroups <IIdName[]>] [-UserPrincipalName <String>]
 [-ValidationPassword <String>] [-PassThru] [-Confirm] [-WhatIf] [<CommonParameters>]
```
