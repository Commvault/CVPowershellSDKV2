...
online version: https://learn.microsoft.com/powershell/module/commvaultpowershell/remove-cvalertcustomrule
schema: 2.0.0
---

# Remove-CVAlertCustomRule
...
### Delete (Default)
```
Remove-CVAlertCustomRule -AlertRuleId <Int64> [-PassThru] [-Confirm] [-WhatIf] [<CommonParameters>]
```

### DeleteViaIdentity
```
Remove-CVAlertCustomRule -InputObject <ICommvaultPowerShellIdentity> [-PassThru] [-Confirm] [-WhatIf]
 [<CommonParameters>]
```
