...
online version: https://learn.microsoft.com/powershell/module/commvaultpowershell/get-cvstorageassociatedcopy
schema: 2.0.0
---

# Get-CVStorageAssociatedCopy
...
### Get (Default)
```
Get-CVStorageAssociatedCopy -StoragePoolId <Int64> [-PassThru] [<CommonParameters>]
```

### GetViaIdentity
```
Get-CVStorageAssociatedCopy -InputObject <ICommvaultPowerShellIdentity> [-PassThru] [<CommonParameters>]
```
...
### Commvault.Powershell.Models.IStorageAssociatedCopies
