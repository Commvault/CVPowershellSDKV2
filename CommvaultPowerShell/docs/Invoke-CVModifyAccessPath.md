...
online version: https://docs.microsoft.com/en-us/powershell/module/commvaultpowershell/invoke-cvmodifyaccesspath
schema: 2.0.0
---

# Invoke-CVModifyAccessPath
...
```
Invoke-CVModifyAccessPath -AccessPathId <Int64> -BucketId <Int64> -CloudStorageId <Int64> [-Access <String>]
 [-Enable] [-Confirm] [-WhatIf] [<CommonParameters>]
```

### Modify
```
Invoke-CVModifyAccessPath -AccessPathId <Int64> -BucketId <Int64> -CloudStorageId <Int64>
 -Body <ICloudStorageAdvanced> [-Confirm] [-WhatIf] [<CommonParameters>]
```

### ModifyViaIdentity
```
Invoke-CVModifyAccessPath -InputObject <ICommvaultPowerShellIdentity> -Body <ICloudStorageAdvanced> [-Confirm]
 [-WhatIf] [<CommonParameters>]
```

### ModifyViaIdentityExpanded
```
Invoke-CVModifyAccessPath -InputObject <ICommvaultPowerShellIdentity> [-Access <String>] [-Enable] [-Confirm]
 [-WhatIf] [<CommonParameters>]
```
...
```yaml
Type: Commvault.Powershell.Models.ICloudStorageAdvanced
