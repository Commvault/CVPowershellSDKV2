...
online version: https://docs.microsoft.com/en-us/powershell/module/commvaultpowershell/set-archiveplan
schema: 2.0.0
---
...
```
Set-ArchivePlan -PlanId <Int64> [-AllowPlanOverride] [-ArchivingRuleAfterArchiving <String>]
...
```
Set-ArchivePlan -InputObject <ICommvaultPowerShellIdentity> [-AllowPlanOverride]
