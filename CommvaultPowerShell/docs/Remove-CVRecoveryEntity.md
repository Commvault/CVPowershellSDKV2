...
online version: https://learn.microsoft.com/powershell/module/commvaultpowershell/remove-cvrecoveryentity
schema: 2.0.0
---
...
```
Remove-CVRecoveryEntity -RecoveryGroupId <Int64> [-Id <Int64>] [-RecoveryEntities <Int64[]>]
 [-RecoveryGroupName <String>] [-Confirm] [-WhatIf] [<CommonParameters>]
```

### Delete
```
Remove-CVRecoveryEntity -RecoveryGroupId <Int64> -Body <IDeleteRecoveryEntityReq> [-Confirm] [-WhatIf]
 [<CommonParameters>]
```

### DeleteViaIdentity
```
Remove-CVRecoveryEntity -InputObject <ICommvaultPowerShellIdentity> -Body <IDeleteRecoveryEntityReq>
 [-Confirm] [-WhatIf] [<CommonParameters>]
```

### DeleteViaIdentityExpanded
```
Remove-CVRecoveryEntity -InputObject <ICommvaultPowerShellIdentity> [-RecoveryGroupId <Int64>]
 [-RecoveryEntities <Int64[]>] [-RecoveryGroupName <String>] [-Confirm] [-WhatIf] [<CommonParameters>]
```
...
```yaml
Type: Commvault.Powershell.Models.IDeleteRecoveryEntityReq
...
```yaml
Type: System.Int64
Parameter Sets: Delete, DeleteExpanded, DeleteViaIdentityExpanded
Aliases:
