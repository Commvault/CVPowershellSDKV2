...
online version: https://learn.microsoft.com/powershell/module/commvaultpowershell/enable-cvlocalauthentication
schema: 2.0.0
---

# Enable-CVLocalAuthentication
...
```
Enable-CVLocalAuthentication -CompanyId <Int64> [-Mode <String>] [-UserGroups <IIdName[]>] [-Confirm]
 [-WhatIf] [<CommonParameters>]
```

### Enable
```
Enable-CVLocalAuthentication -CompanyId <Int64> -Body <ILocalAuthenticationDetails> [-Confirm] [-WhatIf]
 [<CommonParameters>]
```

### EnableViaIdentity
```
Enable-CVLocalAuthentication -InputObject <ICommvaultPowerShellIdentity> -Body <ILocalAuthenticationDetails>
 [-Confirm] [-WhatIf] [<CommonParameters>]
```

### EnableViaIdentityExpanded
```
Enable-CVLocalAuthentication -InputObject <ICommvaultPowerShellIdentity> [-Mode <String>]
 [-UserGroups <IIdName[]>] [-Confirm] [-WhatIf] [<CommonParameters>]
```
...
```yaml
Type: Commvault.Powershell.Models.ILocalAuthenticationDetails
