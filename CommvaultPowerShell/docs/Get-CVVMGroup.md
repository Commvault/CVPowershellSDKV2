...
online version: https://learn.microsoft.com/powershell/module/commvaultpowershell/get-cvvmgroup
schema: 2.0.0
---
...
### Get (Default)
```
Get-CVVMGroup [-HypervisorId <Int64>] [<CommonParameters>]
```

### Get1
```
Get-CVVMGroup -VMGroupId <Int64> [<CommonParameters>]
```

### GetViaIdentity
```
Get-CVVMGroup -InputObject <ICommvaultPowerShellIdentity> [<CommonParameters>]
```
