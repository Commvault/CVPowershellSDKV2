...
online version: https://learn.microsoft.com/powershell/module/commvaultpowershell/new-cvlocalbackuplocation
schema: 2.0.0
---
...
```
New-CVLocalBackupLocation -StoragePoolId <Int64> [-BackupLocation <String>] [-CredentialsName <String>]
...
```
New-CVLocalBackupLocation -InputObject <ICommvaultPowerShellIdentity> [-BackupLocation <String>]
