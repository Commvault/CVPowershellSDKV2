...
online version: https://docs.microsoft.com/en-us/powershell/module/commvaultpowershell/add-laptop
schema: 2.0.0
---
...
### AddExpanded (Default)
```
Add-Laptop -ClientNames <String[]> -OS <String> -Password <String> -UserName <String> [-PassThru] [-Confirm]
 [-WhatIf] [<CommonParameters>]
```

### Add
```
Add-Laptop -Body <IAddLaptop> [-PassThru] [-Confirm] [-WhatIf] [<CommonParameters>]
```
