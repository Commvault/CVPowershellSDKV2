...
online version: https://docs.microsoft.com/en-us/powershell/module/commvaultpowershell/get-cvserver
schema: 2.0.0
---
...
### Get (Default)
```
Get-CVServer [-ShowOnlyInfrastructureMachines <Int64>] [<CommonParameters>]
```

### Get1
```
Get-CVServer -CompanyId <Int64> [<CommonParameters>]
```

### GetViaIdentity
```
Get-CVServer -InputObject <ICommvaultPowerShellIdentity> [<CommonParameters>]
```
