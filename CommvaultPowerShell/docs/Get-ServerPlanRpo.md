...
online version: https://docs.microsoft.com/en-us/powershell/module/commvaultpowershell/get-serverplanrpo
schema: 2.0.0
---
...
### Get (Default)
```
Get-ServerPlanRpo -PlanId <Int64> [<CommonParameters>]
```

### GetViaIdentity
```
Get-ServerPlanRpo -InputObject <ICommvaultPowerShellIdentity> [<CommonParameters>]
```
