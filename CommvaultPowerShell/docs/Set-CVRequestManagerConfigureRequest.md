...
online version: https://docs.microsoft.com/en-us/powershell/module/commvaultpowershell/set-cvrequestmanagerconfigurerequest
schema: 2.0.0
---

# Set-CVRequestManagerConfigureRequest
...
```
Set-CVRequestManagerConfigureRequest -RequestId <Int64> -ProjectIds <Int64[]>
...
```
Set-CVRequestManagerConfigureRequest -InputObject <ICommvaultPowerShellIdentity> -ProjectIds <Int64[]>
 -Reviewers <IIdNameDisplayName[]> [-Approvers <IIdNameDisplayName[]>] [-Confirm] [-WhatIf]
 [<CommonParameters>]
```
