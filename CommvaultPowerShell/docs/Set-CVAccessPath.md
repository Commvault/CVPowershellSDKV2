...
online version: https://learn.microsoft.com/powershell/module/commvaultpowershell/set-cvaccesspath
schema: 2.0.0
---
...
```
Set-CVAccessPath -AccessPathId <Int64> -BucketId <Int64> -CloudStorageId <Int64> [-Access <String>] [-Enable]
 [-Confirm] [-WhatIf] [<CommonParameters>]
```

### UpdateViaIdentityExpanded
```
Set-CVAccessPath -InputObject <ICommvaultPowerShellIdentity> [-Access <String>] [-Enable] [-Confirm] [-WhatIf]
 [<CommonParameters>]
```
