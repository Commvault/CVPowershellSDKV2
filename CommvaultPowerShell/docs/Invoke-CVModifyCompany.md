...
online version: https://docs.microsoft.com/en-us/powershell/module/commvaultpowershell/invoke-cvmodifycompany
schema: 2.0.0
---

# Invoke-CVModifyCompany
...
```
Invoke-CVModifyCompany -CompanyId <Int64> [-DefaultPlans <IDefaultPlan[]>] [-EmailSettingSenderEmail <String>]
...
### Modify
```
Invoke-CVModifyCompany -CompanyId <Int64> -Body <IUpdateCompany> [-PassThru] [-Confirm] [-WhatIf]
 [<CommonParameters>]
```

### ModifyViaIdentity
```
Invoke-CVModifyCompany -InputObject <ICommvaultPowerShellIdentity> -Body <IUpdateCompany> [-PassThru]
 [-Confirm] [-WhatIf] [<CommonParameters>]
```

### ModifyViaIdentityExpanded
```
Invoke-CVModifyCompany -InputObject <ICommvaultPowerShellIdentity> [-DefaultPlans <IDefaultPlan[]>]
