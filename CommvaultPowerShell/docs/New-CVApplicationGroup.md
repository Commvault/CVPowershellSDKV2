...
online version: https://docs.microsoft.com/en-us/powershell/module/commvaultpowershell/new-cvapplicationgroup
schema: 2.0.0
---

# New-CVApplicationGroup
...
```
New-CVApplicationGroup -Name <String> [-ContentOverwrite] [-ContentRuleGroups <IRuleGroupContent[]>]
