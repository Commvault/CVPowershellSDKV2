...
online version: https://learn.microsoft.com/powershell/module/commvaultpowershell/invoke-cvcloudgeteligiblemediaagent
schema: 2.0.0
---

# Invoke-CVCloudGetEligibleMediaAgent
...
### Cloud (Default)
```
Invoke-CVCloudGetEligibleMediaAgent -BucketId <Int64> -CloudStorageId <Int64> [-PassThru] [<CommonParameters>]
```

### CloudViaIdentity
```
Invoke-CVCloudGetEligibleMediaAgent -InputObject <ICommvaultPowerShellIdentity> [-PassThru]
 [<CommonParameters>]
```
