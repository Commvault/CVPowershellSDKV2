...
online version: https://learn.microsoft.com/powershell/module/commvaultpowershell/get-cvjobonbackupdestination
schema: 2.0.0
---

# Get-CVJobOnBackupDestination
...
### Get (Default)
```
Get-CVJobOnBackupDestination -BackupDestinationId <Int64> [-AgedData <Int64>] [-BackupLvl <Int64>]
 [-Clients <String>] [-CopyState <Int64>] [-EndTime <Int64>] [-MaxAppSizeMb <Int64>] [-MinAppSizeMb <Int64>]
 [-StartTime <Int64>] [-View <String>] [<CommonParameters>]
```

### GetViaIdentity
```
Get-CVJobOnBackupDestination -InputObject <ICommvaultPowerShellIdentity> [-AgedData <Int64>]
 [-BackupLvl <Int64>] [-Clients <String>] [-CopyState <Int64>] [-EndTime <Int64>] [-MaxAppSizeMb <Int64>]
 [-MinAppSizeMb <Int64>] [-StartTime <Int64>] [-View <String>] [<CommonParameters>]
```
...
### Commvault.Powershell.Models.IGetJobsOnStorageResp
