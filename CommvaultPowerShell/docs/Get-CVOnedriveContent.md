...
online version: https://learn.microsoft.com/powershell/module/commvaultpowershell/get-cvonedrivecontent
schema: 2.0.0
---

# Get-CVOnedriveContent
...
### Get (Default)
```
Get-CVOnedriveContent -AppId <Int64> [-PageNumber <Int64>] [-PageSize <Int64>] [-SearchKey <String>]
 [-Sort <String>] [<CommonParameters>]
```

### GetViaIdentity
```
Get-CVOnedriveContent -InputObject <ICommvaultPowerShellIdentity> [-PageNumber <Int64>] [-PageSize <Int64>]
...
### Commvault.Powershell.Models.IOffice365OnedriveContentResp
