...
online version: https://docs.microsoft.com/en-us/powershell/module/commvaultpowershell/set-cvbucket
schema: 2.0.0
---
...
```
Set-CVBucket -BucketId <Int64> -CloudStorageId <Int64> [-Enable] [-PrepareForRetirement]
 [-PreventNewDataWritesToBackupLocation] [-StorageAcceleratorCredentialsId <Int64>]
 [-StorageAcceleratorCredentialsName <String>] [-Confirm] [-WhatIf] [<CommonParameters>]
```

### UpdateViaIdentityExpanded
```
Set-CVBucket -InputObject <ICommvaultPowerShellIdentity> [-Enable] [-PrepareForRetirement]
 [-PreventNewDataWritesToBackupLocation] [-StorageAcceleratorCredentialsId <Int64>]
 [-StorageAcceleratorCredentialsName <String>] [-Confirm] [-WhatIf] [<CommonParameters>]
```
