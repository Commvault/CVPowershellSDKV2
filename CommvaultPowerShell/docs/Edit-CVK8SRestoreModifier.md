...
online version: https://learn.microsoft.com/powershell/module/commvaultpowershell/edit-cvk8srestoremodifier
schema: 2.0.0
---

# Edit-CVK8SRestoreModifier
...
```
Edit-CVK8SRestoreModifier -ClusterId <Int64> -ModifierName <String> [-ModifierYaml <String>] [-Confirm]
 [-WhatIf] [<CommonParameters>]
```

### Edit
```
Edit-CVK8SRestoreModifier -ClusterId <Int64> -ModifierName <String> -Body <IK8SRestoreModifierApireq>
 [-Confirm] [-WhatIf] [<CommonParameters>]
```

### EditViaIdentity
```
Edit-CVK8SRestoreModifier -InputObject <ICommvaultPowerShellIdentity> -Body <IK8SRestoreModifierApireq>
 [-Confirm] [-WhatIf] [<CommonParameters>]
```

### EditViaIdentityExpanded
```
Edit-CVK8SRestoreModifier -InputObject <ICommvaultPowerShellIdentity> [-ModifierYaml <String>] [-Confirm]
 [-WhatIf] [<CommonParameters>]
```
