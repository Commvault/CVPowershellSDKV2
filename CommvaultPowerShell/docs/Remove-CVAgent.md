...
online version: https://docs.microsoft.com/en-us/powershell/module/commvaultpowershell/remove-cvagent
schema: 2.0.0
---
...
### Delete (Default)
```
Remove-CVAgent -AgentId <Int64> -ServerId <Int64> [-Confirm] [-WhatIf] [<CommonParameters>]
```

### DeleteViaIdentity
```
Remove-CVAgent -InputObject <ICommvaultPowerShellIdentity> [-Confirm] [-WhatIf] [<CommonParameters>]
```
