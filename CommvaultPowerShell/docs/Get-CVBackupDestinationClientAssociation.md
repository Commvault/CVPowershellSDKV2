...
online version: https://learn.microsoft.com/powershell/module/commvaultpowershell/get-cvbackupdestinationclientassociation
schema: 2.0.0
---

# Get-CVBackupDestinationClientAssociation
...
### Get (Default)
```
Get-CVBackupDestinationClientAssociation -BackupDestinationId <Int64> -PlanId <Int64> [-EntityId <Int64>]
 [-EntityType <Int64>] [<CommonParameters>]
```

### GetViaIdentity
```
Get-CVBackupDestinationClientAssociation -InputObject <ICommvaultPowerShellIdentity> [-EntityId <Int64>]
 [-EntityType <Int64>] [<CommonParameters>]
```
...
### Commvault.Powershell.Models.IBackupDestinationAssociationsResp
