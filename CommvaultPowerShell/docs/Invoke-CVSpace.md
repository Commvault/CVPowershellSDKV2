...
online version: https://learn.microsoft.com/powershell/module/commvaultpowershell/invoke-cvspace
schema: 2.0.0
---
...
### Space (Default)
```
Invoke-CVSpace -StoragePoolId <Int64> [-Confirm] [-WhatIf] [<CommonParameters>]
```

### SpaceViaIdentity
```
Invoke-CVSpace -InputObject <ICommvaultPowerShellIdentity> [-Confirm] [-WhatIf] [<CommonParameters>]
```
