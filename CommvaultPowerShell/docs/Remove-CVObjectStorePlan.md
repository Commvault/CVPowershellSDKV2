...
online version: https://learn.microsoft.com/powershell/module/commvaultpowershell/remove-cvobjectstoreplan
schema: 2.0.0
---
...
### Delete (Default)
```
Remove-CVObjectStorePlan -PlanId <Int64> [-Confirm] [-WhatIf] [<CommonParameters>]
```

### DeleteViaIdentity
```
Remove-CVObjectStorePlan -InputObject <ICommvaultPowerShellIdentity> [-Confirm] [-WhatIf] [<CommonParameters>]
```
