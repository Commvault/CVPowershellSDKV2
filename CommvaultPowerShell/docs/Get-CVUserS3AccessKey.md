...
online version: https://learn.microsoft.com/powershell/module/commvaultpowershell/get-cvusers3accesskey
schema: 2.0.0
---
...
### Get (Default)
```
Get-CVUserS3AccessKey -Id <Int64> [<CommonParameters>]
```

### GetViaIdentity
```
Get-CVUserS3AccessKey -InputObject <ICommvaultPowerShellIdentity> [<CommonParameters>]
```
