...
online version: https://learn.microsoft.com/powershell/module/commvaultpowershell/get-cvrunningjob
schema: 2.0.0
---
...
### Get (Default)
```
Get-CVRunningJob -StoragePoolId <Int64> [-IgnoreSuspendedJobs] [-JobType <String>] [<CommonParameters>]
```

### GetViaIdentity
```
Get-CVRunningJob -InputObject <ICommvaultPowerShellIdentity> [-IgnoreSuspendedJobs] [-JobType <String>]
 [<CommonParameters>]
```
