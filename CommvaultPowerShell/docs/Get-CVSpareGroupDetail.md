...
online version: https://learn.microsoft.com/powershell/module/commvaultpowershell/get-cvsparegroupdetail
schema: 2.0.0
---

# Get-CVSpareGroupDetail
...
### Get (Default)
```
Get-CVSpareGroupDetail -LibraryId <Int64> -SpareGroupType <String> [<CommonParameters>]
```

### GetViaIdentity
```
Get-CVSpareGroupDetail -InputObject <ICommvaultPowerShellIdentity> -SpareGroupType <String>
 [<CommonParameters>]
```
...
### Commvault.Powershell.Models.IGetSpareGroupListResp
