...
online version: https://learn.microsoft.com/powershell/module/commvaultpowershell/set-cvrole
schema: 2.0.0
---
...
Set-CVRole -RoleId <Int64> [-Enabled] [-NewName <String>] [-PermissionList <IPermissions[]>]
 [-PermissionOperationType <String>] [-Security <IUpdateSecurityAssoc[]>] [-VisibleToAll] [-PassThru]
...
Set-CVRole -InputObject <ICommvaultPowerShellIdentity> [-Enabled] [-NewName <String>]
 [-PermissionList <IPermissions[]>] [-PermissionOperationType <String>] [-Security <IUpdateSecurityAssoc[]>]
