...
online version: https://learn.microsoft.com/powershell/module/commvaultpowershell/get-cvsourcecopy
schema: 2.0.0
---
...
### Get1 (Default)
```
Get-CVSourceCopy [<CommonParameters>]
```

### Get
```
Get-CVSourceCopy -PlanId <Int64> [-ForSnapCopy] [-RegionId <Int64>] [<CommonParameters>]
```

### GetViaIdentity
```
Get-CVSourceCopy -InputObject <ICommvaultPowerShellIdentity> [-ForSnapCopy] [-RegionId <Int64>]
 [<CommonParameters>]
```
