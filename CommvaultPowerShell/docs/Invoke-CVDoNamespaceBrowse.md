...
online version: https://learn.microsoft.com/powershell/module/commvaultpowershell/invoke-cvdonamespacebrowse
schema: 2.0.0
---

# Invoke-CVDoNamespaceBrowse
...
### Do (Default)
```
Invoke-CVDoNamespaceBrowse -ApplicationGroupId <Int64> [-FromTime <Int64>] [-Limit <Int64>] [-Page <Int64>]
 [-ToTime <Int64>] [<CommonParameters>]
```

### DoViaIdentity
```
Invoke-CVDoNamespaceBrowse -InputObject <ICommvaultPowerShellIdentity> [-FromTime <Int64>] [-Limit <Int64>]
...
### Commvault.Powershell.Models.IKubernetesAppGroupNamespaceBrowseResp
