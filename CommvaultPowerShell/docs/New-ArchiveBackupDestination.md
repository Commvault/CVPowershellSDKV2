...
online version: https://docs.microsoft.com/en-us/powershell/module/commvaultpowershell/new-archivebackupdestination
schema: 2.0.0
---

# New-ArchiveBackupDestination
...
```
New-ArchiveBackupDestination -PlanId <Int64> -Destinations <ICreateArchivePlanBackupDestination[]>
