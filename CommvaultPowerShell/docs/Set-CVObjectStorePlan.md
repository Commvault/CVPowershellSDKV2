...
online version: https://learn.microsoft.com/powershell/module/commvaultpowershell/set-cvobjectstoreplan
schema: 2.0.0
---

# Set-CVObjectStorePlan
...
```
Set-CVObjectStorePlan -PlanId <Int64> [-BackupDestinationOperationType <String>]
 [-BackupDestinations <IObjectStorePlanUpdateBkpDest[]>] [-BackupFrequencyOperationType <String>]
 [-BackupFrequencySchedules <IObjectStorePlanSchedule[]>] [-Name <String>]
 [-RpoFullBackupWindow <IDayAndTime[]>] [-SlaEnableAfterDelay <Int64>] [-SlaExcludeFromSla]
...
```
Set-CVObjectStorePlan -InputObject <ICommvaultPowerShellIdentity> [-BackupDestinationOperationType <String>]
 [-BackupDestinations <IObjectStorePlanUpdateBkpDest[]>] [-BackupFrequencyOperationType <String>]
 [-BackupFrequencySchedules <IObjectStorePlanSchedule[]>] [-Name <String>]
 [-RpoFullBackupWindow <IDayAndTime[]>] [-SlaEnableAfterDelay <Int64>] [-SlaExcludeFromSla]
 [-SlaExclusionReason <String>] [-SlaLogSlaMinutes <Int64>] [-SlaPeriod <Int64>] [-SlaUseSystemDefaultSla]
...
```yaml
Type: Commvault.Powershell.Models.IObjectStorePlanUpdateBkpDest[]
Parameter Sets: (All)
Aliases:
