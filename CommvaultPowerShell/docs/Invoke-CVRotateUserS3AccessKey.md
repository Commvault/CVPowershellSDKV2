...
online version: https://learn.microsoft.com/powershell/module/commvaultpowershell/invoke-cvrotateusers3accesskey
schema: 2.0.0
---
...
### Rotate (Default)
```
Invoke-CVRotateUserS3AccessKey -Id <Int64> [-Confirm] [-WhatIf] [<CommonParameters>]
```

### RotateViaIdentity
```
Invoke-CVRotateUserS3AccessKey -InputObject <ICommvaultPowerShellIdentity> [-Confirm] [-WhatIf]
 [<CommonParameters>]
```
