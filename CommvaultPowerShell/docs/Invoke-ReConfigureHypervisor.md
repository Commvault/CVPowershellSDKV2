...
online version: https://docs.microsoft.com/en-us/powershell/module/commvaultpowershell/invoke-reconfigurehypervisor
schema: 2.0.0
---

# Invoke-ReConfigureHypervisor
...
### Re (Default)
```
Invoke-ReConfigureHypervisor -HypervisorId <Int64> [-Confirm] [-WhatIf] [<CommonParameters>]
```
