...
online version: https://learn.microsoft.com/powershell/module/commvaultpowershell/get-cvlocalbackuplocationdetail
schema: 2.0.0
---
...
### Get (Default)
```
Get-CVLocalBackupLocationDetail -BackupLocationId <Int64> -StoragePoolId <Int64> [-PassThru]
 [<CommonParameters>]
```

### GetViaIdentity
```
Get-CVLocalBackupLocationDetail -InputObject <ICommvaultPowerShellIdentity> [-PassThru] [<CommonParameters>]
```
