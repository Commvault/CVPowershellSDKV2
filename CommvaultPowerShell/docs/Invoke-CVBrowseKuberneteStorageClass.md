...
online version: https://learn.microsoft.com/powershell/module/commvaultpowershell/invoke-cvbrowsekubernetestorageclass
schema: 2.0.0
---

# Invoke-CVBrowseKuberneteStorageClass
...
### Browse (Default)
```
Invoke-CVBrowseKuberneteStorageClass -ClusterId <Int64> [<CommonParameters>]
```

### BrowseViaIdentity
```
Invoke-CVBrowseKuberneteStorageClass -InputObject <ICommvaultPowerShellIdentity> [<CommonParameters>]
```
