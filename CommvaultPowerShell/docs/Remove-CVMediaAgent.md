...
online version: https://learn.microsoft.com/powershell/module/commvaultpowershell/remove-cvmediaagent
schema: 2.0.0
---
...
### Delete (Default)
```
Remove-CVMediaAgent -MediaAgentId <Int64> [-PassThru] [-Confirm] [-WhatIf] [<CommonParameters>]
```

### DeleteViaIdentity
```
Remove-CVMediaAgent -InputObject <ICommvaultPowerShellIdentity> [-PassThru] [-Confirm] [-WhatIf]
 [<CommonParameters>]
```
