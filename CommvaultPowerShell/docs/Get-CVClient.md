...
online version: https://learn.microsoft.com/powershell/module/commvaultpowershell/get-cvclient
schema: 2.0.0
---
...
### Get
```
Get-CVClient -BackupDestinationId <Int64> [<CommonParameters>]
```

### GetViaIdentity
```
Get-CVClient -InputObject <ICommvaultPowerShellIdentity> [<CommonParameters>]
```
...
Parameter Sets: ById, ByName, Default
Aliases:
...
### Commvault.Powershell.Models.IClientListForStorageResp
