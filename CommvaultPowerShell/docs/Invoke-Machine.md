...
online version: https://docs.microsoft.com/en-us/powershell/module/commvaultpowershell/invoke-machine
schema: 2.0.0
---
...
### Machine (Default)
```
Invoke-Machine -VMUuid <String> [-BackupLevel <String>] [-Confirm] [-WhatIf] [<CommonParameters>]
```

### MachineViaIdentity
```
Invoke-Machine -InputObject <ICommvaultPowerShellIdentity> [-BackupLevel <String>] [-Confirm] [-WhatIf]
 [<CommonParameters>]
```
