...
online version: https://learn.microsoft.com/powershell/module/commvaultpowershell/get-cvtestfailovermachinefailovergroup
schema: 2.0.0
---

# Get-CVTestFailoverMachineFailoverGroup
...
### Get (Default)
```
Get-CVTestFailoverMachineFailoverGroup -FailoverGroupId <Int64> [<CommonParameters>]
```

### GetViaIdentity
```
Get-CVTestFailoverMachineFailoverGroup -InputObject <ICommvaultPowerShellIdentity> [<CommonParameters>]
```
...
### Commvault.Powershell.Models.IPathsVh225Av4FailovergroupsFailovergroupidTestfailovermachinesGetResponses200ContentApplicationJsonSchema
