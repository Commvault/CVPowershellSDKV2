...
online version: https://docs.microsoft.com/en-us/powershell/module/commvaultpowershell/get-virtualmachinedetail
schema: 2.0.0
---

# Get-VirtualMachineDetail
...
### Get (Default)
```
Get-VirtualMachineDetail -VMUuid <String> [-ShowInheritedAssociation] [-PassThru] [<CommonParameters>]
```

### GetViaIdentity
```
Get-VirtualMachineDetail -InputObject <ICommvaultPowerShellIdentity> [-ShowInheritedAssociation] [-PassThru]
 [<CommonParameters>]
```
