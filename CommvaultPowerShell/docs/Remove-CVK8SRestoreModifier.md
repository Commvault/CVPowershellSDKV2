...
online version: https://learn.microsoft.com/powershell/module/commvaultpowershell/remove-cvk8srestoremodifier
schema: 2.0.0
---

# Remove-CVK8SRestoreModifier
...
### Delete (Default)
```
Remove-CVK8SRestoreModifier -ClusterId <Int64> -ModifierName <String> [-Confirm] [-WhatIf]
 [<CommonParameters>]
```

### DeleteViaIdentity
```
Remove-CVK8SRestoreModifier -InputObject <ICommvaultPowerShellIdentity> [-Confirm] [-WhatIf]
 [<CommonParameters>]
```
