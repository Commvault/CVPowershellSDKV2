...
online version: https://learn.microsoft.com/powershell/module/commvaultpowershell/set-cvdiskaccesspath
schema: 2.0.0
---

# Set-CVDiskAccessPath
...
```
Set-CVDiskAccessPath -AccessPathId <Int64> -BackupLocationId <Int64> -StoragePoolId <Int64> [-Access <String>]
 [-Enabled] [-PassThru] [-Confirm] [-WhatIf] [<CommonParameters>]
```

### UpdateViaIdentityExpanded
```
Set-CVDiskAccessPath -InputObject <ICommvaultPowerShellIdentity> [-Access <String>] [-Enabled] [-PassThru]
