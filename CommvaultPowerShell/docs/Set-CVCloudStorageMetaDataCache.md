...
online version: https://learn.microsoft.com/powershell/module/commvaultpowershell/set-cvcloudstoragemetadatacache
schema: 2.0.0
---

# Set-CVCloudStorageMetaDataCache
...
```
Set-CVCloudStorageMetaDataCache -CloudStorageId <Int64> -MetadataCacheId <Int64> [-CredentialsName <String>]
 [-CredentialsPassword <String>] [-Path <String>] [-SavedCredentialsId <Int64>]
 [-SavedCredentialsName <String>] [-Confirm] [-WhatIf] [<CommonParameters>]
```

### UpdateViaIdentityExpanded
```
Set-CVCloudStorageMetaDataCache -InputObject <ICommvaultPowerShellIdentity> [-CredentialsName <String>]
 [-CredentialsPassword <String>] [-Path <String>] [-SavedCredentialsId <Int64>]
 [-SavedCredentialsName <String>] [-Confirm] [-WhatIf] [<CommonParameters>]
```
