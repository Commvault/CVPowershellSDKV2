...
online version: https://learn.microsoft.com/powershell/module/commvaultpowershell/get-cvdrbackupdestinationdetail
schema: 2.0.0
---

# Get-CVDrBackupDestinationDetail
...
### Get (Default)
```
Get-CVDrBackupDestinationDetail -BackupDestinationId <Int64> [-PassThru] [<CommonParameters>]
```

### GetViaIdentity
```
Get-CVDrBackupDestinationDetail -InputObject <ICommvaultPowerShellIdentity> [-PassThru] [<CommonParameters>]
```
