...
online version: https://learn.microsoft.com/powershell/module/commvaultpowershell/get-cvrecoverygroup
schema: 2.0.0
---
...
### Get1 (Default)
```
Get-CVRecoveryGroup [<CommonParameters>]
```

### Get
```
Get-CVRecoveryGroup -RecoveryGroupId <Int64> [-GetEntityDetails] [<CommonParameters>]
```

### GetViaIdentity
```
Get-CVRecoveryGroup -InputObject <ICommvaultPowerShellIdentity> [-GetEntityDetails] [<CommonParameters>]
```
...
### Commvault.Powershell.Models.IRecoveryGroupListResp
