...
online version: https://docs.microsoft.com/en-us/powershell/module/commvaultpowershell/set-bucket
schema: 2.0.0
---
...
```
Set-Bucket -BucketId <Int64> -CloudStorageId <Int64> [-Enable] [-PrepareForRetirement]
...
```
Set-Bucket -InputObject <ICommvaultPowerShellIdentity> [-Enable] [-PrepareForRetirement]
 [-PreventNewDataWritesToBackupLocation] [-StorageAcceleratorCredentialsId <Int64>]
 [-StorageAcceleratorCredentialsName <String>] [-Confirm] [-WhatIf] [<CommonParameters>]
```
