...
online version: https://learn.microsoft.com/powershell/module/commvaultpowershell/start-cvsnapcatalog
schema: 2.0.0
---
...
### Run (Default)
```
Start-CVSnapCatalog -BackupDestionationId <Int64> -PlanId <Int64> [-Confirm] [-WhatIf] [<CommonParameters>]
```

### RunViaIdentity
```
Start-CVSnapCatalog -InputObject <ICommvaultPowerShellIdentity> [-Confirm] [-WhatIf] [<CommonParameters>]
```
