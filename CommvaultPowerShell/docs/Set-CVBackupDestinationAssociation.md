...
online version: https://learn.microsoft.com/powershell/module/commvaultpowershell/set-cvbackupdestinationassociation
schema: 2.0.0
---

# Set-CVBackupDestinationAssociation
...
```
Set-CVBackupDestinationAssociation -BackupDestinationId <Int64> -PlanId <Int64>
 [-Associations <ISubclientAssociation[]>] [-UpdateApplicableForFutureJobs] [-Confirm] [-WhatIf]
 [<CommonParameters>]
```

### UpdateViaIdentityExpanded
```
Set-CVBackupDestinationAssociation -InputObject <ICommvaultPowerShellIdentity>
 [-Associations <ISubclientAssociation[]>] [-UpdateApplicableForFutureJobs] [-Confirm] [-WhatIf]
 [<CommonParameters>]
```
...
```yaml
Type: Commvault.Powershell.Models.ISubclientAssociation[]
Parameter Sets: (All)
Aliases:
...
`ASSOCIATIONS <ISubclientAssociation[]>`: List of selected/excluded entities to be associated with backup destination.
  - `[FlagDisabled <Boolean?>]`: If set to true, the entity is disabled for current user.
  - `[FlagExclude <Boolean?>]`: If set to true, this entity and its child entities are excluded for auxcopy
  - `[FlagInclude <Boolean?>]`: If set to true, this entity and its child entities are included for auxcopy
  ...
  - `[ParentEntity5Id <Int64?>]`: id of the associated entity
  - `[ParentEntity5Name <String>]`: name of the associated entity
  - `[ParentEntity5Type <String>]`: 
  - `[Type <String>]`: 
