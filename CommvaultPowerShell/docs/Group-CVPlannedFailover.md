...
online version: https://learn.microsoft.com/powershell/module/commvaultpowershell/group-cvplannedfailover
schema: 2.0.0
---

# Group-CVPlannedFailover
...
### Group (Default)
```
Group-CVPlannedFailover -DrOperation <String> -FailoverGroupId <Int64> [-ReplicationId <Int64>]
 [-SkipDisableNetworkAdapter] [-Confirm] [-WhatIf] [<CommonParameters>]
```

### GroupViaIdentity
```
Group-CVPlannedFailover -InputObject <ICommvaultPowerShellIdentity> [-ReplicationId <Int64>]
 [-SkipDisableNetworkAdapter] [-Confirm] [-WhatIf] [<CommonParameters>]
```
