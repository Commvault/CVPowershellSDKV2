...
online version: https://learn.microsoft.com/powershell/module/commvaultpowershell/get-cvexchangecontent
schema: 2.0.0
---

# Get-CVExchangeContent
...
### Get (Default)
```
Get-CVExchangeContent -AppId <Int64> [-PageNumber <Int64>] [-PageSize <Int64>] [-SearchKey <String>]
 [-Sort <String>] [<CommonParameters>]
```

### GetViaIdentity
```
Get-CVExchangeContent -InputObject <ICommvaultPowerShellIdentity> [-PageNumber <Int64>] [-PageSize <Int64>]
...
### Commvault.Powershell.Models.IOffice365ExchangeContentResp
