...
online version: https://learn.microsoft.com/powershell/module/commvaultpowershell/remove-cvstoragetagregion
schema: 2.0.0
---
...
### Delete (Default)
```
Remove-CVStorageTagRegion -PlanId <Int64> -RegionId <Int64> [-PassThru] [-Confirm] [-WhatIf]
 [<CommonParameters>]
```

### DeleteViaIdentity
```
Remove-CVStorageTagRegion -InputObject <ICommvaultPowerShellIdentity> [-PassThru] [-Confirm] [-WhatIf]
 [<CommonParameters>]
```
