...
online version: https://learn.microsoft.com/powershell/module/commvaultpowershell/set-cv
schema: 2.0.0
---
...
```
Set-CV -RequestId <Int64> [-Approvers <IIdNameDisplayName[]>] [-ProjectIds <Int64[]>]
 [-Reviewers <IIdNameDisplayName[]>] [-Confirm] [-WhatIf] [<CommonParameters>]
```
...
```
Set-CV -InputObject <ICommvaultPowerShellIdentity> [-Approvers <IIdNameDisplayName[]>] [-ProjectIds <Int64[]>]
 [-Reviewers <IIdNameDisplayName[]>] [-Confirm] [-WhatIf] [<CommonParameters>]
```
...
`BODY <IRmConfigureRequest>`: RMConfigureRequest
  - `ProjectIds <List<Int64>>`: List of project ids
  - `Reviewers <List<IIdNameDisplayName>>`: List of reviewers for the request
  - `[Approvers <List<IIdNameDisplayName>>]`: List of approvers for the request
    - `[DisplayName <String>]`: 
    - `[Id <Int64?>]`: 
    - `[Name <String>]`: 
