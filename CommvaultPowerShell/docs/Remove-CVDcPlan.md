...
online version: https://learn.microsoft.com/powershell/module/commvaultpowershell/remove-cvdcplan
schema: 2.0.0
---
...
### Delete (Default)
```
Remove-CVDcPlan -PlanId <Int64> [-PassThru] [-Confirm] [-WhatIf] [<CommonParameters>]
```

### DeleteViaIdentity
```
Remove-CVDcPlan -InputObject <ICommvaultPowerShellIdentity> [-PassThru] [-Confirm] [-WhatIf]
 [<CommonParameters>]
```
