...
online version: https://learn.microsoft.com/powershell/module/commvaultpowershell/invoke-cvsnaprevert
schema: 2.0.0
---
...
```
Invoke-CVSnapRevert -ArrayId <Int64> [-Volumes <IVolumeSnap[]>] [-Confirm] [-WhatIf] [<CommonParameters>]
```

### Snap
```
Invoke-CVSnapRevert -ArrayId <Int64> -Body <ISnapRevertReq> [-Confirm] [-WhatIf] [<CommonParameters>]
```

### SnapViaIdentity
```
Invoke-CVSnapRevert -InputObject <ICommvaultPowerShellIdentity> -Body <ISnapRevertReq> [-Confirm] [-WhatIf]
 [<CommonParameters>]
```

### SnapViaIdentityExpanded
```
Invoke-CVSnapRevert -InputObject <ICommvaultPowerShellIdentity> [-Volumes <IVolumeSnap[]>] [-Confirm]
...
```yaml
Type: Commvault.Powershell.Models.ISnapRevertReq
