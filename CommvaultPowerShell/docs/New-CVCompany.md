...
online version: https://learn.microsoft.com/powershell/module/commvaultpowershell/new-cvcompany
schema: 2.0.0
---
...
```
New-CVCompany [-Alias <String>] [-ContactName <String>] [-Email <String>] [-EmailSuffix <String>]
 [-Name <String>] [-Plans <IIdName[]>] [-PrimaryDomain <String>] [-SendWelcomeEmail]
 [-ServiceCommcells <IIdName[]>] [-PassThru] [-Confirm] [-WhatIf] [<CommonParameters>]
```
