...
online version: https://docs.microsoft.com/en-us/powershell/module/commvaultpowershell/set-cvcloudstorage
schema: 2.0.0
---
...
```
Set-CVCloudStorage -CloudStorageId <Int64> [-EncryptionCipher <String>] [-EncryptionEncrypt]
...
```
Set-CVCloudStorage -InputObject <ICommvaultPowerShellIdentity> [-EncryptionCipher <String>]
