...
online version: https://learn.microsoft.com/powershell/module/commvaultpowershell/set-cvarchivebackupdestination
schema: 2.0.0
---

# Set-CVArchiveBackupDestination
...
```
Set-CVArchiveBackupDestination -BackupDestinationId <Int64> -PlanId <Int64> [-EnableDataAging]
 [-NewName <String>] [-OverrideRetentionSettings] [-RetentionPeriodDays <Int64>] [-SourceCopyId <Int64>]
 [-SourceCopyName <String>] [-PassThru] [-Confirm] [-WhatIf] [<CommonParameters>]
```

### UpdateViaIdentityExpanded
```
Set-CVArchiveBackupDestination -InputObject <ICommvaultPowerShellIdentity> [-EnableDataAging]
 [-NewName <String>] [-OverrideRetentionSettings] [-RetentionPeriodDays <Int64>] [-SourceCopyId <Int64>]
 [-SourceCopyName <String>] [-PassThru] [-Confirm] [-WhatIf] [<CommonParameters>]
```
