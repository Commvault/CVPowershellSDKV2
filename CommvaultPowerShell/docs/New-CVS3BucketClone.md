...
online version: https://learn.microsoft.com/powershell/module/commvaultpowershell/new-cvs3bucketclone
schema: 2.0.0
---
...
```
New-CVS3BucketClone -Id <Int64> [-CopyPrecedence <Int64>] [-FromTime <Int64>] [-ReservationTime <Int64>]
 [-ToTime <Int64>] [-Confirm] [-WhatIf] [<CommonParameters>]
```

### CreateViaIdentityExpanded
```
New-CVS3BucketClone -InputObject <ICommvaultPowerShellIdentity> [-CopyPrecedence <Int64>] [-FromTime <Int64>]
 [-ReservationTime <Int64>] [-ToTime <Int64>] [-Confirm] [-WhatIf] [<CommonParameters>]
```
