...
online version: https://learn.microsoft.com/powershell/module/commvaultpowershell/new-cvlocalstorage
schema: 2.0.0
---
...
```
New-CVLocalStorage [-DeduplicationDbStorage <IDedupePath[]>] [-EnableDeduplication] [-Name <String>]
