...
online version: https://learn.microsoft.com/powershell/module/commvaultpowershell/invoke-cvfetchk8smodifier
schema: 2.0.0
---

# Invoke-CVFetchK8SModifier
...
### Fetch (Default)
```
Invoke-CVFetchK8SModifier -ClusterId <Int64> -ModifierName <String> [<CommonParameters>]
```

### FetchViaIdentity
```
Invoke-CVFetchK8SModifier -InputObject <ICommvaultPowerShellIdentity> [<CommonParameters>]
```
