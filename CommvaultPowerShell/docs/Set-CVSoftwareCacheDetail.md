...
online version: https://learn.microsoft.com/powershell/module/commvaultpowershell/set-cvsoftwarecachedetail
schema: 2.0.0
---

# Set-CVSoftwareCacheDetail
...
```
Set-CVSoftwareCacheDetail -ClientId <Int64> [-Associations <IModifySoftwareCacheAssociations[]>]
 [-CacheDirectory <String>] [-Enabled] [-Confirm] [-WhatIf] [<CommonParameters>]
```

### UpdateViaIdentityExpanded
```
Set-CVSoftwareCacheDetail -InputObject <ICommvaultPowerShellIdentity>
 [-Associations <IModifySoftwareCacheAssociations[]>] [-CacheDirectory <String>] [-Enabled] [-Confirm]
...
```yaml
Type: Commvault.Powershell.Models.IModifySoftwareCacheAssociations[]
Parameter Sets: (All)
Aliases:
