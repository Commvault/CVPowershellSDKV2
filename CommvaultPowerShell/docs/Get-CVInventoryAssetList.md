...
online version: https://learn.microsoft.com/powershell/module/commvaultpowershell/get-cvinventoryassetlist
schema: 2.0.0
---

# Get-CVInventoryAssetList
...
### Get (Default)
```
Get-CVInventoryAssetList -InventoryId <Int64> [<CommonParameters>]
```

### GetViaIdentity
```
Get-CVInventoryAssetList -InputObject <ICommvaultPowerShellIdentity> [<CommonParameters>]
```
...
### Commvault.Powershell.Models.IInventoryAssetList
