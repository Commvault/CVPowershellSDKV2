...
online version: https://learn.microsoft.com/powershell/module/commvaultpowershell/set-cvs3bucketcloneexpiry
schema: 2.0.0
---
...
```
Set-CVS3BucketCloneExpiry -CloneId <Int64> -Id <Int64> [-ExpiryTime <Int64>] [-Confirm] [-WhatIf]
 [<CommonParameters>]
```

### UpdateViaIdentityExpanded
```
Set-CVS3BucketCloneExpiry -InputObject <ICommvaultPowerShellIdentity> [-ExpiryTime <Int64>] [-Confirm]
