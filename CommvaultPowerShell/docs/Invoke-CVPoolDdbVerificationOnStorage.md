...
online version: https://learn.microsoft.com/powershell/module/commvaultpowershell/invoke-cvpoolddbverificationonstorage
schema: 2.0.0
---

# Invoke-CVPoolDdbVerificationOnStorage
...
### Pool (Default)
```
Invoke-CVPoolDdbVerificationOnStorage -StoragePoolId <Int64> -DdbVerificationLevel <String> [-Confirm]
 [-WhatIf] [<CommonParameters>]
```

### PoolViaIdentity
```
Invoke-CVPoolDdbVerificationOnStorage -InputObject <ICommvaultPowerShellIdentity>
 -DdbVerificationLevel <String> [-Confirm] [-WhatIf] [<CommonParameters>]
```
...
### Commvault.Powershell.Models.IArchiveCheckOperationResp
