...
online version: https://learn.microsoft.com/powershell/module/commvaultpowershell/get-cvmedialist
schema: 2.0.0
---
...
### Get (Default)
```
Get-CVMediaList -LibraryId <Int64> -FilterMediaType <String> -IsExported [<CommonParameters>]
```

### GetViaIdentity
```
Get-CVMediaList -InputObject <ICommvaultPowerShellIdentity> -FilterMediaType <String> -IsExported
 [<CommonParameters>]
```
...
### Commvault.Powershell.Models.IGetMediaListResp
