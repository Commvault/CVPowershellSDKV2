...
online version: https://learn.microsoft.com/powershell/module/commvaultpowershell/set-cvcvfs3bucket
schema: 2.0.0
---
...
```
Set-CVCvfS3Bucket -Id <Int64> [-BucketSize <String>] [-UserId <Int64>] [-UserName <String>]
 [-UserOperation <String>] [-Versioning <String>] [-Confirm] [-WhatIf] [<CommonParameters>]
```

### UpdateViaIdentityExpanded
```
Set-CVCvfS3Bucket -InputObject <ICommvaultPowerShellIdentity> [-BucketSize <String>] [-UserId <Int64>]
 [-UserName <String>] [-UserOperation <String>] [-Versioning <String>] [-Confirm] [-WhatIf]
 [<CommonParameters>]
```
