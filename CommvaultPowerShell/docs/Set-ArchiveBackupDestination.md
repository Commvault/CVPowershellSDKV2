...
online version: https://docs.microsoft.com/en-us/powershell/module/commvaultpowershell/set-archivebackupdestination
schema: 2.0.0
---

# Set-ArchiveBackupDestination
...
```
Set-ArchiveBackupDestination -BackupDestinationId <Int64> -PlanId <Int64> [-NewName <String>]
...
```
Set-ArchiveBackupDestination -InputObject <ICommvaultPowerShellIdentity> [-NewName <String>]
 [-RetentionPeriodDays <Int64>] [-SourceCopyId <Int64>] [-SourceCopyName <String>] [-PassThru] [-Confirm]
 [-WhatIf] [<CommonParameters>]
```
