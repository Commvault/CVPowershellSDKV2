...
online version: https://learn.microsoft.com/powershell/module/commvaultpowershell/get-cvclientinfo
schema: 2.0.0
---
...
### Get (Default)
```
Get-CVClientInfo -ClientId <Int64> [<CommonParameters>]
```

### GetViaIdentity
```
Get-CVClientInfo -InputObject <ICommvaultPowerShellIdentity> [<CommonParameters>]
```
