...
online version: https://docs.microsoft.com/en-us/powershell/module/commvaultpowershell/get-archivebackupdestination
schema: 2.0.0
---

# Get-ArchiveBackupDestination
...
### Get (Default)
```
Get-ArchiveBackupDestination -PlanId <Int64> [-PassThru] [<CommonParameters>]
```

### GetViaIdentity
```
Get-ArchiveBackupDestination -InputObject <ICommvaultPowerShellIdentity> [-PassThru] [<CommonParameters>]
```
