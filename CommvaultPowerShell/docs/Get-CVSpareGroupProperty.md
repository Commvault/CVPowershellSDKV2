...
online version: https://learn.microsoft.com/powershell/module/commvaultpowershell/get-cvsparegroupproperty
schema: 2.0.0
---

# Get-CVSpareGroupProperty
...
### Get (Default)
```
Get-CVSpareGroupProperty -LibraryId <Int64> -SpareGroupId <Int64> [<CommonParameters>]
```

### GetViaIdentity
```
Get-CVSpareGroupProperty -InputObject <ICommvaultPowerShellIdentity> [<CommonParameters>]
```
...
### -SpareGroupId
Id of the Spare group whose properties need to be fetched.
spareGroupId can be fetched from GET V4/Storage/Tape/{libraryId}/MediaType
