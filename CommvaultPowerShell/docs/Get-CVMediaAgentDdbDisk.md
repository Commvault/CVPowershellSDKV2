...
online version: https://learn.microsoft.com/powershell/module/commvaultpowershell/get-cvmediaagentddbdisk
schema: 2.0.0
---
...
### Get (Default)
```
Get-CVMediaAgentDdbDisk -MediaAgentId <Int64> [<CommonParameters>]
```

### GetViaIdentity
```
Get-CVMediaAgentDdbDisk -InputObject <ICommvaultPowerShellIdentity> [<CommonParameters>]
```
