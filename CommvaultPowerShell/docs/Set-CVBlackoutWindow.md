...
online version: https://docs.microsoft.com/en-us/powershell/module/commvaultpowershell/set-cvblackoutwindow
schema: 2.0.0
---
...
```
Set-CVBlackoutWindow -BlackoutWindowId <Int64> [-BackupOperations <String[]>] [-BetweenDateEnd <Int64>]
...
```
Set-CVBlackoutWindow -InputObject <ICommvaultPowerShellIdentity> [-BackupOperations <String[]>]
