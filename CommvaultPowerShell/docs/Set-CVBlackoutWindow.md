...
online version: https://learn.microsoft.com/powershell/module/commvaultpowershell/set-cvblackoutwindow
schema: 2.0.0
---
...
```
Set-CVBlackoutWindow -BlackoutWindowId <Int64> [-AllDays <IDaysAndTimes[]>] [-BackupOperations <String[]>]
 [-BetweenDateEnd <Int64>] [-BetweenDateStart <Int64>] [-CompanyId <Int64>] [-CompanyName <String>]
 [-DoNotSubmitJob] [-NewName <String>] [-Weeks <String[]>] [-PassThru] [-Confirm] [-WhatIf]
 [<CommonParameters>]
```

### UpdateViaIdentityExpanded
```
Set-CVBlackoutWindow -InputObject <ICommvaultPowerShellIdentity> [-AllDays <IDaysAndTimes[]>]
...
`ALLDAYS <IDaysAndTimes[]>`: Days of the week along with the time on which the black out window will be in effect.
  - `[Days <List<String>>]`: Days of the week when the blackout window will be in effect.
