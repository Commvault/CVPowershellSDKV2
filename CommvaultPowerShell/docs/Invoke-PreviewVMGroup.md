...
online version: https://docs.microsoft.com/en-us/powershell/module/commvaultpowershell/invoke-previewvmgroup
schema: 2.0.0
---

# Invoke-PreviewVMGroup
...
```
Invoke-PreviewVMGroup [-HypervisorId <Int64>] [-ContentOverwrite] [-ContentRuleGroups <IRuleGroupContent[]>]
 [-ContentVirtualMachines <IVirtualMachinecontent[]>] [-Confirm] [-WhatIf] [<CommonParameters>]
```

### Preview
```
Invoke-PreviewVMGroup -Body <IVMGroupPreviewReq> [-HypervisorId <Int64>] [-Confirm] [-WhatIf]
 [<CommonParameters>]
```
