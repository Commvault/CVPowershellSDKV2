...
online version: https://learn.microsoft.com/powershell/module/commvaultpowershell/invoke-cvkubernete
schema: 2.0.0
---
...
### Kubernetes (Default)
```
Invoke-CVKubernete -ClusterId <Int64> [<CommonParameters>]
```

### Kubernetes1
```
Invoke-CVKubernete -ClusterId <Int64> -Body <IK8SRestoreModifierApireq> [-Confirm] [-WhatIf]
 [<CommonParameters>]
```

### KubernetesExpanded
```
Invoke-CVKubernete -ClusterId <Int64> [-ModifierYaml <String>] [-Confirm] [-WhatIf] [<CommonParameters>]
```

### KubernetesViaIdentity
```
Invoke-CVKubernete -InputObject <ICommvaultPowerShellIdentity> [<CommonParameters>]
```

### KubernetesViaIdentity1
```
Invoke-CVKubernete -InputObject <ICommvaultPowerShellIdentity> -Body <IK8SRestoreModifierApireq> [-Confirm]
 [-WhatIf] [<CommonParameters>]
```

### KubernetesViaIdentityExpanded
```
Invoke-CVKubernete -InputObject <ICommvaultPowerShellIdentity> [-ModifierYaml <String>] [-Confirm] [-WhatIf]
 [<CommonParameters>]
```
...
```yaml
Type: Commvault.Powershell.Models.IK8SRestoreModifierApireq
Parameter Sets: Kubernetes1, KubernetesViaIdentity1
Aliases:
...
```yaml
Type: System.Int64
Parameter Sets: Kubernetes, Kubernetes1, KubernetesExpanded
Aliases:
...
Parameter Sets: KubernetesViaIdentity, KubernetesViaIdentity1, KubernetesViaIdentityExpanded
Aliases:
...
```yaml
Type: System.String
Parameter Sets: KubernetesExpanded, KubernetesViaIdentityExpanded
Aliases:
