...
online version: https://learn.microsoft.com/powershell/module/commvaultpowershell/set-cvlocalstorage
schema: 2.0.0
---
...
```
Set-CVLocalStorage -StoragePoolId <Int64> [-DataEncryptionCipher <String>] [-DataEncryptionEncrypt]
 [-DataEncryptionKeyLength <Int64>] [-KeyProviderId <Int64>] [-KeyProviderName <String>] [-Name <String>]
 [-Security <IUpdateSecurityAssoc[]>] [-PassThru] [-Confirm] [-WhatIf] [<CommonParameters>]
```

### UpdateViaIdentityExpanded
```
Set-CVLocalStorage -InputObject <ICommvaultPowerShellIdentity> [-DataEncryptionCipher <String>]
 [-DataEncryptionEncrypt] [-DataEncryptionKeyLength <Int64>] [-KeyProviderId <Int64>]
 [-KeyProviderName <String>] [-Name <String>] [-Security <IUpdateSecurityAssoc[]>] [-PassThru] [-Confirm]
