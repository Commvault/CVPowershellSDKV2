...
online version: https://docs.microsoft.com/en-us/powershell/module/commvaultpowershell/get-cvserverplanrpo
schema: 2.0.0
---
...
### Get (Default)
```
Get-CVServerPlanRpo -PlanId <Int64> [<CommonParameters>]
```

### GetViaIdentity
```
Get-CVServerPlanRpo -InputObject <ICommvaultPowerShellIdentity> [<CommonParameters>]
```
