...
online version: https://docs.microsoft.com/en-us/powershell/module/commvaultpowershell/get-cvplansummarydetail
schema: 2.0.0
---

# Get-CVPlanSummaryDetail
...
### Get (Default)
```
Get-CVPlanSummaryDetail -PlanId <Int64> [<CommonParameters>]
```

### GetViaIdentity
```
Get-CVPlanSummaryDetail -InputObject <ICommvaultPowerShellIdentity> [<CommonParameters>]
```
