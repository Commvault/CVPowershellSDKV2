...
online version: https://docs.microsoft.com/en-us/powershell/module/commvaultpowershell/new-cvarchivebackupdestination
schema: 2.0.0
---

# New-CVArchiveBackupDestination
...
```
New-CVArchiveBackupDestination -PlanId <Int64> -Destinations <ICreateArchivePlanBackupDestination[]>
 [-RegionId <Int64>] [-RegionName <String>] [-PassThru] [-Confirm] [-WhatIf] [<CommonParameters>]
```

### CreateViaIdentityExpanded
```
New-CVArchiveBackupDestination -InputObject <ICommvaultPowerShellIdentity>
 -Destinations <ICreateArchivePlanBackupDestination[]> [-RegionId <Int64>] [-RegionName <String>] [-PassThru]
