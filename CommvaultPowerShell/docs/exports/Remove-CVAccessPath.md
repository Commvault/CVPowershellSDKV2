...
online version: https://docs.microsoft.com/en-us/powershell/module/commvaultpowershell/remove-cvaccesspath
schema: 2.0.0
---
...
### Delete (Default)
```
Remove-CVAccessPath -AccessPathId <Int64> -BucketId <Int64> -CloudStorageId <Int64> [-Confirm] [-WhatIf]
 [<CommonParameters>]
```

### DeleteViaIdentity
```
Remove-CVAccessPath -InputObject <ICommvaultPowerShellIdentity> [-Confirm] [-WhatIf] [<CommonParameters>]
```
