...
### Delete (Default)
```
Remove-CVBackupLocation -BackupLocationId <Int64> -StoragePoolId <Int64> [-PassThru] [-Confirm] [-WhatIf]
 [<CommonParameters>]
```

### DeleteViaIdentity
```
Remove-CVBackupLocation -InputObject <ICommvaultPowerShellIdentity> [-PassThru] [-Confirm] [-WhatIf]
 [<CommonParameters>]
```
