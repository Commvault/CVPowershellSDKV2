...
online version: https://docs.microsoft.com/en-us/powershell/module/commvaultpowershell/get-cvbucketdetail
schema: 2.0.0
---
...
### Get (Default)
```
Get-CVBucketDetail -BucketId <Int64> -CloudStorageId <Int64> [<CommonParameters>]
```

### GetViaIdentity
```
Get-CVBucketDetail -InputObject <ICommvaultPowerShellIdentity> [<CommonParameters>]
```
