...
### Browse (Default)
```
Invoke-CVBrowseHypervisorInventory -HypervisorId <Int64> -InventoryEntityName <String>
 [-InventoryType <String>] [<CommonParameters>]
```

### BrowseViaIdentity
```
Invoke-CVBrowseHypervisorInventory -InputObject <ICommvaultPowerShellIdentity> [-InventoryType <String>]
 [<CommonParameters>]
```
