...
online version: https://docs.microsoft.com/en-us/powershell/module/commvaultpowershell/get-cvplan
schema: 2.0.0
---
...
### Get (Default)
```
Get-CVPlan [-PassThru] [<CommonParameters>]
```

### Get1
```
Get-CVPlan -PlanId <Int64> [-PassThru] [<CommonParameters>]
```

### GetViaIdentity
```
Get-CVPlan -InputObject <ICommvaultPowerShellIdentity> [-PassThru] [<CommonParameters>]
```
