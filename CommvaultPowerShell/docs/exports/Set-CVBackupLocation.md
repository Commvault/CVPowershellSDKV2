...
online version: https://docs.microsoft.com/en-us/powershell/module/commvaultpowershell/set-cvbackuplocation
schema: 2.0.0
---
...
```
Set-CVBackupLocation -InputObject <ICommvaultPowerShellIdentity> [-Access <String>]
 [-CredentialsName <String>] [-CredentialsPassword <String>] [-Enabled] [-MediaAgentId <Int64>]
 [-MediaAgentName <String>] [-Path <String>] [-SavedCredentialsId <Int64>] [-SavedCredentialsName <String>]
 [-PassThru] [-Confirm] [-WhatIf] [<CommonParameters>]
```
