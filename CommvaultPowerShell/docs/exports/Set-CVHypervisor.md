...
online version: https://docs.microsoft.com/en-us/powershell/module/commvaultpowershell/set-cvhypervisor
schema: 2.0.0
---
...
```
Set-CVHypervisor -HypervisorId <Int64> [-Confirm] [-WhatIf] [<CommonParameters>]
```

### UpdateViaIdentityExpanded
```
Set-CVHypervisor -InputObject <ICommvaultPowerShellIdentity> [-Confirm] [-WhatIf] [<CommonParameters>]
```
