...
### Get (Default)
```
Get-CVReplicationGroupDetail -ReplicationGroupId <String> [-OverrideReplicationOptions]
 [-ViewReplicationOptions] [-PassThru] [<CommonParameters>]
```

### GetViaIdentity
```
Get-CVReplicationGroupDetail -InputObject <ICommvaultPowerShellIdentity> [-OverrideReplicationOptions]
 [-ViewReplicationOptions] [-PassThru] [<CommonParameters>]
```
