...
online version: https://docs.microsoft.com/en-us/powershell/module/commvaultpowershell/set-cvadldap
schema: 2.0.0
---
...
```
Set-CVAdldap -DomainId <Int64> -DirectoryType <String> -Name <String> [-AccessViaClient]
...
```
Set-CVAdldap -InputObject <ICommvaultPowerShellIdentity> -DirectoryType <String> -Name <String>
