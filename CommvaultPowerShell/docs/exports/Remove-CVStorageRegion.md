...
online version: https://docs.microsoft.com/en-us/powershell/module/commvaultpowershell/remove-cvstorageregion
schema: 2.0.0
---

# Remove-CVStorageRegion
...
### Delete (Default)
```
Remove-CVStorageRegion -PlanId <Int64> -RegionList <String> [-IsRegionIdList] [-PassThru] [-Confirm] [-WhatIf]
 [<CommonParameters>]
```
...
### DeleteViaIdentity
```
Remove-CVStorageRegion -InputObject <ICommvaultPowerShellIdentity> [-IsRegionIdList] [-PassThru] [-Confirm]
