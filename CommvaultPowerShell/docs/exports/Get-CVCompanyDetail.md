...
online version: https://docs.microsoft.com/en-us/powershell/module/commvaultpowershell/get-cvcompanydetail
schema: 2.0.0
---
...
### Get (Default)
```
Get-CVCompanyDetail -CompanyId <Int64> [-ShowInheritedAssociation] [-PassThru] [<CommonParameters>]
```

### GetViaIdentity
```
Get-CVCompanyDetail -InputObject <ICommvaultPowerShellIdentity> [-ShowInheritedAssociation] [-PassThru]
 [<CommonParameters>]
```
