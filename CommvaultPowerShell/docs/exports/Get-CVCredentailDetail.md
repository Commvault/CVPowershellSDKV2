...
online version: https://docs.microsoft.com/en-us/powershell/module/commvaultpowershell/get-cvcredentaildetail
schema: 2.0.0
---

# Get-CVCredentailDetail
...
### Get (Default)
```
Get-CVCredentailDetail -CredentialName <String> [-PassThru] [<CommonParameters>]
```

### GetViaIdentity
```
Get-CVCredentailDetail -InputObject <ICommvaultPowerShellIdentity> [-PassThru] [<CommonParameters>]
```
