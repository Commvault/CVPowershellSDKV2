...
online version: https://docs.microsoft.com/en-us/powershell/module/commvaultpowershell/set-cvaccesspath
schema: 2.0.0
---
...
```
Set-CVAccessPath -AccessPathId <Int64> -BucketId <Int64> -CloudStorageId <Int64> [-Confirm] [-WhatIf]
 [<CommonParameters>]
```

### UpdateViaIdentityExpanded
```
Set-CVAccessPath -InputObject <ICommvaultPowerShellIdentity> [-Confirm] [-WhatIf] [<CommonParameters>]
```
