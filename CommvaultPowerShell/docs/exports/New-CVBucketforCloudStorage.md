...
online version: https://docs.microsoft.com/en-us/powershell/module/commvaultpowershell/new-cvbucketforcloudstorage
schema: 2.0.0
---
...
```
New-CVBucketforCloudStorage -CloudStorageId <Int64> [-PassThru] [-Confirm] [-WhatIf] [<CommonParameters>]
```

### CreateViaIdentityExpanded
```
New-CVBucketforCloudStorage -InputObject <ICommvaultPowerShellIdentity> [-PassThru] [-Confirm] [-WhatIf]
 [<CommonParameters>]
```
