...
### Get (Default)
```
Get-CVRegion [<CommonParameters>]
```

### Get1
```
Get-CVRegion -EntityId <Int64> -EntityType <Int64> [-PassThru] [<CommonParameters>]
```

### GetViaIdentity
```
Get-CVRegion -InputObject <ICommvaultPowerShellIdentity> [-PassThru] [<CommonParameters>]
```
