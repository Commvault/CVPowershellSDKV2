...
online version: https://docs.microsoft.com/en-us/powershell/module/commvaultpowershell/get-cvhyperscalestorage
schema: 2.0.0
---

# Get-CVHyperScaleStorage
...
### Get (Default)
```
Get-CVHyperScaleStorage -HyperScaleStorageId <Int64> [-ShowInheritedAssociation <String>] [-PassThru]
 [<CommonParameters>]
```

### GetViaIdentity
```
Get-CVHyperScaleStorage -InputObject <ICommvaultPowerShellIdentity> [-ShowInheritedAssociation <String>]
