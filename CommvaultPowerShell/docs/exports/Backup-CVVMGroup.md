...
online version: https://docs.microsoft.com/en-us/powershell/module/commvaultpowershell/backup-cvvmgroup
schema: 2.0.0
---
...
### Backup (Default)
```
Backup-CVVMGroup -VMGroupId <Int64> [-BackupLevel <String>] [-Confirm] [-WhatIf] [<CommonParameters>]
```

### BackupViaIdentity
```
Backup-CVVMGroup -InputObject <ICommvaultPowerShellIdentity> [-BackupLevel <String>] [-Confirm] [-WhatIf]
 [<CommonParameters>]
```
