...
online version: https://docs.microsoft.com/en-us/powershell/module/commvaultpowershell/get-cvhypervisor
schema: 2.0.0
---
...
### List (Default)
```
Get-CVHypervisor [<CommonParameters>]
```

### Get
```
Get-CVHypervisor -HypervisorId <Int64> [<CommonParameters>]
```

### GetViaIdentity
```
Get-CVHypervisor -InputObject <ICommvaultPowerShellIdentity> [<CommonParameters>]
```
