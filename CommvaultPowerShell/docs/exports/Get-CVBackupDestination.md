...
online version: https://docs.microsoft.com/en-us/powershell/module/commvaultpowershell/get-cvbackupdestination
schema: 2.0.0
---

# Get-CVBackupDestination
...
### Get (Default)
```
Get-CVBackupDestination -PlanId <Int64> [-PassThru] [<CommonParameters>]
```

### GetViaIdentity
```
Get-CVBackupDestination -InputObject <ICommvaultPowerShellIdentity> [-PassThru] [<CommonParameters>]
```
