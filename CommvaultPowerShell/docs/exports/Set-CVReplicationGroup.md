...
online version: https://docs.microsoft.com/en-us/powershell/module/commvaultpowershell/set-cvreplicationgroup
schema: 2.0.0
---
...
```
Set-CVReplicationGroup -ReplicationGroupId <String> [-Enable] [-NewName <String>] [-PassThru] [-Confirm]
 [-WhatIf] [<CommonParameters>]
```

### UpdateViaIdentityExpanded
```
Set-CVReplicationGroup -InputObject <ICommvaultPowerShellIdentity> [-Enable] [-NewName <String>] [-PassThru]
