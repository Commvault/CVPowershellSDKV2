...
online version: https://docs.microsoft.com/en-us/powershell/module/commvaultpowershell/set-cvhyperscalestorage
schema: 2.0.0
---

# Set-CVHyperScaleStorage
...
```
Set-CVHyperScaleStorage -HyperScaleStorageId <Int64> [-EncryptionCipher <String>] [-EncryptionEncrypt]
 [-EncryptionKeyLength <Int64>] [-KeyManagementServerId <Int64>] [-KeyManagementServerName <String>]
 [-NewName <String>] [-Security <IUpdateSecurityAssoc[]>] [-Confirm] [-WhatIf] [<CommonParameters>]
```

### UpdateViaIdentityExpanded
```
Set-CVHyperScaleStorage -InputObject <ICommvaultPowerShellIdentity> [-EncryptionCipher <String>]
 [-EncryptionEncrypt] [-EncryptionKeyLength <Int64>] [-KeyManagementServerId <Int64>]
 [-KeyManagementServerName <String>] [-NewName <String>] [-Security <IUpdateSecurityAssoc[]>] [-Confirm]
