...
```
New-CVKubernetescluster -AccessNodes <IIdName[]> -Endpointurl <String> -Name <String> [-CredentialsId <Int64>]
 [-CredentialsName <String>] [-Password <String>] [-SecretKey <String>] [-ServiceName <String>]
