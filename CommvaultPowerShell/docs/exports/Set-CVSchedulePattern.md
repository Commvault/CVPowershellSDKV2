...
online version: https://docs.microsoft.com/en-us/powershell/module/commvaultpowershell/set-cvschedulepattern
schema: 2.0.0
---
...
```
Set-CVSchedulePattern -ScheduleId <String> -SchedulePolicyId <String> [-DailyFrequency <Int64>]
