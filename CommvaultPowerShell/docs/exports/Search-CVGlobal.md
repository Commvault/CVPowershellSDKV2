...
online version: https://docs.microsoft.com/en-us/powershell/module/commvaultpowershell/search-cvglobal
schema: 2.0.0
---
...
### Search (Default)
```
Search-CVGlobal -GlobalSearchEntity <String> -Func <String> [-AggregateOn <String>] [-Fq <String>]
 [-GroupBy <String>] [-PassThru] [<CommonParameters>]
```

### SearchViaIdentity
```
Search-CVGlobal -InputObject <ICommvaultPowerShellIdentity> -Func <String> [-AggregateOn <String>]
