...
online version: https://learn.microsoft.com/powershell/module/commvaultpowershell/set-cvlocalaccesspath
schema: 2.0.0
---

# Set-CVLocalAccessPath
...
```
Set-CVLocalAccessPath -AccessPathId <Int64> -BackupLocationId <Int64> -StoragePoolId <Int64>
 [-Access <String>] [-CredentialsName <String>] [-CredentialsPassword <String>] [-Enabled]
 [-MediaAgentId <Int64>] [-MediaAgentName <String>] [-Path <String>] [-SavedCredentialsId <Int64>]
 [-SavedCredentialsName <String>] [-PassThru] [-Confirm] [-WhatIf] [<CommonParameters>]
```

### UpdateViaIdentityExpanded
```
Set-CVLocalAccessPath -InputObject <ICommvaultPowerShellIdentity> [-Access <String>]
 [-CredentialsName <String>] [-CredentialsPassword <String>] [-Enabled] [-MediaAgentId <Int64>]
 [-MediaAgentName <String>] [-Path <String>] [-SavedCredentialsId <Int64>] [-SavedCredentialsName <String>]
