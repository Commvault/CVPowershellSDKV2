...
online version: https://learn.microsoft.com/powershell/module/commvaultpowershell/remove-cvsoftwarecacheserver
schema: 2.0.0
---
...
### Delete (Default)
```
Remove-CVSoftwareCacheServer -ClientId <Int64> [-Confirm] [-WhatIf] [<CommonParameters>]
```

### DeleteViaIdentity
```
Remove-CVSoftwareCacheServer -InputObject <ICommvaultPowerShellIdentity> [-Confirm] [-WhatIf]
 [<CommonParameters>]
```
