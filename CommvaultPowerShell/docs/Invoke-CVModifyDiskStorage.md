...
online version: https://docs.microsoft.com/en-us/powershell/module/commvaultpowershell/invoke-cvmodifydiskstorage
schema: 2.0.0
---

# Invoke-CVModifyDiskStorage
...
```
Invoke-CVModifyDiskStorage -StoragePoolId <Int64> [-DataEncryptionCipher <String>] [-DataEncryptionEncrypt]
 [-DataEncryptionKeyLength <Int64>] [-KeyProviderId <Int64>] [-KeyProviderName <String>] [-NewName <String>]
 [-Security <IUpdateSecurityAssoc[]>] [-PassThru] [-Confirm] [-WhatIf] [<CommonParameters>]
```

### Modify
```
Invoke-CVModifyDiskStorage -StoragePoolId <Int64> -Body <IUpdateDiskStorage> [-PassThru] [-Confirm] [-WhatIf]
 [<CommonParameters>]
```

### ModifyViaIdentity
```
Invoke-CVModifyDiskStorage -InputObject <ICommvaultPowerShellIdentity> -Body <IUpdateDiskStorage> [-PassThru]
 [-Confirm] [-WhatIf] [<CommonParameters>]
```

### ModifyViaIdentityExpanded
```
Invoke-CVModifyDiskStorage -InputObject <ICommvaultPowerShellIdentity> [-DataEncryptionCipher <String>]
 [-DataEncryptionEncrypt] [-DataEncryptionKeyLength <Int64>] [-KeyProviderId <Int64>]
