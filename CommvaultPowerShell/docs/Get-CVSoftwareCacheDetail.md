...
online version: https://learn.microsoft.com/powershell/module/commvaultpowershell/get-cvsoftwarecachedetail
schema: 2.0.0
---
...
### Get (Default)
```
Get-CVSoftwareCacheDetail -ClientId <Int64> [<CommonParameters>]
```

### GetViaIdentity
```
Get-CVSoftwareCacheDetail -InputObject <ICommvaultPowerShellIdentity> [<CommonParameters>]
```
