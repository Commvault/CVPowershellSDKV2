...
online version: https://docs.microsoft.com/en-us/powershell/module/commvaultpowershell/set-triggeredalertnote
schema: 2.0.0
---

# Set-TriggeredAlertNote
...
```
Set-TriggeredAlertNote -Id <Int64> [-Notes <String>] [-PassThru] [-Confirm] [-WhatIf] [<CommonParameters>]
```

### UpdateViaIdentityExpanded
```
Set-TriggeredAlertNote -InputObject <ICommvaultPowerShellIdentity> [-Notes <String>] [-PassThru] [-Confirm]
