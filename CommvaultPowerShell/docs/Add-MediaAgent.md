...
### Add
```
Add-MediaAgent -BackupLocationId <Int64> -StoragePoolId <Int64> -Body <IAddDiskAccessPath> [-PassThru]
 [-Confirm] [-WhatIf] [<CommonParameters>]
```

### AddExpanded
```
Add-MediaAgent -BackupLocationId <Int64> -StoragePoolId <Int64> -MediaAgents <IIdName[]> [-PassThru]
 [-Confirm] [-WhatIf] [<CommonParameters>]
```
