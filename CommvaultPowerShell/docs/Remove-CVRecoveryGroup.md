...
online version: https://learn.microsoft.com/powershell/module/commvaultpowershell/remove-cvrecoverygroup
schema: 2.0.0
---

# Remove-CVRecoveryGroup
...
### Delete (Default)
```
Remove-CVRecoveryGroup -RecoveryGroupId <Int64> [-Confirm] [-WhatIf] [<CommonParameters>]
```

### DeleteViaIdentity
```
Remove-CVRecoveryGroup -InputObject <ICommvaultPowerShellIdentity> [-Confirm] [-WhatIf] [<CommonParameters>]
```
