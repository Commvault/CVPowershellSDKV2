...
online version: https://learn.microsoft.com/powershell/module/commvaultpowershell/new-cvbackupdestinationwithoutplaninfo
schema: 2.0.0
---
...
```
New-CVBackupDestinationWithoutPlanInfo [-BackupDestinations <ICreateBackupDestination[]>] [-PassThru]
