...
online version: https://learn.microsoft.com/powershell/module/commvaultpowershell/new-cvcloudstoragemetadatacache
schema: 2.0.0
---
...
```
New-CVCloudStorageMetaDataCache -CloudStorageId <Int64> [-CredentialsName <String>]
 [-CredentialsPassword <String>] [-MediaAgentId <Int64>] [-MediaAgentName <String>] [-Path <String>]
 [-SavedCredentialsId <Int64>] [-SavedCredentialsName <String>] [-Confirm] [-WhatIf] [<CommonParameters>]
```

### CreateViaIdentityExpanded
```
New-CVCloudStorageMetaDataCache -InputObject <ICommvaultPowerShellIdentity> [-CredentialsName <String>]
 [-CredentialsPassword <String>] [-MediaAgentId <Int64>] [-MediaAgentName <String>] [-Path <String>]
 [-SavedCredentialsId <Int64>] [-SavedCredentialsName <String>] [-Confirm] [-WhatIf] [<CommonParameters>]
```
