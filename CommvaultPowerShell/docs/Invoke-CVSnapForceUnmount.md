...
online version: https://learn.microsoft.com/powershell/module/commvaultpowershell/invoke-cvsnapforceunmount
schema: 2.0.0
---

# Invoke-CVSnapForceUnmount
...
```
Invoke-CVSnapForceUnmount -ArrayId <Int64> [-Volumes <ISnapVolumes[]>] [-PassThru] [-Confirm] [-WhatIf]
 [<CommonParameters>]
```

### Snap
```
Invoke-CVSnapForceUnmount -ArrayId <Int64> -Body <ISnapForceReq> [-PassThru] [-Confirm] [-WhatIf]
 [<CommonParameters>]
```

### SnapViaIdentity
```
Invoke-CVSnapForceUnmount -InputObject <ICommvaultPowerShellIdentity> -Body <ISnapForceReq> [-PassThru]
 [-Confirm] [-WhatIf] [<CommonParameters>]
```

### SnapViaIdentityExpanded
```
Invoke-CVSnapForceUnmount -InputObject <ICommvaultPowerShellIdentity> [-Volumes <ISnapVolumes[]>] [-PassThru]
 [-Confirm] [-WhatIf] [<CommonParameters>]
```
...
```yaml
Type: Commvault.Powershell.Models.ISnapForceReq
