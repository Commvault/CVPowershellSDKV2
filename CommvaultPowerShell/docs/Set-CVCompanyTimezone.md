...
online version: https://docs.microsoft.com/en-us/powershell/module/commvaultpowershell/set-cvcompanytimezone
schema: 2.0.0
---

# Set-CVCompanyTimezone
...
```
Set-CVCompanyTimezone -CompanyId <Int64> [-Clients <IIdName[]>] [-UpdateAll] [-Confirm] [-WhatIf]
 [<CommonParameters>]
```

### UpdateViaIdentityExpanded
```
Set-CVCompanyTimezone -InputObject <ICommvaultPowerShellIdentity> [-Clients <IIdName[]>] [-UpdateAll]
