...
online version: https://learn.microsoft.com/powershell/module/commvaultpowershell/get-cvrecoverytarget
schema: 2.0.0
---

# Get-CVRecoveryTarget
...
### Get (Default)
```
Get-CVRecoveryTarget [<CommonParameters>]
```

### Get1
```
Get-CVRecoveryTarget -RecoveryTargetId <Int64> [-PassThru] [<CommonParameters>]
```

### GetViaIdentity
```
Get-CVRecoveryTarget -InputObject <ICommvaultPowerShellIdentity> [-PassThru] [<CommonParameters>]
```
