...
online version: https://learn.microsoft.com/powershell/module/commvaultpowershell/set-cvcompanylaptopadmin
schema: 2.0.0
---

# Set-CVCompanyLaptopAdmin
...
```
Set-CVCompanyLaptopAdmin -CompanyId <Int64> [-LaptopAdmins <IIdNameType[]>] [-OperationType <String>]
 [-Confirm] [-WhatIf] [<CommonParameters>]
```

### UpdateViaIdentityExpanded
```
Set-CVCompanyLaptopAdmin -InputObject <ICommvaultPowerShellIdentity> [-LaptopAdmins <IIdNameType[]>]
...
### Commvault.Powershell.Models.IUpdateLaptopAdminsResp
