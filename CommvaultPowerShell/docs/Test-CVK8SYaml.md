...
online version: https://learn.microsoft.com/powershell/module/commvaultpowershell/test-cvk8syaml
schema: 2.0.0
---
...
```
Test-CVK8SYaml -ClusterId <Int64> [-ResourceYaml <String>] [-RestoreModifierListYaml <String>] [-Confirm]
 [-WhatIf] [<CommonParameters>]
```

### Test
```
Test-CVK8SYaml -ClusterId <Int64> -Body <ITestK8SModifierReq> [-Confirm] [-WhatIf] [<CommonParameters>]
```

### TestViaIdentity
```
Test-CVK8SYaml -InputObject <ICommvaultPowerShellIdentity> -Body <ITestK8SModifierReq> [-Confirm] [-WhatIf]
 [<CommonParameters>]
```

### TestViaIdentityExpanded
```
Test-CVK8SYaml -InputObject <ICommvaultPowerShellIdentity> [-ResourceYaml <String>]
 [-RestoreModifierListYaml <String>] [-Confirm] [-WhatIf] [<CommonParameters>]
```
...
```yaml
Type: Commvault.Powershell.Models.ITestK8SModifierReq
