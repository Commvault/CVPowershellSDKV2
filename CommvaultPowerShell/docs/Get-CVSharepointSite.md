...
online version: https://learn.microsoft.com/powershell/module/commvaultpowershell/get-cvsharepointsite
schema: 2.0.0
---

# Get-CVSharepointSite
...
### Get (Default)
```
Get-CVSharepointSite -AppId <Int64> [-PageNumber <Int64>] [-PageSize <Int64>] [-PropertyLevel <String>]
 [-SearchKey <String>] [-Sort <String>] [<CommonParameters>]
```

### GetViaIdentity
```
Get-CVSharepointSite -InputObject <ICommvaultPowerShellIdentity> [-PageNumber <Int64>] [-PageSize <Int64>]
...
### Commvault.Powershell.Models.IOffice365SitesResp
