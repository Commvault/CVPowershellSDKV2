...
online version: https://learn.microsoft.com/powershell/module/commvaultpowershell/add-cvmediaagent
schema: 2.0.0
---
...
`BODY <IAddDiskAccessPath>`: Used to add a new access path to a backup location
  - `MediaAgents <List<IIdName>>`: Can add a list of media agents to be added as the disk access path.
    - `[Id <Int64?>]`: 
    - `[Name <String>]`: 
