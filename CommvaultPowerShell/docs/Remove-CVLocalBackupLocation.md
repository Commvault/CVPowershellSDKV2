...
online version: https://learn.microsoft.com/powershell/module/commvaultpowershell/remove-cvlocalbackuplocation
schema: 2.0.0
---
...
### Delete (Default)
```
Remove-CVLocalBackupLocation -BackupLocationId <Int64> -StoragePoolId <Int64> [-ForceDelete] [-PassThru]
 [-Confirm] [-WhatIf] [<CommonParameters>]
```

### DeleteViaIdentity
```
Remove-CVLocalBackupLocation -InputObject <ICommvaultPowerShellIdentity> [-ForceDelete] [-PassThru] [-Confirm]
