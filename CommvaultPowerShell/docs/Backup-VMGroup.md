...
online version: https://docs.microsoft.com/en-us/powershell/module/commvaultpowershell/backup-vmgroup
schema: 2.0.0
---
...
### Backup (Default)
```
Backup-VMGroup -VMGroupId <Int64> [-BackupLevel <String>] [-Confirm] [-WhatIf] [<CommonParameters>]
```

### BackupViaIdentity
```
Backup-VMGroup -InputObject <ICommvaultPowerShellIdentity> [-BackupLevel <String>] [-Confirm] [-WhatIf]
 [<CommonParameters>]
```
