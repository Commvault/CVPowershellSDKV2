...
online version: https://docs.microsoft.com/en-us/powershell/module/commvaultpowershell/invoke-cvmodifydiskaccesspath
schema: 2.0.0
---

# Invoke-CVModifyDiskAccessPath
...
```
Invoke-CVModifyDiskAccessPath -AccessPathId <Int64> -BackupLocationId <Int64> -StoragePoolId <Int64>
 [-Access <String>] [-Enabled] [-PassThru] [-Confirm] [-WhatIf] [<CommonParameters>]
```

### Modify
```
Invoke-CVModifyDiskAccessPath -AccessPathId <Int64> -BackupLocationId <Int64> -StoragePoolId <Int64>
 -Body <IUpdateDiskAccessPath> [-PassThru] [-Confirm] [-WhatIf] [<CommonParameters>]
```

### ModifyViaIdentity
```
Invoke-CVModifyDiskAccessPath -InputObject <ICommvaultPowerShellIdentity> -Body <IUpdateDiskAccessPath>
 [-PassThru] [-Confirm] [-WhatIf] [<CommonParameters>]
```

### ModifyViaIdentityExpanded
```
Invoke-CVModifyDiskAccessPath -InputObject <ICommvaultPowerShellIdentity> [-Access <String>] [-Enabled]
 [-PassThru] [-Confirm] [-WhatIf] [<CommonParameters>]
```
...
```yaml
Type: Commvault.Powershell.Models.IUpdateDiskAccessPath
