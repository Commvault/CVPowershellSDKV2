...
online version: https://docs.microsoft.com/en-us/powershell/module/commvaultpowershell/get-hypervisor
schema: 2.0.0
---
...
### List (Default)
```
Get-Hypervisor [<CommonParameters>]
```

### Get
```
Get-Hypervisor -HypervisorId <Int64> [<CommonParameters>]
```

### GetViaIdentity
```
Get-Hypervisor -InputObject <ICommvaultPowerShellIdentity> [<CommonParameters>]
```
