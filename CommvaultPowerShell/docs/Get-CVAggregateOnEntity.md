...
online version: https://docs.microsoft.com/en-us/powershell/module/commvaultpowershell/get-cvaggregateonentity
schema: 2.0.0
---

# Get-CVAggregateOnEntity
...
### Get (Default)
```
Get-CVAggregateOnEntity -GlobalSearchEntity <String> -Func <String> [-AggregateOn <String>] [-Fq <String>]
 [-GroupBy <String>] [-PassThru] [<CommonParameters>]
```

### GetViaIdentity
```
Get-CVAggregateOnEntity -InputObject <ICommvaultPowerShellIdentity> -Func <String> [-AggregateOn <String>]
