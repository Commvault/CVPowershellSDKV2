...
online version: https://docs.microsoft.com/en-us/powershell/module/commvaultpowershell/set-role
schema: 2.0.0
---
...
```
Set-Role -RoleId <Int64> [-Enabled] [-NewName <String>] [-PermissionList <IPermissions[]>]
 [-Security <IUpdateSecurityAssoc[]>] [-VisibleToAll] [-PassThru] [-Confirm] [-WhatIf] [<CommonParameters>]
```

### UpdateViaIdentityExpanded
```
Set-Role -InputObject <ICommvaultPowerShellIdentity> [-Enabled] [-NewName <String>]
