...
online version: https://docs.microsoft.com/en-us/powershell/module/commvaultpowershell/invoke-cvsnapmount
schema: 2.0.0
---
...
```
Invoke-CVSnapMount -ArrayId <Int64> [-DestinationClientId <Int64>] [-DestinationClientPath <String>]
 [-ProtectSnap <Int64>] [-ScsiServerId <Int64>] [-ScsiServerName <String>] [-Volumes <IVolumeSnap[]>]
...
```
Invoke-CVSnapMount -InputObject <ICommvaultPowerShellIdentity> [-DestinationClientId <Int64>]
 [-DestinationClientPath <String>] [-ProtectSnap <Int64>] [-ScsiServerId <Int64>] [-ScsiServerName <String>]
 [-Volumes <IVolumeSnap[]>] [-PassThru] [-Confirm] [-WhatIf] [<CommonParameters>]
```
