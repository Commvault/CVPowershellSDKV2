...
online version: https://learn.microsoft.com/powershell/module/commvaultpowershell/remove-cvdrbackupdestination
schema: 2.0.0
---

# Remove-CVDrBackupDestination
...
### Delete (Default)
```
Remove-CVDrBackupDestination -BackupDestinationId <Int64> [-Confirm] [-WhatIf] [<CommonParameters>]
```

### DeleteViaIdentity
```
Remove-CVDrBackupDestination -InputObject <ICommvaultPowerShellIdentity> [-Confirm] [-WhatIf]
 [<CommonParameters>]
```
