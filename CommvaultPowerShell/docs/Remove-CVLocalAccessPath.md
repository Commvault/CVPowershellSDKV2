...
online version: https://learn.microsoft.com/powershell/module/commvaultpowershell/remove-cvlocalaccesspath
schema: 2.0.0
---
...
### Delete (Default)
```
Remove-CVLocalAccessPath -AccessPathId <Int64> -BackupLocationId <Int64> -StoragePoolId <Int64> [-PassThru]
 [-Confirm] [-WhatIf] [<CommonParameters>]
```

### DeleteViaIdentity
```
Remove-CVLocalAccessPath -InputObject <ICommvaultPowerShellIdentity> [-PassThru] [-Confirm] [-WhatIf]
 [<CommonParameters>]
```
