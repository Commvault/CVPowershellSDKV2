...
online version: https://learn.microsoft.com/powershell/module/commvaultpowershell/get-cvlocalstoragedetail
schema: 2.0.0
---
...
### Get (Default)
```
Get-CVLocalStorageDetail -StoragePoolId <Int64> [-ShowInheritedAssociation] [-PassThru] [<CommonParameters>]
```

### GetViaIdentity
```
Get-CVLocalStorageDetail -InputObject <ICommvaultPowerShellIdentity> [-ShowInheritedAssociation] [-PassThru]
 [<CommonParameters>]
```
