...
online version: https://learn.microsoft.com/powershell/module/commvaultpowershell/get-cvidentityserverassetjobhistory
schema: 2.0.0
---

# Get-CVIdentityServerAssetJobHistory
...
### Get (Default)
```
Get-CVIdentityServerAssetJobHistory -AssetId <String> -InventoryId <Int64> [<CommonParameters>]
```

### GetViaIdentity
```
Get-CVIdentityServerAssetJobHistory -InputObject <ICommvaultPowerShellIdentity> [<CommonParameters>]
```
...
### Commvault.Powershell.Models.IDatasourceJobHistory
