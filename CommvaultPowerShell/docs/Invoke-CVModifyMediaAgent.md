...
online version: https://docs.microsoft.com/en-us/powershell/module/commvaultpowershell/invoke-cvmodifymediaagent
schema: 2.0.0
---

# Invoke-CVModifyMediaAgent
...
```
Invoke-CVModifyMediaAgent -MediaAgentId <Int64> [-ControlEnabled] [-ControlMaintenanceMode]
 [-ControlOptimizeForConcurrentLanBackups] [-ControlParallelDataTransferOperations <Int64>]
 [-ControlRansomwareProtection] [-Description <String>] [-IndexCachePath <String>] [-LogCacheEnabled]
 [-LogCachePath <String>] [-RoleId <Int64>] [-RoleName <String>] [-UserGroupId <Int64>]
 [-UserGroupName <String>] [-UserId <Int64>] [-UserName <String>] [-PassThru] [-Confirm] [-WhatIf]
 [<CommonParameters>]
```

### Modify
```
Invoke-CVModifyMediaAgent -MediaAgentId <Int64> -Body <IUpdateMediaAgent> [-PassThru] [-Confirm] [-WhatIf]
 [<CommonParameters>]
```

### ModifyViaIdentity
```
Invoke-CVModifyMediaAgent -InputObject <ICommvaultPowerShellIdentity> -Body <IUpdateMediaAgent> [-PassThru]
 [-Confirm] [-WhatIf] [<CommonParameters>]
```

### ModifyViaIdentityExpanded
```
Invoke-CVModifyMediaAgent -InputObject <ICommvaultPowerShellIdentity> [-ControlEnabled]
 [-ControlMaintenanceMode] [-ControlOptimizeForConcurrentLanBackups]
 [-ControlParallelDataTransferOperations <Int64>] [-ControlRansomwareProtection] [-Description <String>]
 [-IndexCachePath <String>] [-LogCacheEnabled] [-LogCachePath <String>] [-RoleId <Int64>] [-RoleName <String>]
