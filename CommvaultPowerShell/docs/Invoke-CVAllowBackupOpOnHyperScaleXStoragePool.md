...
online version: https://learn.microsoft.com/powershell/module/commvaultpowershell/invoke-cvallowbackupoponhyperscalexstoragepool
schema: 2.0.0
---

# Invoke-CVAllowBackupOpOnHyperScaleXStoragePool
...
### Allow (Default)
```
Invoke-CVAllowBackupOpOnHyperScaleXStoragePool -StoragePoolId <Int64> [-Confirm] [-WhatIf]
 [<CommonParameters>]
```

### AllowViaIdentity
```
Invoke-CVAllowBackupOpOnHyperScaleXStoragePool -InputObject <ICommvaultPowerShellIdentity> [-Confirm]
...
### -StoragePoolId
Id of the HyperScale X storage pool
