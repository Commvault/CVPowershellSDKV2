...
online version: https://learn.microsoft.com/powershell/module/commvaultpowershell/enable-cvairgaponstoragepool
schema: 2.0.0
---

# Enable-CVAirgapOnStoragePool
...
### Enable (Default)
```
Enable-CVAirgapOnStoragePool -StoragePoolId <Int64> [-Confirm] [-WhatIf] [<CommonParameters>]
```

### EnableViaIdentity
```
Enable-CVAirgapOnStoragePool -InputObject <ICommvaultPowerShellIdentity> [-Confirm] [-WhatIf]
 [<CommonParameters>]
```
