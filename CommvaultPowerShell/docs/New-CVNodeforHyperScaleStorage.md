...
online version: https://docs.microsoft.com/en-us/powershell/module/commvaultpowershell/new-cvnodeforhyperscalestorage
schema: 2.0.0
---

# New-CVNodeforHyperScaleStorage
...
```
New-CVNodeforHyperScaleStorage -HyperScaleStorageId <Int64> [-Nodes <IIdName[]>] [-PassThru] [-Confirm]
 [-WhatIf] [<CommonParameters>]
```

### CreateViaIdentityExpanded
```
New-CVNodeforHyperScaleStorage -InputObject <ICommvaultPowerShellIdentity> [-Nodes <IIdName[]>] [-PassThru]
