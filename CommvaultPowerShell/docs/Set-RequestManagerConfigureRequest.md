...
online version: https://docs.microsoft.com/en-us/powershell/module/commvaultpowershell/set-requestmanagerconfigurerequest
schema: 2.0.0
---

# Set-RequestManagerConfigureRequest
...
```
Set-RequestManagerConfigureRequest -RequestId <Int64> -ProjectIds <Int64[]> -Reviewers <IIdNameDisplayName[]>
 [-Approvers <IIdNameDisplayName[]>] [-Confirm] [-WhatIf] [<CommonParameters>]
```

### UpdateViaIdentityExpanded
```
Set-RequestManagerConfigureRequest -InputObject <ICommvaultPowerShellIdentity> -ProjectIds <Int64[]>
 -Reviewers <IIdNameDisplayName[]> [-Approvers <IIdNameDisplayName[]>] [-Confirm] [-WhatIf]
 [<CommonParameters>]
```
