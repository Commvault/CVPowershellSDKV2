...
online version: https://learn.microsoft.com/powershell/module/commvaultpowershell/new-cvsamlapp
schema: 2.0.0
---
...
```
New-CVSamlApp [-AssociationCompanies <IIdName[]>] [-AssociationDomains <IIdName[]>]
 [-AssociationEmailSuffixes <String[]>] [-AssociationUserGroups <IIdName[]>] [-Description <String>]
 ...
 [-IdentityProviderMetaDataSecondaryCertificateData <String>] [-Name <String>]
