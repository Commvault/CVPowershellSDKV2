...
online version: https://learn.microsoft.com/powershell/module/commvaultpowershell/invoke-cvbrowsenamespaceapplication
schema: 2.0.0
---

# Invoke-CVBrowseNamespaceApplication
...
### Browse (Default)
```
Invoke-CVBrowseNamespaceApplication -ClusterId <Int64> -NameSpace <String> [<CommonParameters>]
```

### BrowseViaIdentity
```
Invoke-CVBrowseNamespaceApplication -InputObject <ICommvaultPowerShellIdentity> [<CommonParameters>]
```
...
Parameter Sets: BrowseViaIdentity
Aliases:
...
### Commvault.Powershell.Models.IKubernetesBrowseClusterResp
