...
online version: https://learn.microsoft.com/powershell/module/commvaultpowershell/get-cvproject
schema: 2.0.0
---
...
### Get (Default)
```
Get-CVProject -RequestId <Int64> [<CommonParameters>]
```

### GetViaIdentity
```
Get-CVProject -InputObject <ICommvaultPowerShellIdentity> [<CommonParameters>]
```
