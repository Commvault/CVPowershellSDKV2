...
online version: https://learn.microsoft.com/powershell/module/commvaultpowershell/add-cvlocalaccesspath
schema: 2.0.0
---
...
### AddExpanded (Default)
```
Add-CVLocalAccessPath -BackupLocationId <Int64> -StoragePoolId <Int64> [-MediaAgents <IIdName[]>] [-PassThru]
 [-Confirm] [-WhatIf] [<CommonParameters>]
```

### Add
```
Add-CVLocalAccessPath -BackupLocationId <Int64> -StoragePoolId <Int64> -Body <IAddLocalAccessPath> [-PassThru]
 [-Confirm] [-WhatIf] [<CommonParameters>]
```

### AddViaIdentity
```
Add-CVLocalAccessPath -InputObject <ICommvaultPowerShellIdentity> -Body <IAddLocalAccessPath> [-PassThru]
 [-Confirm] [-WhatIf] [<CommonParameters>]
```

### AddViaIdentityExpanded
```
Add-CVLocalAccessPath -InputObject <ICommvaultPowerShellIdentity> [-MediaAgents <IIdName[]>] [-PassThru]
 [-Confirm] [-WhatIf] [<CommonParameters>]
```
...
```yaml
Type: Commvault.Powershell.Models.IAddLocalAccessPath
...
`BODY <IAddLocalAccessPath>`: Used to add a new access path to a backup location
  - `MediaAgents <List<IIdName>>`: Can add a list of media agents to be added as the local storage access path.
    - `[Id <Int64?>]`: 
    - `[Name <String>]`: 
