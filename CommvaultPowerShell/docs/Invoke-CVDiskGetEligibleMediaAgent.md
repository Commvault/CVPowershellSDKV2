...
online version: https://learn.microsoft.com/powershell/module/commvaultpowershell/invoke-cvdiskgeteligiblemediaagent
schema: 2.0.0
---

# Invoke-CVDiskGetEligibleMediaAgent
...
### Disk (Default)
```
Invoke-CVDiskGetEligibleMediaAgent -BackupLocationId <Int64> -StoragePoolId <Int64> [-PassThru]
 [<CommonParameters>]
```

### DiskViaIdentity
```
Invoke-CVDiskGetEligibleMediaAgent -InputObject <ICommvaultPowerShellIdentity> [-PassThru]
 [<CommonParameters>]
```
...
Parameter Sets: DiskViaIdentity
Aliases:
...
### Commvault.Powershell.Models.IMediaAgentList
