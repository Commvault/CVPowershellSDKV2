...
online version: https://docs.microsoft.com/en-us/powershell/module/commvaultpowershell/set-usergroup
schema: 2.0.0
---
...
```
Set-UserGroup -UserGroupId <Int64> [-AllowMultipleCompanyMembers] [-AssociatedExternalGroups <IIdName[]>]
 [-AssociatedLocalGroups <IIdName[]>] [-ConsoleType <String[]>] [-ConsoleTypeOperationType <String>]
 [-Enabled] [-EnableTwoFactorAuthentication <String>] [-EnforceFsQuota]
 ...
 [-NewName <String>] [-PlanOperationType <String>] [-QuotaLimitInGb <Int64>] [-UserOperationType <String>]
 [-Users <IIdName[]>] [-PassThru] [-Confirm] [-WhatIf] [<CommonParameters>]
```

### UpdateViaIdentityExpanded
```
Set-UserGroup -InputObject <ICommvaultPowerShellIdentity> [-AllowMultipleCompanyMembers]
