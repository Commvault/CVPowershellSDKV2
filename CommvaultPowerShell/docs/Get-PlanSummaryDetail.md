...
online version: https://docs.microsoft.com/en-us/powershell/module/commvaultpowershell/get-plansummarydetail
schema: 2.0.0
---

# Get-PlanSummaryDetail
...
### Get (Default)
```
Get-PlanSummaryDetail -PlanId <Int64> [<CommonParameters>]
```

### GetViaIdentity
```
Get-PlanSummaryDetail -InputObject <ICommvaultPowerShellIdentity> [<CommonParameters>]
```
