...
online version: https://docs.microsoft.com/en-us/powershell/module/commvaultpowershell/new-firewalltopology
schema: 2.0.0
---

# New-FirewallTopology
...
```
New-FirewallTopology [-ClientType <String>] [-EncryptTraffic] [-FirewallGroups <IFirewallTopologyGroups[]>]
