...
online version: https://learn.microsoft.com/powershell/module/commvaultpowershell/get-cvsharepointcontent
schema: 2.0.0
---

# Get-CVSharepointContent
...
### Get (Default)
```
Get-CVSharepointContent -AppId <Int64> [-PageNumber <Int64>] [-PageSize <Int64>] [-SearchKey <String>]
 [-Sort <String>] [<CommonParameters>]
```

### GetViaIdentity
```
Get-CVSharepointContent -InputObject <ICommvaultPowerShellIdentity> [-PageNumber <Int64>] [-PageSize <Int64>]
...
### Commvault.Powershell.Models.IOffice365SharepointContentResp
