...
online version: https://learn.microsoft.com/powershell/module/commvaultpowershell/disable-cvalertcustomrule
schema: 2.0.0
---

# Disable-CVAlertCustomRule
...
### Disable (Default)
```
Disable-CVAlertCustomRule -AlertRuleId <Int64> [-PassThru] [-Confirm] [-WhatIf] [<CommonParameters>]
```

### DisableViaIdentity
```
Disable-CVAlertCustomRule -InputObject <ICommvaultPowerShellIdentity> [-PassThru] [-Confirm] [-WhatIf]
 [<CommonParameters>]
```
...
### Commvault.Powershell.Models.IAlertRuleGenericResp
