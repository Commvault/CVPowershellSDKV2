...
online version: https://learn.microsoft.com/powershell/module/commvaultpowershell/remove-cvlocalstorage
schema: 2.0.0
---
...
### Delete (Default)
```
Remove-CVLocalStorage -StoragePoolId <Int64> [-PassThru] [-Confirm] [-WhatIf] [<CommonParameters>]
```

### DeleteViaIdentity
```
Remove-CVLocalStorage -InputObject <ICommvaultPowerShellIdentity> [-PassThru] [-Confirm] [-WhatIf]
 [<CommonParameters>]
```
