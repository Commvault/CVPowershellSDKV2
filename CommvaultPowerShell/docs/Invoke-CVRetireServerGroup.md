...
online version: https://learn.microsoft.com/powershell/module/commvaultpowershell/invoke-cvretireservergroup
schema: 2.0.0
---
...
### Retire (Default)
```
Invoke-CVRetireServerGroup -ServerGroupId <Int64> [-PassThru] [-Confirm] [-WhatIf] [<CommonParameters>]
```

### RetireViaIdentity
```
Invoke-CVRetireServerGroup -InputObject <ICommvaultPowerShellIdentity> [-PassThru] [-Confirm] [-WhatIf]
 [<CommonParameters>]
```
