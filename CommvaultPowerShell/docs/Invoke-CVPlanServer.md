...
online version: https://learn.microsoft.com/powershell/module/commvaultpowershell/invoke-cvplanserver
schema: 2.0.0
---
...
### Plan (Default)
```
Invoke-CVPlanServer -PlanId <Int64> [-PassThru] [-Confirm] [-WhatIf] [<CommonParameters>]
```

### PlanViaIdentity
```
Invoke-CVPlanServer -InputObject <ICommvaultPowerShellIdentity> [-PassThru] [-Confirm] [-WhatIf]
 [<CommonParameters>]
```
...
Parameter Sets: PlanViaIdentity
Aliases:
