...
online version: https://learn.microsoft.com/powershell/module/commvaultpowershell/join-cvma
schema: 2.0.0
---
...
### Associate (Default)
```
Join-CVMa -StoragePoolId <Int64> -Action <String> -MediaAgentId <Int64> [-Confirm] [-WhatIf]
 [<CommonParameters>]
```

### AssociateViaIdentity
```
Join-CVMa -InputObject <ICommvaultPowerShellIdentity> -Action <String> -MediaAgentId <Int64> [-Confirm]
