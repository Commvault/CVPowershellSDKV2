...
online version: https://learn.microsoft.com/powershell/module/commvaultpowershell/remove-cvcvfs3bucket
schema: 2.0.0
---
...
### Delete (Default)
```
Remove-CVCvfS3Bucket -Id <Int64> [-Confirm] [-WhatIf] [<CommonParameters>]
```

### DeleteViaIdentity
```
Remove-CVCvfS3Bucket -InputObject <ICommvaultPowerShellIdentity> [-Confirm] [-WhatIf] [<CommonParameters>]
```
