...
online version: https://learn.microsoft.com/powershell/module/commvaultpowershell/get-cvdcplan
schema: 2.0.0
---
...
### Get (Default)
```
Get-CVDcPlan -PlanId <Int64> [-PassThru] [<CommonParameters>]
```

### GetViaIdentity
```
Get-CVDcPlan -InputObject <ICommvaultPowerShellIdentity> [-PassThru] [<CommonParameters>]
```
