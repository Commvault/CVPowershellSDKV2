...
online version: https://learn.microsoft.com/powershell/module/commvaultpowershell/add-cvexchangecontent
schema: 2.0.0
---
...
### AddExpanded (Default)
```
Add-CVExchangeContent -AppId <Int64> [-Office365PlanId <Int64>] [-Office365PlanName <String>] [-Type <String>]
...
```
Add-CVExchangeContent -InputObject <ICommvaultPowerShellIdentity> [-Office365PlanId <Int64>]
