...
```
Set-Region -RegionId <Int64> [-LocationCity <String>] [-LocationContinent <String>]
...
### Set
```
Set-Region -EntityId <Int64> -EntityType <Int64> -Body <IEntityRegionInfo> [-Confirm] [-WhatIf]
 [<CommonParameters>]
```

### SetExpanded
```
Set-Region -EntityId <Int64> -EntityType <Int64> [-RegionId <Int64>] [-EntityRegionType <String>]
...
```
Set-Region -InputObject <ICommvaultPowerShellIdentity> [-RegionId <Int64>] [-EntityRegionType <String>]
 [-RegionName <String>] [-Confirm] [-WhatIf] [<CommonParameters>]
```
