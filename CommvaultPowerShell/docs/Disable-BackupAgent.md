...
### Disable (Default)
```
Disable-BackupAgent -AgentId <Int64> -ServerId <Int64> [-EnableAfterADelay <Int64>] [-PassThru] [-Confirm]
 [-WhatIf] [<CommonParameters>]
```

### DisableViaIdentity
```
Disable-BackupAgent -InputObject <ICommvaultPowerShellIdentity> [-EnableAfterADelay <Int64>] [-PassThru]
