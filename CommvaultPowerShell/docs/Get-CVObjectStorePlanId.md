...
online version: https://learn.microsoft.com/powershell/module/commvaultpowershell/get-cvobjectstoreplanid
schema: 2.0.0
---
...
### Get (Default)
```
Get-CVObjectStorePlanId -PlanId <Int64> [-PassThru] [<CommonParameters>]
```

### GetViaIdentity
```
Get-CVObjectStorePlanId -InputObject <ICommvaultPowerShellIdentity> [-PassThru] [<CommonParameters>]
```
