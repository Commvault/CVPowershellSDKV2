...
online version: https://learn.microsoft.com/powershell/module/commvaultpowershell/get-cvsubclient
schema: 2.0.0
---
...
### Get
```
Get-CVSubclient [<CommonParameters>]
```

### Get1
```
Get-CVSubclient -PlanId <Int64> -SnapEngineId <Int64> [-CopyId <Int64>] [<CommonParameters>]
```

### GetViaIdentity
```
Get-CVSubclient -InputObject <ICommvaultPowerShellIdentity> [-CopyId <Int64>] [<CommonParameters>]
```
...
Parameter Sets: ByClientName, ByClientObject
Aliases:
...
### Commvault.Powershell.Models.IGetSubclientForSnapEngine
