...
online version: https://learn.microsoft.com/powershell/module/commvaultpowershell/invoke-cvsnapunmount
schema: 2.0.0
---

# Invoke-CVSnapUnmount
...
```
Invoke-CVSnapUnmount -ArrayId <Int64> [-Volumes <IVolumeSnap[]>] [-PassThru] [-Confirm] [-WhatIf]
 [<CommonParameters>]
```

### Snap
```
Invoke-CVSnapUnmount -ArrayId <Int64> -Body <IUnmountSnapReq> [-PassThru] [-Confirm] [-WhatIf]
 [<CommonParameters>]
```

### SnapViaIdentity
```
Invoke-CVSnapUnmount -InputObject <ICommvaultPowerShellIdentity> -Body <IUnmountSnapReq> [-PassThru]
 [-Confirm] [-WhatIf] [<CommonParameters>]
```

### SnapViaIdentityExpanded
```
Invoke-CVSnapUnmount -InputObject <ICommvaultPowerShellIdentity> [-Volumes <IVolumeSnap[]>] [-PassThru]
 [-Confirm] [-WhatIf] [<CommonParameters>]
```
...
```yaml
Type: Commvault.Powershell.Models.IUnmountSnapReq
...
`BODY <IUnmountSnapReq>`: Request template for unmount request of snapshots
  - `[Volumes <List<IVolumeSnap>>]`: Volumes of the snap you want to unmount
