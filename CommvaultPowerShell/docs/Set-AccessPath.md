...
online version: https://docs.microsoft.com/en-us/powershell/module/commvaultpowershell/set-accesspath
schema: 2.0.0
---
...
```
Set-AccessPath -AccessPathId <Int64> -BucketId <Int64> -CloudStorageId <Int64> [-Confirm] [-WhatIf]
 [<CommonParameters>]
```

### UpdateViaIdentityExpanded
```
Set-AccessPath -InputObject <ICommvaultPowerShellIdentity> [-Confirm] [-WhatIf] [<CommonParameters>]
```
