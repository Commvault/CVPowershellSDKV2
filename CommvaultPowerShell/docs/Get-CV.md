...
online version: https://learn.microsoft.com/powershell/module/commvaultpowershell/get-cv
schema: 2.0.0
---
...
### Get (Default)
```
Get-CV -BackupLocationId <Int64> -StoragePoolId <Int64> [-PassThru] [<CommonParameters>]
```

### GetViaIdentity
```
Get-CV -InputObject <ICommvaultPowerShellIdentity> [-PassThru] [<CommonParameters>]
```
