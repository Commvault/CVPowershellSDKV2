...
online version: https://learn.microsoft.com/powershell/module/commvaultpowershell/get-cvteamlist
schema: 2.0.0
---
...
### Get (Default)
```
Get-CVTeamList -AppId <Int64> [-OnlyTeams <Int64>] [-OnlyUsers <Int64>] [-PageNumber <Int64>]
 [-PageSize <Int64>] [-PropertyLevel <String>] [-SearchKey <String>] [-Sort <String>] [<CommonParameters>]
```

### GetViaIdentity
```
Get-CVTeamList -InputObject <ICommvaultPowerShellIdentity> [-OnlyTeams <Int64>] [-OnlyUsers <Int64>]
 [-PageNumber <Int64>] [-PageSize <Int64>] [-PropertyLevel <String>] [-SearchKey <String>] [-Sort <String>]
 [<CommonParameters>]
```
...
### -PropertyLevel
Optional parameter.
Set it to BasicProperties or AllProperties
...
### Commvault.Powershell.Models.IOffice365TeamsResp
