...
online version: https://learn.microsoft.com/powershell/module/commvaultpowershell/get-cvlists3bucketclone
schema: 2.0.0
---
...
### Get (Default)
```
Get-CVListS3BucketClone -Id <Int64> [<CommonParameters>]
```

### GetViaIdentity
```
Get-CVListS3BucketClone -InputObject <ICommvaultPowerShellIdentity> [<CommonParameters>]
```
...
### Commvault.Powershell.Models.IListCvfss3BucketCloneResp
