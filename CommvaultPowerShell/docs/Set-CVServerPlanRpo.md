...
online version: https://learn.microsoft.com/powershell/module/commvaultpowershell/set-cvserverplanrpo
schema: 2.0.0
---
...
Set-CVServerPlanRpo -PlanId <Int64> [-BackupFrequencyOperationType <String>]
 [-BackupFrequencySchedules <IPlanSchedule[]>] [-Confirm] [-WhatIf] [<CommonParameters>]
```
