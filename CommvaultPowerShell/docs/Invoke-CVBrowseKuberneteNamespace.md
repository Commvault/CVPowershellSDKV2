...
online version: https://learn.microsoft.com/powershell/module/commvaultpowershell/invoke-cvbrowsekubernetenamespace
schema: 2.0.0
---

# Invoke-CVBrowseKuberneteNamespace
...
### Browse (Default)
```
Invoke-CVBrowseKuberneteNamespace -ClusterId <Int64> [<CommonParameters>]
```

### BrowseViaIdentity
```
Invoke-CVBrowseKuberneteNamespace -InputObject <ICommvaultPowerShellIdentity> [<CommonParameters>]
```
