...
online version: https://learn.microsoft.com/powershell/module/commvaultpowershell/get-cvalertcustomruledetail
schema: 2.0.0
---

# Get-CVAlertCustomRuleDetail
...
### Get (Default)
```
Get-CVAlertCustomRuleDetail -AlertRuleId <Int64> [-PassThru] [<CommonParameters>]
```

### GetViaIdentity
```
Get-CVAlertCustomRuleDetail -InputObject <ICommvaultPowerShellIdentity> [-PassThru] [<CommonParameters>]
```
