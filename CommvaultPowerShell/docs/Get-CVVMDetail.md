...
online version: https://learn.microsoft.com/powershell/module/commvaultpowershell/get-cvvmdetail
schema: 2.0.0
---
...
### Get (Default)
```
Get-CVVMDetail -VMUuid <String> [-ShowInheritedAssociation] [-PassThru] [<CommonParameters>]
```

### GetViaIdentity
```
Get-CVVMDetail -InputObject <ICommvaultPowerShellIdentity> [-ShowInheritedAssociation] [-PassThru]
 [<CommonParameters>]
```
