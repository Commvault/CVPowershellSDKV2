...
online version: https://learn.microsoft.com/powershell/module/commvaultpowershell/get-cvonedriveuser
schema: 2.0.0
---
...
### Get (Default)
```
Get-CVOnedriveUser -AppId <Int64> [-PageNumber <Int64>] [-PageSize <Int64>] [-PropertyLevel <String>]
 [-SearchKey <String>] [-Sort <String>] [<CommonParameters>]
```

### GetViaIdentity
```
Get-CVOnedriveUser -InputObject <ICommvaultPowerShellIdentity> [-PageNumber <Int64>] [-PageSize <Int64>]
...
### Commvault.Powershell.Models.IOffice365OnedriveUsersResp
