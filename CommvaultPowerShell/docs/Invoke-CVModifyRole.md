...
online version: https://docs.microsoft.com/en-us/powershell/module/commvaultpowershell/invoke-cvmodifyrole
schema: 2.0.0
---
...
```
Invoke-CVModifyRole -RoleId <Int64> [-Enabled] [-NewName <String>] [-PermissionList <IPermissions[]>]
 [-Security <IUpdateSecurityAssoc[]>] [-VisibleToAll] [-PassThru] [-Confirm] [-WhatIf] [<CommonParameters>]
```

### Modify
```
Invoke-CVModifyRole -RoleId <Int64> -Body <IUpdateRole> [-PassThru] [-Confirm] [-WhatIf] [<CommonParameters>]
```

### ModifyViaIdentity
```
Invoke-CVModifyRole -InputObject <ICommvaultPowerShellIdentity> -Body <IUpdateRole> [-PassThru] [-Confirm]
 [-WhatIf] [<CommonParameters>]
```

### ModifyViaIdentityExpanded
```
Invoke-CVModifyRole -InputObject <ICommvaultPowerShellIdentity> [-Enabled] [-NewName <String>]
