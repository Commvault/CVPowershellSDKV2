...
online version: https://learn.microsoft.com/powershell/module/commvaultpowershell/enable-cvalertcustomrule
schema: 2.0.0
---

# Enable-CVAlertCustomRule
...
### Enable (Default)
```
Enable-CVAlertCustomRule -AlertRuleId <Int64> [-PassThru] [-Confirm] [-WhatIf] [<CommonParameters>]
```

### EnableViaIdentity
```
Enable-CVAlertCustomRule -InputObject <ICommvaultPowerShellIdentity> [-PassThru] [-Confirm] [-WhatIf]
 [<CommonParameters>]
```
