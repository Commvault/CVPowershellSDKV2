...
online version: https://docs.microsoft.com/en-us/powershell/module/commvaultpowershell/set-diskstorage
schema: 2.0.0
---
...
```
Set-DiskStorage -StoragePoolId <Int64> [-DataEncryptionCipher <String>] [-DataEncryptionEncrypt]
...
```
Set-DiskStorage -InputObject <ICommvaultPowerShellIdentity> [-DataEncryptionCipher <String>]
