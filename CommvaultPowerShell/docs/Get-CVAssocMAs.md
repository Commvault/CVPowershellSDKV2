...
online version: https://learn.microsoft.com/powershell/module/commvaultpowershell/get-cvassocmas
schema: 2.0.0
---
...
### Get (Default)
```
Get-CVAssocMAs -PlanId <Int64> [-PackageName <String>] [<CommonParameters>]
```

### GetViaIdentity
```
Get-CVAssocMAs -InputObject <ICommvaultPowerShellIdentity> [-PackageName <String>] [<CommonParameters>]
```
...
### -PackageName
Provide the name of the package that needs to be checked if installed on the Media Agents.
isPackageInstalled will be populated accordingly.
By default it checks for Media agent package.
Refer to packageName list.
...
### Commvault.Powershell.Models.IAssociatedMAsForPlanResp
