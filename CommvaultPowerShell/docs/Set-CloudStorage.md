...
online version: https://docs.microsoft.com/en-us/powershell/module/commvaultpowershell/set-cloudstorage
schema: 2.0.0
---
...
```
Set-CloudStorage -CloudStorageId <Int64> [-EncryptionCipher <String>] [-EncryptionEncrypt]
...
```
Set-CloudStorage -InputObject <ICommvaultPowerShellIdentity> [-EncryptionCipher <String>] [-EncryptionEncrypt]
 [-EncryptionKeyLength <Int64>] [-KeyProviderId <Int64>] [-KeyProviderName <String>] [-NewName <String>]
 [-Security <IUpdateSecurityAssoc[]>] [-Confirm] [-WhatIf] [<CommonParameters>]
```
