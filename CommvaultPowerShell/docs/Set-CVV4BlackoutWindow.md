...
online version: https://learn.microsoft.com/powershell/module/commvaultpowershell/set-cvv4blackoutwindow
schema: 2.0.0
---

# Set-CVV4BlackoutWindow
...
```
Set-CVV4BlackoutWindow -BlackoutWindowId <Int64> [-BackupOperations <String[]>] [-BetweenDateEnd <Int64>]
...
```
Set-CVV4BlackoutWindow -InputObject <ICommvaultPowerShellIdentity> [-BackupOperations <String[]>]
