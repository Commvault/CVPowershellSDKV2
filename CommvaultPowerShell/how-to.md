# How-To
This document describes how to develop for `CommvaultPowershell`.

## Building `CommvaultPowershell`
...
- `run-module.ps1`
  - Creates an isolated PowerShell session and loads `CommvaultPowershell` into the session.
