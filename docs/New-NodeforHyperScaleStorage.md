...
online version: https://docs.microsoft.com/en-us/powershell/module/commvaultpowershell/new-nodeforhyperscalestorage
schema: 2.0.0
---

# New-NodeforHyperScaleStorage
...
```
New-NodeforHyperScaleStorage -HyperScaleStorageId <Int32> [-Nodes <IIdName[]>] [-PassThru] [-Confirm]
