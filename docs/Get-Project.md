...
online version: https://docs.microsoft.com/en-us/powershell/module/commvaultpowershell/get-project
schema: 2.0.0
---
...
### Get (Default)
```
Get-Project -RequestId <Int64> [<CommonParameters>]
```

### GetViaIdentity
```
Get-Project -InputObject <ICommvaultPowerShellIdentity> [<CommonParameters>]
```
