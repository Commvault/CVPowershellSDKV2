...
### SetExpanded (Default)
```
Set-HypervisorAccessNode -HypervisorId <Int64> [-AccessNodeId <Int64>] [-AccessNodeName <String>] [-PassThru]
 [-Confirm] [-WhatIf] [<CommonParameters>]
```

### Set
```
Set-HypervisorAccessNode -HypervisorId <Int64>
...
```
Set-HypervisorAccessNode -InputObject <ICommvaultPowerShellIdentity> [-AccessNodeId <Int64>]
