...
online version: https://docs.microsoft.com/en-us/powershell/module/commvaultpowershell/get-blackoutwindowdetail
schema: 2.0.0
---

# Get-BlackoutWindowDetail
...
### Get (Default)
```
Get-BlackoutWindowDetail -BlackoutWindowId <Int64> [-PassThru] [<CommonParameters>]
```

### GetViaIdentity
```
Get-BlackoutWindowDetail -InputObject <ICommvaultPowerShellIdentity> [-PassThru] [<CommonParameters>]
```
