...
online version: https://docs.microsoft.com/en-us/powershell/module/commvaultpowershell/get-replicationgroupdetail
schema: 2.0.0
---

# Get-ReplicationGroupDetail
...
### Get (Default)
```
Get-ReplicationGroupDetail -ReplicationGroupId <String> [-OverrideReplicationOptions]
 [-ViewReplicationOptions] [-PassThru] [<CommonParameters>]
```

### GetViaIdentity
```
Get-ReplicationGroupDetail -InputObject <ICommvaultPowerShellIdentity> [-OverrideReplicationOptions]
 [-ViewReplicationOptions] [-PassThru] [<CommonParameters>]
```
