...
online version: https://docs.microsoft.com/en-us/powershell/module/commvaultpowershell/remove-diskaccesspath
schema: 2.0.0
---

# Remove-DiskAccessPath
...
### Delete (Default)
```
Remove-DiskAccessPath -AccessPathId <Int64> -BackupLocationId <Int64> -StoragePoolId <Int64> [-PassThru]
 [-Confirm] [-WhatIf] [<CommonParameters>]
```

### DeleteViaIdentity
```
Remove-DiskAccessPath -InputObject <ICommvaultPowerShellIdentity> [-PassThru] [-Confirm] [-WhatIf]
 [<CommonParameters>]
```
