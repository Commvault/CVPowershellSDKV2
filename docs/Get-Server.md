...
### Get (Default)
```
Get-Server [-ShowOnlyInfrastructureMachines <Int32>] [<CommonParameters>]
```

### Get1
```
Get-Server -CompanyId <Int32> [<CommonParameters>]
```

### GetViaIdentity
```
Get-Server -InputObject <ICommvaultPowerShellIdentity> [<CommonParameters>]
```
