...
online version: https://docs.microsoft.com/en-us/powershell/module/commvaultpowershell/get-userdetail
schema: 2.0.0
---
...
### Get (Default)
```
Get-UserDetail -UserId <Int64> [-Mode <String>] [-PassThru] [<CommonParameters>]
```

### GetViaIdentity
```
Get-UserDetail -InputObject <ICommvaultPowerShellIdentity> [-Mode <String>] [-PassThru] [<CommonParameters>]
```
