...
### Disable (Default)
```
Disable-BackupInstance -InstanceId <Int64> [-EnableAfterADelay <Int64>] [-Confirm] [-WhatIf]
 [<CommonParameters>]
```

### DisableViaIdentity
```
Disable-BackupInstance -InputObject <ICommvaultPowerShellIdentity> [-EnableAfterADelay <Int64>] [-Confirm]
