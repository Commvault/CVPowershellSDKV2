...
online version: https://docs.microsoft.com/en-us/powershell/module/commvaultpowershell/invoke-modifytriggeredalertnote
schema: 2.0.0
---

# Invoke-ModifyTriggeredAlertNote
...
```
Invoke-ModifyTriggeredAlertNote -Id <Int32> [-Notes <String>] [-PassThru] [-Confirm] [-WhatIf]
 [<CommonParameters>]
```

### Modify
```
Invoke-ModifyTriggeredAlertNote -Id <Int32> -Body <IUpdateTriggeredAlertsNotes> [-PassThru] [-Confirm]
 [-WhatIf] [<CommonParameters>]
```

### ModifyViaIdentity
```
Invoke-ModifyTriggeredAlertNote -InputObject <ICommvaultPowerShellIdentity>
 -Body <IUpdateTriggeredAlertsNotes> [-PassThru] [-Confirm] [-WhatIf] [<CommonParameters>]
```

### ModifyViaIdentityExpanded
```
Invoke-ModifyTriggeredAlertNote -InputObject <ICommvaultPowerShellIdentity> [-Notes <String>] [-PassThru]
