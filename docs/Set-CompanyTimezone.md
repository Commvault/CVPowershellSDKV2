...
online version: https://docs.microsoft.com/en-us/powershell/module/commvaultpowershell/set-companytimezone
schema: 2.0.0
---
...
```
Set-CompanyTimezone -CompanyId <Int32> [-Clients <IIdName[]>] [-UpdateAll] [-Confirm] [-WhatIf]
 [<CommonParameters>]
```
