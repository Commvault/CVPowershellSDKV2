...
online version: https://docs.microsoft.com/en-us/powershell/module/commvaultpowershell/set-blackoutwindow
schema: 2.0.0
---
...
```
Set-BlackoutWindow -BlackoutWindowId <Int64> [-BackupOperations <String[]>] [-BetweenDateEnd <Int64>]
...
```
Set-BlackoutWindow -InputObject <ICommvaultPowerShellIdentity> [-BackupOperations <String[]>]
