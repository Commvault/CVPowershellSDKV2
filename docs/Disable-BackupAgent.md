...
online version: https://docs.microsoft.com/en-us/powershell/module/commvaultpowershell/disable-backupagent
schema: 2.0.0
---
...
### Disable (Default)
```
Disable-BackupAgent -AgentId <Int32> -ServerId <Int32> [-EnableAfterADelay <Int32>] [-PassThru] [-Confirm]
 [-WhatIf] [<CommonParameters>]
```

### DisableViaIdentity
```
Disable-BackupAgent -InputObject <ICommvaultPowerShellIdentity> [-EnableAfterADelay <Int32>] [-PassThru]
