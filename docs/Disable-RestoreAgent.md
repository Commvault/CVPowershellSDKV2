...
### Disable (Default)
```
Disable-RestoreAgent -AgentId <Int32> -ServerId <Int32> [-EnableAfterADelay <Int32>] [-PassThru] [-Confirm]
 [-WhatIf] [<CommonParameters>]
```

### DisableViaIdentity
```
Disable-RestoreAgent -InputObject <ICommvaultPowerShellIdentity> [-EnableAfterADelay <Int32>] [-PassThru]
