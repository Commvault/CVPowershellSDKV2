...
online version: https://docs.microsoft.com/en-us/powershell/module/commvaultpowershell/invoke-modifycloudstorage
schema: 2.0.0
---

# Invoke-ModifyCloudStorage
...
```
Invoke-ModifyCloudStorage -CloudStorageId <Int32> [-EncryptionCipher <String>] [-EncryptionEncrypt]
...
### Modify
```
Invoke-ModifyCloudStorage -CloudStorageId <Int32> -Body <IUpdateCloudStorage> [-Confirm] [-WhatIf]
 [<CommonParameters>]
```

### ModifyViaIdentity
```
Invoke-ModifyCloudStorage -InputObject <ICommvaultPowerShellIdentity> -Body <IUpdateCloudStorage> [-Confirm]
 [-WhatIf] [<CommonParameters>]
```

### ModifyViaIdentityExpanded
```
Invoke-ModifyCloudStorage -InputObject <ICommvaultPowerShellIdentity> [-EncryptionCipher <String>]
