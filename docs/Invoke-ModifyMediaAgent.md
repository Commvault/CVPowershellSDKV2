...
online version: https://docs.microsoft.com/en-us/powershell/module/commvaultpowershell/invoke-modifymediaagent
schema: 2.0.0
---

# Invoke-ModifyMediaAgent
...
```
Invoke-ModifyMediaAgent -MediaAgentId <Int32> [-ControlEnabled] [-ControlMaintenanceMode]
 [-ControlOptimizeForConcurrentLanBackups] [-ControlParallelDataTransferOperations <Int32>]
 [-ControlRansomwareProtection] [-Description <String>] [-IndexCachePath <String>] [-LogCacheEnabled]
 [-LogCachePath <String>] [-RoleId <Int32>] [-RoleName <String>] [-UserGroupId <Int32>]
 [-UserGroupName <String>] [-UserId <Int32>] [-UserName <String>] [-PassThru] [-Confirm] [-WhatIf]
 [<CommonParameters>]
```

### Modify
```
Invoke-ModifyMediaAgent -MediaAgentId <Int32> -Body <IUpdateMediaAgent> [-PassThru] [-Confirm] [-WhatIf]
 [<CommonParameters>]
```

### ModifyViaIdentity
```
Invoke-ModifyMediaAgent -InputObject <ICommvaultPowerShellIdentity> -Body <IUpdateMediaAgent> [-PassThru]
 [-Confirm] [-WhatIf] [<CommonParameters>]
```

### ModifyViaIdentityExpanded
```
Invoke-ModifyMediaAgent -InputObject <ICommvaultPowerShellIdentity> [-ControlEnabled]
 [-ControlMaintenanceMode] [-ControlOptimizeForConcurrentLanBackups]
 [-ControlParallelDataTransferOperations <Int32>] [-ControlRansomwareProtection] [-Description <String>]
 [-IndexCachePath <String>] [-LogCacheEnabled] [-LogCachePath <String>] [-RoleId <Int32>] [-RoleName <String>]
 [-UserGroupId <Int32>] [-UserGroupName <String>] [-UserId <Int32>] [-UserName <String>] [-PassThru]
 [-Confirm] [-WhatIf] [<CommonParameters>]
```
...
```yaml
Type: Commvault.Powershell.Models.IUpdateMediaAgent
...
BODY <IUpdateMediaAgent>: .
  ...
  - `[ControlParallelDataTransferOperations <Int32?>]`: Specifies the number of parallel data operations that can take place. 
