...
online version: https://docs.microsoft.com/en-us/powershell/module/commvaultpowershell/get-backupdestination
schema: 2.0.0
---
...
### Get (Default)
```
Get-BackupDestination -PlanId <Int64> [-PassThru] [<CommonParameters>]
```

### GetViaIdentity
```
Get-BackupDestination -InputObject <ICommvaultPowerShellIdentity> [-PassThru] [<CommonParameters>]
```
