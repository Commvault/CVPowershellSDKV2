...
online version: https://docs.microsoft.com/en-us/powershell/module/commvaultpowershell/remove-storageregion
schema: 2.0.0
---

# Remove-StorageRegion
...
### Delete (Default)
```
Remove-StorageRegion -PlanId <Int32> -RegionList <String> [-IsRegionIdList] [-PassThru] [-Confirm] [-WhatIf]
 [<CommonParameters>]
```
...
### DeleteViaIdentity
```
Remove-StorageRegion -InputObject <ICommvaultPowerShellIdentity> [-IsRegionIdList] [-PassThru] [-Confirm]
