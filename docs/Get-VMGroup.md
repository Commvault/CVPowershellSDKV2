...
online version: https://docs.microsoft.com/en-us/powershell/module/commvaultpowershell/get-vmgroup
schema: 2.0.0
---
...
### Get (Default)
```
Get-VMGroup [-HypervisorId <Int32>] [<CommonParameters>]
```

### Get1
```
Get-VMGroup -VMGroupId <Int32> [<CommonParameters>]
```

### GetViaIdentity
```
Get-VMGroup -InputObject <ICommvaultPowerShellIdentity> [<CommonParameters>]
```
