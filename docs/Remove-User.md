...
online version: https://docs.microsoft.com/en-us/powershell/module/commvaultpowershell/remove-user
schema: 2.0.0
---
...
### Delete (Default)
```
Remove-User -UserId <Int64> [-SkipOwnerShipTransfer] [-TransferToUser <Int64>] [-TransfertoUserGroup <Int64>]
 [-PassThru] [-Confirm] [-WhatIf] [<CommonParameters>]
```

### DeleteViaIdentity
```
Remove-User -InputObject <ICommvaultPowerShellIdentity> [-SkipOwnerShipTransfer] [-TransferToUser <Int64>]
