...
online version: https://docs.microsoft.com/en-us/powershell/module/commvaultpowershell/invoke-modifyarchivebackupdestination
schema: 2.0.0
---

# Invoke-ModifyArchiveBackupDestination
...
```
Invoke-ModifyArchiveBackupDestination -BackupDestinationId <Int32> -PlanId <Int32> [-NewName <String>]
 [-RetentionPeriodDays <Int32>] [-SourceCopyId <Int32>] [-SourceCopyName <String>] [-PassThru] [-Confirm]
 [-WhatIf] [<CommonParameters>]
```

### Modify
```
Invoke-ModifyArchiveBackupDestination -BackupDestinationId <Int32> -PlanId <Int32>
 -Body <IUpdateArchivePlanBackupDestination> [-PassThru] [-Confirm] [-WhatIf] [<CommonParameters>]
```

### ModifyViaIdentity
```
Invoke-ModifyArchiveBackupDestination -InputObject <ICommvaultPowerShellIdentity>
 -Body <IUpdateArchivePlanBackupDestination> [-PassThru] [-Confirm] [-WhatIf] [<CommonParameters>]
```

### ModifyViaIdentityExpanded
```
Invoke-ModifyArchiveBackupDestination -InputObject <ICommvaultPowerShellIdentity> [-NewName <String>]
 [-RetentionPeriodDays <Int32>] [-SourceCopyId <Int32>] [-SourceCopyName <String>] [-PassThru] [-Confirm]
 [-WhatIf] [<CommonParameters>]
```
...
```yaml
Type: Commvault.Powershell.Models.IUpdateArchivePlanBackupDestination
