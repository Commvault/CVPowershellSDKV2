...
online version: https://docs.microsoft.com/en-us/powershell/module/commvaultpowershell/new-backuplocation
schema: 2.0.0
---
...
```
New-BackupLocation -StoragePoolId <Int32> -BackupLocation <String> [-CredentialsName <String>]
 [-CredentialsPassword <String>] [-MediaAgentId <Int32>] [-MediaAgentName <String>]
 [-SavedCredentialsId <Int32>] [-SavedCredentialsName <String>] [-PassThru] [-Confirm] [-WhatIf]
 [<CommonParameters>]
```

### Create
```
New-BackupLocation -StoragePoolId <Int32> -Body <ICreateBackupLocation> [-PassThru] [-Confirm] [-WhatIf]
 [<CommonParameters>]
```

### CreateViaIdentity
```
New-BackupLocation -InputObject <ICommvaultPowerShellIdentity> -Body <ICreateBackupLocation> [-PassThru]
 [-Confirm] [-WhatIf] [<CommonParameters>]
```

### CreateViaIdentityExpanded
```
New-BackupLocation -InputObject <ICommvaultPowerShellIdentity> -BackupLocation <String>
 [-CredentialsName <String>] [-CredentialsPassword <String>] [-MediaAgentId <Int32>]
 [-MediaAgentName <String>] [-SavedCredentialsId <Int32>] [-SavedCredentialsName <String>] [-PassThru]
 [-Confirm] [-WhatIf] [<CommonParameters>]
```
...
```yaml
Type: Commvault.Powershell.Models.ICreateBackupLocation
