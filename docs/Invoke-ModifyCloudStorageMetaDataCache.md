...
online version: https://docs.microsoft.com/en-us/powershell/module/commvaultpowershell/invoke-modifycloudstoragemetadatacache
schema: 2.0.0
---

# Invoke-ModifyCloudStorageMetaDataCache
...
```
Invoke-ModifyCloudStorageMetaDataCache -CloudStorageId <Int32> -MetadataCacheId <Int32> -Path <String>
 [-CredentialsName <String>] [-CredentialsPassword <String>] [-SavedCredentialsId <Int32>]
 [-SavedCredentialsName <String>] [-Confirm] [-WhatIf] [<CommonParameters>]
```

### Modify
```
Invoke-ModifyCloudStorageMetaDataCache -CloudStorageId <Int32> -MetadataCacheId <Int32>
 -Body <IUpdateMetadataCacheConfiguration> [-Confirm] [-WhatIf] [<CommonParameters>]
```

### ModifyViaIdentity
```
Invoke-ModifyCloudStorageMetaDataCache -InputObject <ICommvaultPowerShellIdentity>
 -Body <IUpdateMetadataCacheConfiguration> [-Confirm] [-WhatIf] [<CommonParameters>]
```

### ModifyViaIdentityExpanded
```
Invoke-ModifyCloudStorageMetaDataCache -InputObject <ICommvaultPowerShellIdentity> -Path <String>
 [-CredentialsName <String>] [-CredentialsPassword <String>] [-SavedCredentialsId <Int32>]
 [-SavedCredentialsName <String>] [-Confirm] [-WhatIf] [<CommonParameters>]
```
