...
online version: https://docs.microsoft.com/en-us/powershell/module/commvaultpowershell/invoke-modifydiskstorage
schema: 2.0.0
---

# Invoke-ModifyDiskStorage
...
```
Invoke-ModifyDiskStorage -StoragePoolId <Int32> [-DataEncryptionCipher <String>] [-DataEncryptionEncrypt]
 [-DataEncryptionKeyLength <Int32>] [-KeyProviderId <Int32>] [-KeyProviderName <String>] [-NewName <String>]
 [-Security <IUpdateSecurityAssoc[]>] [-PassThru] [-Confirm] [-WhatIf] [<CommonParameters>]
```

### Modify
```
Invoke-ModifyDiskStorage -StoragePoolId <Int32> -Body <IUpdateDiskStorage> [-PassThru] [-Confirm] [-WhatIf]
 [<CommonParameters>]
```

### ModifyViaIdentity
```
Invoke-ModifyDiskStorage -InputObject <ICommvaultPowerShellIdentity> -Body <IUpdateDiskStorage> [-PassThru]
 [-Confirm] [-WhatIf] [<CommonParameters>]
```

### ModifyViaIdentityExpanded
```
Invoke-ModifyDiskStorage -InputObject <ICommvaultPowerShellIdentity> [-DataEncryptionCipher <String>]
 [-DataEncryptionEncrypt] [-DataEncryptionKeyLength <Int32>] [-KeyProviderId <Int32>]
 [-KeyProviderName <String>] [-NewName <String>] [-Security <IUpdateSecurityAssoc[]>] [-PassThru] [-Confirm]
...
```yaml
Type: Commvault.Powershell.Models.IUpdateDiskStorage
...
BODY <IUpdateDiskStorage>: .
  ...
  - `[DataEncryptionKeyLength <Int32?>]`: Different keylengths are present for different kinds of ciphers. Blowfish,Twofish,AES and Serpent all accept both 128 and 256. DES3 accepts only 192. GOST accepts only 256. 
  - `[KeyProviderId <Int32?>]`: 
